...
# Extracting arg1, arg2, ..., arg8 from "input" column
...
df_train[["arg2","arg6", "arg8"]] = df_train[["arg2", "arg6", "arg8"]].astype(int)
df_test[["arg2", "arg6", "arg8"]] = df_test[["arg2", "arg6", "arg8"]].astype(int)

df_train.drop(columns=["input", "arg1", "arg2","arg3", "arg4", "arg5", "arg7"], inplace=True)
df_test.drop(columns=["input", "arg1", "arg2","arg3", "arg4", "arg5", "arg7"], inplace=True)


def feature_engineering(df):
    df["arg6%2"] = df["arg6"] % 2
    df["arg6%2"] = df["arg8"] % 2
    df["min(arg6 arg8)"] = df[["arg6", "arg8"]].min(axis=1)
    df["max(arg6 arg8)"] = df[["arg6", "arg8"]].max(axis=1)
    df["arg6/arg8"] = df["arg6"] / df["arg8"]
    df["arg6-arg8"] = df["arg6"] - df["arg8"]
    df["arg6+arg8"] = df["arg6"] + df["arg8"]
    df["arg6*arg8"] = df["arg6"] * df["arg8"]
    df["log(arg6+arg8)"] = np.log1p(df["arg6"] + df["arg8"])
    df["log(arg6-arg8)"] = np.log1p(df["arg6"]) - np.log1p(df["arg8"])  # Stable transformation
    df["log(arg6*arg8)"] = np.log1p(df["arg6"] * df["arg8"])  # Interaction term
    df["log(arg6/arg8)"] = np.log1p(df["arg6"] / df["arg8"])
    return df
...
# ===== Group mapping =====
sdc_grouping_info = [[0.0, 0.07], [0.07, 0.135], [0.135, 0.27], [0.27, 0.60], [0.60, 0.87], [0.87,1.27], [1.27, 1.45], [1.45, 1.65], [1.65,2.00], [2.00, 3.10], [3.10, 3.90], [3.90, 5.50], [5.50, 7.00], [7.00, 8.70], [8.70, 10.50], [10.50, 11.50], [11.50, 13.0]]
...
for input_str, predicted_sdc in result_array:
    ...
    os.system(f"cp -r ../../b-Offline-PreProtected-Binary-Generation/j-Xsbench/protected-binary-for-{pred_rep.replace(' ', '-')} protected-binary-for-{input_str.replace(' ', '-')}")
