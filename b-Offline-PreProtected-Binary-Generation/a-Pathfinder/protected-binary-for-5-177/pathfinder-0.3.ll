...
; <label>:109                                     ; preds = %139, %108
  ...
  %112 = load i32* @cols, align 4, !llfi_index !116
  %113 = icmp slt i32 %110, %112, !llfi_index !117
  %114 = icmp slt i32 %111, %112, !llfi_index !117
  %check_cmp11 = icmp eq i1 %113, %114
...
; <label>:115                                     ; preds = %checkBb12, %109
  br i1 %113, label %116, label %140, !llfi_index !118

; <label>:116                                     ; preds = %115
  %117 = load i32* %j1, align 4, !llfi_index !119
  %118 = sext i32 %117 to i64, !llfi_index !120
  %119 = sext i32 %117 to i64, !llfi_index !120
  ...
  %123 = load i32** %121, align 8, !llfi_index !123
  %124 = getelementptr inbounds i32* %122, i64 %118, !llfi_index !124
  %125 = getelementptr inbounds i32* %123, i64 %119, !llfi_index !124
...
; <label>:126                                     ; preds = %checkBb14, %116
  %127 = load i32* %124, align 4, !llfi_index !125
  %128 = load i32* %j1, align 4, !llfi_index !126
  %129 = load i32* %j1, align 4, !llfi_index !126
  %check_cmp15 = icmp eq i32 %128, %129
...
; <label>:130                                     ; preds = %checkBb16, %126
  %131 = sext i32 %128 to i64, !llfi_index !127
  %132 = load i32** @result, align 8, !llfi_index !128
  %133 = getelementptr inbounds i32* %132, i64 %131, !llfi_index !129
  store i32 %127, i32* %133, align 4, !llfi_index !130
  br label %134, !llfi_index !131

; <label>:134                                     ; preds = %130
  %135 = load i32* %j1, align 4, !llfi_index !132
  %136 = load i32* %j1, align 4, !llfi_index !132
  %137 = add nsw i32 %135, 1, !llfi_index !133
...
; <label>:139                                     ; preds = %checkBb18, %134
  store i32 %137, i32* %j1, align 4, !llfi_index !134
...
; <label>:141                                     ; preds = %187, %140
  ...
  %143 = load i32* @rows, align 4, !llfi_index !139
  %144 = icmp slt i32 %142, %143, !llfi_index !140
  %145 = icmp slt i32 %142, %143, !llfi_index !140
...
; <label>:162                                     ; preds = %checkBb24, %155
  %163 = sext i32 %160 to i64, !llfi_index !151
  ...
  %167 = load i32** %165, align 8, !llfi_index !154
  %168 = getelementptr inbounds i32* %166, i64 %158, !llfi_index !155
  %169 = getelementptr inbounds i32* %167, i64 %159, !llfi_index !155
  %170 = load i32* %168, align 4, !llfi_index !156
  %171 = load i32* %169, align 4, !llfi_index !156
...
; <label>:172                                     ; preds = %checkBb26, %162
  %173 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str12, i32 0, i32 0), i32 %170), !llfi_index !157
  br label %174, !llfi_index !158

; <label>:174                                     ; preds = %172
  %175 = load i32* %j3, align 4, !llfi_index !159
  %176 = load i32* %j3, align 4, !llfi_index !159
  %177 = add nsw i32 %175, 1, !llfi_index !160
  %178 = add nsw i32 %176, 1, !llfi_index !160
  %check_cmp27 = icmp eq i32 %177, %178
...
; <label>:179                                     ; preds = %checkBb28, %174
  store i32 %177, i32* %j3, align 4, !llfi_index !161
  br label %148, !llfi_index !162

; <label>:180                                     ; preds = %154
  %181 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0)), !llfi_index !163
  br label %182, !llfi_index !164

; <label>:182                                     ; preds = %180
  %183 = load i32* %i2, align 4, !llfi_index !165
  %184 = load i32* %i2, align 4, !llfi_index !165
  %185 = add nsw i32 %183, 1, !llfi_index !166
  %186 = add nsw i32 %184, 1, !llfi_index !166
  %check_cmp29 = icmp eq i32 %185, %186
...
; <label>:187                                     ; preds = %checkBb30, %182
  store i32 %185, i32* %i2, align 4, !llfi_index !167
...
; <label>:40                                      ; preds = %checkBb4, %30
  ...
  br i1 %42, label %43, label %69, !llfi_index !240
...
; <label>:56                                      ; preds = %43
  ...
  %58 = sub nsw i32 %57, 1, !llfi_index !253
  %59 = sext i32 %58 to i64, !llfi_index !254
  %60 = sext i32 %58 to i64, !llfi_index !254
  %61 = load i32** %src, align 8, !llfi_index !255
  %62 = load i32** %src, align 8, !llfi_index !255
  %63 = getelementptr inbounds i32* %61, i64 %59, !llfi_index !256
...
; <label>:65                                      ; preds = %checkBb8, %56
  %66 = load i32* %63, align 4, !llfi_index !257
  br label %67, !llfi_index !258

; <label>:67                                      ; preds = %65, %55
  %68 = phi i32 [ %53, %55 ], [ %66, %65 ], !llfi_index !259
  store i32 %68, i32* %min, align 4, !llfi_index !260
  br label %69, !llfi_index !261

; <label>:69                                      ; preds = %67, %40
...
; <label>:88                                      ; preds = %checkBb10, %85
  %89 = add nsw i32 %86, 1, !llfi_index !279
  %90 = sext i32 %89 to i64, !llfi_index !280
  %91 = sext i32 %89 to i64, !llfi_index !280
  %92 = load i32** %src, align 8, !llfi_index !281
  %93 = load i32** %src, align 8, !llfi_index !281
  %94 = getelementptr inbounds i32* %92, i64 %90, !llfi_index !282
...
; <label>:96                                      ; preds = %checkBb12, %88
  %97 = load i32* %94, align 4, !llfi_index !283
  br label %98, !llfi_index !284

; <label>:98                                      ; preds = %96, %83
  %99 = phi i32 [ %84, %83 ], [ %97, %96 ], !llfi_index !285
...
; <label>:100                                     ; preds = %98, %69
  ...
  %103 = sext i32 %101 to i64, !llfi_index !289
  %check_cmp13 = icmp eq i64 %102, %103
...
; <label>:117                                     ; preds = %checkBb16, %104
  %118 = load i32* %n, align 4, !llfi_index !300
  %119 = sext i32 %118 to i64, !llfi_index !301
  %120 = load i32** %dst, align 8, !llfi_index !302
  %121 = load i32** %dst, align 8, !llfi_index !302
...
; <label>:122                                     ; preds = %checkBb18, %117
  %123 = getelementptr inbounds i32* %120, i64 %119, !llfi_index !303
...
; <label>:138                                     ; preds = %163, %137
  ...
  %check_cmp23 = icmp eq i1 %142, %143
...
; <label>:145                                     ; preds = %144
  ...
  %check_cmp25 = icmp eq i32 %154, %155
  br i1 %check_cmp25, label %156, label %checkBb26

checkBb26:                                        ; preds = %145
  call void @check_flag()
  br label %156

; <label>:156                                     ; preds = %checkBb26, %145
...
; <label>:173                                     ; preds = %172
  ...
  %check_cmp31 = icmp eq i32 %182, %183
