...
; <label>:126                                     ; preds = %159, %125
  ...
  br i1 %129, label %130, label %160, !llfi_index !141
...
; <label>:131                                     ; preds = %149, %130
  ...
  br i1 %134, label %135, label %152, !llfi_index !147
...
; <label>:135                                     ; preds = %131
  ...
  %144 = getelementptr inbounds i32* %142, i64 %137, !llfi_index !155
  %145 = load i32* %143, align 4, !llfi_index !156
  %146 = load i32* %144, align 4, !llfi_index !156
...
; <label>:147                                     ; preds = %checkBb12, %135
  %148 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str12, i32 0, i32 0), i32 %145), !llfi_index !157
  br label %149, !llfi_index !158

; <label>:149                                     ; preds = %147
  %150 = load i32* %j3, align 4, !llfi_index !159
  %151 = add nsw i32 %150, 1, !llfi_index !160
  store i32 %151, i32* %j3, align 4, !llfi_index !161
  br label %131, !llfi_index !162

; <label>:152                                     ; preds = %131
  %153 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0)), !llfi_index !163
  br label %154, !llfi_index !164

; <label>:154                                     ; preds = %152
  %155 = load i32* %i2, align 4, !llfi_index !165
  %156 = load i32* %i2, align 4, !llfi_index !165
  %157 = add nsw i32 %155, 1, !llfi_index !166
  %158 = add nsw i32 %156, 1, !llfi_index !166
  %check_cmp13 = icmp eq i32 %157, %158
  br i1 %check_cmp13, label %159, label %checkBb14

checkBb14:                                        ; preds = %154
  call void @check_flag()
  br label %159

; <label>:159                                     ; preds = %checkBb14, %154
  store i32 %157, i32* %i2, align 4, !llfi_index !167
...
; <label>:18                                      ; preds = %checkBb, %12
  br i1 %16, label %19, label %115, !llfi_index !219
...
; <label>:27                                      ; preds = %23
  ...
  br i1 %34, label %35, label %59, !llfi_index !240
...
; <label>:54                                      ; preds = %checkBb4, %51
  %55 = getelementptr inbounds i32* %52, i64 %49, !llfi_index !256
  %56 = load i32* %55, align 4, !llfi_index !257
  br label %57, !llfi_index !258

; <label>:57                                      ; preds = %54, %44
  %58 = phi i32 [ %45, %44 ], [ %56, %54 ], !llfi_index !259
...
; <label>:59                                      ; preds = %57, %27
  ...
  br i1 %63, label %64, label %88, !llfi_index !266
...
; <label>:75                                      ; preds = %64
  ...
  %78 = sext i32 %77 to i64, !llfi_index !280
  %79 = sext i32 %77 to i64, !llfi_index !280
  %80 = load i32** %src, align 8, !llfi_index !281
  %81 = load i32** %src, align 8, !llfi_index !281
  %82 = getelementptr inbounds i32* %80, i64 %78, !llfi_index !282
  %83 = getelementptr inbounds i32* %81, i64 %79, !llfi_index !282
  %check_cmp5 = icmp eq i32* %82, %83
  br i1 %check_cmp5, label %84, label %checkBb6
...
; <label>:84                                      ; preds = %checkBb6, %75
  %85 = load i32* %82, align 4, !llfi_index !283
  br label %86, !llfi_index !284

; <label>:86                                      ; preds = %84, %73
  %87 = phi i32 [ %74, %73 ], [ %85, %84 ], !llfi_index !285
...
; <label>:105                                     ; preds = %88
  ...
  %107 = add nsw i32 %106, 1, !llfi_index !307
  store i32 %107, i32* %n, align 4, !llfi_index !308
  br label %23, !llfi_index !309

; <label>:108                                     ; preds = %23
  br label %109, !llfi_index !310

; <label>:109                                     ; preds = %108
  %110 = load i32* %t, align 4, !llfi_index !311
  %111 = load i32* %t, align 4, !llfi_index !311
  %112 = add nsw i32 %110, 1, !llfi_index !312
  %113 = add nsw i32 %111, 1, !llfi_index !312
...
; <label>:114                                     ; preds = %checkBb8, %109
  store i32 %112, i32* %t, align 4, !llfi_index !313
  br label %12, !llfi_index !314

; <label>:115                                     ; preds = %18
  store i32 0, i32* %i, align 4, !llfi_index !315
  br label %116, !llfi_index !316

; <label>:116                                     ; preds = %132, %115
  %117 = load i32* %i, align 4, !llfi_index !317
  %118 = load i32* @cols, align 4, !llfi_index !318
  %119 = icmp slt i32 %117, %118, !llfi_index !319
  br i1 %119, label %120, label %135, !llfi_index !320

; <label>:120                                     ; preds = %116
  %121 = load i32* %i, align 4, !llfi_index !321
  %122 = sext i32 %121 to i64, !llfi_index !322
...
; <label>:132                                     ; preds = %130
  ...
  %134 = add nsw i32 %133, 1, !llfi_index !329
  store i32 %134, i32* %i, align 4, !llfi_index !330
  br label %116, !llfi_index !331
...
; <label>:141                                     ; preds = %137
  ...
  %check_cmp11 = icmp eq i32 %142, %143
  br i1 %check_cmp11, label %144, label %checkBb12

checkBb12:                                        ; preds = %141
  call void @check_flag()
  br label %144

; <label>:144                                     ; preds = %checkBb12, %141
