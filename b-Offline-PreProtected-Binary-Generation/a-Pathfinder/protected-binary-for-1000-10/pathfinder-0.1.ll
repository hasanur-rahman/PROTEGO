...
; <label>:86                                      ; preds = %checkBb12, %79
  br i1 %84, label %87, label %119, !llfi_index !85
...
; <label>:95                                      ; preds = %checkBb14, %88
  br i1 %93, label %96, label %112, !llfi_index !91
...
; <label>:100                                     ; preds = %checkBb16, %96
  ...
  %102 = sext i32 %101 to i64, !llfi_index !95
  %103 = load i32* %i, align 4, !llfi_index !96
  %104 = sext i32 %103 to i64, !llfi_index !97
  %105 = load i32*** @wall, align 8, !llfi_index !98
  %106 = getelementptr inbounds i32** %105, i64 %104, !llfi_index !99
  %107 = load i32** %106, align 8, !llfi_index !100
  %108 = getelementptr inbounds i32* %107, i64 %102, !llfi_index !101
  store i32 %98, i32* %108, align 4, !llfi_index !102
  br label %109, !llfi_index !103

; <label>:109                                     ; preds = %100
  %110 = load i32* %j, align 4, !llfi_index !104
  %111 = add nsw i32 %110, 1, !llfi_index !105
...
; <label>:120                                     ; preds = %139, %119
  ...
  %122 = load i32* %j1, align 4, !llfi_index !115
  %123 = load i32* @cols, align 4, !llfi_index !116
  %124 = icmp slt i32 %121, %123, !llfi_index !117
  %125 = icmp slt i32 %122, %123, !llfi_index !117
...
; <label>:126                                     ; preds = %checkBb20, %120
  br i1 %124, label %127, label %142, !llfi_index !118

; <label>:127                                     ; preds = %126
  %128 = load i32* %j1, align 4, !llfi_index !119
  %129 = sext i32 %128 to i64, !llfi_index !120
  %130 = load i32*** @wall, align 8, !llfi_index !121
  %131 = getelementptr inbounds i32** %130, i64 0, !llfi_index !122
  %132 = load i32** %131, align 8, !llfi_index !123
  %133 = getelementptr inbounds i32* %132, i64 %129, !llfi_index !124
  %134 = load i32* %133, align 4, !llfi_index !125
  %135 = load i32* %j1, align 4, !llfi_index !126
  %136 = sext i32 %135 to i64, !llfi_index !127
  %137 = load i32** @result, align 8, !llfi_index !128
  %138 = getelementptr inbounds i32* %137, i64 %136, !llfi_index !129
  store i32 %134, i32* %138, align 4, !llfi_index !130
  br label %139, !llfi_index !131

; <label>:139                                     ; preds = %127
  %140 = load i32* %j1, align 4, !llfi_index !132
  %141 = add nsw i32 %140, 1, !llfi_index !133
  store i32 %141, i32* %j1, align 4, !llfi_index !134
  br label %120, !llfi_index !135

; <label>:142                                     ; preds = %126
  store i32 0, i32* %i2, align 4, !llfi_index !136
  br label %143, !llfi_index !137
...
; <label>:143                                     ; preds = %181, %142
  ...
  %147 = icmp slt i32 %144, %146, !llfi_index !140
...
; <label>:149                                     ; preds = %checkBb22, %143
  br i1 %147, label %150, label %182, !llfi_index !141
...
; <label>:151                                     ; preds = %171, %150
  ...
  %155 = icmp slt i32 %152, %154, !llfi_index !146
  %156 = icmp slt i32 %153, %154, !llfi_index !146
...
; <label>:157                                     ; preds = %checkBb24, %151
  br i1 %155, label %158, label %174, !llfi_index !147

; <label>:158                                     ; preds = %157
  %159 = load i32* %j3, align 4, !llfi_index !148
  %160 = sext i32 %159 to i64, !llfi_index !149
  %161 = load i32* %i2, align 4, !llfi_index !150
  %162 = sext i32 %161 to i64, !llfi_index !151
  %163 = load i32*** @wall, align 8, !llfi_index !152
  %164 = getelementptr inbounds i32** %163, i64 %162, !llfi_index !153
  %165 = load i32** %164, align 8, !llfi_index !154
  %166 = getelementptr inbounds i32* %165, i64 %160, !llfi_index !155
  %167 = load i32* %166, align 4, !llfi_index !156
  %168 = load i32* %166, align 4, !llfi_index !156
...
; <label>:169                                     ; preds = %checkBb26, %158
  %170 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str12, i32 0, i32 0), i32 %167), !llfi_index !157
  br label %171, !llfi_index !158

; <label>:171                                     ; preds = %169
  %172 = load i32* %j3, align 4, !llfi_index !159
  %173 = add nsw i32 %172, 1, !llfi_index !160
...
; <label>:19                                      ; preds = %checkBb, %12
  br i1 %17, label %20, label %113, !llfi_index !219
...
; <label>:30                                      ; preds = %checkBb2, %24
  br i1 %28, label %31, label %106, !llfi_index !231
...
; <label>:31                                      ; preds = %30
  ...
  br i1 %38, label %39, label %59, !llfi_index !240
...
; <label>:50                                      ; preds = %39
  ...
  %55 = getelementptr inbounds i32* %54, i64 %53, !llfi_index !256
  %56 = load i32* %55, align 4, !llfi_index !257
  br label %57, !llfi_index !258

; <label>:57                                      ; preds = %50, %48
  %58 = phi i32 [ %49, %48 ], [ %56, %50 ], !llfi_index !259
  store i32 %58, i32* %min, align 4, !llfi_index !260
  br label %59, !llfi_index !261

; <label>:59                                      ; preds = %57, %31
  %60 = load i32* %n, align 4, !llfi_index !262
  %61 = load i32* @cols, align 4, !llfi_index !263
  %62 = sub nsw i32 %61, 1, !llfi_index !264
  %63 = icmp slt i32 %60, %62, !llfi_index !265
  br i1 %63, label %64, label %86, !llfi_index !266

; <label>:64                                      ; preds = %59
  %65 = load i32* %min, align 4, !llfi_index !267
  %66 = load i32* %n, align 4, !llfi_index !268
  %67 = add nsw i32 %66, 1, !llfi_index !269
  %68 = sext i32 %67 to i64, !llfi_index !270
  %69 = load i32** %src, align 8, !llfi_index !271
  %70 = getelementptr inbounds i32* %69, i64 %68, !llfi_index !272
  %71 = load i32* %70, align 4, !llfi_index !273
  %72 = icmp sle i32 %65, %71, !llfi_index !274
  br i1 %72, label %73, label %75, !llfi_index !275

; <label>:73                                      ; preds = %64
  %74 = load i32* %min, align 4, !llfi_index !276
  br label %84, !llfi_index !277

; <label>:75                                      ; preds = %64
  %76 = load i32* %n, align 4, !llfi_index !278
  %77 = add nsw i32 %76, 1, !llfi_index !279
  %78 = add nsw i32 %76, 1, !llfi_index !279
...
; <label>:79                                      ; preds = %checkBb4, %75
  %80 = sext i32 %77 to i64, !llfi_index !280
...
; <label>:84                                      ; preds = %79, %73
  %85 = phi i32 [ %74, %73 ], [ %83, %79 ], !llfi_index !285
...
; <label>:114                                     ; preds = %128, %113
  ...
  %117 = load i32* @cols, align 4, !llfi_index !318
  %118 = icmp slt i32 %115, %117, !llfi_index !319
  %119 = icmp slt i32 %116, %117, !llfi_index !319
  %check_cmp7 = icmp eq i1 %118, %119
...
; <label>:120                                     ; preds = %checkBb8, %114
  br i1 %118, label %121, label %131, !llfi_index !320

; <label>:121                                     ; preds = %120
  %122 = load i32* %i, align 4, !llfi_index !321
  %123 = sext i32 %122 to i64, !llfi_index !322
  ...
  %127 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str12, i32 0, i32 0), i32 %126), !llfi_index !326
  br label %128, !llfi_index !327

; <label>:128                                     ; preds = %121
  %129 = load i32* %i, align 4, !llfi_index !328
  %130 = add nsw i32 %129, 1, !llfi_index !329
  store i32 %130, i32* %i, align 4, !llfi_index !330
  br label %114, !llfi_index !331

; <label>:131                                     ; preds = %120
  %132 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0)), !llfi_index !332
  store i32 0, i32* %i1, align 4, !llfi_index !333
  br label %133, !llfi_index !334

; <label>:133                                     ; preds = %147, %131
  %134 = load i32* %i1, align 4, !llfi_index !335
  %135 = load i32* %i1, align 4, !llfi_index !335
  %136 = load i32* @cols, align 4, !llfi_index !336
  %137 = icmp slt i32 %134, %136, !llfi_index !337
  %138 = icmp slt i32 %135, %136, !llfi_index !337
  %check_cmp9 = icmp eq i1 %137, %138
  br i1 %check_cmp9, label %139, label %checkBb10

checkBb10:                                        ; preds = %133
  call void @check_flag()
  br label %139

; <label>:139                                     ; preds = %checkBb10, %133
  br i1 %137, label %140, label %150, !llfi_index !338

; <label>:140                                     ; preds = %139
  %141 = load i32* %i1, align 4, !llfi_index !339
  %142 = sext i32 %141 to i64, !llfi_index !340
  %143 = load i32** %dst, align 8, !llfi_index !341
  %144 = getelementptr inbounds i32* %143, i64 %142, !llfi_index !342
  %145 = load i32* %144, align 4, !llfi_index !343
  %146 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str12, i32 0, i32 0), i32 %145), !llfi_index !344
  br label %147, !llfi_index !345

; <label>:147                                     ; preds = %140
  %148 = load i32* %i1, align 4, !llfi_index !346
  %149 = add nsw i32 %148, 1, !llfi_index !347
  store i32 %149, i32* %i1, align 4, !llfi_index !348
  br label %133, !llfi_index !349

; <label>:150                                     ; preds = %139
  %151 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0)), !llfi_index !350
  %152 = load i32** @data, align 8, !llfi_index !351
  %153 = icmp eq i32* %152, null, !llfi_index !352
  br i1 %153, label %156, label %154, !llfi_index !353

; <label>:154                                     ; preds = %150
  %155 = bitcast i32* %152 to i8*, !llfi_index !354
  call void @_ZdaPv(i8* %155) #13, !llfi_index !355
  br label %156, !llfi_index !356

; <label>:156                                     ; preds = %154, %150
  %157 = load i32*** @wall, align 8, !llfi_index !357
  %158 = icmp eq i32** %157, null, !llfi_index !358
  br i1 %158, label %161, label %159, !llfi_index !359

; <label>:159                                     ; preds = %156
  %160 = bitcast i32** %157 to i8*, !llfi_index !360
  call void @_ZdaPv(i8* %160) #13, !llfi_index !361
  br label %161, !llfi_index !362

; <label>:161                                     ; preds = %159, %156
  %162 = load i32** %dst, align 8, !llfi_index !363
  %163 = icmp eq i32* %162, null, !llfi_index !364
  br i1 %163, label %166, label %164, !llfi_index !365

; <label>:164                                     ; preds = %161
  %165 = bitcast i32* %162 to i8*, !llfi_index !366
  call void @_ZdaPv(i8* %165) #13, !llfi_index !367
  br label %166, !llfi_index !368

; <label>:166                                     ; preds = %164, %161
  %167 = load i32** %src, align 8, !llfi_index !369
  %168 = icmp eq i32* %167, null, !llfi_index !370
  br i1 %168, label %171, label %169, !llfi_index !371

; <label>:169                                     ; preds = %166
  %170 = bitcast i32* %167 to i8*, !llfi_index !372
  call void @_ZdaPv(i8* %170) #13, !llfi_index !373
  br label %171, !llfi_index !374
