...
; <label>:76                                      ; preds = %checkBb2, %69
  br i1 %74, label %77, label %107, !llfi_index !85
...
; <label>:85                                      ; preds = %checkBb4, %78
  br i1 %83, label %86, label %100, !llfi_index !91

; <label>:86                                      ; preds = %85
  %87 = call i32 @rand() #12, !llfi_index !92
  %88 = srem i32 %87, 10, !llfi_index !93
  %89 = load i32* %j, align 4, !llfi_index !94
  %90 = sext i32 %89 to i64, !llfi_index !95
  %91 = load i32* %i, align 4, !llfi_index !96
  %92 = sext i32 %91 to i64, !llfi_index !97
  %93 = load i32*** @wall, align 8, !llfi_index !98
  %94 = getelementptr inbounds i32** %93, i64 %92, !llfi_index !99
  %95 = load i32** %94, align 8, !llfi_index !100
  %96 = getelementptr inbounds i32* %95, i64 %90, !llfi_index !101
  store i32 %88, i32* %96, align 4, !llfi_index !102
  br label %97, !llfi_index !103

; <label>:97                                      ; preds = %86
  %98 = load i32* %j, align 4, !llfi_index !104
  %99 = add nsw i32 %98, 1, !llfi_index !105
  store i32 %99, i32* %j, align 4, !llfi_index !106
  br label %78, !llfi_index !107

; <label>:100                                     ; preds = %85
  br label %101, !llfi_index !108

; <label>:101                                     ; preds = %100
  %102 = load i32* %i, align 4, !llfi_index !109
...
; <label>:106                                     ; preds = %checkBb6, %101
  store i32 %104, i32* %i, align 4, !llfi_index !111
  br label %69, !llfi_index !112

; <label>:107                                     ; preds = %76
  store i32 0, i32* %j1, align 4, !llfi_index !113
  br label %108, !llfi_index !114

; <label>:108                                     ; preds = %130, %107
  %109 = load i32* %j1, align 4, !llfi_index !115
  %110 = load i32* @cols, align 4, !llfi_index !116
  %111 = icmp slt i32 %109, %110, !llfi_index !117
  %112 = icmp slt i32 %109, %110, !llfi_index !117
  %check_cmp7 = icmp eq i1 %111, %112
...
; <label>:113                                     ; preds = %checkBb8, %108
  br i1 %111, label %114, label %131, !llfi_index !118

; <label>:114                                     ; preds = %113
  %115 = load i32* %j1, align 4, !llfi_index !119
  %116 = sext i32 %115 to i64, !llfi_index !120
  %117 = load i32*** @wall, align 8, !llfi_index !121
  %118 = getelementptr inbounds i32** %117, i64 0, !llfi_index !122
  %119 = load i32** %118, align 8, !llfi_index !123
  %120 = getelementptr inbounds i32* %119, i64 %116, !llfi_index !124
  %121 = load i32* %120, align 4, !llfi_index !125
  %122 = load i32* %j1, align 4, !llfi_index !126
  %123 = sext i32 %122 to i64, !llfi_index !127
  %124 = load i32** @result, align 8, !llfi_index !128
  %125 = getelementptr inbounds i32* %124, i64 %123, !llfi_index !129
  store i32 %121, i32* %125, align 4, !llfi_index !130
  br label %126, !llfi_index !131

; <label>:126                                     ; preds = %114
  %127 = load i32* %j1, align 4, !llfi_index !132
  %128 = add nsw i32 %127, 1, !llfi_index !133
  %129 = add nsw i32 %127, 1, !llfi_index !133
  %check_cmp9 = icmp eq i32 %128, %129
...
; <label>:130                                     ; preds = %checkBb10, %126
  store i32 %128, i32* %j1, align 4, !llfi_index !134
  br label %108, !llfi_index !135

; <label>:131                                     ; preds = %113
  store i32 0, i32* %i2, align 4, !llfi_index !136
  br label %132, !llfi_index !137

; <label>:132                                     ; preds = %177, %131
  %133 = load i32* %i2, align 4, !llfi_index !138
  %134 = load i32* %i2, align 4, !llfi_index !138
  %135 = load i32* @rows, align 4, !llfi_index !139
  %136 = load i32* @rows, align 4, !llfi_index !139
  %137 = icmp slt i32 %133, %135, !llfi_index !140
  %138 = icmp slt i32 %134, %136, !llfi_index !140
  %check_cmp11 = icmp eq i1 %137, %138
  br i1 %check_cmp11, label %139, label %checkBb12

checkBb12:                                        ; preds = %132
  call void @check_flag()
  br label %139

; <label>:139                                     ; preds = %checkBb12, %132
  br i1 %137, label %140, label %178, !llfi_index !141

; <label>:140                                     ; preds = %139
  store i32 0, i32* %j3, align 4, !llfi_index !142
  br label %141, !llfi_index !143

; <label>:141                                     ; preds = %168, %140
  %142 = load i32* %j3, align 4, !llfi_index !144
  %143 = load i32* @cols, align 4, !llfi_index !145
  %144 = icmp slt i32 %142, %143, !llfi_index !146
...
; <label>:146                                     ; preds = %checkBb14, %141
  br i1 %144, label %147, label %170, !llfi_index !147
...
; <label>:150                                     ; preds = %checkBb16, %147
  %151 = sext i32 %148 to i64, !llfi_index !149
...
; <label>:154                                     ; preds = %checkBb18, %150
  ...
  %159 = getelementptr inbounds i32* %158, i64 %151, !llfi_index !155
  %160 = getelementptr inbounds i32* %158, i64 %151, !llfi_index !155
...
; <label>:163                                     ; preds = %checkBb20, %154
  %164 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str12, i32 0, i32 0), i32 %161), !llfi_index !157
  br label %165, !llfi_index !158
...
; <label>:168                                     ; preds = %checkBb22, %165
  %169 = add nsw i32 %166, 1, !llfi_index !160
  store i32 %169, i32* %j3, align 4, !llfi_index !161
  br label %141, !llfi_index !162
...
; <label>:177                                     ; preds = %checkBb24, %172
  store i32 %175, i32* %i2, align 4, !llfi_index !167
  br label %132, !llfi_index !168
...
; <label>:118                                     ; preds = %checkBb8, %112
  br i1 %116, label %119, label %138, !llfi_index !320

; <label>:119                                     ; preds = %118
  %120 = load i32* %i, align 4, !llfi_index !321
  %121 = load i32* %i, align 4, !llfi_index !321
  %122 = sext i32 %120 to i64, !llfi_index !322
  %123 = sext i32 %121 to i64, !llfi_index !322
  %124 = load i32** @data, align 8, !llfi_index !323
  %125 = load i32** @data, align 8, !llfi_index !323
  %126 = getelementptr inbounds i32* %124, i64 %122, !llfi_index !324
  %127 = getelementptr inbounds i32* %125, i64 %123, !llfi_index !324
  %128 = load i32* %126, align 4, !llfi_index !325
  %129 = load i32* %127, align 4, !llfi_index !325
  %check_cmp9 = icmp eq i32 %128, %129
  br i1 %check_cmp9, label %130, label %checkBb10
...
; <label>:130                                     ; preds = %checkBb10, %119
  %131 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str12, i32 0, i32 0), i32 %128), !llfi_index !326
  br label %132, !llfi_index !327

; <label>:132                                     ; preds = %130
  %133 = load i32* %i, align 4, !llfi_index !328
  %134 = load i32* %i, align 4, !llfi_index !328
  %135 = add nsw i32 %133, 1, !llfi_index !329
  %136 = add nsw i32 %134, 1, !llfi_index !329
  %check_cmp11 = icmp eq i32 %135, %136
  br i1 %check_cmp11, label %137, label %checkBb12

checkBb12:                                        ; preds = %132
  call void @check_flag()
  br label %137

; <label>:137                                     ; preds = %checkBb12, %132
  store i32 %135, i32* %i, align 4, !llfi_index !330
  br label %112, !llfi_index !331

; <label>:138                                     ; preds = %118
  %139 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0)), !llfi_index !332
  store i32 0, i32* %i1, align 4, !llfi_index !333
  br label %140, !llfi_index !334

; <label>:140                                     ; preds = %164, %138
  %141 = load i32* %i1, align 4, !llfi_index !335
  %142 = load i32* @cols, align 4, !llfi_index !336
  %143 = icmp slt i32 %141, %142, !llfi_index !337
  %144 = icmp slt i32 %141, %142, !llfi_index !337
  %check_cmp13 = icmp eq i1 %143, %144
  br i1 %check_cmp13, label %145, label %checkBb14

checkBb14:                                        ; preds = %140
  call void @check_flag()
  br label %145

; <label>:145                                     ; preds = %checkBb14, %140
  br i1 %143, label %146, label %165, !llfi_index !338

; <label>:146                                     ; preds = %145
  %147 = load i32* %i1, align 4, !llfi_index !339
  %148 = load i32* %i1, align 4, !llfi_index !339
  %149 = sext i32 %147 to i64, !llfi_index !340
  %150 = sext i32 %148 to i64, !llfi_index !340
  %151 = load i32** %dst, align 8, !llfi_index !341
  %152 = load i32** %dst, align 8, !llfi_index !341
  %153 = getelementptr inbounds i32* %151, i64 %149, !llfi_index !342
  %154 = getelementptr inbounds i32* %152, i64 %150, !llfi_index !342
  %155 = load i32* %153, align 4, !llfi_index !343
...
; <label>:164                                     ; preds = %checkBb18, %159
  store i32 %162, i32* %i1, align 4, !llfi_index !348
  br label %140, !llfi_index !349
