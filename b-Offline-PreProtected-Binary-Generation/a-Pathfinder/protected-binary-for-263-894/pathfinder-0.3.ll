...
; <label>:97                                      ; preds = %checkBb8, %90
  ...
  %101 = getelementptr inbounds i32** %99, i64 %98, !llfi_index !99
...
; <label>:103                                     ; preds = %checkBb10, %97
  %104 = load i32** %101, align 8, !llfi_index !100
  %105 = getelementptr inbounds i32* %104, i64 %93, !llfi_index !101
...
; <label>:108                                     ; preds = %107
  ...
  %check_cmp13 = icmp eq i32 %111, %112
  br i1 %check_cmp13, label %113, label %checkBb14

checkBb14:                                        ; preds = %108
  call void @check_flag()
  br label %113

; <label>:113                                     ; preds = %checkBb14, %108
...
; <label>:122                                     ; preds = %144, %121
  ...
  %check_cmp17 = icmp eq i1 %125, %126
...
; <label>:146                                     ; preds = %195, %145
  ...
  %check_cmp21 = icmp eq i1 %151, %152
...
; <label>:182                                     ; preds = %180
  ...
  %check_cmp27 = icmp eq i32 %185, %186
...
; <label>:190                                     ; preds = %188
  ...
  %check_cmp29 = icmp eq i32 %193, %194
...
; <label>:18                                      ; preds = %checkBb, %12
  br i1 %16, label %19, label %126, !llfi_index !219
...
; <label>:28                                      ; preds = %checkBb2, %23
  br i1 %26, label %29, label %119, !llfi_index !231
...
; <label>:33                                      ; preds = %checkBb4, %29
  ...
  %35 = getelementptr inbounds i32* %34, i64 %31, !llfi_index !235
  ...
  br i1 %38, label %39, label %65, !llfi_index !240
...
; <label>:57                                      ; preds = %checkBb8, %52
  %58 = load i32** %src, align 8, !llfi_index !255
  %59 = getelementptr inbounds i32* %58, i64 %55, !llfi_index !256
  %60 = load i32* %59, align 4, !llfi_index !257
  %61 = load i32* %59, align 4, !llfi_index !257
...
; <label>:62                                      ; preds = %checkBb10, %57
  br label %63, !llfi_index !258

; <label>:63                                      ; preds = %62, %51
  %64 = phi i32 [ %49, %51 ], [ %60, %62 ], !llfi_index !259
  store i32 %64, i32* %min, align 4, !llfi_index !260
  br label %65, !llfi_index !261

; <label>:65                                      ; preds = %63, %33
  %66 = load i32* %n, align 4, !llfi_index !262
  %67 = load i32* @cols, align 4, !llfi_index !263
  %68 = sub nsw i32 %67, 1, !llfi_index !264
  %69 = icmp slt i32 %66, %68, !llfi_index !265
  br i1 %69, label %70, label %94, !llfi_index !266

; <label>:70                                      ; preds = %65
  %71 = load i32* %min, align 4, !llfi_index !267
  %72 = load i32* %n, align 4, !llfi_index !268
  %73 = add nsw i32 %72, 1, !llfi_index !269
  %74 = sext i32 %73 to i64, !llfi_index !270
  %75 = load i32** %src, align 8, !llfi_index !271
  %76 = getelementptr inbounds i32* %75, i64 %74, !llfi_index !272
  %77 = load i32* %76, align 4, !llfi_index !273
  %78 = icmp sle i32 %71, %77, !llfi_index !274
  br i1 %78, label %79, label %83, !llfi_index !275
...
; <label>:83                                      ; preds = %70
  ...
  %85 = add nsw i32 %84, 1, !llfi_index !279
  %86 = sext i32 %85 to i64, !llfi_index !280
  %87 = sext i32 %85 to i64, !llfi_index !280
  %check_cmp13 = icmp eq i64 %86, %87
...
; <label>:88                                      ; preds = %checkBb14, %83
  ...
  %90 = getelementptr inbounds i32* %89, i64 %86, !llfi_index !282
  %91 = load i32* %90, align 4, !llfi_index !283
  br label %92, !llfi_index !284

; <label>:92                                      ; preds = %88, %82
  %93 = phi i32 [ %80, %82 ], [ %91, %88 ], !llfi_index !285
...
; <label>:94                                      ; preds = %92, %65
  ...
  %111 = getelementptr inbounds i32* %109, i64 %108, !llfi_index !303
...
; <label>:112                                     ; preds = %checkBb16, %94
  store i32 %106, i32* %110, align 4, !llfi_index !304
  br label %113, !llfi_index !305

; <label>:113                                     ; preds = %112
  %114 = load i32* %n, align 4, !llfi_index !306
  %115 = load i32* %n, align 4, !llfi_index !306
  %116 = add nsw i32 %114, 1, !llfi_index !307
  %117 = add nsw i32 %115, 1, !llfi_index !307
...
; <label>:118                                     ; preds = %checkBb18, %113
  store i32 %116, i32* %n, align 4, !llfi_index !308
  br label %23, !llfi_index !309

; <label>:119                                     ; preds = %28
  br label %120, !llfi_index !310

; <label>:120                                     ; preds = %119
  %121 = load i32* %t, align 4, !llfi_index !311
  %122 = load i32* %t, align 4, !llfi_index !311
  %123 = add nsw i32 %121, 1, !llfi_index !312
  %124 = add nsw i32 %122, 1, !llfi_index !312
...
; <label>:125                                     ; preds = %checkBb20, %120
  store i32 %123, i32* %t, align 4, !llfi_index !313
  br label %12, !llfi_index !314

; <label>:126                                     ; preds = %18
  store i32 0, i32* %i, align 4, !llfi_index !315
  br label %127, !llfi_index !316

; <label>:127                                     ; preds = %152, %126
  %128 = load i32* %i, align 4, !llfi_index !317
  %129 = load i32* %i, align 4, !llfi_index !317
  %130 = load i32* @cols, align 4, !llfi_index !318
  %131 = icmp slt i32 %128, %130, !llfi_index !319
  %132 = icmp slt i32 %129, %130, !llfi_index !319
  %check_cmp21 = icmp eq i1 %131, %132
...
; <label>:133                                     ; preds = %checkBb22, %127
  br i1 %131, label %134, label %153, !llfi_index !320

; <label>:134                                     ; preds = %133
  %135 = load i32* %i, align 4, !llfi_index !321
  %136 = load i32* %i, align 4, !llfi_index !321
  %137 = sext i32 %135 to i64, !llfi_index !322
  %138 = sext i32 %136 to i64, !llfi_index !322
  %139 = load i32** @data, align 8, !llfi_index !323
  %140 = load i32** @data, align 8, !llfi_index !323
  %141 = getelementptr inbounds i32* %139, i64 %137, !llfi_index !324
  %142 = getelementptr inbounds i32* %140, i64 %138, !llfi_index !324
  %143 = load i32* %141, align 4, !llfi_index !325
  %144 = load i32* %142, align 4, !llfi_index !325
...
; <label>:145                                     ; preds = %checkBb24, %134
  %146 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str12, i32 0, i32 0), i32 %143), !llfi_index !326
  br label %147, !llfi_index !327

; <label>:147                                     ; preds = %145
  %148 = load i32* %i, align 4, !llfi_index !328
  %149 = load i32* %i, align 4, !llfi_index !328
  %150 = add nsw i32 %148, 1, !llfi_index !329
  %151 = add nsw i32 %149, 1, !llfi_index !329
  %check_cmp25 = icmp eq i32 %150, %151
...
; <label>:152                                     ; preds = %checkBb26, %147
  store i32 %150, i32* %i, align 4, !llfi_index !330
  br label %127, !llfi_index !331

; <label>:153                                     ; preds = %133
  %154 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0)), !llfi_index !332
  store i32 0, i32* %i1, align 4, !llfi_index !333
  br label %155, !llfi_index !334

; <label>:155                                     ; preds = %179, %153
  %156 = load i32* %i1, align 4, !llfi_index !335
  %157 = load i32* @cols, align 4, !llfi_index !336
  %158 = icmp slt i32 %156, %157, !llfi_index !337
  %159 = icmp slt i32 %156, %157, !llfi_index !337
  %check_cmp27 = icmp eq i1 %158, %159
...
; <label>:160                                     ; preds = %checkBb28, %155
  br i1 %158, label %161, label %180, !llfi_index !338

; <label>:161                                     ; preds = %160
  %162 = load i32* %i1, align 4, !llfi_index !339
  %163 = load i32* %i1, align 4, !llfi_index !339
  %164 = sext i32 %162 to i64, !llfi_index !340
  %165 = sext i32 %163 to i64, !llfi_index !340
  %166 = load i32** %dst, align 8, !llfi_index !341
  %167 = load i32** %dst, align 8, !llfi_index !341
  %168 = getelementptr inbounds i32* %166, i64 %164, !llfi_index !342
  %169 = getelementptr inbounds i32* %167, i64 %165, !llfi_index !342
  %170 = load i32* %168, align 4, !llfi_index !343
  %171 = load i32* %169, align 4, !llfi_index !343
...
; <label>:172                                     ; preds = %checkBb30, %161
  %173 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str12, i32 0, i32 0), i32 %170), !llfi_index !344
  br label %174, !llfi_index !345

; <label>:174                                     ; preds = %172
  %175 = load i32* %i1, align 4, !llfi_index !346
  %176 = load i32* %i1, align 4, !llfi_index !346
  %177 = add nsw i32 %175, 1, !llfi_index !347
  %178 = add nsw i32 %176, 1, !llfi_index !347
...
; <label>:179                                     ; preds = %checkBb32, %174
  store i32 %177, i32* %i1, align 4, !llfi_index !348
  br label %155, !llfi_index !349

; <label>:180                                     ; preds = %160
  %181 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0)), !llfi_index !350
  %182 = load i32** @data, align 8, !llfi_index !351
  %183 = icmp eq i32* %182, null, !llfi_index !352
  br i1 %183, label %186, label %184, !llfi_index !353

; <label>:184                                     ; preds = %180
  %185 = bitcast i32* %182 to i8*, !llfi_index !354
  call void @_ZdaPv(i8* %185) #13, !llfi_index !355
  br label %186, !llfi_index !356

; <label>:186                                     ; preds = %184, %180
  %187 = load i32*** @wall, align 8, !llfi_index !357
  %188 = icmp eq i32** %187, null, !llfi_index !358
  br i1 %188, label %191, label %189, !llfi_index !359

; <label>:189                                     ; preds = %186
  %190 = bitcast i32** %187 to i8*, !llfi_index !360
  call void @_ZdaPv(i8* %190) #13, !llfi_index !361
  br label %191, !llfi_index !362

; <label>:191                                     ; preds = %189, %186
  %192 = load i32** %dst, align 8, !llfi_index !363
  %193 = icmp eq i32* %192, null, !llfi_index !364
  br i1 %193, label %196, label %194, !llfi_index !365

; <label>:194                                     ; preds = %191
  %195 = bitcast i32* %192 to i8*, !llfi_index !366
  call void @_ZdaPv(i8* %195) #13, !llfi_index !367
  br label %196, !llfi_index !368

; <label>:196                                     ; preds = %194, %191
  %197 = load i32** %src, align 8, !llfi_index !369
  %198 = icmp eq i32* %197, null, !llfi_index !370
  br i1 %198, label %201, label %199, !llfi_index !371

; <label>:199                                     ; preds = %196
  %200 = bitcast i32* %197 to i8*, !llfi_index !372
  call void @_ZdaPv(i8* %200) #13, !llfi_index !373
  br label %201, !llfi_index !374
