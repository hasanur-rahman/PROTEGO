...
; <label>:2                                       ; preds = %57, %0
  ...
  br i1 %5, label %6, label %60, !llfi_index !468
...
; <label>:19                                      ; preds = %checkBb, %12
  br i1 %17, label %20, label %56, !llfi_index !480
...
; <label>:39                                      ; preds = %checkBb6, %36
  %40 = add nsw i64 %34, %37, !llfi_index !490
  %41 = mul nsw i64 2, %40, !llfi_index !491
  %42 = mul nsw i64 2, %40, !llfi_index !491
  %43 = add nsw i64 %41, 1, !llfi_index !492
  %44 = add nsw i64 %42, 1, !llfi_index !492
  ...
  %check_cmp7 = icmp eq double* %47, %48
...
; <label>:57                                      ; preds = %56
  ...
  %59 = add nsw i64 %58, 1, !llfi_index !503
  store i64 %59, i64* %j, align 8, !llfi_index !504
...
; <label>:15                                      ; preds = %checkBb, %9
  br i1 %13, label %16, label %248, !llfi_index !1731
...
; <label>:54                                      ; preds = %checkBb14, %48
  br i1 %52, label %55, label %241, !llfi_index !1755
...
; <label>:81                                      ; preds = %checkBb26, %77
  %82 = load double** %5, align 8, !llfi_index !1769
  %83 = getelementptr inbounds double* %82, i64 %79, !llfi_index !1770
  store double* %83, double** %x2, align 8, !llfi_index !1771
  store i64 0, i64* %j, align 8, !llfi_index !1772
  br label %84, !llfi_index !1773

; <label>:84                                      ; preds = %232, %81
...
; <label>:98                                      ; preds = %checkBb30, %92
  %99 = load double* %96, align 8, !llfi_index !1782
  store double %99, double* %omega_r, align 8, !llfi_index !1783
...
; <label>:111                                     ; preds = %checkBb32, %98
  %112 = mul nsw i64 2, %109, !llfi_index !1795
  %113 = load double** %x2, align 8, !llfi_index !1796
  %114 = getelementptr inbounds double* %113, i64 %112, !llfi_index !1797
  %115 = load double* %114, align 8, !llfi_index !1798
  store double %115, double* %x_r, align 8, !llfi_index !1799
  %116 = load i64* %j, align 8, !llfi_index !1800
  %117 = mul nsw i64 2, %116, !llfi_index !1801
  %118 = add nsw i64 %117, 1, !llfi_index !1802
  %119 = add nsw i64 %117, 1, !llfi_index !1802
  %120 = load double** %x2, align 8, !llfi_index !1803
  %121 = getelementptr inbounds double* %120, i64 %118, !llfi_index !1804
  %122 = getelementptr inbounds double* %120, i64 %119, !llfi_index !1804
  %check_cmp33 = icmp eq double* %121, %122
...
; <label>:123                                     ; preds = %checkBb34, %111
  %124 = load double* %121, align 8, !llfi_index !1805
  store double %124, double* %x_c, align 8, !llfi_index !1806
  %125 = load double* %omega_r, align 8, !llfi_index !1807
  %126 = load double* %omega_r, align 8, !llfi_index !1807
  %127 = load double* %x_r, align 8, !llfi_index !1808
  %128 = fmul double %125, %127, !llfi_index !1809
  %129 = fmul double %126, %127, !llfi_index !1809
  %130 = load double* %omega_c, align 8, !llfi_index !1810
  %131 = load double* %x_c, align 8, !llfi_index !1811
  %132 = fmul double %130, %131, !llfi_index !1812
  %133 = fsub double %128, %132, !llfi_index !1813
  %134 = fsub double %129, %132, !llfi_index !1813
...
; <label>:135                                     ; preds = %checkBb36, %123
  store double %133, double* %tau_r, align 8, !llfi_index !1814
  %136 = load double* %omega_r, align 8, !llfi_index !1815
...
; <label>:138                                     ; preds = %checkBb38, %135
  %139 = load double* %x_c, align 8, !llfi_index !1816
  %140 = load double* %x_c, align 8, !llfi_index !1816
  %check_cmp39 = fcmp ueq double %139, %140
...
; <label>:141                                     ; preds = %checkBb40, %138
  %142 = fmul double %136, %139, !llfi_index !1817
  %143 = load double* %omega_c, align 8, !llfi_index !1818
  %144 = load double* %x_r, align 8, !llfi_index !1819
  %145 = fmul double %143, %144, !llfi_index !1820
  %146 = fadd double %142, %145, !llfi_index !1821
  %147 = fadd double %142, %145, !llfi_index !1821
...
; <label>:148                                     ; preds = %checkBb42, %141
  store double %146, double* %tau_c, align 8, !llfi_index !1822
  %149 = load i64* %j, align 8, !llfi_index !1823
  %150 = mul nsw i64 2, %149, !llfi_index !1824
  %151 = load double** %x1, align 8, !llfi_index !1825
  %152 = getelementptr inbounds double* %151, i64 %150, !llfi_index !1826
  %153 = load double* %152, align 8, !llfi_index !1827
  %154 = load double* %152, align 8, !llfi_index !1827
  %check_cmp43 = fcmp ueq double %153, %154
  br i1 %check_cmp43, label %155, label %checkBb44

checkBb44:                                        ; preds = %148
  call void @check_flag()
  br label %155

; <label>:155                                     ; preds = %checkBb44, %148
  ...
  %check_cmp45 = icmp eq i64 %156, %157
...
; <label>:158                                     ; preds = %checkBb46, %155
  %159 = mul nsw i64 2, %156, !llfi_index !1830
  %160 = add nsw i64 %159, 1, !llfi_index !1831
  %161 = add nsw i64 %159, 1, !llfi_index !1831
  %check_cmp47 = icmp eq i64 %160, %161
...
; <label>:165                                     ; preds = %checkBb50, %162
  ...
  %168 = load double* %166, align 8, !llfi_index !1834
  %check_cmp51 = fcmp ueq double %167, %168
...
; <label>:169                                     ; preds = %checkBb52, %165
  ...
  %check_cmp53 = fcmp ueq double %170, %171
...
; <label>:172                                     ; preds = %checkBb54, %169
  ...
  %check_cmp55 = fcmp ueq double %173, %174
...
; <label>:175                                     ; preds = %checkBb56, %172
  %176 = fsub double %170, %173, !llfi_index !1838
  %177 = load i64* %j, align 8, !llfi_index !1839
  %178 = mul nsw i64 2, %177, !llfi_index !1840
  %179 = mul nsw i64 2, %177, !llfi_index !1840
  %180 = load double** %x2, align 8, !llfi_index !1841
  %181 = load double** %x2, align 8, !llfi_index !1841
  %182 = getelementptr inbounds double* %180, i64 %178, !llfi_index !1842
  %183 = getelementptr inbounds double* %181, i64 %179, !llfi_index !1842
  %check_cmp57 = icmp eq double* %182, %183
  br i1 %check_cmp57, label %184, label %checkBb58

checkBb58:                                        ; preds = %175
  call void @check_flag()
  br label %184

; <label>:184                                     ; preds = %checkBb58, %175
  store double %176, double* %182, align 8, !llfi_index !1843
  %185 = load double* %x_c, align 8, !llfi_index !1844
  %186 = load double* %tau_c, align 8, !llfi_index !1845
  %187 = fsub double %185, %186, !llfi_index !1846
  %188 = load i64* %j, align 8, !llfi_index !1847
  %189 = mul nsw i64 2, %188, !llfi_index !1848
  %190 = mul nsw i64 2, %188, !llfi_index !1848
  %191 = add nsw i64 %189, 1, !llfi_index !1849
  ...
  %195 = getelementptr inbounds double* %193, i64 %191, !llfi_index !1851
  %196 = getelementptr inbounds double* %194, i64 %192, !llfi_index !1851
  %check_cmp59 = icmp eq double* %195, %196
  br i1 %check_cmp59, label %197, label %checkBb60

checkBb60:                                        ; preds = %184
  call void @check_flag()
  br label %197

; <label>:197                                     ; preds = %checkBb60, %184
  store double %187, double* %195, align 8, !llfi_index !1852
  %198 = load double* %x_r, align 8, !llfi_index !1853
  %199 = load double* %x_r, align 8, !llfi_index !1853
  %200 = load double* %tau_r, align 8, !llfi_index !1854
  %201 = fadd double %198, %200, !llfi_index !1855
  %202 = fadd double %199, %200, !llfi_index !1855
  %check_cmp61 = fcmp ueq double %201, %202
  br i1 %check_cmp61, label %203, label %checkBb62

checkBb62:                                        ; preds = %197
  call void @check_flag()
  br label %203

; <label>:203                                     ; preds = %checkBb62, %197
  %204 = load i64* %j, align 8, !llfi_index !1856
  %205 = load i64* %j, align 8, !llfi_index !1856
  %206 = mul nsw i64 2, %204, !llfi_index !1857
  %207 = mul nsw i64 2, %205, !llfi_index !1857
  %check_cmp63 = icmp eq i64 %206, %207
...
; <label>:208                                     ; preds = %checkBb64, %203
  %209 = load double** %x1, align 8, !llfi_index !1858
  %210 = load double** %x1, align 8, !llfi_index !1858
  %check_cmp65 = icmp eq double* %209, %210
  br i1 %check_cmp65, label %211, label %checkBb66

checkBb66:                                        ; preds = %208
  call void @check_flag()
  br label %211

; <label>:211                                     ; preds = %checkBb66, %208
  %212 = getelementptr inbounds double* %209, i64 %206, !llfi_index !1859
  store double %201, double* %212, align 8, !llfi_index !1860
  %213 = load double* %x_c, align 8, !llfi_index !1861
  %214 = load double* %x_c, align 8, !llfi_index !1861
  %215 = load double* %tau_c, align 8, !llfi_index !1862
  %216 = fadd double %213, %215, !llfi_index !1863
  %217 = fadd double %214, %215, !llfi_index !1863
  %check_cmp67 = fcmp ueq double %216, %217
...
; <label>:218                                     ; preds = %checkBb68, %211
  %219 = load i64* %j, align 8, !llfi_index !1864
  %220 = load i64* %j, align 8, !llfi_index !1864
  %221 = mul nsw i64 2, %219, !llfi_index !1865
  ...
  %226 = getelementptr inbounds double* %225, i64 %223, !llfi_index !1868
  %227 = getelementptr inbounds double* %225, i64 %224, !llfi_index !1868
  %check_cmp69 = icmp eq double* %226, %227
...
; <label>:228                                     ; preds = %checkBb70, %218
  store double %216, double* %226, align 8, !llfi_index !1869
  br label %229, !llfi_index !1870

; <label>:229                                     ; preds = %228
  %230 = load i64* %j, align 8, !llfi_index !1871
  %231 = load i64* %j, align 8, !llfi_index !1871
  %check_cmp71 = icmp eq i64 %230, %231
  br i1 %check_cmp71, label %232, label %checkBb72

checkBb72:                                        ; preds = %229
  call void @check_flag()
  br label %232

; <label>:232                                     ; preds = %checkBb72, %229
  %233 = add nsw i64 %230, 1, !llfi_index !1872
  store i64 %233, i64* %j, align 8, !llfi_index !1873
...
; <label>:235                                     ; preds = %234
  ...
  %check_cmp73 = icmp eq i64 %238, %239
  br i1 %check_cmp73, label %240, label %checkBb74

checkBb74:                                        ; preds = %235
  call void @check_flag()
  br label %240

; <label>:240                                     ; preds = %checkBb74, %235
...
; <label>:242                                     ; preds = %241
  ...
  %check_cmp75 = icmp eq i64 %245, %246
  br i1 %check_cmp75, label %247, label %checkBb76

checkBb76:                                        ; preds = %242
  call void @check_flag()
  br label %247

; <label>:247                                     ; preds = %checkBb76, %242
...
; <label>:70                                      ; preds = %checkBb16, %63
  ...
  store double %71, double* %76, align 8, !llfi_index !2131
