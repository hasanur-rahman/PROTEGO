...
; <label>:154                                     ; preds = %checkBb, %148
  br i1 %152, label %155, label %468, !llfi_index !327
...
; <label>:231                                     ; preds = %checkBb10, %226
  br i1 %229, label %232, label %411, !llfi_index !377
...
; <label>:238                                     ; preds = %checkBb12, %233
  br i1 %236, label %239, label %404, !llfi_index !382
...
; <label>:245                                     ; preds = %checkBb14, %240
  br i1 %243, label %246, label %397, !llfi_index !387
...
; <label>:283                                     ; preds = %checkBb22, %279
  br i1 %281, label %284, label %390, !llfi_index !406
...
; <label>:284                                     ; preds = %283
  ...
  %292 = icmp slt i32 %289, %291, !llfi_index !411
  %293 = icmp slt i32 %290, %291, !llfi_index !411
  %check_cmp23 = icmp eq i1 %292, %293
...
; <label>:303                                     ; preds = %checkBb26, %295
  br i1 %301, label %304, label %390, !llfi_index !417
...
; <label>:304                                     ; preds = %303
  ...
  %313 = icmp slt i32 %309, %311, !llfi_index !422
  %314 = icmp slt i32 %310, %312, !llfi_index !422
  %check_cmp27 = icmp eq i1 %313, %314
  br i1 %check_cmp27, label %315, label %checkBb28

checkBb28:                                        ; preds = %304
  call void @check_flag()
  br label %315

; <label>:315                                     ; preds = %checkBb28, %304
  br i1 %313, label %316, label %390, !llfi_index !423
...
; <label>:320                                     ; preds = %checkBb30, %316
  br i1 %318, label %321, label %390, !llfi_index !426
...
; <label>:327                                     ; preds = %checkBb32, %321
  br i1 %325, label %328, label %390, !llfi_index !430
...
; <label>:352                                     ; preds = %checkBb36, %347
  br i1 %350, label %353, label %369, !llfi_index !450

; <label>:353                                     ; preds = %352
  %354 = load double** %curvalptr, align 8, !llfi_index !451
  %355 = load i32* %curlocalrow, align 4, !llfi_index !452
  %356 = load i32* %curlocalrow, align 4, !llfi_index !452
  %check_cmp37 = icmp eq i32 %355, %356
  br i1 %check_cmp37, label %357, label %checkBb38

checkBb38:                                        ; preds = %353
  call void @check_flag()
  br label %357

; <label>:357                                     ; preds = %checkBb38, %353
  %358 = sext i32 %355 to i64, !llfi_index !453
  ...
  %362 = load double*** %361, align 8, !llfi_index !457
  %363 = getelementptr inbounds double** %362, i64 %358, !llfi_index !458
  store double* %354, double** %363, align 8, !llfi_index !459
  %364 = load double** %curvalptr, align 8, !llfi_index !460
  %365 = load double** %curvalptr, align 8, !llfi_index !460
  %366 = getelementptr inbounds double* %364, i32 1, !llfi_index !461
  %367 = getelementptr inbounds double* %365, i32 1, !llfi_index !461
  %check_cmp39 = icmp eq double* %366, %367
  br i1 %check_cmp39, label %368, label %checkBb40

checkBb40:                                        ; preds = %357
  call void @check_flag()
  br label %368

; <label>:368                                     ; preds = %checkBb40, %357
  store double* %366, double** %curvalptr, align 8, !llfi_index !462
  store double 2.700000e+01, double* %364, align 8, !llfi_index !463
  br label %375, !llfi_index !464

; <label>:369                                     ; preds = %352
  %370 = load double** %curvalptr, align 8, !llfi_index !465
  %371 = load double** %curvalptr, align 8, !llfi_index !465
  %372 = getelementptr inbounds double* %370, i32 1, !llfi_index !466
  %373 = getelementptr inbounds double* %371, i32 1, !llfi_index !466
  %check_cmp41 = icmp eq double* %372, %373
  br i1 %check_cmp41, label %374, label %checkBb42

checkBb42:                                        ; preds = %369
  call void @check_flag()
  br label %374

; <label>:374                                     ; preds = %checkBb42, %369
  store double* %372, double** %curvalptr, align 8, !llfi_index !467
  store double -1.000000e+00, double* %370, align 8, !llfi_index !468
  br label %375, !llfi_index !469

; <label>:375                                     ; preds = %374, %368
  %376 = load i32* %curcol, align 4, !llfi_index !470
  %377 = load i32* %curcol, align 4, !llfi_index !470
  %check_cmp43 = icmp eq i32 %376, %377
  br i1 %check_cmp43, label %378, label %checkBb44

checkBb44:                                        ; preds = %375
  call void @check_flag()
  br label %378

; <label>:378                                     ; preds = %checkBb44, %375
  %379 = load i32** %curindptr, align 8, !llfi_index !471
  %380 = load i32** %curindptr, align 8, !llfi_index !471
  %381 = getelementptr inbounds i32* %379, i32 1, !llfi_index !472
  %382 = getelementptr inbounds i32* %380, i32 1, !llfi_index !472
  %check_cmp45 = icmp eq i32* %381, %382
  br i1 %check_cmp45, label %383, label %checkBb46

checkBb46:                                        ; preds = %378
  call void @check_flag()
  br label %383

; <label>:383                                     ; preds = %checkBb46, %378
  store i32* %381, i32** %curindptr, align 8, !llfi_index !473
  store i32 %376, i32* %379, align 4, !llfi_index !474
  %384 = load i32* %nnzrow, align 4, !llfi_index !475
  %385 = load i32* %nnzrow, align 4, !llfi_index !475
  %386 = add nsw i32 %384, 1, !llfi_index !476
  %387 = add nsw i32 %385, 1, !llfi_index !476
  %check_cmp47 = icmp eq i32 %386, %387
  br i1 %check_cmp47, label %388, label %checkBb48

checkBb48:                                        ; preds = %383
  call void @check_flag()
  br label %388

; <label>:388                                     ; preds = %checkBb48, %383
  store i32 %386, i32* %nnzrow, align 4, !llfi_index !477
  br label %389, !llfi_index !478

; <label>:389                                     ; preds = %388, %334
  br label %390, !llfi_index !479

; <label>:390                                     ; preds = %389, %327, %320, %315, %303, %294, %283
  br label %391, !llfi_index !480

; <label>:391                                     ; preds = %390
  %392 = load i32* %sx, align 4, !llfi_index !481
  %393 = load i32* %sx, align 4, !llfi_index !481
  %394 = add nsw i32 %392, 1, !llfi_index !482
  %395 = add nsw i32 %393, 1, !llfi_index !482
  %check_cmp49 = icmp eq i32 %394, %395
  br i1 %check_cmp49, label %396, label %checkBb50

checkBb50:                                        ; preds = %391
  call void @check_flag()
  br label %396

; <label>:396                                     ; preds = %checkBb50, %391
  store i32 %394, i32* %sx, align 4, !llfi_index !483
  br label %240, !llfi_index !484

; <label>:397                                     ; preds = %245
  br label %398, !llfi_index !485

; <label>:398                                     ; preds = %397
  %399 = load i32* %sy, align 4, !llfi_index !486
  %400 = load i32* %sy, align 4, !llfi_index !486
  %401 = add nsw i32 %399, 1, !llfi_index !487
  %402 = add nsw i32 %400, 1, !llfi_index !487
  %check_cmp51 = icmp eq i32 %401, %402
  br i1 %check_cmp51, label %403, label %checkBb52

checkBb52:                                        ; preds = %398
  call void @check_flag()
  br label %403

; <label>:403                                     ; preds = %checkBb52, %398
  store i32 %401, i32* %sy, align 4, !llfi_index !488
  br label %233, !llfi_index !489

; <label>:404                                     ; preds = %238
  br label %405, !llfi_index !490

; <label>:405                                     ; preds = %404
  %406 = load i32* %sz, align 4, !llfi_index !491
  %407 = load i32* %sz, align 4, !llfi_index !491
  %408 = add nsw i32 %406, 1, !llfi_index !492
  %409 = add nsw i32 %407, 1, !llfi_index !492
  %check_cmp53 = icmp eq i32 %408, %409
  br i1 %check_cmp53, label %410, label %checkBb54

checkBb54:                                        ; preds = %405
  call void @check_flag()
  br label %410

; <label>:410                                     ; preds = %checkBb54, %405
  store i32 %408, i32* %sz, align 4, !llfi_index !493
  br label %226, !llfi_index !494

; <label>:411                                     ; preds = %231
  %412 = load i32* %nnzrow, align 4, !llfi_index !495
  %413 = load i32* %nnzrow, align 4, !llfi_index !495
  %check_cmp55 = icmp eq i32 %412, %413
  br i1 %check_cmp55, label %414, label %checkBb56

checkBb56:                                        ; preds = %411
  call void @check_flag()
  br label %414

; <label>:414                                     ; preds = %checkBb56, %411
  %415 = load i32* %curlocalrow, align 4, !llfi_index !496
  %416 = load i32* %curlocalrow, align 4, !llfi_index !496
  %417 = sext i32 %415 to i64, !llfi_index !497
  %418 = sext i32 %416 to i64, !llfi_index !497
  %419 = load %struct.HPC_Sparse_Matrix_STRUCT*** %4, align 8, !llfi_index !498
  %420 = load %struct.HPC_Sparse_Matrix_STRUCT** %419, align 8, !llfi_index !499
  %421 = getelementptr inbounds %struct.HPC_Sparse_Matrix_STRUCT* %420, i32 0, i32 8, !llfi_index !500
  %422 = load i32** %421, align 8, !llfi_index !501
  %423 = load i32** %421, align 8, !llfi_index !501
  %424 = getelementptr inbounds i32* %422, i64 %417, !llfi_index !502
  %425 = getelementptr inbounds i32* %423, i64 %418, !llfi_index !502
...
; <label>:426                                     ; preds = %checkBb58, %414
  store i32 %412, i32* %424, align 4, !llfi_index !503
  %427 = load i32* %nnzrow, align 4, !llfi_index !504
  %428 = sext i32 %427 to i64, !llfi_index !505
  %429 = load i64* %nnzglobal, align 8, !llfi_index !506
  %430 = add nsw i64 %429, %428, !llfi_index !507
  store i64 %430, i64* %nnzglobal, align 8, !llfi_index !508
  %431 = load i32* %curlocalrow, align 4, !llfi_index !509
  %432 = sext i32 %431 to i64, !llfi_index !510
  %433 = load double*** %5, align 8, !llfi_index !511
  %434 = load double** %433, align 8, !llfi_index !512
  %435 = getelementptr inbounds double* %434, i64 %432, !llfi_index !513
  store double 0.000000e+00, double* %435, align 8, !llfi_index !514
  %436 = load i32* %nnzrow, align 4, !llfi_index !515
  %437 = load i32* %nnzrow, align 4, !llfi_index !515
  %438 = sub nsw i32 %436, 1, !llfi_index !516
  %439 = sub nsw i32 %437, 1, !llfi_index !516
  %440 = sitofp i32 %438 to double, !llfi_index !517
  %441 = sitofp i32 %439 to double, !llfi_index !517
  %442 = fsub double 2.700000e+01, %440, !llfi_index !518
  %443 = fsub double 2.700000e+01, %441, !llfi_index !518
  %check_cmp59 = fcmp ueq double %442, %443
...
; <label>:444                                     ; preds = %checkBb60, %426
  %445 = load i32* %curlocalrow, align 4, !llfi_index !519
  %446 = load i32* %curlocalrow, align 4, !llfi_index !519
  %447 = sext i32 %445 to i64, !llfi_index !520
  %448 = sext i32 %446 to i64, !llfi_index !520
  %449 = load double*** %6, align 8, !llfi_index !521
  %450 = load double** %449, align 8, !llfi_index !522
  %451 = load double** %449, align 8, !llfi_index !522
  %452 = getelementptr inbounds double* %450, i64 %447, !llfi_index !523
  %453 = getelementptr inbounds double* %451, i64 %448, !llfi_index !523
  %check_cmp61 = icmp eq double* %452, %453
...
; <label>:454                                     ; preds = %checkBb62, %444
  store double %442, double* %452, align 8, !llfi_index !524
  %455 = load i32* %curlocalrow, align 4, !llfi_index !525
  %456 = sext i32 %455 to i64, !llfi_index !526
  %457 = load double*** %7, align 8, !llfi_index !527
  %458 = load double** %457, align 8, !llfi_index !528
  %459 = load double** %457, align 8, !llfi_index !528
  %check_cmp63 = icmp eq double* %458, %459
  br i1 %check_cmp63, label %460, label %checkBb64

checkBb64:                                        ; preds = %454
  call void @check_flag()
  br label %460

; <label>:460                                     ; preds = %checkBb64, %454
  %461 = getelementptr inbounds double* %458, i64 %456, !llfi_index !529
  store double 1.000000e+00, double* %461, align 8, !llfi_index !530
  br label %462, !llfi_index !531

; <label>:462                                     ; preds = %460
  %463 = load i32* %ix, align 4, !llfi_index !532
  %464 = load i32* %ix, align 4, !llfi_index !532
  %465 = add nsw i32 %463, 1, !llfi_index !533
  %466 = add nsw i32 %464, 1, !llfi_index !533
  %check_cmp65 = icmp eq i32 %465, %466
  br i1 %check_cmp65, label %467, label %checkBb66

checkBb66:                                        ; preds = %462
  call void @check_flag()
  br label %467

; <label>:467                                     ; preds = %checkBb66, %462
  store i32 %465, i32* %ix, align 4, !llfi_index !534
  br label %148, !llfi_index !535

; <label>:468                                     ; preds = %154
  br label %469, !llfi_index !536

; <label>:469                                     ; preds = %468
  %470 = load i32* %iy, align 4, !llfi_index !537
  %471 = add nsw i32 %470, 1, !llfi_index !538
  store i32 %471, i32* %iy, align 4, !llfi_index !539
  br label %143, !llfi_index !540

; <label>:472                                     ; preds = %143
  br label %473, !llfi_index !541

; <label>:473                                     ; preds = %472
  %474 = load i32* %iz, align 4, !llfi_index !542
  %475 = add nsw i32 %474, 1, !llfi_index !543
  store i32 %475, i32* %iz, align 4, !llfi_index !544
  br label %138, !llfi_index !545

; <label>:476                                     ; preds = %138
  %477 = load i32* %debug, align 4, !llfi_index !546
  %478 = icmp ne i32 %477, 0, !llfi_index !547
  br i1 %478, label %479, label %489, !llfi_index !548

; <label>:479                                     ; preds = %476
  %480 = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* @_ZSt4cout, i8* getelementptr inbounds ([9 x i8]* @.str29, i32 0, i32 0)), !llfi_index !549
  %481 = load i32* %rank, align 4, !llfi_index !550
  %482 = call %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %480, i32 %481), !llfi_index !551
  %483 = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* %482, i8* getelementptr inbounds ([5 x i8]* @.str310, i32 0, i32 0)), !llfi_index !552
  %484 = load i32* %size, align 4, !llfi_index !553
  %485 = call %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %483, i32 %484), !llfi_index !554
  %486 = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* %485, i8* getelementptr inbounds ([6 x i8]* @.str411, i32 0, i32 0)), !llfi_index !555
  %487 = load i32* %local_nrow, align 4, !llfi_index !556
  %488 = call %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %486, i32 %487), !llfi_index !557
  br label %489, !llfi_index !558

; <label>:489                                     ; preds = %479, %476
  %490 = load i32* %debug, align 4, !llfi_index !559
  %491 = icmp ne i32 %490, 0, !llfi_index !560
  br i1 %491, label %492, label %500, !llfi_index !561

; <label>:492                                     ; preds = %489
  %493 = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* @_ZSt4cout, i8* getelementptr inbounds ([20 x i8]* @.str512, i32 0, i32 0)), !llfi_index !562
  %494 = load i32* %start_row, align 4, !llfi_index !563
  %495 = call %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %493, i32 %494), !llfi_index !564
  %496 = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* %495, i8* getelementptr inbounds ([10 x i8]* @.str613, i32 0, i32 0)), !llfi_index !565
  %497 = load i32* %stop_row, align 4, !llfi_index !566
  %498 = call %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %496, i32 %497), !llfi_index !567
  %499 = call %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %498, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_), !llfi_index !568
  br label %500, !llfi_index !569

; <label>:500                                     ; preds = %492, %489
  %501 = load i32* %debug, align 4, !llfi_index !570
  %502 = icmp ne i32 %501, 0, !llfi_index !571
  br i1 %502, label %503, label %515, !llfi_index !572

; <label>:503                                     ; preds = %500
  %504 = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* @_ZSt4cout, i8* getelementptr inbounds ([9 x i8]* @.str29, i32 0, i32 0)), !llfi_index !573
  %505 = load i32* %rank, align 4, !llfi_index !574
  %506 = call %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %504, i32 %505), !llfi_index !575
  %507 = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* %506, i8* getelementptr inbounds ([5 x i8]* @.str310, i32 0, i32 0)), !llfi_index !576
  %508 = load i32* %size, align 4, !llfi_index !577
  %509 = call %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %507, i32 %508), !llfi_index !578
  %510 = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* %509, i8* getelementptr inbounds ([6 x i8]* @.str411, i32 0, i32 0)), !llfi_index !579
  %511 = load i32* %local_nnz, align 4, !llfi_index !580
  %512 = call %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %510, i32 %511), !llfi_index !581
  %513 = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* %512, i8* getelementptr inbounds ([11 x i8]* @.str714, i32 0, i32 0)), !llfi_index !582
  %514 = call %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %513, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_), !llfi_index !583
  br label %515, !llfi_index !584

; <label>:515                                     ; preds = %503, %500
  %516 = load i32* %start_row, align 4, !llfi_index !585
  %517 = load %struct.HPC_Sparse_Matrix_STRUCT*** %4, align 8, !llfi_index !586
  %518 = load %struct.HPC_Sparse_Matrix_STRUCT** %517, align 8, !llfi_index !587
  %519 = getelementptr inbounds %struct.HPC_Sparse_Matrix_STRUCT* %518, i32 0, i32 1, !llfi_index !588
  store i32 %516, i32* %519, align 4, !llfi_index !589
  %520 = load i32* %stop_row, align 4, !llfi_index !590
  %521 = load %struct.HPC_Sparse_Matrix_STRUCT*** %4, align 8, !llfi_index !591
  %522 = load %struct.HPC_Sparse_Matrix_STRUCT** %521, align 8, !llfi_index !592
  %523 = getelementptr inbounds %struct.HPC_Sparse_Matrix_STRUCT* %522, i32 0, i32 2, !llfi_index !593
  store i32 %520, i32* %523, align 4, !llfi_index !594
  %524 = load i32* %total_nrow, align 4, !llfi_index !595
  %525 = load %struct.HPC_Sparse_Matrix_STRUCT*** %4, align 8, !llfi_index !596
  %526 = load %struct.HPC_Sparse_Matrix_STRUCT** %525, align 8, !llfi_index !597
  %527 = getelementptr inbounds %struct.HPC_Sparse_Matrix_STRUCT* %526, i32 0, i32 3, !llfi_index !598
  store i32 %524, i32* %527, align 4, !llfi_index !599
  %528 = load i64* %total_nnz, align 8, !llfi_index !600
  %529 = load %struct.HPC_Sparse_Matrix_STRUCT*** %4, align 8, !llfi_index !601
  %530 = load %struct.HPC_Sparse_Matrix_STRUCT** %529, align 8, !llfi_index !602
  %531 = getelementptr inbounds %struct.HPC_Sparse_Matrix_STRUCT* %530, i32 0, i32 4, !llfi_index !603
  store i64 %528, i64* %531, align 8, !llfi_index !604
  %532 = load i32* %local_nrow, align 4, !llfi_index !605
  %533 = load %struct.HPC_Sparse_Matrix_STRUCT*** %4, align 8, !llfi_index !606
  %534 = load %struct.HPC_Sparse_Matrix_STRUCT** %533, align 8, !llfi_index !607
  %535 = getelementptr inbounds %struct.HPC_Sparse_Matrix_STRUCT* %534, i32 0, i32 5, !llfi_index !608
  store i32 %532, i32* %535, align 4, !llfi_index !609
  %536 = load i32* %local_nrow, align 4, !llfi_index !610
  %537 = load %struct.HPC_Sparse_Matrix_STRUCT*** %4, align 8, !llfi_index !611
  %538 = load %struct.HPC_Sparse_Matrix_STRUCT** %537, align 8, !llfi_index !612
  %539 = getelementptr inbounds %struct.HPC_Sparse_Matrix_STRUCT* %538, i32 0, i32 6, !llfi_index !613
  store i32 %536, i32* %539, align 4, !llfi_index !614
  %540 = load i32* %local_nnz, align 4, !llfi_index !615
  %541 = load %struct.HPC_Sparse_Matrix_STRUCT*** %4, align 8, !llfi_index !616
  %542 = load %struct.HPC_Sparse_Matrix_STRUCT** %541, align 8, !llfi_index !617
  %543 = getelementptr inbounds %struct.HPC_Sparse_Matrix_STRUCT* %542, i32 0, i32 7, !llfi_index !618
  store i32 %540, i32* %543, align 4, !llfi_index !619
...
; <label>:13                                      ; preds = %checkBb, %7
  br i1 %11, label %14, label %118, !llfi_index !1557
...
; <label>:14                                      ; preds = %13
  ...
  %20 = getelementptr inbounds double** %19, i64 %16, !llfi_index !1564
  %21 = load double** %20, align 8, !llfi_index !1565
  %22 = load double** %20, align 8, !llfi_index !1565
...
; <label>:23                                      ; preds = %checkBb2, %14
  store double* %21, double** %cur_vals, align 8, !llfi_index !1566
  %24 = load i32* %i, align 4, !llfi_index !1567
  %25 = load i32* %i, align 4, !llfi_index !1567
  %26 = sext i32 %24 to i64, !llfi_index !1568
  %27 = sext i32 %25 to i64, !llfi_index !1568
  %28 = load %struct.HPC_Sparse_Matrix_STRUCT** %1, align 8, !llfi_index !1569
  %29 = getelementptr inbounds %struct.HPC_Sparse_Matrix_STRUCT* %28, i32 0, i32 10, !llfi_index !1570
  %30 = load i32*** %29, align 8, !llfi_index !1571
  %31 = load i32*** %29, align 8, !llfi_index !1571
  %32 = getelementptr inbounds i32** %30, i64 %26, !llfi_index !1572
  %33 = getelementptr inbounds i32** %31, i64 %27, !llfi_index !1572
...
; <label>:36                                      ; preds = %checkBb4, %23
  ...
  %39 = load %struct.HPC_Sparse_Matrix_STRUCT** %1, align 8, !llfi_index !1577
  %40 = load %struct.HPC_Sparse_Matrix_STRUCT** %1, align 8, !llfi_index !1577
  %check_cmp5 = icmp eq %struct.HPC_Sparse_Matrix_STRUCT* %39, %40
...
; <label>:41                                      ; preds = %checkBb6, %36
  %42 = getelementptr inbounds %struct.HPC_Sparse_Matrix_STRUCT* %39, i32 0, i32 8, !llfi_index !1578
...
; <label>:55                                      ; preds = %checkBb10, %48
  br i1 %53, label %56, label %99, !llfi_index !1588
...
; <label>:59                                      ; preds = %checkBb12, %56
  ...
  %62 = getelementptr inbounds double* %61, i64 %60, !llfi_index !1592
  %63 = getelementptr inbounds double* %61, i64 %60, !llfi_index !1592
...
; <label>:64                                      ; preds = %checkBb14, %59
  %65 = load double* %62, align 8, !llfi_index !1593
  %66 = load i32* %j, align 4, !llfi_index !1594
  %67 = load i32* %j, align 4, !llfi_index !1594
  %68 = sext i32 %66 to i64, !llfi_index !1595
...
; <label>:73                                      ; preds = %checkBb18, %70
  %74 = getelementptr inbounds i32* %71, i64 %68, !llfi_index !1597
  %75 = load i32* %74, align 4, !llfi_index !1598
  %76 = load i32* %74, align 4, !llfi_index !1598
  %77 = sext i32 %75 to i64, !llfi_index !1599
  %78 = sext i32 %76 to i64, !llfi_index !1599
...
; <label>:82                                      ; preds = %checkBb22, %79
  %83 = getelementptr inbounds double* %80, i64 %77, !llfi_index !1601
  %84 = load double* %83, align 8, !llfi_index !1602
  %85 = load double* %83, align 8, !llfi_index !1602
...
; <label>:86                                      ; preds = %checkBb24, %82
  %87 = fmul double %65, %84, !llfi_index !1603
  %88 = load double* %sum, align 8, !llfi_index !1604
  %89 = load double* %sum, align 8, !llfi_index !1604
  %90 = fadd double %88, %87, !llfi_index !1605
  %91 = fadd double %89, %87, !llfi_index !1605
...
; <label>:92                                      ; preds = %checkBb26, %86
  store double %90, double* %sum, align 8, !llfi_index !1606
  br label %93, !llfi_index !1607
...
; <label>:93                                      ; preds = %92
  ...
  %check_cmp27 = icmp eq i32 %96, %97
  br i1 %check_cmp27, label %98, label %checkBb28

checkBb28:                                        ; preds = %93
  call void @check_flag()
  br label %98

; <label>:98                                      ; preds = %checkBb28, %93
  store i32 %96, i32* %j, align 4, !llfi_index !1610
  br label %48, !llfi_index !1611

; <label>:99                                      ; preds = %55
  %100 = load double* %sum, align 8, !llfi_index !1612
  %101 = load double* %sum, align 8, !llfi_index !1612
  %check_cmp29 = fcmp ueq double %100, %101
...
; <label>:111                                     ; preds = %checkBb32, %102
  store double %100, double* %109, align 8, !llfi_index !1617
  br label %112, !llfi_index !1618
...
; <label>:117                                     ; preds = %checkBb34, %112
  store i32 %115, i32* %i, align 4, !llfi_index !1621
...
define i32 @_Z6waxpbyidPKddS0_Pd(i32 %n, double %alpha, double* %x, double %beta, double* %y, double* %w) #0 {
  ...
  br i1 %9, label %10, label %60, !llfi_index !1642
...
; <label>:18                                      ; preds = %checkBb, %11
  br i1 %16, label %19, label %59, !llfi_index !1648
...
; <label>:22                                      ; preds = %checkBb2, %19
  %23 = sext i32 %20 to i64, !llfi_index !1650
  %24 = load double** %3, align 8, !llfi_index !1651
  %25 = getelementptr inbounds double* %24, i64 %23, !llfi_index !1652
  %26 = load double* %25, align 8, !llfi_index !1653
  %27 = load double* %25, align 8, !llfi_index !1653
  %check_cmp3 = fcmp ueq double %26, %27
...
; <label>:35                                      ; preds = %checkBb6, %28
  ...
  %37 = getelementptr inbounds double* %36, i64 %33, !llfi_index !1658
  %38 = load double* %37, align 8, !llfi_index !1659
  %39 = load double* %37, align 8, !llfi_index !1659
  %40 = fmul double %29, %38, !llfi_index !1660
  %41 = fmul double %30, %39, !llfi_index !1660
...
; <label>:42                                      ; preds = %checkBb8, %35
  %43 = fadd double %26, %40, !llfi_index !1661
  %44 = load i32* %i, align 4, !llfi_index !1662
  %45 = load i32* %i, align 4, !llfi_index !1662
  %46 = sext i32 %44 to i64, !llfi_index !1663
  %47 = sext i32 %45 to i64, !llfi_index !1663
  %48 = load double** %6, align 8, !llfi_index !1664
  %49 = load double** %6, align 8, !llfi_index !1664
  %50 = getelementptr inbounds double* %48, i64 %46, !llfi_index !1665
  %51 = getelementptr inbounds double* %49, i64 %47, !llfi_index !1665
...
; <label>:52                                      ; preds = %checkBb10, %42
  store double %43, double* %50, align 8, !llfi_index !1666
  br label %53, !llfi_index !1667

; <label>:53                                      ; preds = %52
  %54 = load i32* %i, align 4, !llfi_index !1668
  %55 = load i32* %i, align 4, !llfi_index !1668
  %56 = add nsw i32 %54, 1, !llfi_index !1669
...
; <label>:58                                      ; preds = %checkBb12, %53
  store i32 %56, i32* %i, align 4, !llfi_index !1670
  br label %11, !llfi_index !1671

; <label>:59                                      ; preds = %18
  br label %121, !llfi_index !1672

; <label>:60                                      ; preds = %0
  %61 = load double* %4, align 8, !llfi_index !1673
  %62 = fptosi double %61 to i32, !llfi_index !1674
  %63 = icmp eq i32 %62, 1, !llfi_index !1675
  br i1 %63, label %64, label %91, !llfi_index !1676

; <label>:64                                      ; preds = %60
  store i32 0, i32* %i1, align 4, !llfi_index !1677
  br label %65, !llfi_index !1678

; <label>:65                                      ; preds = %87, %64
  %66 = load i32* %i1, align 4, !llfi_index !1679
  %67 = load i32* %1, align 4, !llfi_index !1680
  %68 = icmp slt i32 %66, %67, !llfi_index !1681
  br i1 %68, label %69, label %90, !llfi_index !1682

; <label>:69                                      ; preds = %65
  %70 = load double* %2, align 8, !llfi_index !1683
  %71 = load i32* %i1, align 4, !llfi_index !1684
  %72 = sext i32 %71 to i64, !llfi_index !1685
  %73 = load double** %3, align 8, !llfi_index !1686
  %74 = getelementptr inbounds double* %73, i64 %72, !llfi_index !1687
  %75 = load double* %74, align 8, !llfi_index !1688
  %76 = fmul double %70, %75, !llfi_index !1689
  %77 = load i32* %i1, align 4, !llfi_index !1690
  %78 = sext i32 %77 to i64, !llfi_index !1691
  %79 = load double** %5, align 8, !llfi_index !1692
  %80 = getelementptr inbounds double* %79, i64 %78, !llfi_index !1693
  %81 = load double* %80, align 8, !llfi_index !1694
  %82 = fadd double %76, %81, !llfi_index !1695
  %83 = load i32* %i1, align 4, !llfi_index !1696
  %84 = sext i32 %83 to i64, !llfi_index !1697
  %85 = load double** %6, align 8, !llfi_index !1698
  %86 = getelementptr inbounds double* %85, i64 %84, !llfi_index !1699
  store double %82, double* %86, align 8, !llfi_index !1700
  br label %87, !llfi_index !1701

; <label>:87                                      ; preds = %69
  %88 = load i32* %i1, align 4, !llfi_index !1702
  %89 = add nsw i32 %88, 1, !llfi_index !1703
  store i32 %89, i32* %i1, align 4, !llfi_index !1704
  br label %65, !llfi_index !1705

; <label>:90                                      ; preds = %65
  br label %120, !llfi_index !1706

; <label>:91                                      ; preds = %60
  store i32 0, i32* %i2, align 4, !llfi_index !1707
  br label %92, !llfi_index !1708

; <label>:92                                      ; preds = %116, %91
  %93 = load i32* %i2, align 4, !llfi_index !1709
  %94 = load i32* %1, align 4, !llfi_index !1710
  %95 = icmp slt i32 %93, %94, !llfi_index !1711
  br i1 %95, label %96, label %119, !llfi_index !1712

; <label>:96                                      ; preds = %92
  %97 = load double* %2, align 8, !llfi_index !1713
  %98 = load i32* %i2, align 4, !llfi_index !1714
  %99 = sext i32 %98 to i64, !llfi_index !1715
  %100 = load double** %3, align 8, !llfi_index !1716
  %101 = getelementptr inbounds double* %100, i64 %99, !llfi_index !1717
  %102 = load double* %101, align 8, !llfi_index !1718
  %103 = fmul double %97, %102, !llfi_index !1719
  %104 = load double* %4, align 8, !llfi_index !1720
  %105 = load i32* %i2, align 4, !llfi_index !1721
  %106 = sext i32 %105 to i64, !llfi_index !1722
  %107 = load double** %5, align 8, !llfi_index !1723
  %108 = getelementptr inbounds double* %107, i64 %106, !llfi_index !1724
  %109 = load double* %108, align 8, !llfi_index !1725
  %110 = fmul double %104, %109, !llfi_index !1726
  %111 = fadd double %103, %110, !llfi_index !1727
  %112 = load i32* %i2, align 4, !llfi_index !1728
  %113 = sext i32 %112 to i64, !llfi_index !1729
  %114 = load double** %6, align 8, !llfi_index !1730
  %115 = getelementptr inbounds double* %114, i64 %113, !llfi_index !1731
  store double %111, double* %115, align 8, !llfi_index !1732
  br label %116, !llfi_index !1733

; <label>:116                                     ; preds = %96
  %117 = load i32* %i2, align 4, !llfi_index !1734
  %118 = add nsw i32 %117, 1, !llfi_index !1735
  store i32 %118, i32* %i2, align 4, !llfi_index !1736
  br label %92, !llfi_index !1737

; <label>:119                                     ; preds = %92
  br label %120, !llfi_index !1738

; <label>:120                                     ; preds = %119, %90
  br label %121, !llfi_index !1739
