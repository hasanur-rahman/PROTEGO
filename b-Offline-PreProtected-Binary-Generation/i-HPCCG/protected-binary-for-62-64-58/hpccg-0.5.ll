...
; <label>:13                                      ; preds = %checkBb, %7
  br i1 %11, label %14, label %115, !llfi_index !1557
...
; <label>:60                                      ; preds = %checkBb18, %53
  br i1 %58, label %61, label %97, !llfi_index !1588
...
; <label>:73                                      ; preds = %checkBb24, %69
  %74 = load i32* %j, align 4, !llfi_index !1594
  %75 = sext i32 %74 to i64, !llfi_index !1595
  %76 = sext i32 %74 to i64, !llfi_index !1595
  %check_cmp25 = icmp eq i64 %75, %76
...
; <label>:77                                      ; preds = %checkBb26, %73
  ...
  %79 = getelementptr inbounds i32* %78, i64 %75, !llfi_index !1597
  %80 = load i32* %79, align 4, !llfi_index !1598
  %81 = sext i32 %80 to i64, !llfi_index !1599
  %82 = load double** %2, align 8, !llfi_index !1600
  %83 = getelementptr inbounds double* %82, i64 %81, !llfi_index !1601
  %84 = load double* %83, align 8, !llfi_index !1602
  %85 = fmul double %71, %84, !llfi_index !1603
  %86 = load double* %sum, align 8, !llfi_index !1604
  %87 = load double* %sum, align 8, !llfi_index !1604
  %88 = fadd double %86, %85, !llfi_index !1605
  %89 = fadd double %87, %85, !llfi_index !1605
  %check_cmp27 = fcmp ueq double %88, %89
...
; <label>:90                                      ; preds = %checkBb28, %77
  store double %88, double* %sum, align 8, !llfi_index !1606
  br label %91, !llfi_index !1607

; <label>:91                                      ; preds = %90
  %92 = load i32* %j, align 4, !llfi_index !1608
  %93 = load i32* %j, align 4, !llfi_index !1608
  %94 = add nsw i32 %92, 1, !llfi_index !1609
  %95 = add nsw i32 %93, 1, !llfi_index !1609
  %check_cmp29 = icmp eq i32 %94, %95
  br i1 %check_cmp29, label %96, label %checkBb30

checkBb30:                                        ; preds = %91
  call void @check_flag()
  br label %96

; <label>:96                                      ; preds = %checkBb30, %91
  store i32 %94, i32* %j, align 4, !llfi_index !1610
  br label %53, !llfi_index !1611

; <label>:97                                      ; preds = %60
  %98 = load double* %sum, align 8, !llfi_index !1612
  %99 = load double* %sum, align 8, !llfi_index !1612
  %check_cmp31 = fcmp ueq double %98, %99
  br i1 %check_cmp31, label %100, label %checkBb32

checkBb32:                                        ; preds = %97
  call void @check_flag()
  br label %100

; <label>:100                                     ; preds = %checkBb32, %97
  %101 = load i32* %i, align 4, !llfi_index !1613
  %102 = load i32* %i, align 4, !llfi_index !1613
  %103 = sext i32 %101 to i64, !llfi_index !1614
  %104 = sext i32 %102 to i64, !llfi_index !1614
  %105 = load double** %3, align 8, !llfi_index !1615
  %106 = getelementptr inbounds double* %105, i64 %103, !llfi_index !1616
  %107 = getelementptr inbounds double* %105, i64 %104, !llfi_index !1616
  %check_cmp33 = icmp eq double* %106, %107
  br i1 %check_cmp33, label %108, label %checkBb34

checkBb34:                                        ; preds = %100
  call void @check_flag()
  br label %108

; <label>:108                                     ; preds = %checkBb34, %100
  store double %98, double* %106, align 8, !llfi_index !1617
  br label %109, !llfi_index !1618

; <label>:109                                     ; preds = %108
  %110 = load i32* %i, align 4, !llfi_index !1619
  %111 = load i32* %i, align 4, !llfi_index !1619
  %112 = add nsw i32 %110, 1, !llfi_index !1620
  %113 = add nsw i32 %111, 1, !llfi_index !1620
  %check_cmp35 = icmp eq i32 %112, %113
...
; <label>:114                                     ; preds = %checkBb36, %109
  store i32 %112, i32* %i, align 4, !llfi_index !1621
...
; <label>:60                                      ; preds = %59
  ...
  %check_cmp11 = fcmp ueq double %69, %70
...
; <label>:74                                      ; preds = %checkBb14, %71
  %75 = sext i32 %72 to i64, !llfi_index !1797
  %76 = load double** %3, align 8, !llfi_index !1798
  %77 = getelementptr inbounds double* %76, i64 %75, !llfi_index !1799
  %78 = getelementptr inbounds double* %76, i64 %75, !llfi_index !1799
...
; <label>:79                                      ; preds = %checkBb16, %74
  %80 = load double* %77, align 8, !llfi_index !1800
  %81 = fmul double %69, %80, !llfi_index !1801
  %82 = load double* %local_result, align 8, !llfi_index !1802
  %83 = load double* %local_result, align 8, !llfi_index !1802
  %84 = fadd double %82, %81, !llfi_index !1803
  %85 = fadd double %83, %81, !llfi_index !1803
  %check_cmp17 = fcmp ueq double %84, %85
