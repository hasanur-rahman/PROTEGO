...
; <label>:52                                      ; preds = %checkBb, %46
  br i1 %50, label %53, label %102, !llfi_index !1178
...
; <label>:56                                      ; preds = %checkBb2, %53
  %57 = sext i32 %54 to i64, !llfi_index !1180
...
; <label>:60                                      ; preds = %checkBb4, %56
  ...
  %65 = getelementptr inbounds float* %64, i64 %57, !llfi_index !1186
  %66 = load float* %65, align 4, !llfi_index !1187
  %67 = load float* %65, align 4, !llfi_index !1187
  %check_cmp5 = fcmp ueq float %66, %67
...
; <label>:71                                      ; preds = %checkBb8, %68
  %72 = sext i32 %69 to i64, !llfi_index !1190
  %73 = load i8** %mem, align 8, !llfi_index !1191
  %74 = getelementptr inbounds i8* %73, i64 %72, !llfi_index !1192
...
; <label>:96                                      ; preds = %91
  ...
  %99 = add nsw i32 %97, 1, !llfi_index !1223
...
; <label>:102                                     ; preds = %52
  br label %103, !llfi_index !1226

; <label>:103                                     ; preds = %102
  %104 = load i32* %i, align 4, !llfi_index !1227
  %105 = add nsw i32 %104, 1, !llfi_index !1228
  store i32 %105, i32* %i, align 4, !llfi_index !1229
  br label %41, !llfi_index !1230

; <label>:106                                     ; preds = %41
  %107 = load i8** %mem, align 8, !llfi_index !1231
  %108 = load i32* %n1, align 4, !llfi_index !1232
  %109 = add nsw i32 %108, 1, !llfi_index !1233
  %110 = load i32* %n2, align 4, !llfi_index !1234
  %111 = add nsw i32 %110, 1, !llfi_index !1235
  %112 = mul nsw i32 %109, %111, !llfi_index !1236
  %113 = zext i32 %112 to i64, !llfi_index !1237
  %114 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1238
  %115 = call i64 @fwrite(i8* %107, i64 4, i64 %113, %struct._IO_FILE* %114), !llfi_index !1239
  %116 = load i8** %mem, align 8, !llfi_index !1240
  call void @free(i8* %116) #6, !llfi_index !1241
  store i32 0, i32* %memcnt, align 4, !llfi_index !1242
  %117 = load %struct.BPNN** %1, align 8, !llfi_index !1243
  %118 = getelementptr inbounds %struct.BPNN* %117, i32 0, i32 10, !llfi_index !1244
  %119 = load float*** %118, align 8, !llfi_index !1245
  store float** %119, float*** %w, align 8, !llfi_index !1246
  %120 = load i32* %n2, align 4, !llfi_index !1247
  %121 = add nsw i32 %120, 1, !llfi_index !1248
  %122 = load i32* %n3, align 4, !llfi_index !1249
  %123 = add nsw i32 %122, 1, !llfi_index !1250
  %124 = mul nsw i32 %121, %123, !llfi_index !1251
  %125 = sext i32 %124 to i64, !llfi_index !1252
  %126 = mul i64 %125, 4, !llfi_index !1253
  %127 = trunc i64 %126 to i32, !llfi_index !1254
  %128 = zext i32 %127 to i64, !llfi_index !1255
  %129 = call noalias i8* @malloc(i64 %128) #6, !llfi_index !1256
  store i8* %129, i8** %mem, align 8, !llfi_index !1257
  store i32 0, i32* %i, align 4, !llfi_index !1258
  br label %130, !llfi_index !1259

; <label>:130                                     ; preds = %184, %106
  %131 = load i32* %i, align 4, !llfi_index !1260
  %132 = load i32* %n2, align 4, !llfi_index !1261
  %133 = icmp sle i32 %131, %132, !llfi_index !1262
  br i1 %133, label %134, label %187, !llfi_index !1263

; <label>:134                                     ; preds = %130
  store i32 0, i32* %j, align 4, !llfi_index !1264
  br label %135, !llfi_index !1265

; <label>:135                                     ; preds = %180, %134
  %136 = load i32* %j, align 4, !llfi_index !1266
  %137 = load i32* %n3, align 4, !llfi_index !1267
  %138 = icmp sle i32 %136, %137, !llfi_index !1268
  br i1 %138, label %139, label %183, !llfi_index !1269

; <label>:139                                     ; preds = %135
  %140 = load i32* %j, align 4, !llfi_index !1270
  %141 = sext i32 %140 to i64, !llfi_index !1271
  %142 = load i32* %i, align 4, !llfi_index !1272
  %143 = sext i32 %142 to i64, !llfi_index !1273
  %144 = load float*** %w, align 8, !llfi_index !1274
  %145 = getelementptr inbounds float** %144, i64 %143, !llfi_index !1275
  %146 = load float** %145, align 8, !llfi_index !1276
  %147 = getelementptr inbounds float* %146, i64 %141, !llfi_index !1277
  %148 = load float* %147, align 4, !llfi_index !1278
  store float %148, float* %dvalue, align 4, !llfi_index !1279
  %149 = load i32* %memcnt, align 4, !llfi_index !1280
  %150 = sext i32 %149 to i64, !llfi_index !1281
  %151 = load i8** %mem, align 8, !llfi_index !1282
  %152 = getelementptr inbounds i8* %151, i64 %150, !llfi_index !1283
  store i8* %152, i8** %_to1, align 8, !llfi_index !1284
  %153 = bitcast float* %dvalue to i8*, !llfi_index !1285
  store i8* %153, i8** %_from2, align 8, !llfi_index !1286
  store i32 4, i32* %_l4, align 4, !llfi_index !1287
  store i32 0, i32* %_i3, align 4, !llfi_index !1288
  br label %154, !llfi_index !1289

; <label>:154                                     ; preds = %174, %139
  %155 = load i32* %_i3, align 4, !llfi_index !1290
  %156 = load i32* %_i3, align 4, !llfi_index !1290
  %157 = load i32* %_l4, align 4, !llfi_index !1291
  %158 = icmp slt i32 %155, %157, !llfi_index !1292
  %159 = icmp slt i32 %156, %157, !llfi_index !1292
  %check_cmp13 = icmp eq i1 %158, %159
  br i1 %check_cmp13, label %160, label %checkBb14

checkBb14:                                        ; preds = %154
  call void @check_flag()
  br label %160

; <label>:160                                     ; preds = %checkBb14, %154
  br i1 %158, label %161, label %175, !llfi_index !1293

; <label>:161                                     ; preds = %160
  %162 = load i8** %_from2, align 8, !llfi_index !1294
  %163 = getelementptr inbounds i8* %162, i32 1, !llfi_index !1295
  store i8* %163, i8** %_from2, align 8, !llfi_index !1296
  %164 = load i8* %162, align 1, !llfi_index !1297
  %165 = load i8* %162, align 1, !llfi_index !1297
  %check_cmp15 = icmp eq i8 %164, %165
...
; <label>:166                                     ; preds = %checkBb16, %161
  %167 = load i8** %_to1, align 8, !llfi_index !1298
  %168 = getelementptr inbounds i8* %167, i32 1, !llfi_index !1299
  store i8* %168, i8** %_to1, align 8, !llfi_index !1300
  store i8 %164, i8* %167, align 1, !llfi_index !1301
  br label %169, !llfi_index !1302

; <label>:169                                     ; preds = %166
  %170 = load i32* %_i3, align 4, !llfi_index !1303
  %171 = load i32* %_i3, align 4, !llfi_index !1303
  %172 = add nsw i32 %170, 1, !llfi_index !1304
  %173 = add nsw i32 %171, 1, !llfi_index !1304
  %check_cmp17 = icmp eq i32 %172, %173
...
; <label>:174                                     ; preds = %checkBb18, %169
  store i32 %172, i32* %_i3, align 4, !llfi_index !1305
  br label %154, !llfi_index !1306

; <label>:175                                     ; preds = %160
  %176 = load i32* %memcnt, align 4, !llfi_index !1307
  %177 = sext i32 %176 to i64, !llfi_index !1308
  %178 = add i64 %177, 4, !llfi_index !1309
  %179 = trunc i64 %178 to i32, !llfi_index !1310
  store i32 %179, i32* %memcnt, align 4, !llfi_index !1311
  br label %180, !llfi_index !1312

; <label>:180                                     ; preds = %175
  %181 = load i32* %j, align 4, !llfi_index !1313
  %182 = add nsw i32 %181, 1, !llfi_index !1314
  store i32 %182, i32* %j, align 4, !llfi_index !1315
  br label %135, !llfi_index !1316

; <label>:183                                     ; preds = %135
  br label %184, !llfi_index !1317

; <label>:184                                     ; preds = %183
  %185 = load i32* %i, align 4, !llfi_index !1318
  %186 = add nsw i32 %185, 1, !llfi_index !1319
  store i32 %186, i32* %i, align 4, !llfi_index !1320
  br label %130, !llfi_index !1321

; <label>:187                                     ; preds = %130
  %188 = load i8** %mem, align 8, !llfi_index !1322
  %189 = load i32* %n2, align 4, !llfi_index !1323
  %190 = add nsw i32 %189, 1, !llfi_index !1324
  %191 = load i32* %n3, align 4, !llfi_index !1325
  %192 = add nsw i32 %191, 1, !llfi_index !1326
  %193 = mul nsw i32 %190, %192, !llfi_index !1327
  %194 = zext i32 %193 to i64, !llfi_index !1328
  %195 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1329
  %196 = call i64 @fwrite(i8* %188, i64 4, i64 %194, %struct._IO_FILE* %195), !llfi_index !1330
  %197 = load i8** %mem, align 8, !llfi_index !1331
  call void @free(i8* %197) #6, !llfi_index !1332
  %198 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1333
  %199 = call i32 @fclose(%struct._IO_FILE* %198), !llfi_index !1334
