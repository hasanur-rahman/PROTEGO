...
; <label>:9                                       ; preds = %81, %0
  ...
  br i1 %12, label %13, label %84, !llfi_index !880
...
; <label>:14                                      ; preds = %77, %13
  ...
  br i1 %17, label %18, label %80, !llfi_index !886
...
; <label>:21                                      ; preds = %checkBb, %18
  ...
  %42 = load float** %40, align 8, !llfi_index !907
  %43 = getelementptr inbounds float* %41, i64 %36, !llfi_index !908
  %44 = getelementptr inbounds float* %42, i64 %36, !llfi_index !908
  %check_cmp1 = icmp eq float* %43, %44
...
; <label>:45                                      ; preds = %checkBb2, %21
  %46 = load float* %43, align 4, !llfi_index !909
  %47 = fpext float %46 to double, !llfi_index !910
  %48 = fmul double 3.000000e-01, %47, !llfi_index !911
  %49 = fadd double %34, %48, !llfi_index !912
...
; <label>:64                                      ; preds = %checkBb4, %45
  ...
  %73 = load float** %71, align 8, !llfi_index !934
  %74 = getelementptr inbounds float* %72, i64 %67, !llfi_index !935
  %75 = getelementptr inbounds float* %73, i64 %67, !llfi_index !935
  %check_cmp5 = icmp eq float* %74, %75
...
; <label>:76                                      ; preds = %checkBb6, %64
  store float %65, float* %74, align 4, !llfi_index !936
...
; <label>:47                                      ; preds = %checkBb, %41
  br i1 %45, label %48, label %129, !llfi_index !1172
...
; <label>:55                                      ; preds = %checkBb2, %49
  br i1 %53, label %56, label %122, !llfi_index !1178
...
; <label>:59                                      ; preds = %checkBb4, %56
  %60 = sext i32 %57 to i64, !llfi_index !1180
...
; <label>:63                                      ; preds = %checkBb6, %59
  ...
  %69 = getelementptr inbounds float* %67, i64 %60, !llfi_index !1186
  ...
  %check_cmp7 = fcmp ueq float %71, %72
...
; <label>:76                                      ; preds = %checkBb10, %73
  %77 = sext i32 %74 to i64, !llfi_index !1190
  %78 = load i8** %mem, align 8, !llfi_index !1191
  %79 = getelementptr inbounds i8* %78, i64 %77, !llfi_index !1192
...
; <label>:82                                      ; preds = %checkBb12, %76
  store i8* %80, i8** %_from, align 8, !llfi_index !1195
...
; <label>:89                                      ; preds = %checkBb14, %83
  br i1 %87, label %90, label %107, !llfi_index !1202
...
; <label>:98                                      ; preds = %checkBb18, %95
  %99 = load i8** %_to, align 8, !llfi_index !1207
  %100 = getelementptr inbounds i8* %99, i32 1, !llfi_index !1208
  store i8* %100, i8** %_to, align 8, !llfi_index !1209
  store i8 %96, i8* %99, align 1, !llfi_index !1210
  br label %101, !llfi_index !1211
...
; <label>:106                                     ; preds = %checkBb20, %101
  store i32 %104, i32* %_i, align 4, !llfi_index !1214
...
; <label>:110                                     ; preds = %checkBb22, %107
  %111 = sext i32 %108 to i64, !llfi_index !1217
  %112 = add i64 %111, 4, !llfi_index !1218
  %113 = trunc i64 %112 to i32, !llfi_index !1219
  %114 = trunc i64 %112 to i32, !llfi_index !1219
...
; <label>:115                                     ; preds = %checkBb24, %110
  store i32 %113, i32* %memcnt, align 4, !llfi_index !1220
  br label %116, !llfi_index !1221
...
; <label>:121                                     ; preds = %checkBb26, %116
  store i32 %119, i32* %j, align 4, !llfi_index !1224
  br label %49, !llfi_index !1225

; <label>:122                                     ; preds = %55
  br label %123, !llfi_index !1226
...
; <label>:123                                     ; preds = %122
  ...
  %check_cmp27 = icmp eq i32 %126, %127
...
; <label>:128                                     ; preds = %checkBb28, %123
  store i32 %126, i32* %i, align 4, !llfi_index !1229
  br label %41, !llfi_index !1230

; <label>:129                                     ; preds = %47
  %130 = load i8** %mem, align 8, !llfi_index !1231
  %131 = load i32* %n1, align 4, !llfi_index !1232
  %132 = add nsw i32 %131, 1, !llfi_index !1233
  %133 = load i32* %n2, align 4, !llfi_index !1234
  %134 = add nsw i32 %133, 1, !llfi_index !1235
  %135 = mul nsw i32 %132, %134, !llfi_index !1236
  %136 = zext i32 %135 to i64, !llfi_index !1237
  %137 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1238
  %138 = call i64 @fwrite(i8* %130, i64 4, i64 %136, %struct._IO_FILE* %137), !llfi_index !1239
  %139 = load i8** %mem, align 8, !llfi_index !1240
  call void @free(i8* %139) #6, !llfi_index !1241
  store i32 0, i32* %memcnt, align 4, !llfi_index !1242
  %140 = load %struct.BPNN** %1, align 8, !llfi_index !1243
  %141 = getelementptr inbounds %struct.BPNN* %140, i32 0, i32 10, !llfi_index !1244
  %142 = load float*** %141, align 8, !llfi_index !1245
  store float** %142, float*** %w, align 8, !llfi_index !1246
  %143 = load i32* %n2, align 4, !llfi_index !1247
  %144 = add nsw i32 %143, 1, !llfi_index !1248
  %145 = load i32* %n3, align 4, !llfi_index !1249
  %146 = add nsw i32 %145, 1, !llfi_index !1250
  %147 = mul nsw i32 %144, %146, !llfi_index !1251
  %148 = sext i32 %147 to i64, !llfi_index !1252
  %149 = mul i64 %148, 4, !llfi_index !1253
  %150 = trunc i64 %149 to i32, !llfi_index !1254
  %151 = zext i32 %150 to i64, !llfi_index !1255
  %152 = call noalias i8* @malloc(i64 %151) #6, !llfi_index !1256
  store i8* %152, i8** %mem, align 8, !llfi_index !1257
  store i32 0, i32* %i, align 4, !llfi_index !1258
  br label %153, !llfi_index !1259

; <label>:153                                     ; preds = %216, %129
  %154 = load i32* %i, align 4, !llfi_index !1260
  %155 = load i32* %n2, align 4, !llfi_index !1261
  %156 = icmp sle i32 %154, %155, !llfi_index !1262
  br i1 %156, label %157, label %219, !llfi_index !1263

; <label>:157                                     ; preds = %153
  store i32 0, i32* %j, align 4, !llfi_index !1264
  br label %158, !llfi_index !1265

; <label>:158                                     ; preds = %212, %157
  %159 = load i32* %j, align 4, !llfi_index !1266
  %160 = load i32* %j, align 4, !llfi_index !1266
  %161 = load i32* %n3, align 4, !llfi_index !1267
  %162 = icmp sle i32 %159, %161, !llfi_index !1268
  %163 = icmp sle i32 %160, %161, !llfi_index !1268
  %check_cmp29 = icmp eq i1 %162, %163
...
; <label>:164                                     ; preds = %checkBb30, %158
  br i1 %162, label %165, label %215, !llfi_index !1269

; <label>:165                                     ; preds = %164
  %166 = load i32* %j, align 4, !llfi_index !1270
  %167 = sext i32 %166 to i64, !llfi_index !1271
  %168 = load i32* %i, align 4, !llfi_index !1272
  %169 = sext i32 %168 to i64, !llfi_index !1273
  %170 = load float*** %w, align 8, !llfi_index !1274
  %171 = getelementptr inbounds float** %170, i64 %169, !llfi_index !1275
  %172 = load float** %171, align 8, !llfi_index !1276
  %173 = getelementptr inbounds float* %172, i64 %167, !llfi_index !1277
  %174 = load float* %173, align 4, !llfi_index !1278
  store float %174, float* %dvalue, align 4, !llfi_index !1279
  %175 = load i32* %memcnt, align 4, !llfi_index !1280
  %176 = sext i32 %175 to i64, !llfi_index !1281
  %177 = load i8** %mem, align 8, !llfi_index !1282
  %178 = getelementptr inbounds i8* %177, i64 %176, !llfi_index !1283
  store i8* %178, i8** %_to1, align 8, !llfi_index !1284
  %179 = bitcast float* %dvalue to i8*, !llfi_index !1285
  store i8* %179, i8** %_from2, align 8, !llfi_index !1286
  store i32 4, i32* %_l4, align 4, !llfi_index !1287
  store i32 0, i32* %_i3, align 4, !llfi_index !1288
  br label %180, !llfi_index !1289

; <label>:180                                     ; preds = %206, %165
  %181 = load i32* %_i3, align 4, !llfi_index !1290
  %182 = load i32* %_i3, align 4, !llfi_index !1290
  %183 = load i32* %_l4, align 4, !llfi_index !1291
  %184 = icmp slt i32 %181, %183, !llfi_index !1292
  %185 = icmp slt i32 %182, %183, !llfi_index !1292
...
; <label>:186                                     ; preds = %checkBb32, %180
  br i1 %184, label %187, label %207, !llfi_index !1293

; <label>:187                                     ; preds = %186
  %188 = load i8** %_from2, align 8, !llfi_index !1294
  %189 = load i8** %_from2, align 8, !llfi_index !1294
  %190 = getelementptr inbounds i8* %188, i32 1, !llfi_index !1295
  %191 = getelementptr inbounds i8* %189, i32 1, !llfi_index !1295
  %check_cmp33 = icmp eq i8* %190, %191
...
; <label>:192                                     ; preds = %checkBb34, %187
  store i8* %190, i8** %_from2, align 8, !llfi_index !1296
  %193 = load i8* %188, align 1, !llfi_index !1297
  %194 = load i8* %189, align 1, !llfi_index !1297
  %check_cmp35 = icmp eq i8 %193, %194
  br i1 %check_cmp35, label %195, label %checkBb36

checkBb36:                                        ; preds = %192
  call void @check_flag()
  br label %195

; <label>:195                                     ; preds = %checkBb36, %192
  %196 = load i8** %_to1, align 8, !llfi_index !1298
  %197 = load i8** %_to1, align 8, !llfi_index !1298
  %198 = getelementptr inbounds i8* %196, i32 1, !llfi_index !1299
  %199 = getelementptr inbounds i8* %197, i32 1, !llfi_index !1299
  %check_cmp37 = icmp eq i8* %198, %199
...
; <label>:200                                     ; preds = %checkBb38, %195
  store i8* %198, i8** %_to1, align 8, !llfi_index !1300
  store i8 %193, i8* %196, align 1, !llfi_index !1301
  br label %201, !llfi_index !1302

; <label>:201                                     ; preds = %200
  %202 = load i32* %_i3, align 4, !llfi_index !1303
  %203 = load i32* %_i3, align 4, !llfi_index !1303
  %204 = add nsw i32 %202, 1, !llfi_index !1304
...
; <label>:206                                     ; preds = %checkBb40, %201
  store i32 %204, i32* %_i3, align 4, !llfi_index !1305
  br label %180, !llfi_index !1306

; <label>:207                                     ; preds = %186
  %208 = load i32* %memcnt, align 4, !llfi_index !1307
  %209 = sext i32 %208 to i64, !llfi_index !1308
  ...
  br label %212, !llfi_index !1312

; <label>:212                                     ; preds = %207
  %213 = load i32* %j, align 4, !llfi_index !1313
  %214 = add nsw i32 %213, 1, !llfi_index !1314
  store i32 %214, i32* %j, align 4, !llfi_index !1315
  br label %158, !llfi_index !1316

; <label>:215                                     ; preds = %164
  br label %216, !llfi_index !1317

; <label>:216                                     ; preds = %215
  %217 = load i32* %i, align 4, !llfi_index !1318
  %218 = add nsw i32 %217, 1, !llfi_index !1319
  store i32 %218, i32* %i, align 4, !llfi_index !1320
  br label %153, !llfi_index !1321
