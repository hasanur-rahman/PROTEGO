...
; <label>:46                                      ; preds = %checkBb, %41
  br i1 %44, label %47, label %111, !llfi_index !1172
...
; <label>:58                                      ; preds = %checkBb4, %55
  %59 = sext i32 %56 to i64, !llfi_index !1180
...
; <label>:62                                      ; preds = %checkBb6, %58
  ...
  %67 = getelementptr inbounds float* %66, i64 %59, !llfi_index !1186
  %68 = load float* %67, align 4, !llfi_index !1187
  %69 = load float* %67, align 4, !llfi_index !1187
  %check_cmp7 = fcmp ueq float %68, %69
...
; <label>:70                                      ; preds = %checkBb8, %62
  store float %68, float* %dvalue, align 4, !llfi_index !1188
  %71 = load i32* %memcnt, align 4, !llfi_index !1189
...
; <label>:73                                      ; preds = %checkBb10, %70
  %74 = sext i32 %71 to i64, !llfi_index !1190
  %75 = load i8** %mem, align 8, !llfi_index !1191
  %76 = getelementptr inbounds i8* %75, i64 %74, !llfi_index !1192
  store i8* %76, i8** %_to, align 8, !llfi_index !1193
  %77 = bitcast float* %dvalue to i8*, !llfi_index !1194
  store i8* %77, i8** %_from, align 8, !llfi_index !1195
  store i32 4, i32* %_l, align 4, !llfi_index !1196
  store i32 0, i32* %_i, align 4, !llfi_index !1197
  br label %78, !llfi_index !1198

; <label>:78                                      ; preds = %90, %73
  %79 = load i32* %_i, align 4, !llfi_index !1199
  %80 = load i32* %_l, align 4, !llfi_index !1200
  %81 = icmp slt i32 %79, %80, !llfi_index !1201
  br i1 %81, label %82, label %93, !llfi_index !1202

; <label>:82                                      ; preds = %78
  %83 = load i8** %_from, align 8, !llfi_index !1203
  %84 = getelementptr inbounds i8* %83, i32 1, !llfi_index !1204
  store i8* %84, i8** %_from, align 8, !llfi_index !1205
  %85 = load i8* %83, align 1, !llfi_index !1206
  %86 = load i8* %83, align 1, !llfi_index !1206
  %check_cmp11 = icmp eq i8 %85, %86
...
; <label>:87                                      ; preds = %checkBb12, %82
  %88 = load i8** %_to, align 8, !llfi_index !1207
  %89 = getelementptr inbounds i8* %88, i32 1, !llfi_index !1208
  store i8* %89, i8** %_to, align 8, !llfi_index !1209
  store i8 %85, i8* %88, align 1, !llfi_index !1210
  br label %90, !llfi_index !1211

; <label>:90                                      ; preds = %87
  %91 = load i32* %_i, align 4, !llfi_index !1212
  %92 = add nsw i32 %91, 1, !llfi_index !1213
  store i32 %92, i32* %_i, align 4, !llfi_index !1214
  br label %78, !llfi_index !1215

; <label>:93                                      ; preds = %78
  %94 = load i32* %memcnt, align 4, !llfi_index !1216
  %95 = sext i32 %94 to i64, !llfi_index !1217
  %96 = add i64 %95, 4, !llfi_index !1218
  %97 = trunc i64 %96 to i32, !llfi_index !1219
  store i32 %97, i32* %memcnt, align 4, !llfi_index !1220
  br label %98, !llfi_index !1221
...
; <label>:103                                     ; preds = %checkBb14, %98
  store i32 %101, i32* %j, align 4, !llfi_index !1224
  br label %48, !llfi_index !1225

; <label>:104                                     ; preds = %54
  br label %105, !llfi_index !1226

; <label>:105                                     ; preds = %104
  %106 = load i32* %i, align 4, !llfi_index !1227
  %107 = load i32* %i, align 4, !llfi_index !1227
  %108 = add nsw i32 %106, 1, !llfi_index !1228
  %109 = add nsw i32 %107, 1, !llfi_index !1228
...
; <label>:111                                     ; preds = %46
  %112 = load i8** %mem, align 8, !llfi_index !1231
  %113 = load i32* %n1, align 4, !llfi_index !1232
  %114 = add nsw i32 %113, 1, !llfi_index !1233
  %115 = load i32* %n2, align 4, !llfi_index !1234
  %116 = add nsw i32 %115, 1, !llfi_index !1235
  %117 = mul nsw i32 %114, %116, !llfi_index !1236
  %118 = zext i32 %117 to i64, !llfi_index !1237
  %119 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1238
  %120 = call i64 @fwrite(i8* %112, i64 4, i64 %118, %struct._IO_FILE* %119), !llfi_index !1239
  %121 = load i8** %mem, align 8, !llfi_index !1240
  call void @free(i8* %121) #6, !llfi_index !1241
  store i32 0, i32* %memcnt, align 4, !llfi_index !1242
  %122 = load %struct.BPNN** %1, align 8, !llfi_index !1243
  %123 = getelementptr inbounds %struct.BPNN* %122, i32 0, i32 10, !llfi_index !1244
  %124 = load float*** %123, align 8, !llfi_index !1245
  store float** %124, float*** %w, align 8, !llfi_index !1246
  %125 = load i32* %n2, align 4, !llfi_index !1247
  %126 = add nsw i32 %125, 1, !llfi_index !1248
  %127 = load i32* %n3, align 4, !llfi_index !1249
  %128 = add nsw i32 %127, 1, !llfi_index !1250
  %129 = mul nsw i32 %126, %128, !llfi_index !1251
  %130 = sext i32 %129 to i64, !llfi_index !1252
  %131 = mul i64 %130, 4, !llfi_index !1253
  %132 = trunc i64 %131 to i32, !llfi_index !1254
  %133 = zext i32 %132 to i64, !llfi_index !1255
  %134 = call noalias i8* @malloc(i64 %133) #6, !llfi_index !1256
  store i8* %134, i8** %mem, align 8, !llfi_index !1257
  store i32 0, i32* %i, align 4, !llfi_index !1258
  br label %135, !llfi_index !1259

; <label>:135                                     ; preds = %181, %111
  %136 = load i32* %i, align 4, !llfi_index !1260
  %137 = load i32* %n2, align 4, !llfi_index !1261
  %138 = icmp sle i32 %136, %137, !llfi_index !1262
  br i1 %138, label %139, label %184, !llfi_index !1263

; <label>:139                                     ; preds = %135
  store i32 0, i32* %j, align 4, !llfi_index !1264
  br label %140, !llfi_index !1265

; <label>:140                                     ; preds = %177, %139
  %141 = load i32* %j, align 4, !llfi_index !1266
  %142 = load i32* %n3, align 4, !llfi_index !1267
  %143 = icmp sle i32 %141, %142, !llfi_index !1268
  br i1 %143, label %144, label %180, !llfi_index !1269

; <label>:144                                     ; preds = %140
  %145 = load i32* %j, align 4, !llfi_index !1270
  %146 = sext i32 %145 to i64, !llfi_index !1271
  %147 = load i32* %i, align 4, !llfi_index !1272
  %148 = sext i32 %147 to i64, !llfi_index !1273
  %149 = load float*** %w, align 8, !llfi_index !1274
  %150 = getelementptr inbounds float** %149, i64 %148, !llfi_index !1275
  %151 = load float** %150, align 8, !llfi_index !1276
  %152 = getelementptr inbounds float* %151, i64 %146, !llfi_index !1277
  %153 = load float* %152, align 4, !llfi_index !1278
  store float %153, float* %dvalue, align 4, !llfi_index !1279
  %154 = load i32* %memcnt, align 4, !llfi_index !1280
  %155 = sext i32 %154 to i64, !llfi_index !1281
  %156 = load i8** %mem, align 8, !llfi_index !1282
  %157 = getelementptr inbounds i8* %156, i64 %155, !llfi_index !1283
  store i8* %157, i8** %_to1, align 8, !llfi_index !1284
  %158 = bitcast float* %dvalue to i8*, !llfi_index !1285
  store i8* %158, i8** %_from2, align 8, !llfi_index !1286
  store i32 4, i32* %_l4, align 4, !llfi_index !1287
  store i32 0, i32* %_i3, align 4, !llfi_index !1288
  br label %159, !llfi_index !1289

; <label>:159                                     ; preds = %169, %144
  %160 = load i32* %_i3, align 4, !llfi_index !1290
  %161 = load i32* %_l4, align 4, !llfi_index !1291
  %162 = icmp slt i32 %160, %161, !llfi_index !1292
  br i1 %162, label %163, label %172, !llfi_index !1293

; <label>:163                                     ; preds = %159
  %164 = load i8** %_from2, align 8, !llfi_index !1294
  %165 = getelementptr inbounds i8* %164, i32 1, !llfi_index !1295
  store i8* %165, i8** %_from2, align 8, !llfi_index !1296
  %166 = load i8* %164, align 1, !llfi_index !1297
  ...
  store i8 %166, i8* %167, align 1, !llfi_index !1301
  br label %169, !llfi_index !1302

; <label>:169                                     ; preds = %163
  %170 = load i32* %_i3, align 4, !llfi_index !1303
  %171 = add nsw i32 %170, 1, !llfi_index !1304
  store i32 %171, i32* %_i3, align 4, !llfi_index !1305
  br label %159, !llfi_index !1306

; <label>:172                                     ; preds = %159
  %173 = load i32* %memcnt, align 4, !llfi_index !1307
  %174 = sext i32 %173 to i64, !llfi_index !1308
  %175 = add i64 %174, 4, !llfi_index !1309
  %176 = trunc i64 %175 to i32, !llfi_index !1310
  store i32 %176, i32* %memcnt, align 4, !llfi_index !1311
  br label %177, !llfi_index !1312

; <label>:177                                     ; preds = %172
  %178 = load i32* %j, align 4, !llfi_index !1313
  %179 = add nsw i32 %178, 1, !llfi_index !1314
  store i32 %179, i32* %j, align 4, !llfi_index !1315
  br label %140, !llfi_index !1316

; <label>:180                                     ; preds = %140
  br label %181, !llfi_index !1317

; <label>:181                                     ; preds = %180
  %182 = load i32* %i, align 4, !llfi_index !1318
  %183 = add nsw i32 %182, 1, !llfi_index !1319
  store i32 %183, i32* %i, align 4, !llfi_index !1320
  br label %135, !llfi_index !1321

; <label>:184                                     ; preds = %135
  %185 = load i8** %mem, align 8, !llfi_index !1322
  %186 = load i32* %n2, align 4, !llfi_index !1323
  %187 = add nsw i32 %186, 1, !llfi_index !1324
  %188 = load i32* %n3, align 4, !llfi_index !1325
  %189 = add nsw i32 %188, 1, !llfi_index !1326
  %190 = mul nsw i32 %187, %189, !llfi_index !1327
  %191 = zext i32 %190 to i64, !llfi_index !1328
  %192 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1329
  %193 = call i64 @fwrite(i8* %185, i64 4, i64 %191, %struct._IO_FILE* %192), !llfi_index !1330
  %194 = load i8** %mem, align 8, !llfi_index !1331
  call void @free(i8* %194) #6, !llfi_index !1332
  %195 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1333
  %196 = call i32 @fclose(%struct._IO_FILE* %195), !llfi_index !1334
