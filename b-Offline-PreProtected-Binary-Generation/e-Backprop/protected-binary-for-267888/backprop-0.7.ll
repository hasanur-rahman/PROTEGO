...
; <label>:17                                      ; preds = %13
  ...
  %30 = load float** %1, align 8, !llfi_index !636
  %check_cmp = icmp eq float* %29, %30
...
; <label>:31                                      ; preds = %checkBb, %17
  %32 = getelementptr inbounds float* %29, i64 %28, !llfi_index !637
  %33 = load float* %32, align 4, !llfi_index !638
...
; <label>:9                                       ; preds = %84, %0
  ...
  br i1 %12, label %13, label %87, !llfi_index !880
...
; <label>:14                                      ; preds = %80, %13
  ...
  br i1 %17, label %18, label %83, !llfi_index !886
...
; <label>:21                                      ; preds = %checkBb, %18
  ...
  %25 = getelementptr inbounds float* %23, i64 %22, !llfi_index !890
  %26 = getelementptr inbounds float* %24, i64 %22, !llfi_index !890
  %check_cmp1 = icmp eq float* %25, %26
...
; <label>:27                                      ; preds = %checkBb2, %21
  %28 = load float* %25, align 4, !llfi_index !891
  ...
  %45 = load float** %43, align 8, !llfi_index !907
  %46 = getelementptr inbounds float* %44, i64 %39, !llfi_index !908
  %47 = getelementptr inbounds float* %45, i64 %39, !llfi_index !908
  %check_cmp3 = icmp eq float* %46, %47
...
; <label>:67                                      ; preds = %checkBb6, %48
  ...
  %76 = load float** %74, align 8, !llfi_index !934
  %77 = getelementptr inbounds float* %75, i64 %70, !llfi_index !935
  %78 = getelementptr inbounds float* %76, i64 %70, !llfi_index !935
  %check_cmp7 = icmp eq float* %77, %78
...
; <label>:79                                      ; preds = %checkBb8, %67
  store float %68, float* %77, align 4, !llfi_index !936
  br label %80, !llfi_index !937

; <label>:80                                      ; preds = %79
  %81 = load i32* %k, align 4, !llfi_index !938
  %82 = add nsw i32 %81, 1, !llfi_index !939
  store i32 %82, i32* %k, align 4, !llfi_index !940
  br label %14, !llfi_index !941

; <label>:83                                      ; preds = %14
  br label %84, !llfi_index !942

; <label>:84                                      ; preds = %83
  %85 = load i32* %j, align 4, !llfi_index !943
  %86 = add nsw i32 %85, 1, !llfi_index !944
  store i32 %86, i32* %j, align 4, !llfi_index !945
...
; <label>:46                                      ; preds = %checkBb, %41
  br i1 %44, label %47, label %130, !llfi_index !1172
...
; <label>:55                                      ; preds = %checkBb2, %48
  br i1 %53, label %56, label %123, !llfi_index !1178
...
; <label>:90                                      ; preds = %checkBb12, %84
  br i1 %88, label %91, label %107, !llfi_index !1202

; <label>:91                                      ; preds = %90
  %92 = load i8** %_from, align 8, !llfi_index !1203
  %93 = getelementptr inbounds i8* %92, i32 1, !llfi_index !1204
  store i8* %93, i8** %_from, align 8, !llfi_index !1205
  %94 = load i8* %92, align 1, !llfi_index !1206
  %95 = load i8* %92, align 1, !llfi_index !1206
  %check_cmp13 = icmp eq i8 %94, %95
...
; <label>:99                                      ; preds = %checkBb16, %96
  %100 = getelementptr inbounds i8* %97, i32 1, !llfi_index !1208
...
; <label>:107                                     ; preds = %90
  ...
  %110 = sext i32 %108 to i64, !llfi_index !1217
  %111 = sext i32 %109 to i64, !llfi_index !1217
  %112 = add i64 %110, 4, !llfi_index !1218
  %113 = add i64 %111, 4, !llfi_index !1218
  %114 = trunc i64 %112 to i32, !llfi_index !1219
  %115 = trunc i64 %113 to i32, !llfi_index !1219
  %check_cmp19 = icmp eq i32 %114, %115
  br i1 %check_cmp19, label %116, label %checkBb20

checkBb20:                                        ; preds = %107
  call void @check_flag()
  br label %116

; <label>:116                                     ; preds = %checkBb20, %107
...
; <label>:117                                     ; preds = %116
  ...
  %check_cmp21 = icmp eq i32 %120, %121
  br i1 %check_cmp21, label %122, label %checkBb22

checkBb22:                                        ; preds = %117
  call void @check_flag()
  br label %122

; <label>:122                                     ; preds = %checkBb22, %117
...
; <label>:159                                     ; preds = %196, %158
  ...
  %162 = icmp sle i32 %160, %161, !llfi_index !1268
  br i1 %162, label %163, label %199, !llfi_index !1269

; <label>:163                                     ; preds = %159
  %164 = load i32* %j, align 4, !llfi_index !1270
  %165 = sext i32 %164 to i64, !llfi_index !1271
  %166 = load i32* %i, align 4, !llfi_index !1272
  %167 = sext i32 %166 to i64, !llfi_index !1273
  %168 = load float*** %w, align 8, !llfi_index !1274
  %169 = getelementptr inbounds float** %168, i64 %167, !llfi_index !1275
  %170 = load float** %169, align 8, !llfi_index !1276
  %171 = getelementptr inbounds float* %170, i64 %165, !llfi_index !1277
  %172 = load float* %171, align 4, !llfi_index !1278
  store float %172, float* %dvalue, align 4, !llfi_index !1279
  %173 = load i32* %memcnt, align 4, !llfi_index !1280
  %174 = sext i32 %173 to i64, !llfi_index !1281
  %175 = load i8** %mem, align 8, !llfi_index !1282
  %176 = getelementptr inbounds i8* %175, i64 %174, !llfi_index !1283
  store i8* %176, i8** %_to1, align 8, !llfi_index !1284
  %177 = bitcast float* %dvalue to i8*, !llfi_index !1285
  store i8* %177, i8** %_from2, align 8, !llfi_index !1286
  store i32 4, i32* %_l4, align 4, !llfi_index !1287
  store i32 0, i32* %_i3, align 4, !llfi_index !1288
  br label %178, !llfi_index !1289

; <label>:178                                     ; preds = %188, %163
  %179 = load i32* %_i3, align 4, !llfi_index !1290
  %180 = load i32* %_l4, align 4, !llfi_index !1291
  %181 = icmp slt i32 %179, %180, !llfi_index !1292
  br i1 %181, label %182, label %191, !llfi_index !1293

; <label>:182                                     ; preds = %178
  %183 = load i8** %_from2, align 8, !llfi_index !1294
  %184 = getelementptr inbounds i8* %183, i32 1, !llfi_index !1295
  store i8* %184, i8** %_from2, align 8, !llfi_index !1296
  %185 = load i8* %183, align 1, !llfi_index !1297
  %186 = load i8** %_to1, align 8, !llfi_index !1298
  %187 = getelementptr inbounds i8* %186, i32 1, !llfi_index !1299
  store i8* %187, i8** %_to1, align 8, !llfi_index !1300
  store i8 %185, i8* %186, align 1, !llfi_index !1301
  br label %188, !llfi_index !1302

; <label>:188                                     ; preds = %182
  %189 = load i32* %_i3, align 4, !llfi_index !1303
  %190 = add nsw i32 %189, 1, !llfi_index !1304
  store i32 %190, i32* %_i3, align 4, !llfi_index !1305
  br label %178, !llfi_index !1306

; <label>:191                                     ; preds = %178
  %192 = load i32* %memcnt, align 4, !llfi_index !1307
  %193 = sext i32 %192 to i64, !llfi_index !1308
  %194 = add i64 %193, 4, !llfi_index !1309
  %195 = trunc i64 %194 to i32, !llfi_index !1310
  store i32 %195, i32* %memcnt, align 4, !llfi_index !1311
  br label %196, !llfi_index !1312

; <label>:196                                     ; preds = %191
  %197 = load i32* %j, align 4, !llfi_index !1313
  %198 = add nsw i32 %197, 1, !llfi_index !1314
  store i32 %198, i32* %j, align 4, !llfi_index !1315
  br label %159, !llfi_index !1316

; <label>:199                                     ; preds = %159
  br label %200, !llfi_index !1317

; <label>:200                                     ; preds = %199
  %201 = load i32* %i, align 4, !llfi_index !1318
  %202 = add nsw i32 %201, 1, !llfi_index !1319
  store i32 %202, i32* %i, align 4, !llfi_index !1320
  br label %154, !llfi_index !1321

; <label>:203                                     ; preds = %154
  %204 = load i8** %mem, align 8, !llfi_index !1322
  %205 = load i32* %n2, align 4, !llfi_index !1323
  %206 = add nsw i32 %205, 1, !llfi_index !1324
  %207 = load i32* %n3, align 4, !llfi_index !1325
  %208 = add nsw i32 %207, 1, !llfi_index !1326
  %209 = mul nsw i32 %206, %208, !llfi_index !1327
  %210 = zext i32 %209 to i64, !llfi_index !1328
  %211 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1329
  %212 = call i64 @fwrite(i8* %204, i64 4, i64 %210, %struct._IO_FILE* %211), !llfi_index !1330
  %213 = load i8** %mem, align 8, !llfi_index !1331
  call void @free(i8* %213) #6, !llfi_index !1332
  %214 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1333
  %215 = call i32 @fclose(%struct._IO_FILE* %214), !llfi_index !1334
