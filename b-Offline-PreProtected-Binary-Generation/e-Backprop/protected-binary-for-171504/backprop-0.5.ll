...
; <label>:8                                       ; preds = %49, %0
  ...
  br i1 %11, label %12, label %52, !llfi_index !617
...
; <label>:13                                      ; preds = %38, %12
  ...
  br i1 %16, label %17, label %41, !llfi_index !624
...
; <label>:17                                      ; preds = %13
  ...
  %34 = load float* %sum, align 4, !llfi_index !640
  %35 = fadd float %33, %32, !llfi_index !641
  %36 = fadd float %34, %32, !llfi_index !641
  %check_cmp = fcmp ueq float %35, %36
...
; <label>:37                                      ; preds = %checkBb, %17
  store float %35, float* %sum, align 4, !llfi_index !642
...
; <label>:47                                      ; preds = %checkBb, %41
  br i1 %45, label %48, label %103, !llfi_index !1172
...
; <label>:55                                      ; preds = %checkBb2, %49
  br i1 %53, label %56, label %99, !llfi_index !1178

; <label>:56                                      ; preds = %55
  %57 = load i32* %j, align 4, !llfi_index !1179
  %58 = sext i32 %57 to i64, !llfi_index !1180
  %59 = load i32* %i, align 4, !llfi_index !1181
  %60 = sext i32 %59 to i64, !llfi_index !1182
  ...
  %64 = getelementptr inbounds float* %63, i64 %58, !llfi_index !1186
...
; <label>:67                                      ; preds = %checkBb4, %56
  store float %65, float* %dvalue, align 4, !llfi_index !1188
  %68 = load i32* %memcnt, align 4, !llfi_index !1189
  %69 = sext i32 %68 to i64, !llfi_index !1190
  %70 = load i8** %mem, align 8, !llfi_index !1191
  %71 = getelementptr inbounds i8* %70, i64 %69, !llfi_index !1192
  store i8* %71, i8** %_to, align 8, !llfi_index !1193
  %72 = bitcast float* %dvalue to i8*, !llfi_index !1194
  store i8* %72, i8** %_from, align 8, !llfi_index !1195
  store i32 4, i32* %_l, align 4, !llfi_index !1196
  store i32 0, i32* %_i, align 4, !llfi_index !1197
  br label %73, !llfi_index !1198

; <label>:73                                      ; preds = %88, %67
  %74 = load i32* %_i, align 4, !llfi_index !1199
  %75 = load i32* %_l, align 4, !llfi_index !1200
  %76 = load i32* %_l, align 4, !llfi_index !1200
  %77 = icmp slt i32 %74, %75, !llfi_index !1201
  %78 = icmp slt i32 %74, %76, !llfi_index !1201
...
; <label>:79                                      ; preds = %checkBb6, %73
  br i1 %77, label %80, label %91, !llfi_index !1202
...
; <label>:88                                      ; preds = %85
  ...
  br label %73, !llfi_index !1215

; <label>:91                                      ; preds = %79
  %92 = load i32* %memcnt, align 4, !llfi_index !1216
  %93 = sext i32 %92 to i64, !llfi_index !1217
  %94 = add i64 %93, 4, !llfi_index !1218
  %95 = trunc i64 %94 to i32, !llfi_index !1219
  store i32 %95, i32* %memcnt, align 4, !llfi_index !1220
  br label %96, !llfi_index !1221

; <label>:96                                      ; preds = %91
  %97 = load i32* %j, align 4, !llfi_index !1222
  %98 = add nsw i32 %97, 1, !llfi_index !1223
  store i32 %98, i32* %j, align 4, !llfi_index !1224
  br label %49, !llfi_index !1225

; <label>:99                                      ; preds = %55
  br label %100, !llfi_index !1226

; <label>:100                                     ; preds = %99
  %101 = load i32* %i, align 4, !llfi_index !1227
  %102 = add nsw i32 %101, 1, !llfi_index !1228
  store i32 %102, i32* %i, align 4, !llfi_index !1229
  br label %41, !llfi_index !1230

; <label>:103                                     ; preds = %47
  %104 = load i8** %mem, align 8, !llfi_index !1231
  %105 = load i32* %n1, align 4, !llfi_index !1232
  %106 = add nsw i32 %105, 1, !llfi_index !1233
  %107 = load i32* %n2, align 4, !llfi_index !1234
  %108 = add nsw i32 %107, 1, !llfi_index !1235
  %109 = mul nsw i32 %106, %108, !llfi_index !1236
  %110 = zext i32 %109 to i64, !llfi_index !1237
  %111 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1238
  %112 = call i64 @fwrite(i8* %104, i64 4, i64 %110, %struct._IO_FILE* %111), !llfi_index !1239
  %113 = load i8** %mem, align 8, !llfi_index !1240
  call void @free(i8* %113) #6, !llfi_index !1241
  store i32 0, i32* %memcnt, align 4, !llfi_index !1242
  %114 = load %struct.BPNN** %1, align 8, !llfi_index !1243
  %115 = getelementptr inbounds %struct.BPNN* %114, i32 0, i32 10, !llfi_index !1244
  %116 = load float*** %115, align 8, !llfi_index !1245
  store float** %116, float*** %w, align 8, !llfi_index !1246
  %117 = load i32* %n2, align 4, !llfi_index !1247
  %118 = add nsw i32 %117, 1, !llfi_index !1248
  %119 = load i32* %n3, align 4, !llfi_index !1249
  %120 = add nsw i32 %119, 1, !llfi_index !1250
  %121 = mul nsw i32 %118, %120, !llfi_index !1251
  %122 = sext i32 %121 to i64, !llfi_index !1252
  %123 = mul i64 %122, 4, !llfi_index !1253
  %124 = trunc i64 %123 to i32, !llfi_index !1254
  %125 = zext i32 %124 to i64, !llfi_index !1255
  %126 = call noalias i8* @malloc(i64 %125) #6, !llfi_index !1256
  store i8* %126, i8** %mem, align 8, !llfi_index !1257
  store i32 0, i32* %i, align 4, !llfi_index !1258
  br label %127, !llfi_index !1259

; <label>:127                                     ; preds = %176, %103
  %128 = load i32* %i, align 4, !llfi_index !1260
  %129 = load i32* %n2, align 4, !llfi_index !1261
  %130 = icmp sle i32 %128, %129, !llfi_index !1262
  br i1 %130, label %131, label %179, !llfi_index !1263

; <label>:131                                     ; preds = %127
  store i32 0, i32* %j, align 4, !llfi_index !1264
  br label %132, !llfi_index !1265

; <label>:132                                     ; preds = %172, %131
  %133 = load i32* %j, align 4, !llfi_index !1266
  %134 = load i32* %n3, align 4, !llfi_index !1267
  %135 = icmp sle i32 %133, %134, !llfi_index !1268
  br i1 %135, label %136, label %175, !llfi_index !1269

; <label>:136                                     ; preds = %132
  %137 = load i32* %j, align 4, !llfi_index !1270
  %138 = sext i32 %137 to i64, !llfi_index !1271
  %139 = load i32* %i, align 4, !llfi_index !1272
  %140 = sext i32 %139 to i64, !llfi_index !1273
  %141 = load float*** %w, align 8, !llfi_index !1274
  %142 = getelementptr inbounds float** %141, i64 %140, !llfi_index !1275
  %143 = load float** %142, align 8, !llfi_index !1276
  %144 = getelementptr inbounds float* %143, i64 %138, !llfi_index !1277
  %145 = load float* %144, align 4, !llfi_index !1278
  store float %145, float* %dvalue, align 4, !llfi_index !1279
  %146 = load i32* %memcnt, align 4, !llfi_index !1280
  %147 = sext i32 %146 to i64, !llfi_index !1281
  %148 = load i8** %mem, align 8, !llfi_index !1282
  %149 = getelementptr inbounds i8* %148, i64 %147, !llfi_index !1283
  store i8* %149, i8** %_to1, align 8, !llfi_index !1284
  %150 = bitcast float* %dvalue to i8*, !llfi_index !1285
  store i8* %150, i8** %_from2, align 8, !llfi_index !1286
  store i32 4, i32* %_l4, align 4, !llfi_index !1287
  store i32 0, i32* %_i3, align 4, !llfi_index !1288
  br label %151, !llfi_index !1289

; <label>:151                                     ; preds = %164, %136
  %152 = load i32* %_i3, align 4, !llfi_index !1290
  %153 = load i32* %_l4, align 4, !llfi_index !1291
  %154 = load i32* %_l4, align 4, !llfi_index !1291
  %155 = icmp slt i32 %152, %153, !llfi_index !1292
  %156 = icmp slt i32 %152, %154, !llfi_index !1292
  %check_cmp9 = icmp eq i1 %155, %156
  br i1 %check_cmp9, label %157, label %checkBb10

checkBb10:                                        ; preds = %151
  call void @check_flag()
  br label %157

; <label>:157                                     ; preds = %checkBb10, %151
  br i1 %155, label %158, label %167, !llfi_index !1293

; <label>:158                                     ; preds = %157
  %159 = load i8** %_from2, align 8, !llfi_index !1294
  %160 = getelementptr inbounds i8* %159, i32 1, !llfi_index !1295
  store i8* %160, i8** %_from2, align 8, !llfi_index !1296
  %161 = load i8* %159, align 1, !llfi_index !1297
  %162 = load i8** %_to1, align 8, !llfi_index !1298
  %163 = getelementptr inbounds i8* %162, i32 1, !llfi_index !1299
  store i8* %163, i8** %_to1, align 8, !llfi_index !1300
  store i8 %161, i8* %162, align 1, !llfi_index !1301
  br label %164, !llfi_index !1302

; <label>:164                                     ; preds = %158
  %165 = load i32* %_i3, align 4, !llfi_index !1303
  %166 = add nsw i32 %165, 1, !llfi_index !1304
  store i32 %166, i32* %_i3, align 4, !llfi_index !1305
  br label %151, !llfi_index !1306

; <label>:167                                     ; preds = %157
  %168 = load i32* %memcnt, align 4, !llfi_index !1307
  %169 = sext i32 %168 to i64, !llfi_index !1308
  %170 = add i64 %169, 4, !llfi_index !1309
  %171 = trunc i64 %170 to i32, !llfi_index !1310
  store i32 %171, i32* %memcnt, align 4, !llfi_index !1311
  br label %172, !llfi_index !1312

; <label>:172                                     ; preds = %167
  %173 = load i32* %j, align 4, !llfi_index !1313
  %174 = add nsw i32 %173, 1, !llfi_index !1314
  store i32 %174, i32* %j, align 4, !llfi_index !1315
  br label %132, !llfi_index !1316

; <label>:175                                     ; preds = %132
  br label %176, !llfi_index !1317

; <label>:176                                     ; preds = %175
  %177 = load i32* %i, align 4, !llfi_index !1318
  %178 = add nsw i32 %177, 1, !llfi_index !1319
  store i32 %178, i32* %i, align 4, !llfi_index !1320
  br label %127, !llfi_index !1321

; <label>:179                                     ; preds = %127
  %180 = load i8** %mem, align 8, !llfi_index !1322
  %181 = load i32* %n2, align 4, !llfi_index !1323
  %182 = add nsw i32 %181, 1, !llfi_index !1324
  %183 = load i32* %n3, align 4, !llfi_index !1325
  %184 = add nsw i32 %183, 1, !llfi_index !1326
  %185 = mul nsw i32 %182, %184, !llfi_index !1327
  %186 = zext i32 %185 to i64, !llfi_index !1328
  %187 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1329
  %188 = call i64 @fwrite(i8* %180, i64 4, i64 %186, %struct._IO_FILE* %187), !llfi_index !1330
  %189 = load i8** %mem, align 8, !llfi_index !1331
  call void @free(i8* %189) #6, !llfi_index !1332
  %190 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1333
  %191 = call i32 @fclose(%struct._IO_FILE* %190), !llfi_index !1334
