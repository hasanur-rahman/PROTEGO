...
; <label>:47                                      ; preds = %checkBb, %41
  br i1 %45, label %48, label %102, !llfi_index !1172
...
; <label>:55                                      ; preds = %checkBb2, %49
  br i1 %53, label %56, label %98, !llfi_index !1178
...
; <label>:77                                      ; preds = %checkBb6, %73
  %78 = icmp slt i32 %74, %75, !llfi_index !1201
...
; <label>:95                                      ; preds = %90
  ...
  %97 = add nsw i32 %96, 1, !llfi_index !1223
  store i32 %97, i32* %j, align 4, !llfi_index !1224
  br label %49, !llfi_index !1225

; <label>:98                                      ; preds = %55
  br label %99, !llfi_index !1226

; <label>:99                                      ; preds = %98
  %100 = load i32* %i, align 4, !llfi_index !1227
  %101 = add nsw i32 %100, 1, !llfi_index !1228
  store i32 %101, i32* %i, align 4, !llfi_index !1229
  br label %41, !llfi_index !1230

; <label>:102                                     ; preds = %47
  %103 = load i8** %mem, align 8, !llfi_index !1231
  %104 = load i32* %n1, align 4, !llfi_index !1232
  %105 = add nsw i32 %104, 1, !llfi_index !1233
  %106 = load i32* %n2, align 4, !llfi_index !1234
  %107 = add nsw i32 %106, 1, !llfi_index !1235
  %108 = mul nsw i32 %105, %107, !llfi_index !1236
  %109 = zext i32 %108 to i64, !llfi_index !1237
  %110 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1238
  %111 = call i64 @fwrite(i8* %103, i64 4, i64 %109, %struct._IO_FILE* %110), !llfi_index !1239
  %112 = load i8** %mem, align 8, !llfi_index !1240
  call void @free(i8* %112) #6, !llfi_index !1241
  store i32 0, i32* %memcnt, align 4, !llfi_index !1242
  %113 = load %struct.BPNN** %1, align 8, !llfi_index !1243
  %114 = getelementptr inbounds %struct.BPNN* %113, i32 0, i32 10, !llfi_index !1244
  %115 = load float*** %114, align 8, !llfi_index !1245
  store float** %115, float*** %w, align 8, !llfi_index !1246
  %116 = load i32* %n2, align 4, !llfi_index !1247
  %117 = add nsw i32 %116, 1, !llfi_index !1248
  %118 = load i32* %n3, align 4, !llfi_index !1249
  %119 = add nsw i32 %118, 1, !llfi_index !1250
  %120 = mul nsw i32 %117, %119, !llfi_index !1251
  %121 = sext i32 %120 to i64, !llfi_index !1252
  %122 = mul i64 %121, 4, !llfi_index !1253
  %123 = trunc i64 %122 to i32, !llfi_index !1254
  %124 = zext i32 %123 to i64, !llfi_index !1255
  %125 = call noalias i8* @malloc(i64 %124) #6, !llfi_index !1256
  store i8* %125, i8** %mem, align 8, !llfi_index !1257
  store i32 0, i32* %i, align 4, !llfi_index !1258
  br label %126, !llfi_index !1259

; <label>:126                                     ; preds = %175, %102
  %127 = load i32* %i, align 4, !llfi_index !1260
  %128 = load i32* %n2, align 4, !llfi_index !1261
  %129 = icmp sle i32 %127, %128, !llfi_index !1262
  br i1 %129, label %130, label %178, !llfi_index !1263

; <label>:130                                     ; preds = %126
  store i32 0, i32* %j, align 4, !llfi_index !1264
  br label %131, !llfi_index !1265

; <label>:131                                     ; preds = %171, %130
  %132 = load i32* %j, align 4, !llfi_index !1266
  %133 = load i32* %n3, align 4, !llfi_index !1267
  %134 = icmp sle i32 %132, %133, !llfi_index !1268
  br i1 %134, label %135, label %174, !llfi_index !1269

; <label>:135                                     ; preds = %131
  %136 = load i32* %j, align 4, !llfi_index !1270
  %137 = sext i32 %136 to i64, !llfi_index !1271
  %138 = load i32* %i, align 4, !llfi_index !1272
  %139 = sext i32 %138 to i64, !llfi_index !1273
  %140 = load float*** %w, align 8, !llfi_index !1274
  %141 = getelementptr inbounds float** %140, i64 %139, !llfi_index !1275
  %142 = load float** %141, align 8, !llfi_index !1276
  %143 = getelementptr inbounds float* %142, i64 %137, !llfi_index !1277
  %144 = load float* %143, align 4, !llfi_index !1278
  store float %144, float* %dvalue, align 4, !llfi_index !1279
  %145 = load i32* %memcnt, align 4, !llfi_index !1280
  %146 = sext i32 %145 to i64, !llfi_index !1281
  %147 = load i8** %mem, align 8, !llfi_index !1282
  %148 = getelementptr inbounds i8* %147, i64 %146, !llfi_index !1283
  store i8* %148, i8** %_to1, align 8, !llfi_index !1284
  %149 = bitcast float* %dvalue to i8*, !llfi_index !1285
  store i8* %149, i8** %_from2, align 8, !llfi_index !1286
  store i32 4, i32* %_l4, align 4, !llfi_index !1287
  store i32 0, i32* %_i3, align 4, !llfi_index !1288
  br label %150, !llfi_index !1289

; <label>:150                                     ; preds = %163, %135
  %151 = load i32* %_i3, align 4, !llfi_index !1290
  %152 = load i32* %_l4, align 4, !llfi_index !1291
  %153 = load i32* %_l4, align 4, !llfi_index !1291
  %154 = icmp slt i32 %151, %152, !llfi_index !1292
  %155 = icmp slt i32 %151, %153, !llfi_index !1292
  %check_cmp9 = icmp eq i1 %154, %155
  br i1 %check_cmp9, label %156, label %checkBb10

checkBb10:                                        ; preds = %150
  call void @check_flag()
  br label %156

; <label>:156                                     ; preds = %checkBb10, %150
  br i1 %154, label %157, label %166, !llfi_index !1293

; <label>:157                                     ; preds = %156
  %158 = load i8** %_from2, align 8, !llfi_index !1294
  %159 = getelementptr inbounds i8* %158, i32 1, !llfi_index !1295
  store i8* %159, i8** %_from2, align 8, !llfi_index !1296
  %160 = load i8* %158, align 1, !llfi_index !1297
  %161 = load i8** %_to1, align 8, !llfi_index !1298
  %162 = getelementptr inbounds i8* %161, i32 1, !llfi_index !1299
  store i8* %162, i8** %_to1, align 8, !llfi_index !1300
  store i8 %160, i8* %161, align 1, !llfi_index !1301
  br label %163, !llfi_index !1302

; <label>:163                                     ; preds = %157
  %164 = load i32* %_i3, align 4, !llfi_index !1303
  %165 = add nsw i32 %164, 1, !llfi_index !1304
  store i32 %165, i32* %_i3, align 4, !llfi_index !1305
  br label %150, !llfi_index !1306

; <label>:166                                     ; preds = %156
  %167 = load i32* %memcnt, align 4, !llfi_index !1307
  %168 = sext i32 %167 to i64, !llfi_index !1308
  %169 = add i64 %168, 4, !llfi_index !1309
  %170 = trunc i64 %169 to i32, !llfi_index !1310
  store i32 %170, i32* %memcnt, align 4, !llfi_index !1311
  br label %171, !llfi_index !1312

; <label>:171                                     ; preds = %166
  %172 = load i32* %j, align 4, !llfi_index !1313
  %173 = add nsw i32 %172, 1, !llfi_index !1314
  store i32 %173, i32* %j, align 4, !llfi_index !1315
  br label %131, !llfi_index !1316

; <label>:174                                     ; preds = %131
  br label %175, !llfi_index !1317

; <label>:175                                     ; preds = %174
  %176 = load i32* %i, align 4, !llfi_index !1318
  %177 = add nsw i32 %176, 1, !llfi_index !1319
  store i32 %177, i32* %i, align 4, !llfi_index !1320
  br label %126, !llfi_index !1321

; <label>:178                                     ; preds = %126
  %179 = load i8** %mem, align 8, !llfi_index !1322
  %180 = load i32* %n2, align 4, !llfi_index !1323
  %181 = add nsw i32 %180, 1, !llfi_index !1324
  %182 = load i32* %n3, align 4, !llfi_index !1325
  %183 = add nsw i32 %182, 1, !llfi_index !1326
  %184 = mul nsw i32 %181, %183, !llfi_index !1327
  %185 = zext i32 %184 to i64, !llfi_index !1328
  %186 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1329
  %187 = call i64 @fwrite(i8* %179, i64 4, i64 %185, %struct._IO_FILE* %186), !llfi_index !1330
  %188 = load i8** %mem, align 8, !llfi_index !1331
  call void @free(i8* %188) #6, !llfi_index !1332
  %189 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1333
  %190 = call i32 @fclose(%struct._IO_FILE* %189), !llfi_index !1334
