...
; <label>:34                                      ; preds = %checkBb6, %27
  ...
  %check_cmp7 = icmp eq float** %36, %37
...
; <label>:38                                      ; preds = %checkBb8, %34
  %39 = getelementptr inbounds float** %36, i64 %35, !llfi_index !242
...
; <label>:9                                       ; preds = %73, %0
  ...
  br i1 %12, label %13, label %76, !llfi_index !880
...
; <label>:14                                      ; preds = %69, %13
  ...
  br i1 %17, label %18, label %72, !llfi_index !886
...
; <label>:18                                      ; preds = %14
  ...
  %56 = load float* %54, align 4, !llfi_index !924
  %57 = fadd float %55, %46, !llfi_index !925
  %58 = fadd float %56, %46, !llfi_index !925
  %check_cmp = fcmp ueq float %57, %58
  br i1 %check_cmp, label %59, label %checkBb

checkBb:                                          ; preds = %18
  call void @check_flag()
  br label %59

; <label>:59                                      ; preds = %checkBb, %18
  store float %57, float* %54, align 4, !llfi_index !926
  %60 = load float* %new_dw, align 4, !llfi_index !927
  %61 = load i32* %j, align 4, !llfi_index !928
  %62 = sext i32 %61 to i64, !llfi_index !929
  %63 = load i32* %k, align 4, !llfi_index !930
  %64 = sext i32 %63 to i64, !llfi_index !931
  %65 = load float*** %6, align 8, !llfi_index !932
  %66 = getelementptr inbounds float** %65, i64 %64, !llfi_index !933
  %67 = load float** %66, align 8, !llfi_index !934
  %68 = getelementptr inbounds float* %67, i64 %62, !llfi_index !935
  store float %60, float* %68, align 4, !llfi_index !936
  br label %69, !llfi_index !937

; <label>:69                                      ; preds = %59
  %70 = load i32* %k, align 4, !llfi_index !938
  %71 = add nsw i32 %70, 1, !llfi_index !939
  store i32 %71, i32* %k, align 4, !llfi_index !940
  br label %14, !llfi_index !941

; <label>:72                                      ; preds = %14
  br label %73, !llfi_index !942

; <label>:73                                      ; preds = %72
  %74 = load i32* %j, align 4, !llfi_index !943
  %75 = add nsw i32 %74, 1, !llfi_index !944
  store i32 %75, i32* %j, align 4, !llfi_index !945
...
; <label>:46                                      ; preds = %checkBb, %41
  br i1 %44, label %47, label %134, !llfi_index !1172
...
; <label>:48                                      ; preds = %126, %47
  ...
  %51 = icmp sle i32 %49, %50, !llfi_index !1177
...
; <label>:53                                      ; preds = %checkBb2, %48
  br i1 %51, label %54, label %127, !llfi_index !1178
...
; <label>:54                                      ; preds = %53
  ...
  %61 = sext i32 %59 to i64, !llfi_index !1182
  %62 = sext i32 %60 to i64, !llfi_index !1182
  %check_cmp3 = icmp eq i64 %61, %62
...
; <label>:63                                      ; preds = %checkBb4, %54
  %64 = load float*** %w, align 8, !llfi_index !1183
  %65 = getelementptr inbounds float** %64, i64 %61, !llfi_index !1184
  %66 = load float** %65, align 8, !llfi_index !1185
  %67 = load float** %65, align 8, !llfi_index !1185
  %68 = getelementptr inbounds float* %66, i64 %57, !llfi_index !1186
  ...
  %check_cmp5 = fcmp ueq float %70, %71
...
; <label>:90                                      ; preds = %checkBb12, %85
  br i1 %88, label %91, label %111, !llfi_index !1202
...
; <label>:104                                     ; preds = %checkBb18, %99
  store i8* %102, i8** %_to, align 8, !llfi_index !1209
  store i8 %97, i8* %100, align 1, !llfi_index !1210
  br label %105, !llfi_index !1211
...
; <label>:105                                     ; preds = %104
  ...
  %check_cmp19 = icmp eq i32 %108, %109
...
; <label>:110                                     ; preds = %checkBb20, %105
  store i32 %108, i32* %_i, align 4, !llfi_index !1214
  br label %85, !llfi_index !1215
...
; <label>:111                                     ; preds = %90
  ...
  %check_cmp21 = icmp eq i32 %118, %119
...
; <label>:120                                     ; preds = %checkBb22, %111
  store i32 %118, i32* %memcnt, align 4, !llfi_index !1220
  br label %121, !llfi_index !1221
...
; <label>:126                                     ; preds = %checkBb24, %121
  store i32 %124, i32* %j, align 4, !llfi_index !1224
  br label %48, !llfi_index !1225

; <label>:127                                     ; preds = %53
  br label %128, !llfi_index !1226
...
; <label>:128                                     ; preds = %127
  ...
  %check_cmp25 = icmp eq i32 %131, %132
...
; <label>:133                                     ; preds = %checkBb26, %128
  store i32 %131, i32* %i, align 4, !llfi_index !1229
  br label %41, !llfi_index !1230

; <label>:134                                     ; preds = %46
  %135 = load i8** %mem, align 8, !llfi_index !1231
  %136 = load i32* %n1, align 4, !llfi_index !1232
  %137 = add nsw i32 %136, 1, !llfi_index !1233
  %138 = load i32* %n2, align 4, !llfi_index !1234
  %139 = add nsw i32 %138, 1, !llfi_index !1235
  %140 = mul nsw i32 %137, %139, !llfi_index !1236
  %141 = zext i32 %140 to i64, !llfi_index !1237
  %142 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1238
  %143 = call i64 @fwrite(i8* %135, i64 4, i64 %141, %struct._IO_FILE* %142), !llfi_index !1239
  %144 = load i8** %mem, align 8, !llfi_index !1240
  call void @free(i8* %144) #6, !llfi_index !1241
  store i32 0, i32* %memcnt, align 4, !llfi_index !1242
  %145 = load %struct.BPNN** %1, align 8, !llfi_index !1243
  %146 = getelementptr inbounds %struct.BPNN* %145, i32 0, i32 10, !llfi_index !1244
  %147 = load float*** %146, align 8, !llfi_index !1245
  store float** %147, float*** %w, align 8, !llfi_index !1246
  %148 = load i32* %n2, align 4, !llfi_index !1247
  %149 = add nsw i32 %148, 1, !llfi_index !1248
  %150 = load i32* %n3, align 4, !llfi_index !1249
  %151 = add nsw i32 %150, 1, !llfi_index !1250
  %152 = mul nsw i32 %149, %151, !llfi_index !1251
  %153 = sext i32 %152 to i64, !llfi_index !1252
  %154 = mul i64 %153, 4, !llfi_index !1253
  %155 = trunc i64 %154 to i32, !llfi_index !1254
  %156 = zext i32 %155 to i64, !llfi_index !1255
  %157 = call noalias i8* @malloc(i64 %156) #6, !llfi_index !1256
  store i8* %157, i8** %mem, align 8, !llfi_index !1257
  store i32 0, i32* %i, align 4, !llfi_index !1258
  br label %158, !llfi_index !1259

; <label>:158                                     ; preds = %204, %134
  %159 = load i32* %i, align 4, !llfi_index !1260
  %160 = load i32* %n2, align 4, !llfi_index !1261
  %161 = icmp sle i32 %159, %160, !llfi_index !1262
  br i1 %161, label %162, label %207, !llfi_index !1263

; <label>:162                                     ; preds = %158
  store i32 0, i32* %j, align 4, !llfi_index !1264
  br label %163, !llfi_index !1265

; <label>:163                                     ; preds = %200, %162
  %164 = load i32* %j, align 4, !llfi_index !1266
  %165 = load i32* %n3, align 4, !llfi_index !1267
  %166 = icmp sle i32 %164, %165, !llfi_index !1268
  br i1 %166, label %167, label %203, !llfi_index !1269

; <label>:167                                     ; preds = %163
  %168 = load i32* %j, align 4, !llfi_index !1270
  %169 = sext i32 %168 to i64, !llfi_index !1271
  %170 = load i32* %i, align 4, !llfi_index !1272
  %171 = sext i32 %170 to i64, !llfi_index !1273
  %172 = load float*** %w, align 8, !llfi_index !1274
  %173 = getelementptr inbounds float** %172, i64 %171, !llfi_index !1275
  %174 = load float** %173, align 8, !llfi_index !1276
  %175 = getelementptr inbounds float* %174, i64 %169, !llfi_index !1277
  %176 = load float* %175, align 4, !llfi_index !1278
  store float %176, float* %dvalue, align 4, !llfi_index !1279
  %177 = load i32* %memcnt, align 4, !llfi_index !1280
  %178 = sext i32 %177 to i64, !llfi_index !1281
  %179 = load i8** %mem, align 8, !llfi_index !1282
  %180 = getelementptr inbounds i8* %179, i64 %178, !llfi_index !1283
  store i8* %180, i8** %_to1, align 8, !llfi_index !1284
  %181 = bitcast float* %dvalue to i8*, !llfi_index !1285
  store i8* %181, i8** %_from2, align 8, !llfi_index !1286
  store i32 4, i32* %_l4, align 4, !llfi_index !1287
  store i32 0, i32* %_i3, align 4, !llfi_index !1288
  br label %182, !llfi_index !1289

; <label>:182                                     ; preds = %192, %167
  %183 = load i32* %_i3, align 4, !llfi_index !1290
  %184 = load i32* %_l4, align 4, !llfi_index !1291
  %185 = icmp slt i32 %183, %184, !llfi_index !1292
  br i1 %185, label %186, label %195, !llfi_index !1293

; <label>:186                                     ; preds = %182
  %187 = load i8** %_from2, align 8, !llfi_index !1294
  %188 = getelementptr inbounds i8* %187, i32 1, !llfi_index !1295
  store i8* %188, i8** %_from2, align 8, !llfi_index !1296
  %189 = load i8* %187, align 1, !llfi_index !1297
  %190 = load i8** %_to1, align 8, !llfi_index !1298
  %191 = getelementptr inbounds i8* %190, i32 1, !llfi_index !1299
  store i8* %191, i8** %_to1, align 8, !llfi_index !1300
  store i8 %189, i8* %190, align 1, !llfi_index !1301
  br label %192, !llfi_index !1302

; <label>:192                                     ; preds = %186
  %193 = load i32* %_i3, align 4, !llfi_index !1303
  %194 = add nsw i32 %193, 1, !llfi_index !1304
  store i32 %194, i32* %_i3, align 4, !llfi_index !1305
  br label %182, !llfi_index !1306

; <label>:195                                     ; preds = %182
  %196 = load i32* %memcnt, align 4, !llfi_index !1307
  %197 = sext i32 %196 to i64, !llfi_index !1308
  %198 = add i64 %197, 4, !llfi_index !1309
  %199 = trunc i64 %198 to i32, !llfi_index !1310
  store i32 %199, i32* %memcnt, align 4, !llfi_index !1311
  br label %200, !llfi_index !1312

; <label>:200                                     ; preds = %195
  %201 = load i32* %j, align 4, !llfi_index !1313
  %202 = add nsw i32 %201, 1, !llfi_index !1314
  store i32 %202, i32* %j, align 4, !llfi_index !1315
  br label %163, !llfi_index !1316

; <label>:203                                     ; preds = %163
  br label %204, !llfi_index !1317

; <label>:204                                     ; preds = %203
  %205 = load i32* %i, align 4, !llfi_index !1318
  %206 = add nsw i32 %205, 1, !llfi_index !1319
  store i32 %206, i32* %i, align 4, !llfi_index !1320
  br label %158, !llfi_index !1321

; <label>:207                                     ; preds = %158
  %208 = load i8** %mem, align 8, !llfi_index !1322
  %209 = load i32* %n2, align 4, !llfi_index !1323
  %210 = add nsw i32 %209, 1, !llfi_index !1324
  %211 = load i32* %n3, align 4, !llfi_index !1325
  %212 = add nsw i32 %211, 1, !llfi_index !1326
  %213 = mul nsw i32 %210, %212, !llfi_index !1327
  %214 = zext i32 %213 to i64, !llfi_index !1328
  %215 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1329
  %216 = call i64 @fwrite(i8* %208, i64 4, i64 %214, %struct._IO_FILE* %215), !llfi_index !1330
  %217 = load i8** %mem, align 8, !llfi_index !1331
  call void @free(i8* %217) #6, !llfi_index !1332
  %218 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1333
  %219 = call i32 @fclose(%struct._IO_FILE* %218), !llfi_index !1334
