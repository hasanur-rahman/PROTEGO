...
; <label>:47                                      ; preds = %checkBb, %41
  br i1 %45, label %48, label %104, !llfi_index !1172
...
; <label>:56                                      ; preds = %checkBb2, %49
  br i1 %54, label %57, label %100, !llfi_index !1178

; <label>:57                                      ; preds = %56
  %58 = load i32* %j, align 4, !llfi_index !1179
  %59 = sext i32 %58 to i64, !llfi_index !1180
  %60 = load i32* %i, align 4, !llfi_index !1181
  %61 = sext i32 %60 to i64, !llfi_index !1182
  %62 = load float*** %w, align 8, !llfi_index !1183
  %63 = getelementptr inbounds float** %62, i64 %61, !llfi_index !1184
  %64 = load float** %63, align 8, !llfi_index !1185
  %65 = getelementptr inbounds float* %64, i64 %59, !llfi_index !1186
  %66 = load float* %65, align 4, !llfi_index !1187
  %67 = load float* %65, align 4, !llfi_index !1187
  %check_cmp3 = fcmp ueq float %66, %67
...
; <label>:74                                      ; preds = %89, %68
  ...
  %78 = icmp slt i32 %75, %76, !llfi_index !1201
  %79 = icmp slt i32 %75, %77, !llfi_index !1201
...
; <label>:80                                      ; preds = %checkBb6, %74
  br i1 %78, label %81, label %92, !llfi_index !1202

; <label>:81                                      ; preds = %80
  %82 = load i8** %_from, align 8, !llfi_index !1203
  %83 = getelementptr inbounds i8* %82, i32 1, !llfi_index !1204
  store i8* %83, i8** %_from, align 8, !llfi_index !1205
  %84 = load i8* %82, align 1, !llfi_index !1206
  %85 = load i8* %82, align 1, !llfi_index !1206
...
; <label>:86                                      ; preds = %checkBb8, %81
  %87 = load i8** %_to, align 8, !llfi_index !1207
  %88 = getelementptr inbounds i8* %87, i32 1, !llfi_index !1208
  store i8* %88, i8** %_to, align 8, !llfi_index !1209
  store i8 %84, i8* %87, align 1, !llfi_index !1210
  br label %89, !llfi_index !1211

; <label>:89                                      ; preds = %86
  %90 = load i32* %_i, align 4, !llfi_index !1212
  %91 = add nsw i32 %90, 1, !llfi_index !1213
  store i32 %91, i32* %_i, align 4, !llfi_index !1214
  br label %74, !llfi_index !1215

; <label>:92                                      ; preds = %80
  %93 = load i32* %memcnt, align 4, !llfi_index !1216
  %94 = sext i32 %93 to i64, !llfi_index !1217
...
; <label>:97                                      ; preds = %92
  ...
  %99 = add nsw i32 %98, 1, !llfi_index !1223
  store i32 %99, i32* %j, align 4, !llfi_index !1224
  br label %49, !llfi_index !1225

; <label>:100                                     ; preds = %56
  br label %101, !llfi_index !1226

; <label>:101                                     ; preds = %100
  %102 = load i32* %i, align 4, !llfi_index !1227
  %103 = add nsw i32 %102, 1, !llfi_index !1228
  store i32 %103, i32* %i, align 4, !llfi_index !1229
  br label %41, !llfi_index !1230

; <label>:104                                     ; preds = %47
  %105 = load i8** %mem, align 8, !llfi_index !1231
  %106 = load i32* %n1, align 4, !llfi_index !1232
  %107 = add nsw i32 %106, 1, !llfi_index !1233
  %108 = load i32* %n2, align 4, !llfi_index !1234
  %109 = add nsw i32 %108, 1, !llfi_index !1235
  %110 = mul nsw i32 %107, %109, !llfi_index !1236
  %111 = zext i32 %110 to i64, !llfi_index !1237
  %112 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1238
  %113 = call i64 @fwrite(i8* %105, i64 4, i64 %111, %struct._IO_FILE* %112), !llfi_index !1239
  %114 = load i8** %mem, align 8, !llfi_index !1240
  call void @free(i8* %114) #6, !llfi_index !1241
  store i32 0, i32* %memcnt, align 4, !llfi_index !1242
  %115 = load %struct.BPNN** %1, align 8, !llfi_index !1243
  %116 = getelementptr inbounds %struct.BPNN* %115, i32 0, i32 10, !llfi_index !1244
  %117 = load float*** %116, align 8, !llfi_index !1245
  store float** %117, float*** %w, align 8, !llfi_index !1246
  %118 = load i32* %n2, align 4, !llfi_index !1247
  %119 = add nsw i32 %118, 1, !llfi_index !1248
  %120 = load i32* %n3, align 4, !llfi_index !1249
  %121 = add nsw i32 %120, 1, !llfi_index !1250
  %122 = mul nsw i32 %119, %121, !llfi_index !1251
  %123 = sext i32 %122 to i64, !llfi_index !1252
  %124 = mul i64 %123, 4, !llfi_index !1253
  %125 = trunc i64 %124 to i32, !llfi_index !1254
  %126 = zext i32 %125 to i64, !llfi_index !1255
  %127 = call noalias i8* @malloc(i64 %126) #6, !llfi_index !1256
  store i8* %127, i8** %mem, align 8, !llfi_index !1257
  store i32 0, i32* %i, align 4, !llfi_index !1258
  br label %128, !llfi_index !1259

; <label>:128                                     ; preds = %174, %104
  %129 = load i32* %i, align 4, !llfi_index !1260
  %130 = load i32* %n2, align 4, !llfi_index !1261
  %131 = icmp sle i32 %129, %130, !llfi_index !1262
  br i1 %131, label %132, label %177, !llfi_index !1263
...
; <label>:133                                     ; preds = %170, %132
  ...
  %135 = load i32* %n3, align 4, !llfi_index !1267
  %136 = icmp sle i32 %134, %135, !llfi_index !1268
  br i1 %136, label %137, label %173, !llfi_index !1269

; <label>:137                                     ; preds = %133
  %138 = load i32* %j, align 4, !llfi_index !1270
  %139 = sext i32 %138 to i64, !llfi_index !1271
  %140 = load i32* %i, align 4, !llfi_index !1272
  %141 = sext i32 %140 to i64, !llfi_index !1273
  %142 = load float*** %w, align 8, !llfi_index !1274
  %143 = getelementptr inbounds float** %142, i64 %141, !llfi_index !1275
  %144 = load float** %143, align 8, !llfi_index !1276
  %145 = getelementptr inbounds float* %144, i64 %139, !llfi_index !1277
  %146 = load float* %145, align 4, !llfi_index !1278
  store float %146, float* %dvalue, align 4, !llfi_index !1279
  %147 = load i32* %memcnt, align 4, !llfi_index !1280
  %148 = sext i32 %147 to i64, !llfi_index !1281
  %149 = load i8** %mem, align 8, !llfi_index !1282
  %150 = getelementptr inbounds i8* %149, i64 %148, !llfi_index !1283
  store i8* %150, i8** %_to1, align 8, !llfi_index !1284
  %151 = bitcast float* %dvalue to i8*, !llfi_index !1285
  store i8* %151, i8** %_from2, align 8, !llfi_index !1286
  store i32 4, i32* %_l4, align 4, !llfi_index !1287
  store i32 0, i32* %_i3, align 4, !llfi_index !1288
  br label %152, !llfi_index !1289

; <label>:152                                     ; preds = %162, %137
  %153 = load i32* %_i3, align 4, !llfi_index !1290
  %154 = load i32* %_l4, align 4, !llfi_index !1291
  %155 = icmp slt i32 %153, %154, !llfi_index !1292
  br i1 %155, label %156, label %165, !llfi_index !1293

; <label>:156                                     ; preds = %152
  %157 = load i8** %_from2, align 8, !llfi_index !1294
  %158 = getelementptr inbounds i8* %157, i32 1, !llfi_index !1295
  store i8* %158, i8** %_from2, align 8, !llfi_index !1296
  %159 = load i8* %157, align 1, !llfi_index !1297
  %160 = load i8** %_to1, align 8, !llfi_index !1298
  %161 = getelementptr inbounds i8* %160, i32 1, !llfi_index !1299
  store i8* %161, i8** %_to1, align 8, !llfi_index !1300
  store i8 %159, i8* %160, align 1, !llfi_index !1301
  br label %162, !llfi_index !1302

; <label>:162                                     ; preds = %156
  %163 = load i32* %_i3, align 4, !llfi_index !1303
  %164 = add nsw i32 %163, 1, !llfi_index !1304
  store i32 %164, i32* %_i3, align 4, !llfi_index !1305
  br label %152, !llfi_index !1306

; <label>:165                                     ; preds = %152
  %166 = load i32* %memcnt, align 4, !llfi_index !1307
  %167 = sext i32 %166 to i64, !llfi_index !1308
  %168 = add i64 %167, 4, !llfi_index !1309
  %169 = trunc i64 %168 to i32, !llfi_index !1310
  store i32 %169, i32* %memcnt, align 4, !llfi_index !1311
  br label %170, !llfi_index !1312

; <label>:170                                     ; preds = %165
  %171 = load i32* %j, align 4, !llfi_index !1313
  %172 = add nsw i32 %171, 1, !llfi_index !1314
  store i32 %172, i32* %j, align 4, !llfi_index !1315
  br label %133, !llfi_index !1316

; <label>:173                                     ; preds = %133
  br label %174, !llfi_index !1317

; <label>:174                                     ; preds = %173
  %175 = load i32* %i, align 4, !llfi_index !1318
  %176 = add nsw i32 %175, 1, !llfi_index !1319
  store i32 %176, i32* %i, align 4, !llfi_index !1320
  br label %128, !llfi_index !1321

; <label>:177                                     ; preds = %128
  %178 = load i8** %mem, align 8, !llfi_index !1322
  %179 = load i32* %n2, align 4, !llfi_index !1323
  %180 = add nsw i32 %179, 1, !llfi_index !1324
  %181 = load i32* %n3, align 4, !llfi_index !1325
  %182 = add nsw i32 %181, 1, !llfi_index !1326
  %183 = mul nsw i32 %180, %182, !llfi_index !1327
  %184 = zext i32 %183 to i64, !llfi_index !1328
  %185 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1329
  %186 = call i64 @fwrite(i8* %178, i64 4, i64 %184, %struct._IO_FILE* %185), !llfi_index !1330
  %187 = load i8** %mem, align 8, !llfi_index !1331
  call void @free(i8* %187) #6, !llfi_index !1332
  %188 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1333
  %189 = call i32 @fclose(%struct._IO_FILE* %188), !llfi_index !1334
