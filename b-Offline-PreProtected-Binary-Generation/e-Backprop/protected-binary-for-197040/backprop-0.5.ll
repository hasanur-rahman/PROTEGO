...
; <label>:167                                     ; preds = %207, %166
  ...
  br i1 %170, label %171, label %210, !llfi_index !1269
...
; <label>:192                                     ; preds = %checkBb26, %186
  br i1 %190, label %193, label %202, !llfi_index !1293

; <label>:193                                     ; preds = %192
  %194 = load i8** %_from2, align 8, !llfi_index !1294
  %195 = getelementptr inbounds i8* %194, i32 1, !llfi_index !1295
  store i8* %195, i8** %_from2, align 8, !llfi_index !1296
  %196 = load i8* %194, align 1, !llfi_index !1297
  %197 = load i8** %_to1, align 8, !llfi_index !1298
  %198 = getelementptr inbounds i8* %197, i32 1, !llfi_index !1299
  store i8* %198, i8** %_to1, align 8, !llfi_index !1300
  store i8 %196, i8* %197, align 1, !llfi_index !1301
  br label %199, !llfi_index !1302

; <label>:199                                     ; preds = %193
  %200 = load i32* %_i3, align 4, !llfi_index !1303
  %201 = add nsw i32 %200, 1, !llfi_index !1304
  store i32 %201, i32* %_i3, align 4, !llfi_index !1305
  br label %186, !llfi_index !1306

; <label>:202                                     ; preds = %192
  %203 = load i32* %memcnt, align 4, !llfi_index !1307
  %204 = sext i32 %203 to i64, !llfi_index !1308
  %205 = add i64 %204, 4, !llfi_index !1309
  %206 = trunc i64 %205 to i32, !llfi_index !1310
  store i32 %206, i32* %memcnt, align 4, !llfi_index !1311
  br label %207, !llfi_index !1312

; <label>:207                                     ; preds = %202
  %208 = load i32* %j, align 4, !llfi_index !1313
  %209 = add nsw i32 %208, 1, !llfi_index !1314
  store i32 %209, i32* %j, align 4, !llfi_index !1315
  br label %167, !llfi_index !1316

; <label>:210                                     ; preds = %167
  br label %211, !llfi_index !1317

; <label>:211                                     ; preds = %210
  %212 = load i32* %i, align 4, !llfi_index !1318
  %213 = add nsw i32 %212, 1, !llfi_index !1319
  store i32 %213, i32* %i, align 4, !llfi_index !1320
  br label %162, !llfi_index !1321

; <label>:214                                     ; preds = %162
  %215 = load i8** %mem, align 8, !llfi_index !1322
  %216 = load i32* %n2, align 4, !llfi_index !1323
  %217 = add nsw i32 %216, 1, !llfi_index !1324
  %218 = load i32* %n3, align 4, !llfi_index !1325
  %219 = add nsw i32 %218, 1, !llfi_index !1326
  %220 = mul nsw i32 %217, %219, !llfi_index !1327
  %221 = zext i32 %220 to i64, !llfi_index !1328
  %222 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1329
  %223 = call i64 @fwrite(i8* %215, i64 4, i64 %221, %struct._IO_FILE* %222), !llfi_index !1330
  %224 = load i8** %mem, align 8, !llfi_index !1331
  call void @free(i8* %224) #6, !llfi_index !1332
  %225 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1333
  %226 = call i32 @fclose(%struct._IO_FILE* %225), !llfi_index !1334
