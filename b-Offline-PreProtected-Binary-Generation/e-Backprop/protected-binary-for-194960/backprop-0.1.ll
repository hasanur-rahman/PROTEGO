...
; <label>:136                                     ; preds = %176, %135
  ...
  br i1 %139, label %140, label %179, !llfi_index !1269
...
; <label>:161                                     ; preds = %checkBb14, %155
  br i1 %159, label %162, label %171, !llfi_index !1293
...
; <label>:162                                     ; preds = %161
  ...
  %166 = load i8** %_to1, align 8, !llfi_index !1298
  %167 = getelementptr inbounds i8* %166, i32 1, !llfi_index !1299
  store i8* %167, i8** %_to1, align 8, !llfi_index !1300
  store i8 %165, i8* %166, align 1, !llfi_index !1301
  br label %168, !llfi_index !1302

; <label>:168                                     ; preds = %162
  %169 = load i32* %_i3, align 4, !llfi_index !1303
  %170 = add nsw i32 %169, 1, !llfi_index !1304
  store i32 %170, i32* %_i3, align 4, !llfi_index !1305
  br label %155, !llfi_index !1306

; <label>:171                                     ; preds = %161
  %172 = load i32* %memcnt, align 4, !llfi_index !1307
  %173 = sext i32 %172 to i64, !llfi_index !1308
  %174 = add i64 %173, 4, !llfi_index !1309
  %175 = trunc i64 %174 to i32, !llfi_index !1310
  store i32 %175, i32* %memcnt, align 4, !llfi_index !1311
  br label %176, !llfi_index !1312

; <label>:176                                     ; preds = %171
  %177 = load i32* %j, align 4, !llfi_index !1313
  %178 = add nsw i32 %177, 1, !llfi_index !1314
  store i32 %178, i32* %j, align 4, !llfi_index !1315
  br label %136, !llfi_index !1316

; <label>:179                                     ; preds = %136
  br label %180, !llfi_index !1317

; <label>:180                                     ; preds = %179
  %181 = load i32* %i, align 4, !llfi_index !1318
  %182 = add nsw i32 %181, 1, !llfi_index !1319
  store i32 %182, i32* %i, align 4, !llfi_index !1320
  br label %131, !llfi_index !1321

; <label>:183                                     ; preds = %131
  %184 = load i8** %mem, align 8, !llfi_index !1322
  %185 = load i32* %n2, align 4, !llfi_index !1323
  %186 = add nsw i32 %185, 1, !llfi_index !1324
  %187 = load i32* %n3, align 4, !llfi_index !1325
  %188 = add nsw i32 %187, 1, !llfi_index !1326
  %189 = mul nsw i32 %186, %188, !llfi_index !1327
  %190 = zext i32 %189 to i64, !llfi_index !1328
  %191 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1329
  %192 = call i64 @fwrite(i8* %184, i64 4, i64 %190, %struct._IO_FILE* %191), !llfi_index !1330
  %193 = load i8** %mem, align 8, !llfi_index !1331
  call void @free(i8* %193) #6, !llfi_index !1332
  %194 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1333
  %195 = call i32 @fclose(%struct._IO_FILE* %194), !llfi_index !1334
