...
; <label>:47                                      ; preds = %checkBb, %41
  br i1 %45, label %48, label %113, !llfi_index !1172
...
; <label>:56                                      ; preds = %checkBb2, %49
  br i1 %54, label %57, label %106, !llfi_index !1178
...
; <label>:74                                      ; preds = %94, %68
  ...
  %78 = icmp slt i32 %75, %77, !llfi_index !1201
  %79 = icmp slt i32 %76, %77, !llfi_index !1201
...
; <label>:80                                      ; preds = %checkBb6, %74
  br i1 %78, label %81, label %95, !llfi_index !1202
...
; <label>:89                                      ; preds = %86
  ...
  %91 = load i32* %_i, align 4, !llfi_index !1212
  %92 = add nsw i32 %90, 1, !llfi_index !1213
  %93 = add nsw i32 %91, 1, !llfi_index !1213
...
; <label>:94                                      ; preds = %checkBb10, %89
  store i32 %92, i32* %_i, align 4, !llfi_index !1214
  br label %74, !llfi_index !1215

; <label>:95                                      ; preds = %80
  %96 = load i32* %memcnt, align 4, !llfi_index !1216
  %97 = sext i32 %96 to i64, !llfi_index !1217
  %98 = add i64 %97, 4, !llfi_index !1218
  %99 = trunc i64 %98 to i32, !llfi_index !1219
  store i32 %99, i32* %memcnt, align 4, !llfi_index !1220
  br label %100, !llfi_index !1221

; <label>:100                                     ; preds = %95
  %101 = load i32* %j, align 4, !llfi_index !1222
  %102 = load i32* %j, align 4, !llfi_index !1222
  %103 = add nsw i32 %101, 1, !llfi_index !1223
  %104 = add nsw i32 %102, 1, !llfi_index !1223
  %check_cmp11 = icmp eq i32 %103, %104
...
; <label>:105                                     ; preds = %checkBb12, %100
  store i32 %103, i32* %j, align 4, !llfi_index !1224
  br label %49, !llfi_index !1225

; <label>:106                                     ; preds = %56
  br label %107, !llfi_index !1226

; <label>:107                                     ; preds = %106
  %108 = load i32* %i, align 4, !llfi_index !1227
  %109 = load i32* %i, align 4, !llfi_index !1227
  %110 = add nsw i32 %108, 1, !llfi_index !1228
  %111 = add nsw i32 %109, 1, !llfi_index !1228
...
; <label>:112                                     ; preds = %checkBb14, %107
  store i32 %110, i32* %i, align 4, !llfi_index !1229
  br label %41, !llfi_index !1230

; <label>:113                                     ; preds = %47
  %114 = load i8** %mem, align 8, !llfi_index !1231
  %115 = load i32* %n1, align 4, !llfi_index !1232
  %116 = add nsw i32 %115, 1, !llfi_index !1233
  %117 = load i32* %n2, align 4, !llfi_index !1234
  %118 = add nsw i32 %117, 1, !llfi_index !1235
  %119 = mul nsw i32 %116, %118, !llfi_index !1236
  %120 = zext i32 %119 to i64, !llfi_index !1237
  %121 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1238
  %122 = call i64 @fwrite(i8* %114, i64 4, i64 %120, %struct._IO_FILE* %121), !llfi_index !1239
  %123 = load i8** %mem, align 8, !llfi_index !1240
  call void @free(i8* %123) #6, !llfi_index !1241
  store i32 0, i32* %memcnt, align 4, !llfi_index !1242
  %124 = load %struct.BPNN** %1, align 8, !llfi_index !1243
  %125 = getelementptr inbounds %struct.BPNN* %124, i32 0, i32 10, !llfi_index !1244
  %126 = load float*** %125, align 8, !llfi_index !1245
  store float** %126, float*** %w, align 8, !llfi_index !1246
  %127 = load i32* %n2, align 4, !llfi_index !1247
  %128 = add nsw i32 %127, 1, !llfi_index !1248
  %129 = load i32* %n3, align 4, !llfi_index !1249
  %130 = add nsw i32 %129, 1, !llfi_index !1250
  %131 = mul nsw i32 %128, %130, !llfi_index !1251
  %132 = sext i32 %131 to i64, !llfi_index !1252
  %133 = mul i64 %132, 4, !llfi_index !1253
  %134 = trunc i64 %133 to i32, !llfi_index !1254
  %135 = zext i32 %134 to i64, !llfi_index !1255
  %136 = call noalias i8* @malloc(i64 %135) #6, !llfi_index !1256
  store i8* %136, i8** %mem, align 8, !llfi_index !1257
  store i32 0, i32* %i, align 4, !llfi_index !1258
  br label %137, !llfi_index !1259

; <label>:137                                     ; preds = %186, %113
  %138 = load i32* %i, align 4, !llfi_index !1260
  %139 = load i32* %n2, align 4, !llfi_index !1261
  %140 = icmp sle i32 %138, %139, !llfi_index !1262
  br i1 %140, label %141, label %189, !llfi_index !1263

; <label>:141                                     ; preds = %137
  store i32 0, i32* %j, align 4, !llfi_index !1264
  br label %142, !llfi_index !1265

; <label>:142                                     ; preds = %182, %141
  %143 = load i32* %j, align 4, !llfi_index !1266
  %144 = load i32* %n3, align 4, !llfi_index !1267
  %145 = icmp sle i32 %143, %144, !llfi_index !1268
  br i1 %145, label %146, label %185, !llfi_index !1269

; <label>:146                                     ; preds = %142
  %147 = load i32* %j, align 4, !llfi_index !1270
  %148 = sext i32 %147 to i64, !llfi_index !1271
  %149 = load i32* %i, align 4, !llfi_index !1272
  %150 = sext i32 %149 to i64, !llfi_index !1273
  %151 = load float*** %w, align 8, !llfi_index !1274
  %152 = getelementptr inbounds float** %151, i64 %150, !llfi_index !1275
  %153 = load float** %152, align 8, !llfi_index !1276
  %154 = getelementptr inbounds float* %153, i64 %148, !llfi_index !1277
  %155 = load float* %154, align 4, !llfi_index !1278
  store float %155, float* %dvalue, align 4, !llfi_index !1279
  %156 = load i32* %memcnt, align 4, !llfi_index !1280
  %157 = sext i32 %156 to i64, !llfi_index !1281
  %158 = load i8** %mem, align 8, !llfi_index !1282
  %159 = getelementptr inbounds i8* %158, i64 %157, !llfi_index !1283
  store i8* %159, i8** %_to1, align 8, !llfi_index !1284
  %160 = bitcast float* %dvalue to i8*, !llfi_index !1285
  store i8* %160, i8** %_from2, align 8, !llfi_index !1286
  store i32 4, i32* %_l4, align 4, !llfi_index !1287
  store i32 0, i32* %_i3, align 4, !llfi_index !1288
  br label %161, !llfi_index !1289

; <label>:161                                     ; preds = %174, %146
  %162 = load i32* %_i3, align 4, !llfi_index !1290
  %163 = load i32* %_i3, align 4, !llfi_index !1290
  %164 = load i32* %_l4, align 4, !llfi_index !1291
  %165 = icmp slt i32 %162, %164, !llfi_index !1292
  %166 = icmp slt i32 %163, %164, !llfi_index !1292
  %check_cmp15 = icmp eq i1 %165, %166
...
; <label>:167                                     ; preds = %checkBb16, %161
  br i1 %165, label %168, label %177, !llfi_index !1293

; <label>:168                                     ; preds = %167
  %169 = load i8** %_from2, align 8, !llfi_index !1294
  %170 = getelementptr inbounds i8* %169, i32 1, !llfi_index !1295
  store i8* %170, i8** %_from2, align 8, !llfi_index !1296
  %171 = load i8* %169, align 1, !llfi_index !1297
  %172 = load i8** %_to1, align 8, !llfi_index !1298
  %173 = getelementptr inbounds i8* %172, i32 1, !llfi_index !1299
  store i8* %173, i8** %_to1, align 8, !llfi_index !1300
  store i8 %171, i8* %172, align 1, !llfi_index !1301
  br label %174, !llfi_index !1302

; <label>:174                                     ; preds = %168
  %175 = load i32* %_i3, align 4, !llfi_index !1303
  %176 = add nsw i32 %175, 1, !llfi_index !1304
  store i32 %176, i32* %_i3, align 4, !llfi_index !1305
  br label %161, !llfi_index !1306

; <label>:177                                     ; preds = %167
  %178 = load i32* %memcnt, align 4, !llfi_index !1307
  %179 = sext i32 %178 to i64, !llfi_index !1308
  %180 = add i64 %179, 4, !llfi_index !1309
  %181 = trunc i64 %180 to i32, !llfi_index !1310
  store i32 %181, i32* %memcnt, align 4, !llfi_index !1311
  br label %182, !llfi_index !1312

; <label>:182                                     ; preds = %177
  %183 = load i32* %j, align 4, !llfi_index !1313
  %184 = add nsw i32 %183, 1, !llfi_index !1314
  store i32 %184, i32* %j, align 4, !llfi_index !1315
  br label %142, !llfi_index !1316

; <label>:185                                     ; preds = %142
  br label %186, !llfi_index !1317

; <label>:186                                     ; preds = %185
  %187 = load i32* %i, align 4, !llfi_index !1318
  %188 = add nsw i32 %187, 1, !llfi_index !1319
  store i32 %188, i32* %i, align 4, !llfi_index !1320
  br label %137, !llfi_index !1321

; <label>:189                                     ; preds = %137
  %190 = load i8** %mem, align 8, !llfi_index !1322
  %191 = load i32* %n2, align 4, !llfi_index !1323
  %192 = add nsw i32 %191, 1, !llfi_index !1324
  %193 = load i32* %n3, align 4, !llfi_index !1325
  %194 = add nsw i32 %193, 1, !llfi_index !1326
  %195 = mul nsw i32 %192, %194, !llfi_index !1327
  %196 = zext i32 %195 to i64, !llfi_index !1328
  %197 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1329
  %198 = call i64 @fwrite(i8* %190, i64 4, i64 %196, %struct._IO_FILE* %197), !llfi_index !1330
  %199 = load i8** %mem, align 8, !llfi_index !1331
  call void @free(i8* %199) #6, !llfi_index !1332
  %200 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1333
  %201 = call i32 @fclose(%struct._IO_FILE* %200), !llfi_index !1334
...
; <label>:14                                      ; preds = %10
  ...
  %22 = getelementptr inbounds float* %20, i64 %19, !llfi_index !1669
  %check_cmp = icmp eq float* %21, %22
