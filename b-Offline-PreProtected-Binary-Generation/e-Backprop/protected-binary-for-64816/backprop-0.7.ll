...
; <label>:142                                     ; preds = %187, %141
  ...
  br i1 %145, label %146, label %190, !llfi_index !1269
...
; <label>:167                                     ; preds = %checkBb16, %161
  br i1 %165, label %168, label %182, !llfi_index !1293
...
; <label>:168                                     ; preds = %167
  ...
  %172 = load i8* %169, align 1, !llfi_index !1297
  %check_cmp17 = icmp eq i8 %171, %172
...
; <label>:173                                     ; preds = %checkBb18, %168
  ...
  %175 = getelementptr inbounds i8* %174, i32 1, !llfi_index !1299
  store i8* %175, i8** %_to1, align 8, !llfi_index !1300
  store i8 %171, i8* %174, align 1, !llfi_index !1301
  br label %176, !llfi_index !1302

; <label>:176                                     ; preds = %173
  %177 = load i32* %_i3, align 4, !llfi_index !1303
  %178 = load i32* %_i3, align 4, !llfi_index !1303
  %179 = add nsw i32 %177, 1, !llfi_index !1304
  %180 = add nsw i32 %178, 1, !llfi_index !1304
  %check_cmp19 = icmp eq i32 %179, %180
  br i1 %check_cmp19, label %181, label %checkBb20

checkBb20:                                        ; preds = %176
  call void @check_flag()
  br label %181

; <label>:181                                     ; preds = %checkBb20, %176
  store i32 %179, i32* %_i3, align 4, !llfi_index !1305
  br label %161, !llfi_index !1306

; <label>:182                                     ; preds = %167
  %183 = load i32* %memcnt, align 4, !llfi_index !1307
  %184 = sext i32 %183 to i64, !llfi_index !1308
  %185 = add i64 %184, 4, !llfi_index !1309
  %186 = trunc i64 %185 to i32, !llfi_index !1310
  store i32 %186, i32* %memcnt, align 4, !llfi_index !1311
  br label %187, !llfi_index !1312

; <label>:187                                     ; preds = %182
  %188 = load i32* %j, align 4, !llfi_index !1313
  %189 = add nsw i32 %188, 1, !llfi_index !1314
  store i32 %189, i32* %j, align 4, !llfi_index !1315
  br label %142, !llfi_index !1316

; <label>:190                                     ; preds = %142
  br label %191, !llfi_index !1317

; <label>:191                                     ; preds = %190
  %192 = load i32* %i, align 4, !llfi_index !1318
  %193 = add nsw i32 %192, 1, !llfi_index !1319
  store i32 %193, i32* %i, align 4, !llfi_index !1320
  br label %137, !llfi_index !1321

; <label>:194                                     ; preds = %137
  %195 = load i8** %mem, align 8, !llfi_index !1322
  %196 = load i32* %n2, align 4, !llfi_index !1323
  %197 = add nsw i32 %196, 1, !llfi_index !1324
  %198 = load i32* %n3, align 4, !llfi_index !1325
  %199 = add nsw i32 %198, 1, !llfi_index !1326
  %200 = mul nsw i32 %197, %199, !llfi_index !1327
  %201 = zext i32 %200 to i64, !llfi_index !1328
  %202 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1329
  %203 = call i64 @fwrite(i8* %195, i64 4, i64 %201, %struct._IO_FILE* %202), !llfi_index !1330
  %204 = load i8** %mem, align 8, !llfi_index !1331
  call void @free(i8* %204) #6, !llfi_index !1332
  %205 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1333
  %206 = call i32 @fclose(%struct._IO_FILE* %205), !llfi_index !1334
