...
; <label>:47                                      ; preds = %checkBb, %41
  br i1 %45, label %48, label %107, !llfi_index !1172
...
; <label>:55                                      ; preds = %checkBb2, %49
  br i1 %53, label %56, label %100, !llfi_index !1178
...
; <label>:73                                      ; preds = %88, %67
  ...
  br i1 %76, label %77, label %90, !llfi_index !1202
...
; <label>:98                                      ; preds = %checkBb10, %95
  %99 = add nsw i32 %96, 1, !llfi_index !1223
...
; <label>:101                                     ; preds = %100
  ...
  %103 = load i32* %i, align 4, !llfi_index !1227
  %104 = add nsw i32 %102, 1, !llfi_index !1228
  %105 = add nsw i32 %103, 1, !llfi_index !1228
...
; <label>:106                                     ; preds = %checkBb12, %101
  store i32 %104, i32* %i, align 4, !llfi_index !1229
...
; <label>:136                                     ; preds = %181, %135
  ...
  %138 = load i32* %n3, align 4, !llfi_index !1267
  %139 = icmp sle i32 %137, %138, !llfi_index !1268
  br i1 %139, label %140, label %184, !llfi_index !1269

; <label>:140                                     ; preds = %136
  %141 = load i32* %j, align 4, !llfi_index !1270
  %142 = sext i32 %141 to i64, !llfi_index !1271
  %143 = load i32* %i, align 4, !llfi_index !1272
  %144 = sext i32 %143 to i64, !llfi_index !1273
  %145 = load float*** %w, align 8, !llfi_index !1274
  %146 = getelementptr inbounds float** %145, i64 %144, !llfi_index !1275
  %147 = load float** %146, align 8, !llfi_index !1276
  %148 = getelementptr inbounds float* %147, i64 %142, !llfi_index !1277
  %149 = load float* %148, align 4, !llfi_index !1278
  store float %149, float* %dvalue, align 4, !llfi_index !1279
  %150 = load i32* %memcnt, align 4, !llfi_index !1280
  %151 = sext i32 %150 to i64, !llfi_index !1281
  %152 = load i8** %mem, align 8, !llfi_index !1282
  %153 = getelementptr inbounds i8* %152, i64 %151, !llfi_index !1283
  store i8* %153, i8** %_to1, align 8, !llfi_index !1284
  %154 = bitcast float* %dvalue to i8*, !llfi_index !1285
  store i8* %154, i8** %_from2, align 8, !llfi_index !1286
  store i32 4, i32* %_l4, align 4, !llfi_index !1287
  store i32 0, i32* %_i3, align 4, !llfi_index !1288
  br label %155, !llfi_index !1289

; <label>:155                                     ; preds = %175, %140
  %156 = load i32* %_i3, align 4, !llfi_index !1290
  %157 = load i32* %_i3, align 4, !llfi_index !1290
  %158 = load i32* %_l4, align 4, !llfi_index !1291
  %159 = icmp slt i32 %156, %158, !llfi_index !1292
  %160 = icmp slt i32 %157, %158, !llfi_index !1292
  %check_cmp13 = icmp eq i1 %159, %160
  br i1 %check_cmp13, label %161, label %checkBb14

checkBb14:                                        ; preds = %155
  call void @check_flag()
  br label %161

; <label>:161                                     ; preds = %checkBb14, %155
  br i1 %159, label %162, label %176, !llfi_index !1293

; <label>:162                                     ; preds = %161
  %163 = load i8** %_from2, align 8, !llfi_index !1294
  %164 = getelementptr inbounds i8* %163, i32 1, !llfi_index !1295
  store i8* %164, i8** %_from2, align 8, !llfi_index !1296
  %165 = load i8* %163, align 1, !llfi_index !1297
  %166 = load i8* %163, align 1, !llfi_index !1297
  %check_cmp15 = icmp eq i8 %165, %166
...
; <label>:167                                     ; preds = %checkBb16, %162
  %168 = load i8** %_to1, align 8, !llfi_index !1298
  %169 = getelementptr inbounds i8* %168, i32 1, !llfi_index !1299
  store i8* %169, i8** %_to1, align 8, !llfi_index !1300
  store i8 %165, i8* %168, align 1, !llfi_index !1301
  br label %170, !llfi_index !1302

; <label>:170                                     ; preds = %167
  %171 = load i32* %_i3, align 4, !llfi_index !1303
  %172 = load i32* %_i3, align 4, !llfi_index !1303
  %173 = add nsw i32 %171, 1, !llfi_index !1304
  %174 = add nsw i32 %172, 1, !llfi_index !1304
  %check_cmp17 = icmp eq i32 %173, %174
...
; <label>:175                                     ; preds = %checkBb18, %170
  store i32 %173, i32* %_i3, align 4, !llfi_index !1305
  br label %155, !llfi_index !1306

; <label>:176                                     ; preds = %161
  %177 = load i32* %memcnt, align 4, !llfi_index !1307
  %178 = sext i32 %177 to i64, !llfi_index !1308
  %179 = add i64 %178, 4, !llfi_index !1309
  %180 = trunc i64 %179 to i32, !llfi_index !1310
  store i32 %180, i32* %memcnt, align 4, !llfi_index !1311
  br label %181, !llfi_index !1312

; <label>:181                                     ; preds = %176
  %182 = load i32* %j, align 4, !llfi_index !1313
  %183 = add nsw i32 %182, 1, !llfi_index !1314
  store i32 %183, i32* %j, align 4, !llfi_index !1315
  br label %136, !llfi_index !1316

; <label>:184                                     ; preds = %136
  br label %185, !llfi_index !1317

; <label>:185                                     ; preds = %184
  %186 = load i32* %i, align 4, !llfi_index !1318
  %187 = add nsw i32 %186, 1, !llfi_index !1319
  store i32 %187, i32* %i, align 4, !llfi_index !1320
  br label %131, !llfi_index !1321

; <label>:188                                     ; preds = %131
  %189 = load i8** %mem, align 8, !llfi_index !1322
  %190 = load i32* %n2, align 4, !llfi_index !1323
  %191 = add nsw i32 %190, 1, !llfi_index !1324
  %192 = load i32* %n3, align 4, !llfi_index !1325
  %193 = add nsw i32 %192, 1, !llfi_index !1326
  %194 = mul nsw i32 %191, %193, !llfi_index !1327
  %195 = zext i32 %194 to i64, !llfi_index !1328
  %196 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1329
  %197 = call i64 @fwrite(i8* %189, i64 4, i64 %195, %struct._IO_FILE* %196), !llfi_index !1330
  %198 = load i8** %mem, align 8, !llfi_index !1331
  call void @free(i8* %198) #6, !llfi_index !1332
  %199 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1333
  %200 = call i32 @fclose(%struct._IO_FILE* %199), !llfi_index !1334
