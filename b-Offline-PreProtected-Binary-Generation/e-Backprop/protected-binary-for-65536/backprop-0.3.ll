...
; <label>:11                                      ; preds = %checkBb, %4
  br i1 %9, label %12, label %53, !llfi_index !227
...
; <label>:20                                      ; preds = %checkBb2, %13
  br i1 %18, label %21, label %46, !llfi_index !233
...
; <label>:30                                      ; preds = %checkBb6, %27
  %31 = sext i32 %28 to i64, !llfi_index !238
...
; <label>:34                                      ; preds = %checkBb8, %30
  ...
  %39 = getelementptr inbounds float* %38, i64 %31, !llfi_index !244
  store float %25, float* %39, align 4, !llfi_index !245
  br label %40, !llfi_index !246

; <label>:40                                      ; preds = %34
  %41 = load i32* %j, align 4, !llfi_index !247
  %42 = load i32* %j, align 4, !llfi_index !247
  %43 = add nsw i32 %41, 1, !llfi_index !248
  %44 = add nsw i32 %42, 1, !llfi_index !248
...
; <label>:45                                      ; preds = %checkBb10, %40
  store i32 %43, i32* %j, align 4, !llfi_index !249
  br label %13, !llfi_index !250

; <label>:46                                      ; preds = %20
  br label %47, !llfi_index !251

; <label>:47                                      ; preds = %46
  %48 = load i32* %i, align 4, !llfi_index !252
  %49 = load i32* %i, align 4, !llfi_index !252
  %50 = add nsw i32 %48, 1, !llfi_index !253
  %51 = add nsw i32 %49, 1, !llfi_index !253
...
; <label>:52                                      ; preds = %checkBb12, %47
  store i32 %50, i32* %i, align 4, !llfi_index !254
...
; <label>:9                                       ; preds = %78, %0
  ...
  br i1 %12, label %13, label %81, !llfi_index !880
...
; <label>:14                                      ; preds = %74, %13
  ...
  br i1 %17, label %18, label %77, !llfi_index !886
...
; <label>:26                                      ; preds = %checkBb2, %23
  %27 = getelementptr inbounds float* %24, i64 %21, !llfi_index !890
...
; <label>:48                                      ; preds = %127, %47
  ...
  %52 = icmp sle i32 %49, %51, !llfi_index !1177
  %53 = icmp sle i32 %50, %51, !llfi_index !1177
...
; <label>:93                                      ; preds = %checkBb10, %87
  br i1 %91, label %94, label %113, !llfi_index !1202
...
; <label>:99                                      ; preds = %checkBb12, %94
  ...
  %check_cmp13 = icmp eq i8 %100, %101
...
; <label>:102                                     ; preds = %checkBb14, %99
  ...
  %check_cmp15 = icmp eq i8* %103, %104
...
; <label>:105                                     ; preds = %checkBb16, %102
  %106 = getelementptr inbounds i8* %103, i32 1, !llfi_index !1208
  store i8* %106, i8** %_to, align 8, !llfi_index !1209
  store i8 %100, i8* %103, align 1, !llfi_index !1210
  br label %107, !llfi_index !1211
...
; <label>:107                                     ; preds = %105
  ...
  %check_cmp17 = icmp eq i32 %110, %111
  br i1 %check_cmp17, label %112, label %checkBb18

checkBb18:                                        ; preds = %107
  call void @check_flag()
  br label %112

; <label>:112                                     ; preds = %checkBb18, %107
  store i32 %110, i32* %_i, align 4, !llfi_index !1214
...
; <label>:116                                     ; preds = %checkBb20, %113
  %117 = sext i32 %114 to i64, !llfi_index !1217
  %118 = add i64 %117, 4, !llfi_index !1218
  %119 = trunc i64 %118 to i32, !llfi_index !1219
...
; <label>:164                                     ; preds = %215, %163
  ...
  br i1 %167, label %168, label %218, !llfi_index !1269
...
; <label>:183                                     ; preds = %209, %168
  %184 = load i32* %_i3, align 4, !llfi_index !1290
  %185 = load i32* %_i3, align 4, !llfi_index !1290
  %186 = load i32* %_l4, align 4, !llfi_index !1291
  %187 = icmp slt i32 %184, %186, !llfi_index !1292
  %188 = icmp slt i32 %185, %186, !llfi_index !1292
...
; <label>:189                                     ; preds = %checkBb28, %183
  br i1 %187, label %190, label %210, !llfi_index !1293

; <label>:190                                     ; preds = %189
  %191 = load i8** %_from2, align 8, !llfi_index !1294
  %192 = load i8** %_from2, align 8, !llfi_index !1294
  %193 = getelementptr inbounds i8* %191, i32 1, !llfi_index !1295
  %194 = getelementptr inbounds i8* %192, i32 1, !llfi_index !1295
  %check_cmp29 = icmp eq i8* %193, %194
  br i1 %check_cmp29, label %195, label %checkBb30

checkBb30:                                        ; preds = %190
  call void @check_flag()
  br label %195

; <label>:195                                     ; preds = %checkBb30, %190
  store i8* %193, i8** %_from2, align 8, !llfi_index !1296
  %196 = load i8* %191, align 1, !llfi_index !1297
  %197 = load i8* %192, align 1, !llfi_index !1297
...
; <label>:198                                     ; preds = %checkBb32, %195
  %199 = load i8** %_to1, align 8, !llfi_index !1298
  %200 = load i8** %_to1, align 8, !llfi_index !1298
  %201 = getelementptr inbounds i8* %199, i32 1, !llfi_index !1299
  %202 = getelementptr inbounds i8* %200, i32 1, !llfi_index !1299
  %check_cmp33 = icmp eq i8* %201, %202
  br i1 %check_cmp33, label %203, label %checkBb34

checkBb34:                                        ; preds = %198
  call void @check_flag()
  br label %203

; <label>:203                                     ; preds = %checkBb34, %198
  store i8* %201, i8** %_to1, align 8, !llfi_index !1300
  store i8 %196, i8* %199, align 1, !llfi_index !1301
  br label %204, !llfi_index !1302

; <label>:204                                     ; preds = %203
  %205 = load i32* %_i3, align 4, !llfi_index !1303
  %206 = load i32* %_i3, align 4, !llfi_index !1303
  %207 = add nsw i32 %205, 1, !llfi_index !1304
  %208 = add nsw i32 %206, 1, !llfi_index !1304
  %check_cmp35 = icmp eq i32 %207, %208
...
; <label>:209                                     ; preds = %checkBb36, %204
  store i32 %207, i32* %_i3, align 4, !llfi_index !1305
  br label %183, !llfi_index !1306

; <label>:210                                     ; preds = %189
  %211 = load i32* %memcnt, align 4, !llfi_index !1307
  %212 = sext i32 %211 to i64, !llfi_index !1308
  %213 = add i64 %212, 4, !llfi_index !1309
  %214 = trunc i64 %213 to i32, !llfi_index !1310
  store i32 %214, i32* %memcnt, align 4, !llfi_index !1311
  br label %215, !llfi_index !1312

; <label>:215                                     ; preds = %210
  %216 = load i32* %j, align 4, !llfi_index !1313
  %217 = add nsw i32 %216, 1, !llfi_index !1314
  store i32 %217, i32* %j, align 4, !llfi_index !1315
  br label %164, !llfi_index !1316

; <label>:218                                     ; preds = %164
  br label %219, !llfi_index !1317

; <label>:219                                     ; preds = %218
  %220 = load i32* %i, align 4, !llfi_index !1318
  %221 = add nsw i32 %220, 1, !llfi_index !1319
  store i32 %221, i32* %i, align 4, !llfi_index !1320
  br label %159, !llfi_index !1321

; <label>:222                                     ; preds = %159
  %223 = load i8** %mem, align 8, !llfi_index !1322
  %224 = load i32* %n2, align 4, !llfi_index !1323
  %225 = add nsw i32 %224, 1, !llfi_index !1324
  %226 = load i32* %n3, align 4, !llfi_index !1325
  %227 = add nsw i32 %226, 1, !llfi_index !1326
  %228 = mul nsw i32 %225, %227, !llfi_index !1327
  %229 = zext i32 %228 to i64, !llfi_index !1328
  %230 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1329
  %231 = call i64 @fwrite(i8* %223, i64 4, i64 %229, %struct._IO_FILE* %230), !llfi_index !1330
  %232 = load i8** %mem, align 8, !llfi_index !1331
  call void @free(i8* %232) #6, !llfi_index !1332
  %233 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1333
  %234 = call i32 @fclose(%struct._IO_FILE* %233), !llfi_index !1334
