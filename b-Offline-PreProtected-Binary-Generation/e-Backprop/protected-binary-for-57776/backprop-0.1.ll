...
; <label>:46                                      ; preds = %checkBb, %41
  br i1 %44, label %47, label %114, !llfi_index !1172
...
; <label>:53                                      ; preds = %checkBb2, %48
  br i1 %51, label %54, label %107, !llfi_index !1178
...
; <label>:54                                      ; preds = %53
  ...
  %check_cmp3 = fcmp ueq float %71, %72
...
; <label>:86                                      ; preds = %96, %85
  ...
  br i1 %89, label %90, label %99, !llfi_index !1202

; <label>:90                                      ; preds = %86
  %91 = load i8** %_from, align 8, !llfi_index !1203
  %92 = getelementptr inbounds i8* %91, i32 1, !llfi_index !1204
  store i8* %92, i8** %_from, align 8, !llfi_index !1205
  %93 = load i8* %91, align 1, !llfi_index !1206
  %94 = load i8** %_to, align 8, !llfi_index !1207
  %95 = getelementptr inbounds i8* %94, i32 1, !llfi_index !1208
  store i8* %95, i8** %_to, align 8, !llfi_index !1209
  store i8 %93, i8* %94, align 1, !llfi_index !1210
  br label %96, !llfi_index !1211

; <label>:96                                      ; preds = %90
  %97 = load i32* %_i, align 4, !llfi_index !1212
  %98 = add nsw i32 %97, 1, !llfi_index !1213
  store i32 %98, i32* %_i, align 4, !llfi_index !1214
  br label %86, !llfi_index !1215

; <label>:99                                      ; preds = %86
  %100 = load i32* %memcnt, align 4, !llfi_index !1216
  %101 = sext i32 %100 to i64, !llfi_index !1217
  %102 = add i64 %101, 4, !llfi_index !1218
  %103 = trunc i64 %102 to i32, !llfi_index !1219
  store i32 %103, i32* %memcnt, align 4, !llfi_index !1220
  br label %104, !llfi_index !1221

; <label>:104                                     ; preds = %99
  %105 = load i32* %j, align 4, !llfi_index !1222
  %106 = add nsw i32 %105, 1, !llfi_index !1223
  store i32 %106, i32* %j, align 4, !llfi_index !1224
  br label %48, !llfi_index !1225

; <label>:107                                     ; preds = %53
  br label %108, !llfi_index !1226

; <label>:108                                     ; preds = %107
  %109 = load i32* %i, align 4, !llfi_index !1227
  %110 = load i32* %i, align 4, !llfi_index !1227
  %111 = add nsw i32 %109, 1, !llfi_index !1228
  %112 = add nsw i32 %110, 1, !llfi_index !1228
...
; <label>:113                                     ; preds = %checkBb10, %108
  store i32 %111, i32* %i, align 4, !llfi_index !1229
  br label %41, !llfi_index !1230

; <label>:114                                     ; preds = %46
  %115 = load i8** %mem, align 8, !llfi_index !1231
  %116 = load i32* %n1, align 4, !llfi_index !1232
  %117 = add nsw i32 %116, 1, !llfi_index !1233
  %118 = load i32* %n2, align 4, !llfi_index !1234
  %119 = add nsw i32 %118, 1, !llfi_index !1235
  %120 = mul nsw i32 %117, %119, !llfi_index !1236
  %121 = zext i32 %120 to i64, !llfi_index !1237
  %122 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1238
  %123 = call i64 @fwrite(i8* %115, i64 4, i64 %121, %struct._IO_FILE* %122), !llfi_index !1239
  %124 = load i8** %mem, align 8, !llfi_index !1240
  call void @free(i8* %124) #6, !llfi_index !1241
  store i32 0, i32* %memcnt, align 4, !llfi_index !1242
  %125 = load %struct.BPNN** %1, align 8, !llfi_index !1243
  %126 = getelementptr inbounds %struct.BPNN* %125, i32 0, i32 10, !llfi_index !1244
  %127 = load float*** %126, align 8, !llfi_index !1245
  store float** %127, float*** %w, align 8, !llfi_index !1246
  %128 = load i32* %n2, align 4, !llfi_index !1247
  %129 = add nsw i32 %128, 1, !llfi_index !1248
  %130 = load i32* %n3, align 4, !llfi_index !1249
  %131 = add nsw i32 %130, 1, !llfi_index !1250
  %132 = mul nsw i32 %129, %131, !llfi_index !1251
  %133 = sext i32 %132 to i64, !llfi_index !1252
  %134 = mul i64 %133, 4, !llfi_index !1253
  %135 = trunc i64 %134 to i32, !llfi_index !1254
  %136 = zext i32 %135 to i64, !llfi_index !1255
  %137 = call noalias i8* @malloc(i64 %136) #6, !llfi_index !1256
  store i8* %137, i8** %mem, align 8, !llfi_index !1257
  store i32 0, i32* %i, align 4, !llfi_index !1258
  br label %138, !llfi_index !1259

; <label>:138                                     ; preds = %202, %114
  %139 = load i32* %i, align 4, !llfi_index !1260
  %140 = load i32* %n2, align 4, !llfi_index !1261
  %141 = icmp sle i32 %139, %140, !llfi_index !1262
  br i1 %141, label %142, label %205, !llfi_index !1263

; <label>:142                                     ; preds = %138
  store i32 0, i32* %j, align 4, !llfi_index !1264
  br label %143, !llfi_index !1265

; <label>:143                                     ; preds = %198, %142
  %144 = load i32* %j, align 4, !llfi_index !1266
  %145 = load i32* %j, align 4, !llfi_index !1266
  %146 = load i32* %n3, align 4, !llfi_index !1267
  %147 = icmp sle i32 %144, %146, !llfi_index !1268
  %148 = icmp sle i32 %145, %146, !llfi_index !1268
  %check_cmp11 = icmp eq i1 %147, %148
  br i1 %check_cmp11, label %149, label %checkBb12

checkBb12:                                        ; preds = %143
  call void @check_flag()
  br label %149

; <label>:149                                     ; preds = %checkBb12, %143
  br i1 %147, label %150, label %201, !llfi_index !1269

; <label>:150                                     ; preds = %149
  %151 = load i32* %j, align 4, !llfi_index !1270
  %152 = sext i32 %151 to i64, !llfi_index !1271
  %153 = load i32* %i, align 4, !llfi_index !1272
  %154 = sext i32 %153 to i64, !llfi_index !1273
  %155 = load float*** %w, align 8, !llfi_index !1274
  %156 = getelementptr inbounds float** %155, i64 %154, !llfi_index !1275
  %157 = load float** %156, align 8, !llfi_index !1276
  %158 = getelementptr inbounds float* %157, i64 %152, !llfi_index !1277
  %159 = load float* %158, align 4, !llfi_index !1278
  store float %159, float* %dvalue, align 4, !llfi_index !1279
  %160 = load i32* %memcnt, align 4, !llfi_index !1280
  %161 = sext i32 %160 to i64, !llfi_index !1281
  %162 = load i8** %mem, align 8, !llfi_index !1282
  %163 = getelementptr inbounds i8* %162, i64 %161, !llfi_index !1283
  store i8* %163, i8** %_to1, align 8, !llfi_index !1284
  %164 = bitcast float* %dvalue to i8*, !llfi_index !1285
  store i8* %164, i8** %_from2, align 8, !llfi_index !1286
  store i32 4, i32* %_l4, align 4, !llfi_index !1287
  store i32 0, i32* %_i3, align 4, !llfi_index !1288
  br label %165, !llfi_index !1289

; <label>:165                                     ; preds = %192, %150
  %166 = load i32* %_i3, align 4, !llfi_index !1290
  %167 = load i32* %_i3, align 4, !llfi_index !1290
  %168 = load i32* %_l4, align 4, !llfi_index !1291
  %169 = load i32* %_l4, align 4, !llfi_index !1291
  %170 = icmp slt i32 %166, %168, !llfi_index !1292
  %171 = icmp slt i32 %167, %169, !llfi_index !1292
  %check_cmp13 = icmp eq i1 %170, %171
...
; <label>:172                                     ; preds = %checkBb14, %165
  br i1 %170, label %173, label %193, !llfi_index !1293

; <label>:173                                     ; preds = %172
  %174 = load i8** %_from2, align 8, !llfi_index !1294
  %175 = load i8** %_from2, align 8, !llfi_index !1294
  %176 = getelementptr inbounds i8* %174, i32 1, !llfi_index !1295
  %177 = getelementptr inbounds i8* %175, i32 1, !llfi_index !1295
  %check_cmp15 = icmp eq i8* %176, %177
...
; <label>:178                                     ; preds = %checkBb16, %173
  store i8* %176, i8** %_from2, align 8, !llfi_index !1296
  %179 = load i8* %174, align 1, !llfi_index !1297
  %180 = load i8* %175, align 1, !llfi_index !1297
  %check_cmp17 = icmp eq i8 %179, %180
...
; <label>:181                                     ; preds = %checkBb18, %178
  %182 = load i8** %_to1, align 8, !llfi_index !1298
  %183 = load i8** %_to1, align 8, !llfi_index !1298
  %184 = getelementptr inbounds i8* %182, i32 1, !llfi_index !1299
  %185 = getelementptr inbounds i8* %183, i32 1, !llfi_index !1299
  %check_cmp19 = icmp eq i8* %184, %185
...
; <label>:186                                     ; preds = %checkBb20, %181
  store i8* %184, i8** %_to1, align 8, !llfi_index !1300
  store i8 %179, i8* %182, align 1, !llfi_index !1301
  br label %187, !llfi_index !1302

; <label>:187                                     ; preds = %186
  %188 = load i32* %_i3, align 4, !llfi_index !1303
  %189 = load i32* %_i3, align 4, !llfi_index !1303
  %190 = add nsw i32 %188, 1, !llfi_index !1304
  %191 = add nsw i32 %189, 1, !llfi_index !1304
...
; <label>:192                                     ; preds = %checkBb22, %187
  ...
  br label %165, !llfi_index !1306

; <label>:193                                     ; preds = %172
  %194 = load i32* %memcnt, align 4, !llfi_index !1307
  %195 = sext i32 %194 to i64, !llfi_index !1308
  %196 = add i64 %195, 4, !llfi_index !1309
  %197 = trunc i64 %196 to i32, !llfi_index !1310
  store i32 %197, i32* %memcnt, align 4, !llfi_index !1311
  br label %198, !llfi_index !1312

; <label>:198                                     ; preds = %193
  %199 = load i32* %j, align 4, !llfi_index !1313
  %200 = add nsw i32 %199, 1, !llfi_index !1314
  store i32 %200, i32* %j, align 4, !llfi_index !1315
  br label %143, !llfi_index !1316

; <label>:201                                     ; preds = %149
  br label %202, !llfi_index !1317

; <label>:202                                     ; preds = %201
  %203 = load i32* %i, align 4, !llfi_index !1318
  %204 = add nsw i32 %203, 1, !llfi_index !1319
  store i32 %204, i32* %i, align 4, !llfi_index !1320
  br label %138, !llfi_index !1321

; <label>:205                                     ; preds = %138
  %206 = load i8** %mem, align 8, !llfi_index !1322
  %207 = load i32* %n2, align 4, !llfi_index !1323
  %208 = add nsw i32 %207, 1, !llfi_index !1324
  %209 = load i32* %n3, align 4, !llfi_index !1325
  %210 = add nsw i32 %209, 1, !llfi_index !1326
  %211 = mul nsw i32 %208, %210, !llfi_index !1327
  %212 = zext i32 %211 to i64, !llfi_index !1328
  %213 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1329
  %214 = call i64 @fwrite(i8* %206, i64 4, i64 %212, %struct._IO_FILE* %213), !llfi_index !1330
  %215 = load i8** %mem, align 8, !llfi_index !1331
  call void @free(i8* %215) #6, !llfi_index !1332
  %216 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1333
  %217 = call i32 @fclose(%struct._IO_FILE* %216), !llfi_index !1334
