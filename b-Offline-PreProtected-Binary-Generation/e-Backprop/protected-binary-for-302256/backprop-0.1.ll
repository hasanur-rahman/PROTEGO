...
; <label>:7                                       ; preds = %checkBb, %4
  ...
  br i1 %9, label %10, label %46, !llfi_index !227
...
; <label>:18                                      ; preds = %checkBb2, %11
  br i1 %16, label %19, label %42, !llfi_index !233
...
; <label>:25                                      ; preds = %checkBb4, %19
  ...
  %27 = load i32* %j, align 4, !llfi_index !237
...
; <label>:28                                      ; preds = %checkBb6, %25
  %29 = sext i32 %26 to i64, !llfi_index !238
  ...
  store float %23, float* %35, align 4, !llfi_index !245
...
; <label>:51                                      ; preds = %checkBb, %46
  br i1 %49, label %52, label %100, !llfi_index !1178
...
; <label>:59                                      ; preds = %checkBb2, %52
  ...
  %65 = getelementptr inbounds float* %63, i64 %55, !llfi_index !1186
  %66 = getelementptr inbounds float* %64, i64 %56, !llfi_index !1186
  %67 = load float* %65, align 4, !llfi_index !1187
  %68 = load float* %66, align 4, !llfi_index !1187
  %check_cmp3 = fcmp ueq float %67, %68
