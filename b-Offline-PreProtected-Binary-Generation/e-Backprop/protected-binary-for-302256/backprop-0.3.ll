...
; <label>:11                                      ; preds = %checkBb, %4
  br i1 %9, label %12, label %57, !llfi_index !227
...
; <label>:20                                      ; preds = %checkBb2, %13
  br i1 %18, label %21, label %50, !llfi_index !233
...
; <label>:32                                      ; preds = %checkBb6, %27
  ...
  %34 = load i32* %i, align 4, !llfi_index !239
  %35 = sext i32 %33 to i64, !llfi_index !240
  %36 = sext i32 %34 to i64, !llfi_index !240
...
; <label>:37                                      ; preds = %checkBb8, %32
  %38 = load float*** %1, align 8, !llfi_index !241
  %39 = getelementptr inbounds float** %38, i64 %35, !llfi_index !242
  %40 = load float** %39, align 8, !llfi_index !243
  %41 = load float** %39, align 8, !llfi_index !243
  %check_cmp9 = icmp eq float* %40, %41
...
; <label>:42                                      ; preds = %checkBb10, %37
  %43 = getelementptr inbounds float* %40, i64 %30, !llfi_index !244
  store float %25, float* %43, align 4, !llfi_index !245
  br label %44, !llfi_index !246
...
; <label>:49                                      ; preds = %checkBb12, %44
  store i32 %47, i32* %j, align 4, !llfi_index !249
  br label %13, !llfi_index !250

; <label>:50                                      ; preds = %20
  br label %51, !llfi_index !251
...
; <label>:56                                      ; preds = %checkBb14, %51
  store i32 %54, i32* %i, align 4, !llfi_index !254
...
; <label>:26                                      ; preds = %checkBb2, %23
  ...
  %check_cmp3 = icmp eq float** %42, %43
...
; <label>:44                                      ; preds = %checkBb4, %26
  %45 = getelementptr inbounds float** %42, i64 %41, !llfi_index !906
  %46 = load float** %45, align 8, !llfi_index !907
  %47 = getelementptr inbounds float* %46, i64 %39, !llfi_index !908
  ...
  %51 = fadd double %37, %50, !llfi_index !912
...
; <label>:46                                      ; preds = %checkBb, %41
  br i1 %44, label %47, label %133, !llfi_index !1172
...
; <label>:54                                      ; preds = %checkBb2, %48
  br i1 %52, label %55, label %126, !llfi_index !1178
...
; <label>:62                                      ; preds = %checkBb4, %55
  %63 = sext i32 %60 to i64, !llfi_index !1182
  %64 = load float*** %w, align 8, !llfi_index !1183
  %65 = getelementptr inbounds float** %64, i64 %63, !llfi_index !1184
  %66 = getelementptr inbounds float** %64, i64 %63, !llfi_index !1184
...
; <label>:92                                      ; preds = %checkBb12, %86
  br i1 %90, label %93, label %110, !llfi_index !1202

; <label>:93                                      ; preds = %92
  %94 = load i8** %_from, align 8, !llfi_index !1203
  %95 = getelementptr inbounds i8* %94, i32 1, !llfi_index !1204
  store i8* %95, i8** %_from, align 8, !llfi_index !1205
  %96 = load i8* %94, align 1, !llfi_index !1206
  %97 = load i8* %94, align 1, !llfi_index !1206
...
; <label>:98                                      ; preds = %checkBb14, %93
  ...
  %101 = getelementptr inbounds i8* %99, i32 1, !llfi_index !1208
  %102 = getelementptr inbounds i8* %100, i32 1, !llfi_index !1208
...
; <label>:103                                     ; preds = %checkBb16, %98
  ...
  br label %104, !llfi_index !1211

; <label>:104                                     ; preds = %103
  %105 = load i32* %_i, align 4, !llfi_index !1212
  %106 = load i32* %_i, align 4, !llfi_index !1212
  %107 = add nsw i32 %105, 1, !llfi_index !1213
  %108 = add nsw i32 %106, 1, !llfi_index !1213
...
; <label>:109                                     ; preds = %checkBb18, %104
  store i32 %107, i32* %_i, align 4, !llfi_index !1214
  br label %86, !llfi_index !1215

; <label>:110                                     ; preds = %92
  %111 = load i32* %memcnt, align 4, !llfi_index !1216
  %112 = load i32* %memcnt, align 4, !llfi_index !1216
  %113 = sext i32 %111 to i64, !llfi_index !1217
  %114 = sext i32 %112 to i64, !llfi_index !1217
  %115 = add i64 %113, 4, !llfi_index !1218
  %116 = add i64 %114, 4, !llfi_index !1218
  %117 = trunc i64 %115 to i32, !llfi_index !1219
  %118 = trunc i64 %116 to i32, !llfi_index !1219
  %check_cmp19 = icmp eq i32 %117, %118
  br i1 %check_cmp19, label %119, label %checkBb20

checkBb20:                                        ; preds = %110
  call void @check_flag()
  br label %119

; <label>:119                                     ; preds = %checkBb20, %110
  store i32 %117, i32* %memcnt, align 4, !llfi_index !1220
  br label %120, !llfi_index !1221

; <label>:120                                     ; preds = %119
  %121 = load i32* %j, align 4, !llfi_index !1222
  %122 = load i32* %j, align 4, !llfi_index !1222
  %123 = add nsw i32 %121, 1, !llfi_index !1223
  %124 = add nsw i32 %122, 1, !llfi_index !1223
...
; <label>:125                                     ; preds = %checkBb22, %120
  store i32 %123, i32* %j, align 4, !llfi_index !1224
  br label %48, !llfi_index !1225

; <label>:126                                     ; preds = %54
  br label %127, !llfi_index !1226

; <label>:127                                     ; preds = %126
  %128 = load i32* %i, align 4, !llfi_index !1227
  %129 = load i32* %i, align 4, !llfi_index !1227
  %130 = add nsw i32 %128, 1, !llfi_index !1228
  %131 = add nsw i32 %129, 1, !llfi_index !1228
  %check_cmp23 = icmp eq i32 %130, %131
  br i1 %check_cmp23, label %132, label %checkBb24

checkBb24:                                        ; preds = %127
  call void @check_flag()
  br label %132

; <label>:132                                     ; preds = %checkBb24, %127
  store i32 %130, i32* %i, align 4, !llfi_index !1229
  br label %41, !llfi_index !1230

; <label>:133                                     ; preds = %46
  %134 = load i8** %mem, align 8, !llfi_index !1231
  %135 = load i32* %n1, align 4, !llfi_index !1232
  %136 = add nsw i32 %135, 1, !llfi_index !1233
  %137 = load i32* %n2, align 4, !llfi_index !1234
  %138 = add nsw i32 %137, 1, !llfi_index !1235
  %139 = mul nsw i32 %136, %138, !llfi_index !1236
  %140 = zext i32 %139 to i64, !llfi_index !1237
  %141 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1238
  %142 = call i64 @fwrite(i8* %134, i64 4, i64 %140, %struct._IO_FILE* %141), !llfi_index !1239
  %143 = load i8** %mem, align 8, !llfi_index !1240
  call void @free(i8* %143) #6, !llfi_index !1241
  store i32 0, i32* %memcnt, align 4, !llfi_index !1242
  %144 = load %struct.BPNN** %1, align 8, !llfi_index !1243
  %145 = getelementptr inbounds %struct.BPNN* %144, i32 0, i32 10, !llfi_index !1244
  %146 = load float*** %145, align 8, !llfi_index !1245
  store float** %146, float*** %w, align 8, !llfi_index !1246
  %147 = load i32* %n2, align 4, !llfi_index !1247
  %148 = add nsw i32 %147, 1, !llfi_index !1248
  %149 = load i32* %n3, align 4, !llfi_index !1249
  %150 = add nsw i32 %149, 1, !llfi_index !1250
  %151 = mul nsw i32 %148, %150, !llfi_index !1251
  %152 = sext i32 %151 to i64, !llfi_index !1252
  %153 = mul i64 %152, 4, !llfi_index !1253
  %154 = trunc i64 %153 to i32, !llfi_index !1254
  %155 = zext i32 %154 to i64, !llfi_index !1255
  %156 = call noalias i8* @malloc(i64 %155) #6, !llfi_index !1256
  store i8* %156, i8** %mem, align 8, !llfi_index !1257
  store i32 0, i32* %i, align 4, !llfi_index !1258
  br label %157, !llfi_index !1259

; <label>:157                                     ; preds = %203, %133
  %158 = load i32* %i, align 4, !llfi_index !1260
  %159 = load i32* %n2, align 4, !llfi_index !1261
  %160 = icmp sle i32 %158, %159, !llfi_index !1262
  br i1 %160, label %161, label %206, !llfi_index !1263

; <label>:161                                     ; preds = %157
  store i32 0, i32* %j, align 4, !llfi_index !1264
  br label %162, !llfi_index !1265

; <label>:162                                     ; preds = %199, %161
  %163 = load i32* %j, align 4, !llfi_index !1266
  %164 = load i32* %n3, align 4, !llfi_index !1267
  %165 = icmp sle i32 %163, %164, !llfi_index !1268
  br i1 %165, label %166, label %202, !llfi_index !1269
...
; <label>:181                                     ; preds = %191, %166
  %182 = load i32* %_i3, align 4, !llfi_index !1290
  %183 = load i32* %_l4, align 4, !llfi_index !1291
  %184 = icmp slt i32 %182, %183, !llfi_index !1292
  br i1 %184, label %185, label %194, !llfi_index !1293

; <label>:185                                     ; preds = %181
  %186 = load i8** %_from2, align 8, !llfi_index !1294
  %187 = getelementptr inbounds i8* %186, i32 1, !llfi_index !1295
  store i8* %187, i8** %_from2, align 8, !llfi_index !1296
  %188 = load i8* %186, align 1, !llfi_index !1297
  ...
  store i8 %188, i8* %189, align 1, !llfi_index !1301
  br label %191, !llfi_index !1302

; <label>:191                                     ; preds = %185
  %192 = load i32* %_i3, align 4, !llfi_index !1303
  %193 = add nsw i32 %192, 1, !llfi_index !1304
  store i32 %193, i32* %_i3, align 4, !llfi_index !1305
  br label %181, !llfi_index !1306

; <label>:194                                     ; preds = %181
  %195 = load i32* %memcnt, align 4, !llfi_index !1307
  %196 = sext i32 %195 to i64, !llfi_index !1308
  %197 = add i64 %196, 4, !llfi_index !1309
  %198 = trunc i64 %197 to i32, !llfi_index !1310
  store i32 %198, i32* %memcnt, align 4, !llfi_index !1311
  br label %199, !llfi_index !1312

; <label>:199                                     ; preds = %194
  %200 = load i32* %j, align 4, !llfi_index !1313
  %201 = add nsw i32 %200, 1, !llfi_index !1314
  store i32 %201, i32* %j, align 4, !llfi_index !1315
  br label %162, !llfi_index !1316

; <label>:202                                     ; preds = %162
  br label %203, !llfi_index !1317

; <label>:203                                     ; preds = %202
  %204 = load i32* %i, align 4, !llfi_index !1318
  %205 = add nsw i32 %204, 1, !llfi_index !1319
  store i32 %205, i32* %i, align 4, !llfi_index !1320
  br label %157, !llfi_index !1321

; <label>:206                                     ; preds = %157
  %207 = load i8** %mem, align 8, !llfi_index !1322
  %208 = load i32* %n2, align 4, !llfi_index !1323
  %209 = add nsw i32 %208, 1, !llfi_index !1324
  %210 = load i32* %n3, align 4, !llfi_index !1325
  %211 = add nsw i32 %210, 1, !llfi_index !1326
  %212 = mul nsw i32 %209, %211, !llfi_index !1327
  %213 = zext i32 %212 to i64, !llfi_index !1328
  %214 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1329
  %215 = call i64 @fwrite(i8* %207, i64 4, i64 %213, %struct._IO_FILE* %214), !llfi_index !1330
  %216 = load i8** %mem, align 8, !llfi_index !1331
  call void @free(i8* %216) #6, !llfi_index !1332
  %217 = load %struct._IO_FILE** %pFile, align 8, !llfi_index !1333
  %218 = call i32 @fclose(%struct._IO_FILE* %217), !llfi_index !1334
