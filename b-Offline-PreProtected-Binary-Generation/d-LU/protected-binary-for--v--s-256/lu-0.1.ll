...
; <label>:3                                       ; preds = %172, %0
  ...
  br i1 %6, label %7, label %175, !llfi_index !14
...
; <label>:15                                      ; preds = %checkBb, %9
  br i1 %13, label %16, label %85, !llfi_index !21
...
; <label>:22                                      ; preds = %checkBb2, %16
  %23 = add nsw i32 %19, %20, !llfi_index !26
...
; <label>:70                                      ; preds = %checkBb12, %67
  ...
  %75 = add nsw i32 %73, %74, !llfi_index !70
  %76 = sext i32 %75 to i64, !llfi_index !71
  %77 = load float** %1, align 8, !llfi_index !72
  %78 = getelementptr inbounds float* %77, i64 %76, !llfi_index !73
  store float %68, float* %78, align 4, !llfi_index !74
  br label %79, !llfi_index !75

; <label>:79                                      ; preds = %70
  %80 = load i32* %j, align 4, !llfi_index !76
  %81 = load i32* %j, align 4, !llfi_index !76
  %82 = add nsw i32 %80, 1, !llfi_index !77
  %83 = add nsw i32 %81, 1, !llfi_index !77
...
; <label>:84                                      ; preds = %checkBb14, %79
  store i32 %82, i32* %j, align 4, !llfi_index !78
  br label %9, !llfi_index !79

; <label>:85                                      ; preds = %15
  %86 = load i32* %i, align 4, !llfi_index !80
  %87 = add nsw i32 %86, 1, !llfi_index !81
  store i32 %87, i32* %j, align 4, !llfi_index !82
  br label %88, !llfi_index !83

; <label>:88                                      ; preds = %170, %85
  %89 = load i32* %j, align 4, !llfi_index !84
  %90 = load i32* %2, align 4, !llfi_index !85
  %91 = icmp slt i32 %89, %90, !llfi_index !86
...
; <label>:93                                      ; preds = %checkBb16, %88
  br i1 %91, label %94, label %171, !llfi_index !87
...
; <label>:111                                     ; preds = %checkBb20, %106
  br i1 %109, label %112, label %141, !llfi_index !103
...
; <label>:112                                     ; preds = %111
  ...
  %122 = load i32* %k, align 4, !llfi_index !113
  %123 = load i32* %2, align 4, !llfi_index !114
  %124 = mul nsw i32 %122, %123, !llfi_index !115
  %125 = load i32* %i, align 4, !llfi_index !116
  %126 = add nsw i32 %124, %125, !llfi_index !117
  %127 = sext i32 %126 to i64, !llfi_index !118
  %128 = load float** %1, align 8, !llfi_index !119
  %129 = getelementptr inbounds float* %128, i64 %127, !llfi_index !120
  %130 = load float* %129, align 4, !llfi_index !121
  %131 = fmul float %121, %130, !llfi_index !122
  %132 = fmul float %121, %130, !llfi_index !122
  %133 = load float* %sum, align 4, !llfi_index !123
  %134 = load float* %sum, align 4, !llfi_index !123
  %135 = fsub float %133, %131, !llfi_index !124
  %136 = fsub float %134, %132, !llfi_index !124
  %check_cmp21 = fcmp ueq float %135, %136
...
; <label>:137                                     ; preds = %checkBb22, %112
  store float %135, float* %sum, align 4, !llfi_index !125
  br label %138, !llfi_index !126

; <label>:138                                     ; preds = %137
  %139 = load i32* %k, align 4, !llfi_index !127
  %140 = add nsw i32 %139, 1, !llfi_index !128
  store i32 %140, i32* %k, align 4, !llfi_index !129
  br label %106, !llfi_index !130

; <label>:141                                     ; preds = %111
  %142 = load float* %sum, align 4, !llfi_index !131
  %143 = load float* %sum, align 4, !llfi_index !131
  %144 = load i32* %i, align 4, !llfi_index !132
  %145 = load i32* %2, align 4, !llfi_index !133
  %146 = mul nsw i32 %144, %145, !llfi_index !134
  %147 = load i32* %i, align 4, !llfi_index !135
  %148 = add nsw i32 %146, %147, !llfi_index !136
  %149 = sext i32 %148 to i64, !llfi_index !137
  %150 = load float** %1, align 8, !llfi_index !138
  %151 = getelementptr inbounds float* %150, i64 %149, !llfi_index !139
  %152 = load float* %151, align 4, !llfi_index !140
  %153 = load float* %151, align 4, !llfi_index !140
  %154 = fdiv float %142, %152, !llfi_index !141
  %155 = fdiv float %143, %153, !llfi_index !141
  %check_cmp23 = fcmp ueq float %154, %155
...
; <label>:156                                     ; preds = %checkBb24, %141
  %157 = load i32* %j, align 4, !llfi_index !142
  %158 = load i32* %2, align 4, !llfi_index !143
  %159 = mul nsw i32 %157, %158, !llfi_index !144
  %160 = load i32* %i, align 4, !llfi_index !145
  %161 = add nsw i32 %159, %160, !llfi_index !146
  %162 = sext i32 %161 to i64, !llfi_index !147
  %163 = load float** %1, align 8, !llfi_index !148
  %164 = getelementptr inbounds float* %163, i64 %162, !llfi_index !149
  store float %154, float* %164, align 4, !llfi_index !150
  br label %165, !llfi_index !151

; <label>:165                                     ; preds = %156
  %166 = load i32* %j, align 4, !llfi_index !152
  %167 = load i32* %j, align 4, !llfi_index !152
  %168 = add nsw i32 %166, 1, !llfi_index !153
  %169 = add nsw i32 %167, 1, !llfi_index !153
  %check_cmp25 = icmp eq i32 %168, %169
...
; <label>:170                                     ; preds = %checkBb26, %165
  store i32 %168, i32* %j, align 4, !llfi_index !154
  br label %88, !llfi_index !155

; <label>:171                                     ; preds = %93
  br label %172, !llfi_index !156

; <label>:172                                     ; preds = %171
  %173 = load i32* %i, align 4, !llfi_index !157
  %174 = add nsw i32 %173, 1, !llfi_index !158
  store i32 %174, i32* %i, align 4, !llfi_index !159
...
; <label>:38                                      ; preds = %checkBb2, %34
  br i1 %36, label %39, label %76, !llfi_index !831
...
; <label>:71                                      ; preds = %56
  ...
  %73 = load i32* %k, align 4, !llfi_index !866
...
; <label>:74                                      ; preds = %checkBb6, %71
  %75 = add nsw i32 %72, 1, !llfi_index !867
  store i32 %75, i32* %k, align 4, !llfi_index !868
...
; <label>:99                                      ; preds = %166, %98
  ...
  br i1 %102, label %103, label %169, !llfi_index !895
...
; <label>:104                                     ; preds = %162, %103
  ...
  br i1 %107, label %108, label %165, !llfi_index !901
...
; <label>:108                                     ; preds = %104
  ...
  %113 = load i32* %j, align 4, !llfi_index !905
...
; <label>:114                                     ; preds = %checkBb12, %108
  %115 = add nsw i32 %111, %112, !llfi_index !906
  %116 = sext i32 %115 to i64, !llfi_index !907
  %117 = load float** %2, align 8, !llfi_index !908
  %118 = getelementptr inbounds float* %117, i64 %116, !llfi_index !909
  %119 = load float* %118, align 4, !llfi_index !910
  ...
  %125 = sext i32 %124 to i64, !llfi_index !916
  %126 = load float** %tmp, align 8, !llfi_index !917
  %127 = getelementptr inbounds float* %126, i64 %125, !llfi_index !918
  %128 = load float* %127, align 4, !llfi_index !919
  %129 = load float* %127, align 4, !llfi_index !919
  %check_cmp13 = fcmp ueq float %128, %129
...
; <label>:130                                     ; preds = %checkBb14, %114
  %131 = fsub float %119, %128, !llfi_index !920
  %132 = fpext float %131 to double, !llfi_index !921
  %133 = call double @fabs(double %132) #9, !llfi_index !922
  %134 = fcmp ogt double %133, 1.000000e-04, !llfi_index !923
  %135 = fcmp ogt double %133, 1.000000e-04, !llfi_index !923
  %check_cmp15 = icmp eq i1 %134, %135
...
; <label>:136                                     ; preds = %checkBb16, %130
  br i1 %134, label %137, label %161, !llfi_index !924

; <label>:137                                     ; preds = %136
  %138 = load i32* %i, align 4, !llfi_index !925
  %139 = load i32* %j, align 4, !llfi_index !926
  %140 = load i32* %i, align 4, !llfi_index !927
  %141 = load i32* %4, align 4, !llfi_index !928
  %142 = mul nsw i32 %140, %141, !llfi_index !929
  %143 = load i32* %j, align 4, !llfi_index !930
  %144 = add nsw i32 %142, %143, !llfi_index !931
  %145 = sext i32 %144 to i64, !llfi_index !932
  %146 = load float** %2, align 8, !llfi_index !933
  %147 = getelementptr inbounds float* %146, i64 %145, !llfi_index !934
  %148 = load float* %147, align 4, !llfi_index !935
  %149 = fpext float %148 to double, !llfi_index !936
  %150 = load i32* %i, align 4, !llfi_index !937
  %151 = load i32* %4, align 4, !llfi_index !938
  %152 = mul nsw i32 %150, %151, !llfi_index !939
  %153 = load i32* %j, align 4, !llfi_index !940
  %154 = add nsw i32 %152, %153, !llfi_index !941
  %155 = sext i32 %154 to i64, !llfi_index !942
  %156 = load float** %tmp, align 8, !llfi_index !943
  %157 = getelementptr inbounds float* %156, i64 %155, !llfi_index !944
  %158 = load float* %157, align 4, !llfi_index !945
  %159 = fpext float %158 to double, !llfi_index !946
  %160 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([35 x i8]* @.str314, i32 0, i32 0), i32 %138, i32 %139, double %149, double %159), !llfi_index !947
  br label %161, !llfi_index !948

; <label>:161                                     ; preds = %137, %136
  br label %162, !llfi_index !949

; <label>:162                                     ; preds = %161
  %163 = load i32* %j, align 4, !llfi_index !950
  %164 = add nsw i32 %163, 1, !llfi_index !951
  store i32 %164, i32* %j, align 4, !llfi_index !952
  br label %104, !llfi_index !953

; <label>:165                                     ; preds = %104
  br label %166, !llfi_index !954

; <label>:166                                     ; preds = %165
  %167 = load i32* %i, align 4, !llfi_index !955
  %168 = add nsw i32 %167, 1, !llfi_index !956
  store i32 %168, i32* %i, align 4, !llfi_index !957
  br label %99, !llfi_index !958

; <label>:169                                     ; preds = %99
  %170 = load float** %tmp, align 8, !llfi_index !959
  %171 = bitcast float* %170 to i8*, !llfi_index !960
  call void @free(i8* %171) #5, !llfi_index !961
  %172 = load i32* %1, !llfi_index !962
  ret i32 %172, !llfi_index !963
}
