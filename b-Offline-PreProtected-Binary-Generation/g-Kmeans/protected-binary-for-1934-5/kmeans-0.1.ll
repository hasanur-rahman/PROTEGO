...
; <label>:10                                      ; preds = %9
  ...
  %32 = load float* %30, align 4, !llfi_index !527
  %check_cmp1 = fcmp ueq float %31, %32
...
; <label>:33                                      ; preds = %checkBb2, %10
  %34 = fsub float %26, %31, !llfi_index !528
  %35 = fmul float %21, %34, !llfi_index !529
