...
; <label>:222                                     ; preds = %checkBb2, %216
  ...
  %225 = load float** %buf, align 8, !llfi_index !289
  %check_cmp3 = icmp eq float* %224, %225
  br i1 %check_cmp3, label %226, label %checkBb4

checkBb4:                                         ; preds = %222
  call void @check_flag()
  br label %226

; <label>:226                                     ; preds = %checkBb4, %222
  %227 = getelementptr inbounds float* %224, i64 %223, !llfi_index !290
...
; <label>:4                                       ; preds = %41, %0
  ...
  br i1 %7, label %8, label %42, !llfi_index !506
...
; <label>:8                                       ; preds = %4
  ...
  %14 = load i32* %i, align 4, !llfi_index !512
  %15 = sext i32 %14 to i64, !llfi_index !513
  %16 = load float** %2, align 8, !llfi_index !514
  %17 = getelementptr inbounds float* %16, i64 %15, !llfi_index !515
  %18 = load float* %17, align 4, !llfi_index !516
  %19 = fsub float %13, %18, !llfi_index !517
  %20 = load i32* %i, align 4, !llfi_index !518
  %21 = sext i32 %20 to i64, !llfi_index !519
  %22 = load float** %1, align 8, !llfi_index !520
  %23 = getelementptr inbounds float* %22, i64 %21, !llfi_index !521
  %24 = load float* %23, align 4, !llfi_index !522
  %25 = load float* %23, align 4, !llfi_index !522
  %check_cmp = fcmp ueq float %24, %25
...
; <label>:26                                      ; preds = %checkBb, %8
  ...
  %32 = fsub float %24, %31, !llfi_index !528
  %33 = fmul float %19, %32, !llfi_index !529
