...
; <label>:198                                     ; preds = %234, %207, %196
  ...
  br i1 %202, label %203, label %235, !llfi_index !272
...
; <label>:209                                     ; preds = %233, %208
  ...
  %213 = icmp slt i32 %210, %212, !llfi_index !282
  %214 = icmp slt i32 %211, %212, !llfi_index !282
  %check_cmp = icmp eq i1 %213, %214
  br i1 %check_cmp, label %215, label %checkBb

checkBb:                                          ; preds = %209
  call void @check_flag()
  br label %215

; <label>:215                                     ; preds = %checkBb, %209
  br i1 %213, label %216, label %234, !llfi_index !283

; <label>:216                                     ; preds = %215
  %217 = call i8* @strtok(i8* null, i8* getelementptr inbounds ([5 x i8]* @.str6, i32 0, i32 0)) #5, !llfi_index !284
  %218 = call double @atof(i8* %217) #8, !llfi_index !285
  %219 = fptrunc double %218 to float, !llfi_index !286
  %220 = load i32* %i, align 4, !llfi_index !287
  %221 = load i32* %i, align 4, !llfi_index !287
  %check_cmp1 = icmp eq i32 %220, %221
...
; <label>:222                                     ; preds = %checkBb2, %216
  %223 = sext i32 %220 to i64, !llfi_index !288
  %224 = load float** %buf, align 8, !llfi_index !289
  %225 = getelementptr inbounds float* %224, i64 %223, !llfi_index !290
  store float %219, float* %225, align 4, !llfi_index !291
  %226 = load i32* %i, align 4, !llfi_index !292
  %227 = add nsw i32 %226, 1, !llfi_index !293
  store i32 %227, i32* %i, align 4, !llfi_index !294
  br label %228, !llfi_index !295

; <label>:228                                     ; preds = %222
  %229 = load i32* %j, align 4, !llfi_index !296
  %230 = load i32* %j, align 4, !llfi_index !296
  %231 = add nsw i32 %229, 1, !llfi_index !297
  %232 = add nsw i32 %230, 1, !llfi_index !297
  %check_cmp3 = icmp eq i32 %231, %232
  br i1 %check_cmp3, label %233, label %checkBb4

checkBb4:                                         ; preds = %228
  call void @check_flag()
  br label %233

; <label>:233                                     ; preds = %checkBb4, %228
  store i32 %231, i32* %j, align 4, !llfi_index !298
...
; <label>:235                                     ; preds = %198
  %236 = load %struct._IO_FILE** %infile1, align 8, !llfi_index !301
  %237 = call i32 @fclose(%struct._IO_FILE* %236), !llfi_index !302
  br label %238, !llfi_index !303

; <label>:238                                     ; preds = %235, %97
  %239 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str8, i32 0, i32 0)), !llfi_index !304
  %240 = load float*** %attributes, align 8, !llfi_index !305
  %241 = getelementptr inbounds float** %240, i64 0, !llfi_index !306
  %242 = load float** %241, align 8, !llfi_index !307
  %243 = bitcast float* %242 to i8*, !llfi_index !308
  %244 = load float** %buf, align 8, !llfi_index !309
  %245 = bitcast float* %244 to i8*, !llfi_index !310
  %246 = load i32* %numObjects, align 4, !llfi_index !311
  %247 = load i32* %numAttributes, align 4, !llfi_index !312
  %248 = mul nsw i32 %246, %247, !llfi_index !313
  %249 = sext i32 %248 to i64, !llfi_index !314
  %250 = mul i64 %249, 4, !llfi_index !315
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %243, i8* %245, i64 %250, i32 4, i1 false), !llfi_index !316
  store i32 0, i32* %i, align 4, !llfi_index !317
  br label %251, !llfi_index !318

; <label>:251                                     ; preds = %262, %238
  %252 = load i32* %i, align 4, !llfi_index !319
  %253 = load i32* %nloops, align 4, !llfi_index !320
  %254 = icmp slt i32 %252, %253, !llfi_index !321
  br i1 %254, label %255, label %265, !llfi_index !322

; <label>:255                                     ; preds = %251
  store float** null, float*** %cluster_centres, align 8, !llfi_index !323
  %256 = load i32* %numObjects, align 4, !llfi_index !324
  %257 = load i32* %numAttributes, align 4, !llfi_index !325
  %258 = load float*** %attributes, align 8, !llfi_index !326
  %259 = load i32* %nclusters, align 4, !llfi_index !327
  %260 = load float* %threshold, align 4, !llfi_index !328
  %261 = call i32 @cluster(i32 %256, i32 %257, float** %258, i32 %259, float %260, float*** %cluster_centres), !llfi_index !329
  br label %262, !llfi_index !330

; <label>:262                                     ; preds = %255
  %263 = load i32* %i, align 4, !llfi_index !331
  %264 = add nsw i32 %263, 1, !llfi_index !332
  store i32 %264, i32* %i, align 4, !llfi_index !333
  br label %251, !llfi_index !334

; <label>:265                                     ; preds = %251
  %266 = load i32* %nclusters, align 4, !llfi_index !335
  %267 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str9, i32 0, i32 0), i32 %266), !llfi_index !336
  %268 = load i32* %numAttributes, align 4, !llfi_index !337
  %269 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([26 x i8]* @.str10, i32 0, i32 0), i32 %268), !llfi_index !338
  %270 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([11 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8]* @.str123, i32 0, i32 0)), !llfi_index !339
  store %struct._IO_FILE* %270, %struct._IO_FILE** %file, align 8, !llfi_index !340
  store i32 0, i32* %i, align 4, !llfi_index !341
  br label %271, !llfi_index !342

; <label>:271                                     ; preds = %302, %265
  %272 = load i32* %i, align 4, !llfi_index !343
  %273 = load i32* %nclusters, align 4, !llfi_index !344
  %274 = icmp slt i32 %272, %273, !llfi_index !345
  br i1 %274, label %275, label %305, !llfi_index !346

; <label>:275                                     ; preds = %271
  %276 = load %struct._IO_FILE** %file, align 8, !llfi_index !347
  %277 = load i32* %i, align 4, !llfi_index !348
  %278 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %276, i8* getelementptr inbounds ([5 x i8]* @.str13, i32 0, i32 0), i32 %277), !llfi_index !349
  store i32 0, i32* %j, align 4, !llfi_index !350
  br label %279, !llfi_index !351

; <label>:279                                     ; preds = %296, %275
  %280 = load i32* %j, align 4, !llfi_index !352
  %281 = load i32* %numAttributes, align 4, !llfi_index !353
  %282 = icmp slt i32 %280, %281, !llfi_index !354
  br i1 %282, label %283, label %299, !llfi_index !355

; <label>:283                                     ; preds = %279
  %284 = load %struct._IO_FILE** %file, align 8, !llfi_index !356
  %285 = load i32* %j, align 4, !llfi_index !357
  %286 = sext i32 %285 to i64, !llfi_index !358
  %287 = load i32* %i, align 4, !llfi_index !359
  %288 = sext i32 %287 to i64, !llfi_index !360
  %289 = load float*** %cluster_centres, align 8, !llfi_index !361
  %290 = getelementptr inbounds float** %289, i64 %288, !llfi_index !362
  %291 = load float** %290, align 8, !llfi_index !363
  %292 = getelementptr inbounds float* %291, i64 %286, !llfi_index !364
  %293 = load float* %292, align 4, !llfi_index !365
  %294 = fpext float %293 to double, !llfi_index !366
  %295 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %284, i8* getelementptr inbounds ([6 x i8]* @.str14, i32 0, i32 0), double %294), !llfi_index !367
  br label %296, !llfi_index !368

; <label>:296                                     ; preds = %283
  %297 = load i32* %j, align 4, !llfi_index !369
  %298 = add nsw i32 %297, 1, !llfi_index !370
  store i32 %298, i32* %j, align 4, !llfi_index !371
  br label %279, !llfi_index !372

; <label>:299                                     ; preds = %279
  %300 = load %struct._IO_FILE** %file, align 8, !llfi_index !373
  %301 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %300, i8* getelementptr inbounds ([3 x i8]* @.str15, i32 0, i32 0)), !llfi_index !374
  br label %302, !llfi_index !375

; <label>:302                                     ; preds = %299
  %303 = load i32* %i, align 4, !llfi_index !376
  %304 = add nsw i32 %303, 1, !llfi_index !377
  store i32 %304, i32* %i, align 4, !llfi_index !378
  br label %271, !llfi_index !379

; <label>:305                                     ; preds = %271
  %306 = load %struct._IO_FILE** %file, align 8, !llfi_index !380
  %307 = call i32 @fclose(%struct._IO_FILE* %306), !llfi_index !381
  %308 = load float*** %attributes, align 8, !llfi_index !382
  %309 = bitcast float** %308 to i8*, !llfi_index !383
  call void @free(i8* %309) #5, !llfi_index !384
  %310 = load float*** %cluster_centres, align 8, !llfi_index !385
  %311 = getelementptr inbounds float** %310, i64 0, !llfi_index !386
  %312 = load float** %311, align 8, !llfi_index !387
  %313 = bitcast float* %312 to i8*, !llfi_index !388
  call void @free(i8* %313) #5, !llfi_index !389
  %314 = load float*** %cluster_centres, align 8, !llfi_index !390
  %315 = bitcast float** %314 to i8*, !llfi_index !391
  call void @free(i8* %315) #5, !llfi_index !392
  %316 = load float** %buf, align 8, !llfi_index !393
  %317 = bitcast float* %316 to i8*, !llfi_index !394
  call void @free(i8* %317) #5, !llfi_index !395
...
; <label>:5                                       ; preds = %25, %0
  ...
  br i1 %8, label %9, label %28, !llfi_index !466
...
; <label>:9                                       ; preds = %5
  ...
  br i1 %20, label %21, label %24, !llfi_index !479

; <label>:21                                      ; preds = %9
  %22 = load float* %dist, align 4, !llfi_index !480
  store float %22, float* %min_dist, align 4, !llfi_index !481
  %23 = load i32* %i, align 4, !llfi_index !482
  store i32 %23, i32* %index, align 4, !llfi_index !483
  br label %24, !llfi_index !484

; <label>:24                                      ; preds = %21, %9
  br label %25, !llfi_index !485

; <label>:25                                      ; preds = %24
  %26 = load i32* %i, align 4, !llfi_index !486
  %27 = add nsw i32 %26, 1, !llfi_index !487
  store i32 %27, i32* %i, align 4, !llfi_index !488
  br label %5, !llfi_index !489

; <label>:28                                      ; preds = %5
  %29 = load i32* %index, align 4, !llfi_index !490
  ret i32 %29, !llfi_index !491
}
...
; <label>:4                                       ; preds = %40, %0
  ...
  %8 = icmp slt i32 %5, %6, !llfi_index !505
...
; <label>:9                                       ; preds = %checkBb, %4
  br i1 %7, label %10, label %43, !llfi_index !506

; <label>:10                                      ; preds = %9
  %11 = load i32* %i, align 4, !llfi_index !507
  %12 = sext i32 %11 to i64, !llfi_index !508
  %13 = load float** %1, align 8, !llfi_index !509
  %14 = getelementptr inbounds float* %13, i64 %12, !llfi_index !510
  %15 = load float* %14, align 4, !llfi_index !511
  %16 = load float* %14, align 4, !llfi_index !511
  %check_cmp1 = fcmp ueq float %15, %16
...
; <label>:17                                      ; preds = %checkBb2, %10
  %18 = load i32* %i, align 4, !llfi_index !512
  %19 = sext i32 %18 to i64, !llfi_index !513
  %20 = load float** %2, align 8, !llfi_index !514
  %21 = getelementptr inbounds float* %20, i64 %19, !llfi_index !515
  %22 = load float* %21, align 4, !llfi_index !516
  %23 = fsub float %15, %22, !llfi_index !517
  %24 = load i32* %i, align 4, !llfi_index !518
  %25 = sext i32 %24 to i64, !llfi_index !519
  %26 = load float** %1, align 8, !llfi_index !520
  %27 = getelementptr inbounds float* %26, i64 %25, !llfi_index !521
  %28 = load float* %27, align 4, !llfi_index !522
  %29 = load float* %27, align 4, !llfi_index !522
...
; <label>:30                                      ; preds = %checkBb4, %17
  %31 = load i32* %i, align 4, !llfi_index !523
  %32 = sext i32 %31 to i64, !llfi_index !524
  %33 = load float** %2, align 8, !llfi_index !525
  %34 = getelementptr inbounds float* %33, i64 %32, !llfi_index !526
  %35 = load float* %34, align 4, !llfi_index !527
  %36 = fsub float %28, %35, !llfi_index !528
  %37 = fmul float %23, %36, !llfi_index !529
  %38 = load float* %ans, align 4, !llfi_index !530
  %39 = fadd float %38, %37, !llfi_index !531
  store float %39, float* %ans, align 4, !llfi_index !532
  br label %40, !llfi_index !533

; <label>:40                                      ; preds = %30
  %41 = load i32* %i, align 4, !llfi_index !534
  %42 = add nsw i32 %41, 1, !llfi_index !535
  store i32 %42, i32* %i, align 4, !llfi_index !536
...
; <label>:240                                     ; preds = %checkBb, %234
  br i1 %238, label %241, label %329, !llfi_index !839
...
; <label>:282                                     ; preds = %321, %281
  ...
  %check_cmp3 = icmp eq i32 %283, %284
  br i1 %check_cmp3, label %285, label %checkBb4

checkBb4:                                         ; preds = %282
  call void @check_flag()
  br label %285

; <label>:285                                     ; preds = %checkBb4, %282
  %286 = load i32* %2, align 4, !llfi_index !884
  %287 = icmp slt i32 %283, %286, !llfi_index !885
  br i1 %287, label %288, label %322, !llfi_index !886

; <label>:288                                     ; preds = %285
  %289 = load i32* %j, align 4, !llfi_index !887
  %290 = sext i32 %289 to i64, !llfi_index !888
  %291 = load i32* %i, align 4, !llfi_index !889
  %292 = sext i32 %291 to i64, !llfi_index !890
  %293 = load float*** %1, align 8, !llfi_index !891
  %294 = getelementptr inbounds float** %293, i64 %292, !llfi_index !892
  %295 = load float** %294, align 8, !llfi_index !893
  %296 = getelementptr inbounds float* %295, i64 %290, !llfi_index !894
  %297 = load float* %296, align 4, !llfi_index !895
  %298 = load float* %296, align 4, !llfi_index !895
  %299 = load i32* %j, align 4, !llfi_index !896
  %300 = sext i32 %299 to i64, !llfi_index !897
  %301 = load i32* %index, align 4, !llfi_index !898
  %302 = sext i32 %301 to i64, !llfi_index !899
  %303 = load i32* %tid, align 4, !llfi_index !900
  %304 = sext i32 %303 to i64, !llfi_index !901
  %305 = load float**** %partial_new_centers, align 8, !llfi_index !902
  %306 = getelementptr inbounds float*** %305, i64 %304, !llfi_index !903
  %307 = load float*** %306, align 8, !llfi_index !904
  %308 = getelementptr inbounds float** %307, i64 %302, !llfi_index !905
  %309 = load float** %308, align 8, !llfi_index !906
  %310 = getelementptr inbounds float* %309, i64 %300, !llfi_index !907
  %311 = load float* %310, align 4, !llfi_index !908
  %312 = load float* %310, align 4, !llfi_index !908
  %313 = fadd float %311, %297, !llfi_index !909
  %314 = fadd float %312, %298, !llfi_index !909
  %check_cmp5 = fcmp ueq float %313, %314
  br i1 %check_cmp5, label %315, label %checkBb6

checkBb6:                                         ; preds = %288
  call void @check_flag()
  br label %315

; <label>:315                                     ; preds = %checkBb6, %288
  store float %313, float* %310, align 4, !llfi_index !910
  br label %316, !llfi_index !911

; <label>:316                                     ; preds = %315
  %317 = load i32* %j, align 4, !llfi_index !912
  %318 = load i32* %j, align 4, !llfi_index !912
  %319 = add nsw i32 %317, 1, !llfi_index !913
  %320 = add nsw i32 %318, 1, !llfi_index !913
  %check_cmp7 = icmp eq i32 %319, %320
  br i1 %check_cmp7, label %321, label %checkBb8

checkBb8:                                         ; preds = %316
  call void @check_flag()
  br label %321

; <label>:321                                     ; preds = %checkBb8, %316
  store i32 %319, i32* %j, align 4, !llfi_index !914
  br label %282, !llfi_index !915

; <label>:322                                     ; preds = %285
  br label %323, !llfi_index !916

; <label>:323                                     ; preds = %322
  %324 = load i32* %i, align 4, !llfi_index !917
  %325 = load i32* %i, align 4, !llfi_index !917
  %326 = add nsw i32 %324, 1, !llfi_index !918
  %327 = add nsw i32 %325, 1, !llfi_index !918
  %check_cmp9 = icmp eq i32 %326, %327
  br i1 %check_cmp9, label %328, label %checkBb10

checkBb10:                                        ; preds = %323
  call void @check_flag()
  br label %328

; <label>:328                                     ; preds = %checkBb10, %323
  store i32 %326, i32* %i, align 4, !llfi_index !919
  br label %234, !llfi_index !920

; <label>:329                                     ; preds = %240
  store i32 0, i32* %i, align 4, !llfi_index !921
  br label %330, !llfi_index !922

; <label>:330                                     ; preds = %420, %329
  %331 = load i32* %i, align 4, !llfi_index !923
  %332 = load i32* %4, align 4, !llfi_index !924
  %333 = icmp slt i32 %331, %332, !llfi_index !925
  br i1 %333, label %334, label %423, !llfi_index !926

; <label>:334                                     ; preds = %330
  store i32 0, i32* %j, align 4, !llfi_index !927
  br label %335, !llfi_index !928

; <label>:335                                     ; preds = %416, %334
  %336 = load i32* %j, align 4, !llfi_index !929
  %337 = load i32* %nthreads, align 4, !llfi_index !930
  %338 = icmp slt i32 %336, %337, !llfi_index !931
  br i1 %338, label %339, label %419, !llfi_index !932

; <label>:339                                     ; preds = %335
  %340 = load i32* %i, align 4, !llfi_index !933
  %341 = sext i32 %340 to i64, !llfi_index !934
  %342 = load i32* %j, align 4, !llfi_index !935
  %343 = sext i32 %342 to i64, !llfi_index !936
  %344 = load i32*** %partial_new_centers_len, align 8, !llfi_index !937
  %345 = getelementptr inbounds i32** %344, i64 %343, !llfi_index !938
  %346 = load i32** %345, align 8, !llfi_index !939
  %347 = getelementptr inbounds i32* %346, i64 %341, !llfi_index !940
  %348 = load i32* %347, align 4, !llfi_index !941
  %349 = load i32* %i, align 4, !llfi_index !942
  %350 = sext i32 %349 to i64, !llfi_index !943
  %351 = load i32** %new_centers_len, align 8, !llfi_index !944
  %352 = getelementptr inbounds i32* %351, i64 %350, !llfi_index !945
  %353 = load i32* %352, align 4, !llfi_index !946
  %354 = add nsw i32 %353, %348, !llfi_index !947
  store i32 %354, i32* %352, align 4, !llfi_index !948
  %355 = load i32* %i, align 4, !llfi_index !949
  %356 = sext i32 %355 to i64, !llfi_index !950
  %357 = load i32* %j, align 4, !llfi_index !951
  %358 = sext i32 %357 to i64, !llfi_index !952
  %359 = load i32*** %partial_new_centers_len, align 8, !llfi_index !953
  %360 = getelementptr inbounds i32** %359, i64 %358, !llfi_index !954
  %361 = load i32** %360, align 8, !llfi_index !955
  %362 = getelementptr inbounds i32* %361, i64 %356, !llfi_index !956
  store i32 0, i32* %362, align 4, !llfi_index !957
  store i32 0, i32* %k, align 4, !llfi_index !958
  br label %363, !llfi_index !959

; <label>:363                                     ; preds = %414, %339
  %364 = load i32* %k, align 4, !llfi_index !960
  %365 = load i32* %k, align 4, !llfi_index !960
  %366 = load i32* %2, align 4, !llfi_index !961
  %367 = icmp slt i32 %364, %366, !llfi_index !962
  %368 = icmp slt i32 %365, %366, !llfi_index !962
  %check_cmp11 = icmp eq i1 %367, %368
  br i1 %check_cmp11, label %369, label %checkBb12

checkBb12:                                        ; preds = %363
  call void @check_flag()
  br label %369

; <label>:369                                     ; preds = %checkBb12, %363
  br i1 %367, label %370, label %415, !llfi_index !963

; <label>:370                                     ; preds = %369
  %371 = load i32* %k, align 4, !llfi_index !964
  %372 = sext i32 %371 to i64, !llfi_index !965
  %373 = load i32* %i, align 4, !llfi_index !966
  %374 = sext i32 %373 to i64, !llfi_index !967
  %375 = load i32* %j, align 4, !llfi_index !968
  %376 = sext i32 %375 to i64, !llfi_index !969
  %377 = load float**** %partial_new_centers, align 8, !llfi_index !970
  %378 = getelementptr inbounds float*** %377, i64 %376, !llfi_index !971
  %379 = load float*** %378, align 8, !llfi_index !972
  %380 = getelementptr inbounds float** %379, i64 %374, !llfi_index !973
  %381 = load float** %380, align 8, !llfi_index !974
  %382 = getelementptr inbounds float* %381, i64 %372, !llfi_index !975
  %383 = load float* %382, align 4, !llfi_index !976
  %384 = load float* %382, align 4, !llfi_index !976
  %385 = load i32* %k, align 4, !llfi_index !977
  %386 = sext i32 %385 to i64, !llfi_index !978
  %387 = load i32* %i, align 4, !llfi_index !979
  %388 = sext i32 %387 to i64, !llfi_index !980
  %389 = load float*** %new_centers, align 8, !llfi_index !981
  %390 = getelementptr inbounds float** %389, i64 %388, !llfi_index !982
  %391 = load float** %390, align 8, !llfi_index !983
  %392 = getelementptr inbounds float* %391, i64 %386, !llfi_index !984
  %393 = load float* %392, align 4, !llfi_index !985
  %394 = fadd float %393, %383, !llfi_index !986
  %395 = fadd float %393, %384, !llfi_index !986
  %check_cmp13 = fcmp ueq float %394, %395
  br i1 %check_cmp13, label %396, label %checkBb14

checkBb14:                                        ; preds = %370
  call void @check_flag()
  br label %396

; <label>:396                                     ; preds = %checkBb14, %370
  store float %394, float* %392, align 4, !llfi_index !987
  %397 = load i32* %k, align 4, !llfi_index !988
  %398 = sext i32 %397 to i64, !llfi_index !989
  %399 = load i32* %i, align 4, !llfi_index !990
  %400 = sext i32 %399 to i64, !llfi_index !991
  %401 = load i32* %j, align 4, !llfi_index !992
  %402 = sext i32 %401 to i64, !llfi_index !993
  %403 = load float**** %partial_new_centers, align 8, !llfi_index !994
  %404 = getelementptr inbounds float*** %403, i64 %402, !llfi_index !995
  %405 = load float*** %404, align 8, !llfi_index !996
  %406 = getelementptr inbounds float** %405, i64 %400, !llfi_index !997
  %407 = load float** %406, align 8, !llfi_index !998
  %408 = getelementptr inbounds float* %407, i64 %398, !llfi_index !999
  store float 0.000000e+00, float* %408, align 4, !llfi_index !1000
  br label %409, !llfi_index !1001

; <label>:409                                     ; preds = %396
  %410 = load i32* %k, align 4, !llfi_index !1002
  %411 = load i32* %k, align 4, !llfi_index !1002
  %412 = add nsw i32 %410, 1, !llfi_index !1003
  %413 = add nsw i32 %411, 1, !llfi_index !1003
  %check_cmp15 = icmp eq i32 %412, %413
  br i1 %check_cmp15, label %414, label %checkBb16

checkBb16:                                        ; preds = %409
  call void @check_flag()
  br label %414

; <label>:414                                     ; preds = %checkBb16, %409
  store i32 %412, i32* %k, align 4, !llfi_index !1004
  br label %363, !llfi_index !1005

; <label>:415                                     ; preds = %369
  br label %416, !llfi_index !1006

; <label>:416                                     ; preds = %415
  %417 = load i32* %j, align 4, !llfi_index !1007
  %418 = add nsw i32 %417, 1, !llfi_index !1008
  store i32 %418, i32* %j, align 4, !llfi_index !1009
  br label %335, !llfi_index !1010

; <label>:419                                     ; preds = %335
  br label %420, !llfi_index !1011

; <label>:420                                     ; preds = %419
  %421 = load i32* %i, align 4, !llfi_index !1012
  %422 = add nsw i32 %421, 1, !llfi_index !1013
  store i32 %422, i32* %i, align 4, !llfi_index !1014
  br label %330, !llfi_index !1015

; <label>:423                                     ; preds = %330
  store i32 0, i32* %i, align 4, !llfi_index !1016
  br label %424, !llfi_index !1017

; <label>:424                                     ; preds = %492, %423
  %425 = load i32* %i, align 4, !llfi_index !1018
  %426 = load i32* %4, align 4, !llfi_index !1019
  %427 = icmp slt i32 %425, %426, !llfi_index !1020
  br i1 %427, label %428, label %495, !llfi_index !1021

; <label>:428                                     ; preds = %424
  store i32 0, i32* %j, align 4, !llfi_index !1022
  br label %429, !llfi_index !1023

; <label>:429                                     ; preds = %485, %428
  %430 = load i32* %j, align 4, !llfi_index !1024
  %431 = load i32* %j, align 4, !llfi_index !1024
  %432 = load i32* %2, align 4, !llfi_index !1025
  %433 = icmp slt i32 %430, %432, !llfi_index !1026
  %434 = icmp slt i32 %431, %432, !llfi_index !1026
  %check_cmp17 = icmp eq i1 %433, %434
  br i1 %check_cmp17, label %435, label %checkBb18

checkBb18:                                        ; preds = %429
  call void @check_flag()
  br label %435

; <label>:435                                     ; preds = %checkBb18, %429
  br i1 %433, label %436, label %487, !llfi_index !1027

; <label>:436                                     ; preds = %435
  %437 = load i32* %i, align 4, !llfi_index !1028
  %438 = sext i32 %437 to i64, !llfi_index !1029
  %439 = load i32** %new_centers_len, align 8, !llfi_index !1030
  %440 = getelementptr inbounds i32* %439, i64 %438, !llfi_index !1031
  %441 = load i32* %440, align 4, !llfi_index !1032
  %442 = icmp sgt i32 %441, 0, !llfi_index !1033
  br i1 %442, label %443, label %473, !llfi_index !1034

; <label>:443                                     ; preds = %436
  %444 = load i32* %j, align 4, !llfi_index !1035
  %445 = sext i32 %444 to i64, !llfi_index !1036
  %446 = load i32* %i, align 4, !llfi_index !1037
  %447 = sext i32 %446 to i64, !llfi_index !1038
  %448 = load float*** %new_centers, align 8, !llfi_index !1039
  %449 = getelementptr inbounds float** %448, i64 %447, !llfi_index !1040
  %450 = load float** %449, align 8, !llfi_index !1041
  %451 = getelementptr inbounds float* %450, i64 %445, !llfi_index !1042
  %452 = load float* %451, align 4, !llfi_index !1043
  %453 = load float* %451, align 4, !llfi_index !1043
  %454 = load i32* %i, align 4, !llfi_index !1044
  %455 = sext i32 %454 to i64, !llfi_index !1045
  %456 = load i32** %new_centers_len, align 8, !llfi_index !1046
  %457 = getelementptr inbounds i32* %456, i64 %455, !llfi_index !1047
  %458 = load i32* %457, align 4, !llfi_index !1048
  %459 = load i32* %457, align 4, !llfi_index !1048
  %460 = sitofp i32 %458 to float, !llfi_index !1049
  %461 = sitofp i32 %459 to float, !llfi_index !1049
  %462 = fdiv float %452, %460, !llfi_index !1050
  %463 = fdiv float %453, %461, !llfi_index !1050
  %check_cmp19 = fcmp ueq float %462, %463
  br i1 %check_cmp19, label %464, label %checkBb20

checkBb20:                                        ; preds = %443
  call void @check_flag()
  br label %464

; <label>:464                                     ; preds = %checkBb20, %443
  %465 = load i32* %j, align 4, !llfi_index !1051
  %466 = sext i32 %465 to i64, !llfi_index !1052
  %467 = load i32* %i, align 4, !llfi_index !1053
  %468 = sext i32 %467 to i64, !llfi_index !1054
  %469 = load float*** %clusters, align 8, !llfi_index !1055
  %470 = getelementptr inbounds float** %469, i64 %468, !llfi_index !1056
  %471 = load float** %470, align 8, !llfi_index !1057
  %472 = getelementptr inbounds float* %471, i64 %466, !llfi_index !1058
  store float %462, float* %472, align 4, !llfi_index !1059
  br label %473, !llfi_index !1060

; <label>:473                                     ; preds = %464, %436
  %474 = load i32* %j, align 4, !llfi_index !1061
  %475 = sext i32 %474 to i64, !llfi_index !1062
  %476 = load i32* %i, align 4, !llfi_index !1063
  %477 = sext i32 %476 to i64, !llfi_index !1064
  %478 = load float*** %new_centers, align 8, !llfi_index !1065
  %479 = getelementptr inbounds float** %478, i64 %477, !llfi_index !1066
  %480 = load float** %479, align 8, !llfi_index !1067
  %481 = getelementptr inbounds float* %480, i64 %475, !llfi_index !1068
  store float 0.000000e+00, float* %481, align 4, !llfi_index !1069
  br label %482, !llfi_index !1070

; <label>:482                                     ; preds = %473
  %483 = load i32* %j, align 4, !llfi_index !1071
  %484 = load i32* %j, align 4, !llfi_index !1071
  %check_cmp21 = icmp eq i32 %483, %484
  br i1 %check_cmp21, label %485, label %checkBb22

checkBb22:                                        ; preds = %482
  call void @check_flag()
  br label %485

; <label>:485                                     ; preds = %checkBb22, %482
  %486 = add nsw i32 %483, 1, !llfi_index !1072
  store i32 %486, i32* %j, align 4, !llfi_index !1073
  br label %429, !llfi_index !1074

; <label>:487                                     ; preds = %435
  %488 = load i32* %i, align 4, !llfi_index !1075
  %489 = sext i32 %488 to i64, !llfi_index !1076
  %490 = load i32** %new_centers_len, align 8, !llfi_index !1077
  %491 = getelementptr inbounds i32* %490, i64 %489, !llfi_index !1078
  store i32 0, i32* %491, align 4, !llfi_index !1079
  br label %492, !llfi_index !1080

; <label>:492                                     ; preds = %487
  %493 = load i32* %i, align 4, !llfi_index !1081
  %494 = add nsw i32 %493, 1, !llfi_index !1082
  store i32 %494, i32* %i, align 4, !llfi_index !1083
  br label %424, !llfi_index !1084

; <label>:495                                     ; preds = %424
  br label %496, !llfi_index !1085

; <label>:496                                     ; preds = %495
  %497 = load float* %delta, align 4, !llfi_index !1086
  %498 = load float* %5, align 4, !llfi_index !1087
  %499 = fcmp ogt float %497, %498, !llfi_index !1088
  br i1 %499, label %500, label %504, !llfi_index !1089

; <label>:500                                     ; preds = %496
  %501 = load i32* %loop, align 4, !llfi_index !1090
  %502 = add nsw i32 %501, 1, !llfi_index !1091
  store i32 %502, i32* %loop, align 4, !llfi_index !1092
  %503 = icmp slt i32 %501, 500, !llfi_index !1093
  br label %504, !llfi_index !1094

; <label>:504                                     ; preds = %500, %496
  %505 = phi i1 [ false, %496 ], [ %503, %500 ], !llfi_index !1095
  br i1 %505, label %233, label %506, !llfi_index !1096

; <label>:506                                     ; preds = %504
  %507 = load float*** %new_centers, align 8, !llfi_index !1097
  %508 = getelementptr inbounds float** %507, i64 0, !llfi_index !1098
  %509 = load float** %508, align 8, !llfi_index !1099
  %510 = bitcast float* %509 to i8*, !llfi_index !1100
  call void @free(i8* %510) #5, !llfi_index !1101
  %511 = load float*** %new_centers, align 8, !llfi_index !1102
  %512 = bitcast float** %511 to i8*, !llfi_index !1103
  call void @free(i8* %512) #5, !llfi_index !1104
  %513 = load i32** %new_centers_len, align 8, !llfi_index !1105
  %514 = bitcast i32* %513 to i8*, !llfi_index !1106
  call void @free(i8* %514) #5, !llfi_index !1107
  %515 = load float*** %clusters, align 8, !llfi_index !1108
  ret float** %515, !llfi_index !1109
}
