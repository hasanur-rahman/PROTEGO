...
; <label>:10                                      ; preds = %checkBb, %4
  br i1 %8, label %11, label %55, !llfi_index !506
...
; <label>:40                                      ; preds = %checkBb8, %33
  ...
  %43 = fmul float %26, %41, !llfi_index !529
  %44 = load float* %ans, align 4, !llfi_index !530
  %45 = load float* %ans, align 4, !llfi_index !530
  %46 = fadd float %44, %42, !llfi_index !531
  %47 = fadd float %45, %43, !llfi_index !531
  %check_cmp9 = fcmp ueq float %46, %47
...
; <label>:48                                      ; preds = %checkBb10, %40
  store float %46, float* %ans, align 4, !llfi_index !532
  br label %49, !llfi_index !533

; <label>:49                                      ; preds = %48
  %50 = load i32* %i, align 4, !llfi_index !534
  %51 = load i32* %i, align 4, !llfi_index !534
  %52 = add nsw i32 %50, 1, !llfi_index !535
  %53 = add nsw i32 %51, 1, !llfi_index !535
...
; <label>:54                                      ; preds = %checkBb12, %49
  store i32 %52, i32* %i, align 4, !llfi_index !536
  br label %4, !llfi_index !537

; <label>:55                                      ; preds = %10
  %56 = load float* %ans, align 4, !llfi_index !538
  %57 = load float* %ans, align 4, !llfi_index !538
