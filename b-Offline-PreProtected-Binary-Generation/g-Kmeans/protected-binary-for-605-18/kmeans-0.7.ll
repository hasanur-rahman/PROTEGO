...
; <label>:25                                      ; preds = %checkBb4, %18
  ...
  %41 = fmul float %26, %39, !llfi_index !529
  %42 = fmul float %26, %40, !llfi_index !529
  %43 = load float* %ans, align 4, !llfi_index !530
  %44 = load float* %ans, align 4, !llfi_index !530
  %45 = fadd float %43, %41, !llfi_index !531
  %46 = fadd float %44, %42, !llfi_index !531
  %check_cmp5 = fcmp ueq float %45, %46
...
; <label>:54                                      ; preds = %10
  ...
  %check_cmp9 = fcmp ueq float %55, %56
