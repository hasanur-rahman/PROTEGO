...
; <label>:11                                      ; preds = %checkBb, %5
  br i1 %9, label %12, label %40, !llfi_index !466
...
; <label>:34                                      ; preds = %33
  ...
  %38 = add nsw i32 %36, 1, !llfi_index !487
...
; <label>:39                                      ; preds = %checkBb6, %34
  store i32 %37, i32* %i, align 4, !llfi_index !488
  br label %5, !llfi_index !489

; <label>:40                                      ; preds = %11
  %41 = load i32* %index, align 4, !llfi_index !490
  ret i32 %41, !llfi_index !491
}
...
; <label>:7                                       ; preds = %checkBb, %4
  ...
  br i1 %9, label %10, label %43, !llfi_index !506
...
; <label>:10                                      ; preds = %7
  ...
  %27 = load float* %25, align 4, !llfi_index !522
  %check_cmp1 = fcmp ueq float %26, %27
...
; <label>:35                                      ; preds = %checkBb4, %28
  %36 = fsub float %26, %33, !llfi_index !528
  %37 = fmul float %21, %36, !llfi_index !529
...
; <label>:364                                     ; preds = %415, %340
  %365 = load i32* %k, align 4, !llfi_index !960
  %366 = load i32* %k, align 4, !llfi_index !960
  %367 = load i32* %2, align 4, !llfi_index !961
  %368 = icmp slt i32 %365, %367, !llfi_index !962
  %369 = icmp slt i32 %366, %367, !llfi_index !962
  %check_cmp11 = icmp eq i1 %368, %369
  br i1 %check_cmp11, label %370, label %checkBb12

checkBb12:                                        ; preds = %364
  call void @check_flag()
  br label %370

; <label>:370                                     ; preds = %checkBb12, %364
  br i1 %368, label %371, label %416, !llfi_index !963

; <label>:371                                     ; preds = %370
  %372 = load i32* %k, align 4, !llfi_index !964
  %373 = sext i32 %372 to i64, !llfi_index !965
  %374 = load i32* %i, align 4, !llfi_index !966
  %375 = sext i32 %374 to i64, !llfi_index !967
  %376 = load i32* %j, align 4, !llfi_index !968
  %377 = sext i32 %376 to i64, !llfi_index !969
  %378 = load float**** %partial_new_centers, align 8, !llfi_index !970
  %379 = getelementptr inbounds float*** %378, i64 %377, !llfi_index !971
  %380 = load float*** %379, align 8, !llfi_index !972
  %381 = getelementptr inbounds float** %380, i64 %375, !llfi_index !973
  %382 = load float** %381, align 8, !llfi_index !974
  %383 = getelementptr inbounds float* %382, i64 %373, !llfi_index !975
  %384 = load float* %383, align 4, !llfi_index !976
  %385 = load float* %383, align 4, !llfi_index !976
  %386 = load i32* %k, align 4, !llfi_index !977
  %387 = sext i32 %386 to i64, !llfi_index !978
  %388 = load i32* %i, align 4, !llfi_index !979
  %389 = sext i32 %388 to i64, !llfi_index !980
  %390 = load float*** %new_centers, align 8, !llfi_index !981
  %391 = getelementptr inbounds float** %390, i64 %389, !llfi_index !982
  %392 = load float** %391, align 8, !llfi_index !983
  %393 = getelementptr inbounds float* %392, i64 %387, !llfi_index !984
  %394 = load float* %393, align 4, !llfi_index !985
  %395 = fadd float %394, %384, !llfi_index !986
  %396 = fadd float %394, %385, !llfi_index !986
  %check_cmp13 = fcmp ueq float %395, %396
  br i1 %check_cmp13, label %397, label %checkBb14

checkBb14:                                        ; preds = %371
  call void @check_flag()
  br label %397

; <label>:397                                     ; preds = %checkBb14, %371
  store float %395, float* %393, align 4, !llfi_index !987
  %398 = load i32* %k, align 4, !llfi_index !988
  %399 = sext i32 %398 to i64, !llfi_index !989
  %400 = load i32* %i, align 4, !llfi_index !990
  %401 = sext i32 %400 to i64, !llfi_index !991
  %402 = load i32* %j, align 4, !llfi_index !992
  %403 = sext i32 %402 to i64, !llfi_index !993
  %404 = load float**** %partial_new_centers, align 8, !llfi_index !994
  %405 = getelementptr inbounds float*** %404, i64 %403, !llfi_index !995
  %406 = load float*** %405, align 8, !llfi_index !996
  %407 = getelementptr inbounds float** %406, i64 %401, !llfi_index !997
  %408 = load float** %407, align 8, !llfi_index !998
  %409 = getelementptr inbounds float* %408, i64 %399, !llfi_index !999
  store float 0.000000e+00, float* %409, align 4, !llfi_index !1000
  br label %410, !llfi_index !1001

; <label>:410                                     ; preds = %397
  %411 = load i32* %k, align 4, !llfi_index !1002
  %412 = load i32* %k, align 4, !llfi_index !1002
  %413 = add nsw i32 %411, 1, !llfi_index !1003
  %414 = add nsw i32 %412, 1, !llfi_index !1003
  %check_cmp15 = icmp eq i32 %413, %414
  br i1 %check_cmp15, label %415, label %checkBb16

checkBb16:                                        ; preds = %410
  call void @check_flag()
  br label %415

; <label>:415                                     ; preds = %checkBb16, %410
  store i32 %413, i32* %k, align 4, !llfi_index !1004
  br label %364, !llfi_index !1005

; <label>:416                                     ; preds = %370
  br label %417, !llfi_index !1006

; <label>:417                                     ; preds = %416
  %418 = load i32* %j, align 4, !llfi_index !1007
  %419 = add nsw i32 %418, 1, !llfi_index !1008
  store i32 %419, i32* %j, align 4, !llfi_index !1009
  br label %336, !llfi_index !1010

; <label>:420                                     ; preds = %336
  br label %421, !llfi_index !1011

; <label>:421                                     ; preds = %420
  %422 = load i32* %i, align 4, !llfi_index !1012
  %423 = add nsw i32 %422, 1, !llfi_index !1013
  store i32 %423, i32* %i, align 4, !llfi_index !1014
  br label %331, !llfi_index !1015

; <label>:424                                     ; preds = %331
  store i32 0, i32* %i, align 4, !llfi_index !1016
  br label %425, !llfi_index !1017

; <label>:425                                     ; preds = %496, %424
  %426 = load i32* %i, align 4, !llfi_index !1018
  %427 = load i32* %4, align 4, !llfi_index !1019
  %428 = icmp slt i32 %426, %427, !llfi_index !1020
  br i1 %428, label %429, label %499, !llfi_index !1021

; <label>:429                                     ; preds = %425
  store i32 0, i32* %j, align 4, !llfi_index !1022
  br label %430, !llfi_index !1023

; <label>:430                                     ; preds = %490, %429
  %431 = load i32* %j, align 4, !llfi_index !1024
  %432 = load i32* %j, align 4, !llfi_index !1024
  %433 = load i32* %2, align 4, !llfi_index !1025
  %434 = icmp slt i32 %431, %433, !llfi_index !1026
  %435 = icmp slt i32 %432, %433, !llfi_index !1026
