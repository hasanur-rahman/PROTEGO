...
; <label>:198                                     ; preds = %238, %207, %196
  ...
  br i1 %202, label %203, label %239, !llfi_index !272
...
; <label>:215                                     ; preds = %checkBb, %209
  br i1 %213, label %216, label %238, !llfi_index !283
...
; <label>:221                                     ; preds = %checkBb2, %216
  ...
  %check_cmp3 = icmp eq i32 %222, %223
  br i1 %check_cmp3, label %224, label %checkBb4

checkBb4:                                         ; preds = %221
  call void @check_flag()
  br label %224

; <label>:224                                     ; preds = %checkBb4, %221
  %225 = sext i32 %222 to i64, !llfi_index !288
  %226 = load float** %buf, align 8, !llfi_index !289
  %227 = getelementptr inbounds float* %226, i64 %225, !llfi_index !290
  store float %219, float* %227, align 4, !llfi_index !291
  %228 = load i32* %i, align 4, !llfi_index !292
  %229 = load i32* %i, align 4, !llfi_index !292
  %check_cmp5 = icmp eq i32 %228, %229
  br i1 %check_cmp5, label %230, label %checkBb6

checkBb6:                                         ; preds = %224
  call void @check_flag()
  br label %230

; <label>:230                                     ; preds = %checkBb6, %224
  %231 = add nsw i32 %228, 1, !llfi_index !293
  store i32 %231, i32* %i, align 4, !llfi_index !294
  br label %232, !llfi_index !295

; <label>:232                                     ; preds = %230
  %233 = load i32* %j, align 4, !llfi_index !296
  %234 = load i32* %j, align 4, !llfi_index !296
  %235 = add nsw i32 %233, 1, !llfi_index !297
  %236 = add nsw i32 %234, 1, !llfi_index !297
  %check_cmp7 = icmp eq i32 %235, %236
  br i1 %check_cmp7, label %237, label %checkBb8

checkBb8:                                         ; preds = %232
  call void @check_flag()
  br label %237

; <label>:237                                     ; preds = %checkBb8, %232
  store i32 %235, i32* %j, align 4, !llfi_index !298
...
; <label>:239                                     ; preds = %198
  %240 = load %struct._IO_FILE** %infile1, align 8, !llfi_index !301
  %241 = call i32 @fclose(%struct._IO_FILE* %240), !llfi_index !302
  br label %242, !llfi_index !303

; <label>:242                                     ; preds = %239, %97
  %243 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str8, i32 0, i32 0)), !llfi_index !304
  %244 = load float*** %attributes, align 8, !llfi_index !305
  %245 = getelementptr inbounds float** %244, i64 0, !llfi_index !306
  %246 = load float** %245, align 8, !llfi_index !307
  %247 = bitcast float* %246 to i8*, !llfi_index !308
  %248 = load float** %buf, align 8, !llfi_index !309
  %249 = bitcast float* %248 to i8*, !llfi_index !310
  %250 = load i32* %numObjects, align 4, !llfi_index !311
  %251 = load i32* %numAttributes, align 4, !llfi_index !312
  %252 = mul nsw i32 %250, %251, !llfi_index !313
  %253 = sext i32 %252 to i64, !llfi_index !314
  %254 = mul i64 %253, 4, !llfi_index !315
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %247, i8* %249, i64 %254, i32 4, i1 false), !llfi_index !316
  store i32 0, i32* %i, align 4, !llfi_index !317
  br label %255, !llfi_index !318

; <label>:255                                     ; preds = %266, %242
  %256 = load i32* %i, align 4, !llfi_index !319
  %257 = load i32* %nloops, align 4, !llfi_index !320
  %258 = icmp slt i32 %256, %257, !llfi_index !321
  br i1 %258, label %259, label %269, !llfi_index !322

; <label>:259                                     ; preds = %255
  store float** null, float*** %cluster_centres, align 8, !llfi_index !323
  %260 = load i32* %numObjects, align 4, !llfi_index !324
  %261 = load i32* %numAttributes, align 4, !llfi_index !325
  %262 = load float*** %attributes, align 8, !llfi_index !326
  %263 = load i32* %nclusters, align 4, !llfi_index !327
  %264 = load float* %threshold, align 4, !llfi_index !328
  %265 = call i32 @cluster(i32 %260, i32 %261, float** %262, i32 %263, float %264, float*** %cluster_centres), !llfi_index !329
  br label %266, !llfi_index !330

; <label>:266                                     ; preds = %259
  %267 = load i32* %i, align 4, !llfi_index !331
  %268 = add nsw i32 %267, 1, !llfi_index !332
  store i32 %268, i32* %i, align 4, !llfi_index !333
  br label %255, !llfi_index !334

; <label>:269                                     ; preds = %255
  %270 = load i32* %nclusters, align 4, !llfi_index !335
  %271 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str9, i32 0, i32 0), i32 %270), !llfi_index !336
  %272 = load i32* %numAttributes, align 4, !llfi_index !337
  %273 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([26 x i8]* @.str10, i32 0, i32 0), i32 %272), !llfi_index !338
  %274 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([11 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8]* @.str123, i32 0, i32 0)), !llfi_index !339
  store %struct._IO_FILE* %274, %struct._IO_FILE** %file, align 8, !llfi_index !340
  store i32 0, i32* %i, align 4, !llfi_index !341
  br label %275, !llfi_index !342

; <label>:275                                     ; preds = %306, %269
  %276 = load i32* %i, align 4, !llfi_index !343
  %277 = load i32* %nclusters, align 4, !llfi_index !344
  %278 = icmp slt i32 %276, %277, !llfi_index !345
  br i1 %278, label %279, label %309, !llfi_index !346

; <label>:279                                     ; preds = %275
  %280 = load %struct._IO_FILE** %file, align 8, !llfi_index !347
  %281 = load i32* %i, align 4, !llfi_index !348
  %282 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %280, i8* getelementptr inbounds ([5 x i8]* @.str13, i32 0, i32 0), i32 %281), !llfi_index !349
  store i32 0, i32* %j, align 4, !llfi_index !350
  br label %283, !llfi_index !351

; <label>:283                                     ; preds = %300, %279
  %284 = load i32* %j, align 4, !llfi_index !352
  %285 = load i32* %numAttributes, align 4, !llfi_index !353
  %286 = icmp slt i32 %284, %285, !llfi_index !354
  br i1 %286, label %287, label %303, !llfi_index !355

; <label>:287                                     ; preds = %283
  %288 = load %struct._IO_FILE** %file, align 8, !llfi_index !356
  %289 = load i32* %j, align 4, !llfi_index !357
  %290 = sext i32 %289 to i64, !llfi_index !358
  %291 = load i32* %i, align 4, !llfi_index !359
  %292 = sext i32 %291 to i64, !llfi_index !360
  %293 = load float*** %cluster_centres, align 8, !llfi_index !361
  %294 = getelementptr inbounds float** %293, i64 %292, !llfi_index !362
  %295 = load float** %294, align 8, !llfi_index !363
  %296 = getelementptr inbounds float* %295, i64 %290, !llfi_index !364
  %297 = load float* %296, align 4, !llfi_index !365
  %298 = fpext float %297 to double, !llfi_index !366
  %299 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %288, i8* getelementptr inbounds ([6 x i8]* @.str14, i32 0, i32 0), double %298), !llfi_index !367
  br label %300, !llfi_index !368

; <label>:300                                     ; preds = %287
  %301 = load i32* %j, align 4, !llfi_index !369
  %302 = add nsw i32 %301, 1, !llfi_index !370
  store i32 %302, i32* %j, align 4, !llfi_index !371
  br label %283, !llfi_index !372

; <label>:303                                     ; preds = %283
  %304 = load %struct._IO_FILE** %file, align 8, !llfi_index !373
  %305 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %304, i8* getelementptr inbounds ([3 x i8]* @.str15, i32 0, i32 0)), !llfi_index !374
  br label %306, !llfi_index !375

; <label>:306                                     ; preds = %303
  %307 = load i32* %i, align 4, !llfi_index !376
  %308 = add nsw i32 %307, 1, !llfi_index !377
  store i32 %308, i32* %i, align 4, !llfi_index !378
  br label %275, !llfi_index !379

; <label>:309                                     ; preds = %275
  %310 = load %struct._IO_FILE** %file, align 8, !llfi_index !380
  %311 = call i32 @fclose(%struct._IO_FILE* %310), !llfi_index !381
  %312 = load float*** %attributes, align 8, !llfi_index !382
  %313 = bitcast float** %312 to i8*, !llfi_index !383
  call void @free(i8* %313) #5, !llfi_index !384
  %314 = load float*** %cluster_centres, align 8, !llfi_index !385
  %315 = getelementptr inbounds float** %314, i64 0, !llfi_index !386
  %316 = load float** %315, align 8, !llfi_index !387
  %317 = bitcast float* %316 to i8*, !llfi_index !388
  call void @free(i8* %317) #5, !llfi_index !389
  %318 = load float*** %cluster_centres, align 8, !llfi_index !390
  %319 = bitcast float** %318 to i8*, !llfi_index !391
  call void @free(i8* %319) #5, !llfi_index !392
  %320 = load float** %buf, align 8, !llfi_index !393
  %321 = bitcast float* %320 to i8*, !llfi_index !394
  call void @free(i8* %321) #5, !llfi_index !395
...
; <label>:7                                       ; preds = %checkBb, %4
  %8 = load i32* %3, align 4, !llfi_index !504
  %9 = icmp slt i32 %5, %8, !llfi_index !505
  br i1 %9, label %10, label %42, !llfi_index !506
...
; <label>:320                                     ; preds = %checkBb8, %317
  %321 = add nsw i32 %318, 1, !llfi_index !913
  store i32 %321, i32* %j, align 4, !llfi_index !914
