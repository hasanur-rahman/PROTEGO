...
; <label>:198                                     ; preds = %242, %207, %196
  ...
  br i1 %202, label %203, label %243, !llfi_index !272
...
; <label>:215                                     ; preds = %checkBb, %209
  br i1 %213, label %216, label %242, !llfi_index !283
...
; <label>:216                                     ; preds = %215
  ...
  %220 = fptrunc double %218 to float, !llfi_index !286
  %check_cmp1 = fcmp ueq float %219, %220
  br i1 %check_cmp1, label %221, label %checkBb2

checkBb2:                                         ; preds = %216
  call void @check_flag()
  br label %221

; <label>:221                                     ; preds = %checkBb2, %216
  %222 = load i32* %i, align 4, !llfi_index !287
  %223 = load i32* %i, align 4, !llfi_index !287
  %224 = sext i32 %222 to i64, !llfi_index !288
  %225 = sext i32 %223 to i64, !llfi_index !288
  %226 = load float** %buf, align 8, !llfi_index !289
  %227 = load float** %buf, align 8, !llfi_index !289
  %228 = getelementptr inbounds float* %226, i64 %224, !llfi_index !290
  %229 = getelementptr inbounds float* %227, i64 %225, !llfi_index !290
  %check_cmp3 = icmp eq float* %228, %229
  br i1 %check_cmp3, label %230, label %checkBb4

checkBb4:                                         ; preds = %221
  call void @check_flag()
  br label %230

; <label>:230                                     ; preds = %checkBb4, %221
  store float %219, float* %228, align 4, !llfi_index !291
  %231 = load i32* %i, align 4, !llfi_index !292
  %232 = load i32* %i, align 4, !llfi_index !292
  %233 = add nsw i32 %231, 1, !llfi_index !293
...
; <label>:235                                     ; preds = %checkBb6, %230
  store i32 %233, i32* %i, align 4, !llfi_index !294
  br label %236, !llfi_index !295

; <label>:236                                     ; preds = %235
  %237 = load i32* %j, align 4, !llfi_index !296
  %238 = load i32* %j, align 4, !llfi_index !296
  %239 = add nsw i32 %237, 1, !llfi_index !297
  %240 = add nsw i32 %238, 1, !llfi_index !297
  %check_cmp7 = icmp eq i32 %239, %240
  br i1 %check_cmp7, label %241, label %checkBb8

checkBb8:                                         ; preds = %236
  call void @check_flag()
  br label %241

; <label>:241                                     ; preds = %checkBb8, %236
  store i32 %239, i32* %j, align 4, !llfi_index !298
...
; <label>:243                                     ; preds = %198
  %244 = load %struct._IO_FILE** %infile1, align 8, !llfi_index !301
  %245 = call i32 @fclose(%struct._IO_FILE* %244), !llfi_index !302
  br label %246, !llfi_index !303

; <label>:246                                     ; preds = %243, %97
  %247 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str8, i32 0, i32 0)), !llfi_index !304
  %248 = load float*** %attributes, align 8, !llfi_index !305
  %249 = getelementptr inbounds float** %248, i64 0, !llfi_index !306
  %250 = load float** %249, align 8, !llfi_index !307
  %251 = bitcast float* %250 to i8*, !llfi_index !308
  %252 = load float** %buf, align 8, !llfi_index !309
  %253 = bitcast float* %252 to i8*, !llfi_index !310
  %254 = load i32* %numObjects, align 4, !llfi_index !311
  %255 = load i32* %numAttributes, align 4, !llfi_index !312
  %256 = mul nsw i32 %254, %255, !llfi_index !313
  %257 = sext i32 %256 to i64, !llfi_index !314
  %258 = mul i64 %257, 4, !llfi_index !315
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %251, i8* %253, i64 %258, i32 4, i1 false), !llfi_index !316
  store i32 0, i32* %i, align 4, !llfi_index !317
  br label %259, !llfi_index !318

; <label>:259                                     ; preds = %270, %246
  %260 = load i32* %i, align 4, !llfi_index !319
  %261 = load i32* %nloops, align 4, !llfi_index !320
  %262 = icmp slt i32 %260, %261, !llfi_index !321
  br i1 %262, label %263, label %273, !llfi_index !322

; <label>:263                                     ; preds = %259
  store float** null, float*** %cluster_centres, align 8, !llfi_index !323
  %264 = load i32* %numObjects, align 4, !llfi_index !324
  %265 = load i32* %numAttributes, align 4, !llfi_index !325
  %266 = load float*** %attributes, align 8, !llfi_index !326
  %267 = load i32* %nclusters, align 4, !llfi_index !327
  %268 = load float* %threshold, align 4, !llfi_index !328
  %269 = call i32 @cluster(i32 %264, i32 %265, float** %266, i32 %267, float %268, float*** %cluster_centres), !llfi_index !329
  br label %270, !llfi_index !330

; <label>:270                                     ; preds = %263
  %271 = load i32* %i, align 4, !llfi_index !331
  %272 = add nsw i32 %271, 1, !llfi_index !332
  store i32 %272, i32* %i, align 4, !llfi_index !333
  br label %259, !llfi_index !334

; <label>:273                                     ; preds = %259
  %274 = load i32* %nclusters, align 4, !llfi_index !335
  %275 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str9, i32 0, i32 0), i32 %274), !llfi_index !336
  %276 = load i32* %numAttributes, align 4, !llfi_index !337
  %277 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([26 x i8]* @.str10, i32 0, i32 0), i32 %276), !llfi_index !338
  %278 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([11 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8]* @.str123, i32 0, i32 0)), !llfi_index !339
  store %struct._IO_FILE* %278, %struct._IO_FILE** %file, align 8, !llfi_index !340
  store i32 0, i32* %i, align 4, !llfi_index !341
  br label %279, !llfi_index !342

; <label>:279                                     ; preds = %310, %273
  %280 = load i32* %i, align 4, !llfi_index !343
  %281 = load i32* %nclusters, align 4, !llfi_index !344
  %282 = icmp slt i32 %280, %281, !llfi_index !345
  br i1 %282, label %283, label %313, !llfi_index !346

; <label>:283                                     ; preds = %279
  %284 = load %struct._IO_FILE** %file, align 8, !llfi_index !347
  %285 = load i32* %i, align 4, !llfi_index !348
  %286 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %284, i8* getelementptr inbounds ([5 x i8]* @.str13, i32 0, i32 0), i32 %285), !llfi_index !349
  store i32 0, i32* %j, align 4, !llfi_index !350
  br label %287, !llfi_index !351

; <label>:287                                     ; preds = %304, %283
  %288 = load i32* %j, align 4, !llfi_index !352
  %289 = load i32* %numAttributes, align 4, !llfi_index !353
  %290 = icmp slt i32 %288, %289, !llfi_index !354
  br i1 %290, label %291, label %307, !llfi_index !355

; <label>:291                                     ; preds = %287
  %292 = load %struct._IO_FILE** %file, align 8, !llfi_index !356
  %293 = load i32* %j, align 4, !llfi_index !357
  %294 = sext i32 %293 to i64, !llfi_index !358
  %295 = load i32* %i, align 4, !llfi_index !359
  %296 = sext i32 %295 to i64, !llfi_index !360
  %297 = load float*** %cluster_centres, align 8, !llfi_index !361
  %298 = getelementptr inbounds float** %297, i64 %296, !llfi_index !362
  %299 = load float** %298, align 8, !llfi_index !363
  %300 = getelementptr inbounds float* %299, i64 %294, !llfi_index !364
  %301 = load float* %300, align 4, !llfi_index !365
  %302 = fpext float %301 to double, !llfi_index !366
  %303 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %292, i8* getelementptr inbounds ([6 x i8]* @.str14, i32 0, i32 0), double %302), !llfi_index !367
  br label %304, !llfi_index !368

; <label>:304                                     ; preds = %291
  %305 = load i32* %j, align 4, !llfi_index !369
  %306 = add nsw i32 %305, 1, !llfi_index !370
  store i32 %306, i32* %j, align 4, !llfi_index !371
  br label %287, !llfi_index !372

; <label>:307                                     ; preds = %287
  %308 = load %struct._IO_FILE** %file, align 8, !llfi_index !373
  %309 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %308, i8* getelementptr inbounds ([3 x i8]* @.str15, i32 0, i32 0)), !llfi_index !374
  br label %310, !llfi_index !375

; <label>:310                                     ; preds = %307
  %311 = load i32* %i, align 4, !llfi_index !376
  %312 = add nsw i32 %311, 1, !llfi_index !377
  store i32 %312, i32* %i, align 4, !llfi_index !378
  br label %279, !llfi_index !379

; <label>:313                                     ; preds = %279
  %314 = load %struct._IO_FILE** %file, align 8, !llfi_index !380
  %315 = call i32 @fclose(%struct._IO_FILE* %314), !llfi_index !381
  %316 = load float*** %attributes, align 8, !llfi_index !382
  %317 = bitcast float** %316 to i8*, !llfi_index !383
  call void @free(i8* %317) #5, !llfi_index !384
  %318 = load float*** %cluster_centres, align 8, !llfi_index !385
  %319 = getelementptr inbounds float** %318, i64 0, !llfi_index !386
  %320 = load float** %319, align 8, !llfi_index !387
  %321 = bitcast float* %320 to i8*, !llfi_index !388
  call void @free(i8* %321) #5, !llfi_index !389
  %322 = load float*** %cluster_centres, align 8, !llfi_index !390
  %323 = bitcast float** %322 to i8*, !llfi_index !391
  call void @free(i8* %323) #5, !llfi_index !392
  %324 = load float** %buf, align 8, !llfi_index !393
  %325 = bitcast float* %324 to i8*, !llfi_index !394
  call void @free(i8* %325) #5, !llfi_index !395
...
; <label>:8                                       ; preds = %checkBb, %5
  ...
  br i1 %10, label %11, label %37, !llfi_index !466
...
; <label>:24                                      ; preds = %checkBb2, %11
  br i1 %22, label %25, label %30, !llfi_index !479

; <label>:25                                      ; preds = %24
  %26 = load float* %dist, align 4, !llfi_index !480
  %27 = load float* %dist, align 4, !llfi_index !480
  %check_cmp3 = fcmp ueq float %26, %27
...
; <label>:28                                      ; preds = %checkBb4, %25
  ...
  %29 = load i32* %i, align 4, !llfi_index !482
  store i32 %29, i32* %index, align 4, !llfi_index !483
  br label %30, !llfi_index !484

; <label>:30                                      ; preds = %28, %24
  br label %31, !llfi_index !485

; <label>:31                                      ; preds = %30
  %32 = load i32* %i, align 4, !llfi_index !486
  %33 = load i32* %i, align 4, !llfi_index !486
  %34 = add nsw i32 %32, 1, !llfi_index !487
  %35 = add nsw i32 %33, 1, !llfi_index !487
...
; <label>:36                                      ; preds = %checkBb6, %31
  store i32 %34, i32* %i, align 4, !llfi_index !488
  br label %5, !llfi_index !489

; <label>:37                                      ; preds = %8
  %38 = load i32* %index, align 4, !llfi_index !490
  ret i32 %38, !llfi_index !491
}
...
; <label>:4                                       ; preds = %38, %0
  ...
  br i1 %7, label %8, label %41, !llfi_index !506
...
; <label>:22                                      ; preds = %checkBb2, %15
  %23 = fsub float %13, %20, !llfi_index !517
  ...
  %34 = fsub float %28, %33, !llfi_index !528
  %35 = fmul float %23, %34, !llfi_index !529
  %36 = load float* %ans, align 4, !llfi_index !530
  %37 = fadd float %36, %35, !llfi_index !531
  store float %37, float* %ans, align 4, !llfi_index !532
...
; <label>:41                                      ; preds = %4
  %42 = load float* %ans, align 4, !llfi_index !538
  ret float %42, !llfi_index !539
}
...
; <label>:282                                     ; preds = %321, %281
  ...
  %284 = load i32* %2, align 4, !llfi_index !884
  %285 = icmp slt i32 %283, %284, !llfi_index !885
  %286 = icmp slt i32 %283, %284, !llfi_index !885
  %check_cmp3 = icmp eq i1 %285, %286
  br i1 %check_cmp3, label %287, label %checkBb4

checkBb4:                                         ; preds = %282
  call void @check_flag()
  br label %287

; <label>:287                                     ; preds = %checkBb4, %282
  br i1 %285, label %288, label %322, !llfi_index !886
...
; <label>:363                                     ; preds = %403, %339
  %364 = load i32* %k, align 4, !llfi_index !960
  %365 = load i32* %2, align 4, !llfi_index !961
  %366 = icmp slt i32 %364, %365, !llfi_index !962
  br i1 %366, label %367, label %406, !llfi_index !963

; <label>:367                                     ; preds = %363
  %368 = load i32* %k, align 4, !llfi_index !964
  %369 = sext i32 %368 to i64, !llfi_index !965
  %370 = load i32* %i, align 4, !llfi_index !966
  %371 = sext i32 %370 to i64, !llfi_index !967
  %372 = load i32* %j, align 4, !llfi_index !968
  %373 = sext i32 %372 to i64, !llfi_index !969
  %374 = load float**** %partial_new_centers, align 8, !llfi_index !970
  %375 = getelementptr inbounds float*** %374, i64 %373, !llfi_index !971
  %376 = load float*** %375, align 8, !llfi_index !972
  %377 = getelementptr inbounds float** %376, i64 %371, !llfi_index !973
  %378 = load float** %377, align 8, !llfi_index !974
  %379 = getelementptr inbounds float* %378, i64 %369, !llfi_index !975
  %380 = load float* %379, align 4, !llfi_index !976
  %381 = load i32* %k, align 4, !llfi_index !977
  %382 = sext i32 %381 to i64, !llfi_index !978
  %383 = load i32* %i, align 4, !llfi_index !979
  %384 = sext i32 %383 to i64, !llfi_index !980
  %385 = load float*** %new_centers, align 8, !llfi_index !981
  %386 = getelementptr inbounds float** %385, i64 %384, !llfi_index !982
  %387 = load float** %386, align 8, !llfi_index !983
  %388 = getelementptr inbounds float* %387, i64 %382, !llfi_index !984
  %389 = load float* %388, align 4, !llfi_index !985
  %390 = fadd float %389, %380, !llfi_index !986
  store float %390, float* %388, align 4, !llfi_index !987
  %391 = load i32* %k, align 4, !llfi_index !988
  %392 = sext i32 %391 to i64, !llfi_index !989
  %393 = load i32* %i, align 4, !llfi_index !990
  %394 = sext i32 %393 to i64, !llfi_index !991
  %395 = load i32* %j, align 4, !llfi_index !992
  %396 = sext i32 %395 to i64, !llfi_index !993
  %397 = load float**** %partial_new_centers, align 8, !llfi_index !994
  %398 = getelementptr inbounds float*** %397, i64 %396, !llfi_index !995
  %399 = load float*** %398, align 8, !llfi_index !996
  %400 = getelementptr inbounds float** %399, i64 %394, !llfi_index !997
  %401 = load float** %400, align 8, !llfi_index !998
  %402 = getelementptr inbounds float* %401, i64 %392, !llfi_index !999
  store float 0.000000e+00, float* %402, align 4, !llfi_index !1000
  br label %403, !llfi_index !1001

; <label>:403                                     ; preds = %367
  %404 = load i32* %k, align 4, !llfi_index !1002
  %405 = add nsw i32 %404, 1, !llfi_index !1003
  store i32 %405, i32* %k, align 4, !llfi_index !1004
  br label %363, !llfi_index !1005

; <label>:406                                     ; preds = %363
  br label %407, !llfi_index !1006

; <label>:407                                     ; preds = %406
  %408 = load i32* %j, align 4, !llfi_index !1007
  %409 = add nsw i32 %408, 1, !llfi_index !1008
  store i32 %409, i32* %j, align 4, !llfi_index !1009
  br label %335, !llfi_index !1010

; <label>:410                                     ; preds = %335
  br label %411, !llfi_index !1011

; <label>:411                                     ; preds = %410
  %412 = load i32* %i, align 4, !llfi_index !1012
  %413 = add nsw i32 %412, 1, !llfi_index !1013
  store i32 %413, i32* %i, align 4, !llfi_index !1014
  br label %330, !llfi_index !1015

; <label>:414                                     ; preds = %330
  store i32 0, i32* %i, align 4, !llfi_index !1016
  br label %415, !llfi_index !1017

; <label>:415                                     ; preds = %473, %414
  %416 = load i32* %i, align 4, !llfi_index !1018
  %417 = load i32* %4, align 4, !llfi_index !1019
  %418 = icmp slt i32 %416, %417, !llfi_index !1020
  br i1 %418, label %419, label %476, !llfi_index !1021

; <label>:419                                     ; preds = %415
  store i32 0, i32* %j, align 4, !llfi_index !1022
  br label %420, !llfi_index !1023

; <label>:420                                     ; preds = %465, %419
  %421 = load i32* %j, align 4, !llfi_index !1024
  %422 = load i32* %2, align 4, !llfi_index !1025
  %423 = icmp slt i32 %421, %422, !llfi_index !1026
  br i1 %423, label %424, label %468, !llfi_index !1027

; <label>:424                                     ; preds = %420
  %425 = load i32* %i, align 4, !llfi_index !1028
  %426 = sext i32 %425 to i64, !llfi_index !1029
  %427 = load i32** %new_centers_len, align 8, !llfi_index !1030
  %428 = getelementptr inbounds i32* %427, i64 %426, !llfi_index !1031
  %429 = load i32* %428, align 4, !llfi_index !1032
  %430 = icmp sgt i32 %429, 0, !llfi_index !1033
  br i1 %430, label %431, label %456, !llfi_index !1034

; <label>:431                                     ; preds = %424
  %432 = load i32* %j, align 4, !llfi_index !1035
  %433 = sext i32 %432 to i64, !llfi_index !1036
  %434 = load i32* %i, align 4, !llfi_index !1037
  %435 = sext i32 %434 to i64, !llfi_index !1038
  %436 = load float*** %new_centers, align 8, !llfi_index !1039
  %437 = getelementptr inbounds float** %436, i64 %435, !llfi_index !1040
  %438 = load float** %437, align 8, !llfi_index !1041
  %439 = getelementptr inbounds float* %438, i64 %433, !llfi_index !1042
  %440 = load float* %439, align 4, !llfi_index !1043
  %441 = load i32* %i, align 4, !llfi_index !1044
  %442 = sext i32 %441 to i64, !llfi_index !1045
  %443 = load i32** %new_centers_len, align 8, !llfi_index !1046
  %444 = getelementptr inbounds i32* %443, i64 %442, !llfi_index !1047
  %445 = load i32* %444, align 4, !llfi_index !1048
  %446 = sitofp i32 %445 to float, !llfi_index !1049
  %447 = fdiv float %440, %446, !llfi_index !1050
  %448 = load i32* %j, align 4, !llfi_index !1051
  %449 = sext i32 %448 to i64, !llfi_index !1052
  %450 = load i32* %i, align 4, !llfi_index !1053
  %451 = sext i32 %450 to i64, !llfi_index !1054
  %452 = load float*** %clusters, align 8, !llfi_index !1055
  %453 = getelementptr inbounds float** %452, i64 %451, !llfi_index !1056
  %454 = load float** %453, align 8, !llfi_index !1057
  %455 = getelementptr inbounds float* %454, i64 %449, !llfi_index !1058
  store float %447, float* %455, align 4, !llfi_index !1059
  br label %456, !llfi_index !1060

; <label>:456                                     ; preds = %431, %424
  %457 = load i32* %j, align 4, !llfi_index !1061
  %458 = sext i32 %457 to i64, !llfi_index !1062
  %459 = load i32* %i, align 4, !llfi_index !1063
  %460 = sext i32 %459 to i64, !llfi_index !1064
  %461 = load float*** %new_centers, align 8, !llfi_index !1065
  %462 = getelementptr inbounds float** %461, i64 %460, !llfi_index !1066
  %463 = load float** %462, align 8, !llfi_index !1067
  %464 = getelementptr inbounds float* %463, i64 %458, !llfi_index !1068
  store float 0.000000e+00, float* %464, align 4, !llfi_index !1069
  br label %465, !llfi_index !1070

; <label>:465                                     ; preds = %456
  %466 = load i32* %j, align 4, !llfi_index !1071
  %467 = add nsw i32 %466, 1, !llfi_index !1072
  store i32 %467, i32* %j, align 4, !llfi_index !1073
  br label %420, !llfi_index !1074

; <label>:468                                     ; preds = %420
  %469 = load i32* %i, align 4, !llfi_index !1075
  %470 = sext i32 %469 to i64, !llfi_index !1076
  %471 = load i32** %new_centers_len, align 8, !llfi_index !1077
  %472 = getelementptr inbounds i32* %471, i64 %470, !llfi_index !1078
  store i32 0, i32* %472, align 4, !llfi_index !1079
  br label %473, !llfi_index !1080

; <label>:473                                     ; preds = %468
  %474 = load i32* %i, align 4, !llfi_index !1081
  %475 = add nsw i32 %474, 1, !llfi_index !1082
  store i32 %475, i32* %i, align 4, !llfi_index !1083
  br label %415, !llfi_index !1084

; <label>:476                                     ; preds = %415
  br label %477, !llfi_index !1085

; <label>:477                                     ; preds = %476
  %478 = load float* %delta, align 4, !llfi_index !1086
  %479 = load float* %5, align 4, !llfi_index !1087
  %480 = fcmp ogt float %478, %479, !llfi_index !1088
  br i1 %480, label %481, label %485, !llfi_index !1089

; <label>:481                                     ; preds = %477
  %482 = load i32* %loop, align 4, !llfi_index !1090
  %483 = add nsw i32 %482, 1, !llfi_index !1091
  store i32 %483, i32* %loop, align 4, !llfi_index !1092
  %484 = icmp slt i32 %482, 500, !llfi_index !1093
  br label %485, !llfi_index !1094

; <label>:485                                     ; preds = %481, %477
  %486 = phi i1 [ false, %477 ], [ %484, %481 ], !llfi_index !1095
  br i1 %486, label %233, label %487, !llfi_index !1096

; <label>:487                                     ; preds = %485
  %488 = load float*** %new_centers, align 8, !llfi_index !1097
  %489 = getelementptr inbounds float** %488, i64 0, !llfi_index !1098
  %490 = load float** %489, align 8, !llfi_index !1099
  %491 = bitcast float* %490 to i8*, !llfi_index !1100
  call void @free(i8* %491) #5, !llfi_index !1101
  %492 = load float*** %new_centers, align 8, !llfi_index !1102
  %493 = bitcast float** %492 to i8*, !llfi_index !1103
  call void @free(i8* %493) #5, !llfi_index !1104
  %494 = load i32** %new_centers_len, align 8, !llfi_index !1105
  %495 = bitcast i32* %494 to i8*, !llfi_index !1106
  call void @free(i8* %495) #5, !llfi_index !1107
  %496 = load float*** %clusters, align 8, !llfi_index !1108
  ret float** %496, !llfi_index !1109
}
