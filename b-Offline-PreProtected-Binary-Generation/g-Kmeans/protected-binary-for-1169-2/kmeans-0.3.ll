...
; <label>:10                                      ; preds = %checkBb, %4
  br i1 %8, label %11, label %51, !llfi_index !506
...
; <label>:32                                      ; preds = %checkBb2, %11
  ...
  %38 = fsub float %30, %37, !llfi_index !528
  %39 = fmul float %24, %38, !llfi_index !529
  %40 = fmul float %25, %38, !llfi_index !529
  %check_cmp3 = fcmp ueq float %39, %40
...
; <label>:41                                      ; preds = %checkBb4, %32
  ...
  %check_cmp5 = fcmp ueq float %42, %43
...
; <label>:44                                      ; preds = %checkBb6, %41
  %45 = fadd float %42, %39, !llfi_index !531
...
; <label>:49                                      ; preds = %checkBb8, %46
  %50 = add nsw i32 %47, 1, !llfi_index !535
  store i32 %50, i32* %i, align 4, !llfi_index !536
  br label %4, !llfi_index !537

; <label>:51                                      ; preds = %10
  %52 = load float* %ans, align 4, !llfi_index !538
  ret float %52, !llfi_index !539
}
