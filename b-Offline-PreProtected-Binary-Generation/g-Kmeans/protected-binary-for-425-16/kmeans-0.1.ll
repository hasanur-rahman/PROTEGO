...
; <label>:437                                     ; preds = %checkBb18, %430
  br i1 %435, label %438, label %490, !llfi_index !1027
...
; <label>:438                                     ; preds = %437
  ...
  br i1 %444, label %445, label %475, !llfi_index !1034

; <label>:445                                     ; preds = %438
  %446 = load i32* %j, align 4, !llfi_index !1035
  %447 = sext i32 %446 to i64, !llfi_index !1036
  %448 = load i32* %i, align 4, !llfi_index !1037
  %449 = sext i32 %448 to i64, !llfi_index !1038
  %450 = load float*** %new_centers, align 8, !llfi_index !1039
  %451 = getelementptr inbounds float** %450, i64 %449, !llfi_index !1040
  %452 = load float** %451, align 8, !llfi_index !1041
  %453 = getelementptr inbounds float* %452, i64 %447, !llfi_index !1042
  %454 = load float* %453, align 4, !llfi_index !1043
  %455 = load float* %453, align 4, !llfi_index !1043
  %456 = load i32* %i, align 4, !llfi_index !1044
  %457 = sext i32 %456 to i64, !llfi_index !1045
  %458 = load i32** %new_centers_len, align 8, !llfi_index !1046
  %459 = getelementptr inbounds i32* %458, i64 %457, !llfi_index !1047
  %460 = load i32* %459, align 4, !llfi_index !1048
  %461 = load i32* %459, align 4, !llfi_index !1048
  ...
  %check_cmp19 = fcmp ueq float %464, %465
  br i1 %check_cmp19, label %466, label %checkBb20

checkBb20:                                        ; preds = %445
  call void @check_flag()
  br label %466

; <label>:466                                     ; preds = %checkBb20, %445
  %467 = load i32* %j, align 4, !llfi_index !1051
  %468 = sext i32 %467 to i64, !llfi_index !1052
  %469 = load i32* %i, align 4, !llfi_index !1053
  %470 = sext i32 %469 to i64, !llfi_index !1054
  %471 = load float*** %clusters, align 8, !llfi_index !1055
  %472 = getelementptr inbounds float** %471, i64 %470, !llfi_index !1056
  %473 = load float** %472, align 8, !llfi_index !1057
  %474 = getelementptr inbounds float* %473, i64 %468, !llfi_index !1058
  store float %464, float* %474, align 4, !llfi_index !1059
  br label %475, !llfi_index !1060

; <label>:475                                     ; preds = %466, %438
  %476 = load i32* %j, align 4, !llfi_index !1061
  %477 = sext i32 %476 to i64, !llfi_index !1062
  %478 = load i32* %i, align 4, !llfi_index !1063
  %479 = sext i32 %478 to i64, !llfi_index !1064
  %480 = load float*** %new_centers, align 8, !llfi_index !1065
  %481 = getelementptr inbounds float** %480, i64 %479, !llfi_index !1066
  %482 = load float** %481, align 8, !llfi_index !1067
  %483 = getelementptr inbounds float* %482, i64 %477, !llfi_index !1068
  store float 0.000000e+00, float* %483, align 4, !llfi_index !1069
  br label %484, !llfi_index !1070
...
; <label>:484                                     ; preds = %475
  ...
  %check_cmp21 = icmp eq i32 %487, %488
  br i1 %check_cmp21, label %489, label %checkBb22

checkBb22:                                        ; preds = %484
  call void @check_flag()
  br label %489

; <label>:489                                     ; preds = %checkBb22, %484
  store i32 %487, i32* %j, align 4, !llfi_index !1073
  br label %430, !llfi_index !1074

; <label>:490                                     ; preds = %437
  %491 = load i32* %i, align 4, !llfi_index !1075
  %492 = sext i32 %491 to i64, !llfi_index !1076
  %493 = load i32** %new_centers_len, align 8, !llfi_index !1077
  %494 = getelementptr inbounds i32* %493, i64 %492, !llfi_index !1078
  store i32 0, i32* %494, align 4, !llfi_index !1079
  br label %495, !llfi_index !1080

; <label>:495                                     ; preds = %490
  %496 = load i32* %i, align 4, !llfi_index !1081
  %497 = add nsw i32 %496, 1, !llfi_index !1082
  store i32 %497, i32* %i, align 4, !llfi_index !1083
  br label %425, !llfi_index !1084

; <label>:498                                     ; preds = %425
  br label %499, !llfi_index !1085

; <label>:499                                     ; preds = %498
  %500 = load float* %delta, align 4, !llfi_index !1086
  %501 = load float* %5, align 4, !llfi_index !1087
  %502 = fcmp ogt float %500, %501, !llfi_index !1088
  br i1 %502, label %503, label %507, !llfi_index !1089

; <label>:503                                     ; preds = %499
  %504 = load i32* %loop, align 4, !llfi_index !1090
  %505 = add nsw i32 %504, 1, !llfi_index !1091
  store i32 %505, i32* %loop, align 4, !llfi_index !1092
  %506 = icmp slt i32 %504, 500, !llfi_index !1093
  br label %507, !llfi_index !1094

; <label>:507                                     ; preds = %503, %499
  %508 = phi i1 [ false, %499 ], [ %506, %503 ], !llfi_index !1095
  br i1 %508, label %233, label %509, !llfi_index !1096

; <label>:509                                     ; preds = %507
  %510 = load float*** %new_centers, align 8, !llfi_index !1097
  %511 = getelementptr inbounds float** %510, i64 0, !llfi_index !1098
  %512 = load float** %511, align 8, !llfi_index !1099
  %513 = bitcast float* %512 to i8*, !llfi_index !1100
  call void @free(i8* %513) #5, !llfi_index !1101
  %514 = load float*** %new_centers, align 8, !llfi_index !1102
  %515 = bitcast float** %514 to i8*, !llfi_index !1103
  call void @free(i8* %515) #5, !llfi_index !1104
  %516 = load i32** %new_centers_len, align 8, !llfi_index !1105
  %517 = bitcast i32* %516 to i8*, !llfi_index !1106
  call void @free(i8* %517) #5, !llfi_index !1107
  %518 = load float*** %clusters, align 8, !llfi_index !1108
  ret float** %518, !llfi_index !1109
}
