...
; <label>:198                                     ; preds = %239, %207, %196
  ...
  br i1 %202, label %203, label %240, !llfi_index !272
...
; <label>:215                                     ; preds = %checkBb, %209
  br i1 %213, label %216, label %239, !llfi_index !283
...
; <label>:222                                     ; preds = %checkBb2, %216
  ...
  %226 = getelementptr inbounds float* %224, i64 %223, !llfi_index !290
  %check_cmp3 = icmp eq float* %225, %226
  br i1 %check_cmp3, label %227, label %checkBb4

checkBb4:                                         ; preds = %222
  call void @check_flag()
  br label %227

; <label>:227                                     ; preds = %checkBb4, %222
  store float %219, float* %225, align 4, !llfi_index !291
  %228 = load i32* %i, align 4, !llfi_index !292
  %229 = load i32* %i, align 4, !llfi_index !292
  %230 = add nsw i32 %228, 1, !llfi_index !293
  %231 = add nsw i32 %229, 1, !llfi_index !293
  %check_cmp5 = icmp eq i32 %230, %231
  br i1 %check_cmp5, label %232, label %checkBb6

checkBb6:                                         ; preds = %227
  call void @check_flag()
  br label %232

; <label>:232                                     ; preds = %checkBb6, %227
  store i32 %230, i32* %i, align 4, !llfi_index !294
  br label %233, !llfi_index !295

; <label>:233                                     ; preds = %232
  %234 = load i32* %j, align 4, !llfi_index !296
  %235 = load i32* %j, align 4, !llfi_index !296
  %236 = add nsw i32 %234, 1, !llfi_index !297
  %237 = add nsw i32 %235, 1, !llfi_index !297
  %check_cmp7 = icmp eq i32 %236, %237
  br i1 %check_cmp7, label %238, label %checkBb8

checkBb8:                                         ; preds = %233
  call void @check_flag()
  br label %238

; <label>:238                                     ; preds = %checkBb8, %233
  store i32 %236, i32* %j, align 4, !llfi_index !298
...
; <label>:240                                     ; preds = %198
  %241 = load %struct._IO_FILE** %infile1, align 8, !llfi_index !301
  %242 = call i32 @fclose(%struct._IO_FILE* %241), !llfi_index !302
  br label %243, !llfi_index !303

; <label>:243                                     ; preds = %240, %97
  %244 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str8, i32 0, i32 0)), !llfi_index !304
  %245 = load float*** %attributes, align 8, !llfi_index !305
  %246 = getelementptr inbounds float** %245, i64 0, !llfi_index !306
  %247 = load float** %246, align 8, !llfi_index !307
  %248 = bitcast float* %247 to i8*, !llfi_index !308
  %249 = load float** %buf, align 8, !llfi_index !309
  %250 = bitcast float* %249 to i8*, !llfi_index !310
  %251 = load i32* %numObjects, align 4, !llfi_index !311
  %252 = load i32* %numAttributes, align 4, !llfi_index !312
  %253 = mul nsw i32 %251, %252, !llfi_index !313
  %254 = sext i32 %253 to i64, !llfi_index !314
  %255 = mul i64 %254, 4, !llfi_index !315
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %248, i8* %250, i64 %255, i32 4, i1 false), !llfi_index !316
  store i32 0, i32* %i, align 4, !llfi_index !317
  br label %256, !llfi_index !318

; <label>:256                                     ; preds = %267, %243
  %257 = load i32* %i, align 4, !llfi_index !319
  %258 = load i32* %nloops, align 4, !llfi_index !320
  %259 = icmp slt i32 %257, %258, !llfi_index !321
  br i1 %259, label %260, label %270, !llfi_index !322

; <label>:260                                     ; preds = %256
  store float** null, float*** %cluster_centres, align 8, !llfi_index !323
  %261 = load i32* %numObjects, align 4, !llfi_index !324
  %262 = load i32* %numAttributes, align 4, !llfi_index !325
  %263 = load float*** %attributes, align 8, !llfi_index !326
  %264 = load i32* %nclusters, align 4, !llfi_index !327
  %265 = load float* %threshold, align 4, !llfi_index !328
  %266 = call i32 @cluster(i32 %261, i32 %262, float** %263, i32 %264, float %265, float*** %cluster_centres), !llfi_index !329
  br label %267, !llfi_index !330

; <label>:267                                     ; preds = %260
  %268 = load i32* %i, align 4, !llfi_index !331
  %269 = add nsw i32 %268, 1, !llfi_index !332
  store i32 %269, i32* %i, align 4, !llfi_index !333
  br label %256, !llfi_index !334

; <label>:270                                     ; preds = %256
  %271 = load i32* %nclusters, align 4, !llfi_index !335
  %272 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str9, i32 0, i32 0), i32 %271), !llfi_index !336
  %273 = load i32* %numAttributes, align 4, !llfi_index !337
  %274 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([26 x i8]* @.str10, i32 0, i32 0), i32 %273), !llfi_index !338
  %275 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([11 x i8]* @.str11, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8]* @.str123, i32 0, i32 0)), !llfi_index !339
  store %struct._IO_FILE* %275, %struct._IO_FILE** %file, align 8, !llfi_index !340
  store i32 0, i32* %i, align 4, !llfi_index !341
  br label %276, !llfi_index !342

; <label>:276                                     ; preds = %307, %270
  %277 = load i32* %i, align 4, !llfi_index !343
  %278 = load i32* %nclusters, align 4, !llfi_index !344
  %279 = icmp slt i32 %277, %278, !llfi_index !345
  br i1 %279, label %280, label %310, !llfi_index !346

; <label>:280                                     ; preds = %276
  %281 = load %struct._IO_FILE** %file, align 8, !llfi_index !347
  %282 = load i32* %i, align 4, !llfi_index !348
  %283 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %281, i8* getelementptr inbounds ([5 x i8]* @.str13, i32 0, i32 0), i32 %282), !llfi_index !349
  store i32 0, i32* %j, align 4, !llfi_index !350
  br label %284, !llfi_index !351

; <label>:284                                     ; preds = %301, %280
  %285 = load i32* %j, align 4, !llfi_index !352
  %286 = load i32* %numAttributes, align 4, !llfi_index !353
  %287 = icmp slt i32 %285, %286, !llfi_index !354
  br i1 %287, label %288, label %304, !llfi_index !355
...
; <label>:288                                     ; preds = %284
  ...
  %299 = fpext float %298 to double, !llfi_index !366
  %300 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %289, i8* getelementptr inbounds ([6 x i8]* @.str14, i32 0, i32 0), double %299), !llfi_index !367
  br label %301, !llfi_index !368

; <label>:301                                     ; preds = %288
  %302 = load i32* %j, align 4, !llfi_index !369
  %303 = add nsw i32 %302, 1, !llfi_index !370
  store i32 %303, i32* %j, align 4, !llfi_index !371
  br label %284, !llfi_index !372

; <label>:304                                     ; preds = %284
  %305 = load %struct._IO_FILE** %file, align 8, !llfi_index !373
  %306 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %305, i8* getelementptr inbounds ([3 x i8]* @.str15, i32 0, i32 0)), !llfi_index !374
  br label %307, !llfi_index !375

; <label>:307                                     ; preds = %304
  %308 = load i32* %i, align 4, !llfi_index !376
  %309 = add nsw i32 %308, 1, !llfi_index !377
  store i32 %309, i32* %i, align 4, !llfi_index !378
  br label %276, !llfi_index !379

; <label>:310                                     ; preds = %276
  %311 = load %struct._IO_FILE** %file, align 8, !llfi_index !380
  %312 = call i32 @fclose(%struct._IO_FILE* %311), !llfi_index !381
  %313 = load float*** %attributes, align 8, !llfi_index !382
  %314 = bitcast float** %313 to i8*, !llfi_index !383
  call void @free(i8* %314) #5, !llfi_index !384
  %315 = load float*** %cluster_centres, align 8, !llfi_index !385
  %316 = getelementptr inbounds float** %315, i64 0, !llfi_index !386
  %317 = load float** %316, align 8, !llfi_index !387
  %318 = bitcast float* %317 to i8*, !llfi_index !388
  call void @free(i8* %318) #5, !llfi_index !389
  %319 = load float*** %cluster_centres, align 8, !llfi_index !390
  %320 = bitcast float** %319 to i8*, !llfi_index !391
  call void @free(i8* %320) #5, !llfi_index !392
  %321 = load float** %buf, align 8, !llfi_index !393
  %322 = bitcast float* %321 to i8*, !llfi_index !394
  call void @free(i8* %322) #5, !llfi_index !395
...
; <label>:8                                       ; preds = %checkBb, %5
  %9 = load i32* %4, align 4, !llfi_index !464
  %10 = icmp slt i32 %6, %9, !llfi_index !465
  br i1 %10, label %11, label %32, !llfi_index !466

; <label>:11                                      ; preds = %8
  %12 = load float** %1, align 8, !llfi_index !467
  %13 = load i32* %i, align 4, !llfi_index !468
  %14 = sext i32 %13 to i64, !llfi_index !469
  %15 = load float*** %3, align 8, !llfi_index !470
  %16 = getelementptr inbounds float** %15, i64 %14, !llfi_index !471
  %17 = load float** %16, align 8, !llfi_index !472
  %18 = load i32* %2, align 4, !llfi_index !473
  %19 = call float @euclid_dist_2(float* %12, float* %17, i32 %18), !llfi_index !474
  store float %19, float* %dist, align 4, !llfi_index !475
  %20 = load float* %dist, align 4, !llfi_index !476
  %21 = load float* %min_dist, align 4, !llfi_index !477
  %22 = fcmp olt float %20, %21, !llfi_index !478
  %23 = fcmp olt float %20, %21, !llfi_index !478
...
; <label>:24                                      ; preds = %checkBb2, %11
  br i1 %22, label %25, label %28, !llfi_index !479

; <label>:25                                      ; preds = %24
  %26 = load float* %dist, align 4, !llfi_index !480
  store float %26, float* %min_dist, align 4, !llfi_index !481
  %27 = load i32* %i, align 4, !llfi_index !482
  store i32 %27, i32* %index, align 4, !llfi_index !483
  br label %28, !llfi_index !484

; <label>:28                                      ; preds = %25, %24
  br label %29, !llfi_index !485

; <label>:29                                      ; preds = %28
  %30 = load i32* %i, align 4, !llfi_index !486
  %31 = add nsw i32 %30, 1, !llfi_index !487
  store i32 %31, i32* %i, align 4, !llfi_index !488
  br label %5, !llfi_index !489

; <label>:32                                      ; preds = %8
  %33 = load i32* %index, align 4, !llfi_index !490
  ret i32 %33, !llfi_index !491
}
...
; <label>:10                                      ; preds = %9
  ...
  %21 = load float* %19, align 4, !llfi_index !516
  %check_cmp1 = fcmp ueq float %20, %21
...
; <label>:22                                      ; preds = %checkBb2, %10
  %23 = fsub float %15, %20, !llfi_index !517
  ...
  %29 = load i32* %i, align 4, !llfi_index !523
  %30 = sext i32 %29 to i64, !llfi_index !524
  %31 = load float** %2, align 8, !llfi_index !525
  %32 = getelementptr inbounds float* %31, i64 %30, !llfi_index !526
  %33 = load float* %32, align 4, !llfi_index !527
  %34 = load float* %32, align 4, !llfi_index !527
  %check_cmp3 = fcmp ueq float %33, %34
...
; <label>:35                                      ; preds = %checkBb4, %22
  %36 = fsub float %28, %33, !llfi_index !528
...
; <label>:240                                     ; preds = %checkBb, %234
  br i1 %238, label %241, label %328, !llfi_index !839
...
; <label>:285                                     ; preds = %checkBb4, %282
  ...
  br i1 %287, label %288, label %321, !llfi_index !886
...
; <label>:316                                     ; preds = %315
  ...
  %318 = add nsw i32 %317, 1, !llfi_index !913
  %319 = add nsw i32 %317, 1, !llfi_index !913
  %check_cmp7 = icmp eq i32 %318, %319
  br i1 %check_cmp7, label %320, label %checkBb8

checkBb8:                                         ; preds = %316
  call void @check_flag()
  br label %320

; <label>:320                                     ; preds = %checkBb8, %316
  store i32 %318, i32* %j, align 4, !llfi_index !914
  br label %282, !llfi_index !915

; <label>:321                                     ; preds = %285
  br label %322, !llfi_index !916

; <label>:322                                     ; preds = %321
  %323 = load i32* %i, align 4, !llfi_index !917
  %324 = load i32* %i, align 4, !llfi_index !917
  %325 = add nsw i32 %323, 1, !llfi_index !918
  %326 = add nsw i32 %324, 1, !llfi_index !918
  %check_cmp9 = icmp eq i32 %325, %326
  br i1 %check_cmp9, label %327, label %checkBb10

checkBb10:                                        ; preds = %322
  call void @check_flag()
  br label %327

; <label>:327                                     ; preds = %checkBb10, %322
  store i32 %325, i32* %i, align 4, !llfi_index !919
  br label %234, !llfi_index !920

; <label>:328                                     ; preds = %240
  store i32 0, i32* %i, align 4, !llfi_index !921
  br label %329, !llfi_index !922

; <label>:329                                     ; preds = %410, %328
  %330 = load i32* %i, align 4, !llfi_index !923
  %331 = load i32* %4, align 4, !llfi_index !924
  %332 = icmp slt i32 %330, %331, !llfi_index !925
  br i1 %332, label %333, label %413, !llfi_index !926

; <label>:333                                     ; preds = %329
  store i32 0, i32* %j, align 4, !llfi_index !927
  br label %334, !llfi_index !928

; <label>:334                                     ; preds = %406, %333
  %335 = load i32* %j, align 4, !llfi_index !929
  %336 = load i32* %nthreads, align 4, !llfi_index !930
  %337 = icmp slt i32 %335, %336, !llfi_index !931
  br i1 %337, label %338, label %409, !llfi_index !932

; <label>:338                                     ; preds = %334
  %339 = load i32* %i, align 4, !llfi_index !933
  %340 = sext i32 %339 to i64, !llfi_index !934
  %341 = load i32* %j, align 4, !llfi_index !935
  %342 = sext i32 %341 to i64, !llfi_index !936
  %343 = load i32*** %partial_new_centers_len, align 8, !llfi_index !937
  %344 = getelementptr inbounds i32** %343, i64 %342, !llfi_index !938
  %345 = load i32** %344, align 8, !llfi_index !939
  %346 = getelementptr inbounds i32* %345, i64 %340, !llfi_index !940
  %347 = load i32* %346, align 4, !llfi_index !941
  %348 = load i32* %i, align 4, !llfi_index !942
  %349 = sext i32 %348 to i64, !llfi_index !943
  %350 = load i32** %new_centers_len, align 8, !llfi_index !944
  %351 = getelementptr inbounds i32* %350, i64 %349, !llfi_index !945
  %352 = load i32* %351, align 4, !llfi_index !946
  %353 = add nsw i32 %352, %347, !llfi_index !947
  store i32 %353, i32* %351, align 4, !llfi_index !948
  %354 = load i32* %i, align 4, !llfi_index !949
  %355 = sext i32 %354 to i64, !llfi_index !950
  %356 = load i32* %j, align 4, !llfi_index !951
  %357 = sext i32 %356 to i64, !llfi_index !952
  %358 = load i32*** %partial_new_centers_len, align 8, !llfi_index !953
  %359 = getelementptr inbounds i32** %358, i64 %357, !llfi_index !954
  %360 = load i32** %359, align 8, !llfi_index !955
  %361 = getelementptr inbounds i32* %360, i64 %355, !llfi_index !956
  store i32 0, i32* %361, align 4, !llfi_index !957
  store i32 0, i32* %k, align 4, !llfi_index !958
  br label %362, !llfi_index !959

; <label>:362                                     ; preds = %402, %338
  %363 = load i32* %k, align 4, !llfi_index !960
  %364 = load i32* %2, align 4, !llfi_index !961
  %365 = icmp slt i32 %363, %364, !llfi_index !962
  br i1 %365, label %366, label %405, !llfi_index !963

; <label>:366                                     ; preds = %362
  %367 = load i32* %k, align 4, !llfi_index !964
  %368 = sext i32 %367 to i64, !llfi_index !965
  %369 = load i32* %i, align 4, !llfi_index !966
  %370 = sext i32 %369 to i64, !llfi_index !967
  %371 = load i32* %j, align 4, !llfi_index !968
  %372 = sext i32 %371 to i64, !llfi_index !969
  %373 = load float**** %partial_new_centers, align 8, !llfi_index !970
  %374 = getelementptr inbounds float*** %373, i64 %372, !llfi_index !971
  %375 = load float*** %374, align 8, !llfi_index !972
  %376 = getelementptr inbounds float** %375, i64 %370, !llfi_index !973
  %377 = load float** %376, align 8, !llfi_index !974
  %378 = getelementptr inbounds float* %377, i64 %368, !llfi_index !975
  %379 = load float* %378, align 4, !llfi_index !976
  %380 = load i32* %k, align 4, !llfi_index !977
  %381 = sext i32 %380 to i64, !llfi_index !978
  %382 = load i32* %i, align 4, !llfi_index !979
  %383 = sext i32 %382 to i64, !llfi_index !980
  %384 = load float*** %new_centers, align 8, !llfi_index !981
  %385 = getelementptr inbounds float** %384, i64 %383, !llfi_index !982
  %386 = load float** %385, align 8, !llfi_index !983
  %387 = getelementptr inbounds float* %386, i64 %381, !llfi_index !984
  %388 = load float* %387, align 4, !llfi_index !985
  %389 = fadd float %388, %379, !llfi_index !986
  store float %389, float* %387, align 4, !llfi_index !987
  %390 = load i32* %k, align 4, !llfi_index !988
  %391 = sext i32 %390 to i64, !llfi_index !989
  %392 = load i32* %i, align 4, !llfi_index !990
  %393 = sext i32 %392 to i64, !llfi_index !991
  %394 = load i32* %j, align 4, !llfi_index !992
  %395 = sext i32 %394 to i64, !llfi_index !993
  %396 = load float**** %partial_new_centers, align 8, !llfi_index !994
  %397 = getelementptr inbounds float*** %396, i64 %395, !llfi_index !995
  %398 = load float*** %397, align 8, !llfi_index !996
  %399 = getelementptr inbounds float** %398, i64 %393, !llfi_index !997
  %400 = load float** %399, align 8, !llfi_index !998
  %401 = getelementptr inbounds float* %400, i64 %391, !llfi_index !999
  store float 0.000000e+00, float* %401, align 4, !llfi_index !1000
  br label %402, !llfi_index !1001

; <label>:402                                     ; preds = %366
  %403 = load i32* %k, align 4, !llfi_index !1002
  %404 = add nsw i32 %403, 1, !llfi_index !1003
  store i32 %404, i32* %k, align 4, !llfi_index !1004
  br label %362, !llfi_index !1005

; <label>:405                                     ; preds = %362
  br label %406, !llfi_index !1006

; <label>:406                                     ; preds = %405
  %407 = load i32* %j, align 4, !llfi_index !1007
  %408 = add nsw i32 %407, 1, !llfi_index !1008
  store i32 %408, i32* %j, align 4, !llfi_index !1009
  br label %334, !llfi_index !1010

; <label>:409                                     ; preds = %334
  br label %410, !llfi_index !1011

; <label>:410                                     ; preds = %409
  %411 = load i32* %i, align 4, !llfi_index !1012
  %412 = add nsw i32 %411, 1, !llfi_index !1013
  store i32 %412, i32* %i, align 4, !llfi_index !1014
  br label %329, !llfi_index !1015

; <label>:413                                     ; preds = %329
  store i32 0, i32* %i, align 4, !llfi_index !1016
  br label %414, !llfi_index !1017

; <label>:414                                     ; preds = %472, %413
  %415 = load i32* %i, align 4, !llfi_index !1018
  %416 = load i32* %4, align 4, !llfi_index !1019
  %417 = icmp slt i32 %415, %416, !llfi_index !1020
  br i1 %417, label %418, label %475, !llfi_index !1021

; <label>:418                                     ; preds = %414
  store i32 0, i32* %j, align 4, !llfi_index !1022
  br label %419, !llfi_index !1023

; <label>:419                                     ; preds = %464, %418
  %420 = load i32* %j, align 4, !llfi_index !1024
  %421 = load i32* %2, align 4, !llfi_index !1025
  %422 = icmp slt i32 %420, %421, !llfi_index !1026
  br i1 %422, label %423, label %467, !llfi_index !1027

; <label>:423                                     ; preds = %419
  %424 = load i32* %i, align 4, !llfi_index !1028
  %425 = sext i32 %424 to i64, !llfi_index !1029
  %426 = load i32** %new_centers_len, align 8, !llfi_index !1030
  %427 = getelementptr inbounds i32* %426, i64 %425, !llfi_index !1031
  %428 = load i32* %427, align 4, !llfi_index !1032
  %429 = icmp sgt i32 %428, 0, !llfi_index !1033
  br i1 %429, label %430, label %455, !llfi_index !1034

; <label>:430                                     ; preds = %423
  %431 = load i32* %j, align 4, !llfi_index !1035
  %432 = sext i32 %431 to i64, !llfi_index !1036
  %433 = load i32* %i, align 4, !llfi_index !1037
  %434 = sext i32 %433 to i64, !llfi_index !1038
  %435 = load float*** %new_centers, align 8, !llfi_index !1039
  %436 = getelementptr inbounds float** %435, i64 %434, !llfi_index !1040
  %437 = load float** %436, align 8, !llfi_index !1041
  %438 = getelementptr inbounds float* %437, i64 %432, !llfi_index !1042
  %439 = load float* %438, align 4, !llfi_index !1043
  %440 = load i32* %i, align 4, !llfi_index !1044
  %441 = sext i32 %440 to i64, !llfi_index !1045
  %442 = load i32** %new_centers_len, align 8, !llfi_index !1046
  %443 = getelementptr inbounds i32* %442, i64 %441, !llfi_index !1047
  %444 = load i32* %443, align 4, !llfi_index !1048
  %445 = sitofp i32 %444 to float, !llfi_index !1049
  %446 = fdiv float %439, %445, !llfi_index !1050
  %447 = load i32* %j, align 4, !llfi_index !1051
  %448 = sext i32 %447 to i64, !llfi_index !1052
  %449 = load i32* %i, align 4, !llfi_index !1053
  %450 = sext i32 %449 to i64, !llfi_index !1054
  %451 = load float*** %clusters, align 8, !llfi_index !1055
  %452 = getelementptr inbounds float** %451, i64 %450, !llfi_index !1056
  %453 = load float** %452, align 8, !llfi_index !1057
  %454 = getelementptr inbounds float* %453, i64 %448, !llfi_index !1058
  store float %446, float* %454, align 4, !llfi_index !1059
  br label %455, !llfi_index !1060

; <label>:455                                     ; preds = %430, %423
  %456 = load i32* %j, align 4, !llfi_index !1061
  %457 = sext i32 %456 to i64, !llfi_index !1062
  %458 = load i32* %i, align 4, !llfi_index !1063
  %459 = sext i32 %458 to i64, !llfi_index !1064
  %460 = load float*** %new_centers, align 8, !llfi_index !1065
  %461 = getelementptr inbounds float** %460, i64 %459, !llfi_index !1066
  %462 = load float** %461, align 8, !llfi_index !1067
  %463 = getelementptr inbounds float* %462, i64 %457, !llfi_index !1068
  store float 0.000000e+00, float* %463, align 4, !llfi_index !1069
  br label %464, !llfi_index !1070

; <label>:464                                     ; preds = %455
  %465 = load i32* %j, align 4, !llfi_index !1071
  %466 = add nsw i32 %465, 1, !llfi_index !1072
  store i32 %466, i32* %j, align 4, !llfi_index !1073
  br label %419, !llfi_index !1074

; <label>:467                                     ; preds = %419
  %468 = load i32* %i, align 4, !llfi_index !1075
  %469 = sext i32 %468 to i64, !llfi_index !1076
  %470 = load i32** %new_centers_len, align 8, !llfi_index !1077
  %471 = getelementptr inbounds i32* %470, i64 %469, !llfi_index !1078
  store i32 0, i32* %471, align 4, !llfi_index !1079
  br label %472, !llfi_index !1080

; <label>:472                                     ; preds = %467
  %473 = load i32* %i, align 4, !llfi_index !1081
  %474 = add nsw i32 %473, 1, !llfi_index !1082
  store i32 %474, i32* %i, align 4, !llfi_index !1083
  br label %414, !llfi_index !1084

; <label>:475                                     ; preds = %414
  br label %476, !llfi_index !1085

; <label>:476                                     ; preds = %475
  %477 = load float* %delta, align 4, !llfi_index !1086
  %478 = load float* %5, align 4, !llfi_index !1087
  %479 = fcmp ogt float %477, %478, !llfi_index !1088
  br i1 %479, label %480, label %484, !llfi_index !1089

; <label>:480                                     ; preds = %476
  %481 = load i32* %loop, align 4, !llfi_index !1090
  %482 = add nsw i32 %481, 1, !llfi_index !1091
  store i32 %482, i32* %loop, align 4, !llfi_index !1092
  %483 = icmp slt i32 %481, 500, !llfi_index !1093
  br label %484, !llfi_index !1094

; <label>:484                                     ; preds = %480, %476
  %485 = phi i1 [ false, %476 ], [ %483, %480 ], !llfi_index !1095
  br i1 %485, label %233, label %486, !llfi_index !1096

; <label>:486                                     ; preds = %484
  %487 = load float*** %new_centers, align 8, !llfi_index !1097
  %488 = getelementptr inbounds float** %487, i64 0, !llfi_index !1098
  %489 = load float** %488, align 8, !llfi_index !1099
  %490 = bitcast float* %489 to i8*, !llfi_index !1100
  call void @free(i8* %490) #5, !llfi_index !1101
  %491 = load float*** %new_centers, align 8, !llfi_index !1102
  %492 = bitcast float** %491 to i8*, !llfi_index !1103
  call void @free(i8* %492) #5, !llfi_index !1104
  %493 = load i32** %new_centers_len, align 8, !llfi_index !1105
  %494 = bitcast i32* %493 to i8*, !llfi_index !1106
  call void @free(i8* %494) #5, !llfi_index !1107
  %495 = load float*** %clusters, align 8, !llfi_index !1108
  ret float** %495, !llfi_index !1109
}
