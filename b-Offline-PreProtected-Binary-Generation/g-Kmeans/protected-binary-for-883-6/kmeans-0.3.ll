...
; <label>:10                                      ; preds = %checkBb, %4
  br i1 %8, label %11, label %52, !llfi_index !506
...
; <label>:18                                      ; preds = %checkBb2, %11
  ...
  %24 = fsub float %16, %23, !llfi_index !517
  %25 = load i32* %i, align 4, !llfi_index !518
  %26 = sext i32 %25 to i64, !llfi_index !519
  %27 = load float** %1, align 8, !llfi_index !520
  %28 = getelementptr inbounds float* %27, i64 %26, !llfi_index !521
  %29 = load float* %28, align 4, !llfi_index !522
  %30 = load float* %28, align 4, !llfi_index !522
  ...
  %36 = load float* %34, align 4, !llfi_index !527
  %37 = fsub float %29, %35, !llfi_index !528
  %38 = fsub float %30, %36, !llfi_index !528
  %39 = fmul float %24, %37, !llfi_index !529
  %40 = fmul float %24, %38, !llfi_index !529
  %41 = load float* %ans, align 4, !llfi_index !530
  %42 = load float* %ans, align 4, !llfi_index !530
  %43 = fadd float %41, %39, !llfi_index !531
...
; <label>:45                                      ; preds = %checkBb4, %18
  store float %43, float* %ans, align 4, !llfi_index !532
  br label %46, !llfi_index !533

; <label>:46                                      ; preds = %45
  %47 = load i32* %i, align 4, !llfi_index !534
  %48 = load i32* %i, align 4, !llfi_index !534
  %49 = add nsw i32 %47, 1, !llfi_index !535
...
; <label>:51                                      ; preds = %checkBb6, %46
  store i32 %49, i32* %i, align 4, !llfi_index !536
  br label %4, !llfi_index !537

; <label>:52                                      ; preds = %10
  %53 = load float* %ans, align 4, !llfi_index !538
  %54 = load float* %ans, align 4, !llfi_index !538
  %check_cmp7 = fcmp ueq float %53, %54
...
; <label>:436                                     ; preds = %checkBb18, %430
  br i1 %434, label %437, label %489, !llfi_index !1027
...
; <label>:437                                     ; preds = %436
  ...
  br i1 %443, label %444, label %474, !llfi_index !1034

; <label>:444                                     ; preds = %437
  %445 = load i32* %j, align 4, !llfi_index !1035
  %446 = sext i32 %445 to i64, !llfi_index !1036
  %447 = load i32* %i, align 4, !llfi_index !1037
  %448 = sext i32 %447 to i64, !llfi_index !1038
  %449 = load float*** %new_centers, align 8, !llfi_index !1039
  %450 = getelementptr inbounds float** %449, i64 %448, !llfi_index !1040
  %451 = load float** %450, align 8, !llfi_index !1041
  %452 = getelementptr inbounds float* %451, i64 %446, !llfi_index !1042
  %453 = load float* %452, align 4, !llfi_index !1043
  %454 = load float* %452, align 4, !llfi_index !1043
  %455 = load i32* %i, align 4, !llfi_index !1044
  %456 = sext i32 %455 to i64, !llfi_index !1045
  %457 = load i32** %new_centers_len, align 8, !llfi_index !1046
  %458 = getelementptr inbounds i32* %457, i64 %456, !llfi_index !1047
  %459 = load i32* %458, align 4, !llfi_index !1048
  %460 = load i32* %458, align 4, !llfi_index !1048
  %461 = sitofp i32 %459 to float, !llfi_index !1049
  %462 = sitofp i32 %460 to float, !llfi_index !1049
  %463 = fdiv float %453, %461, !llfi_index !1050
  %464 = fdiv float %454, %462, !llfi_index !1050
  %check_cmp19 = fcmp ueq float %463, %464
  br i1 %check_cmp19, label %465, label %checkBb20

checkBb20:                                        ; preds = %444
  call void @check_flag()
  br label %465

; <label>:465                                     ; preds = %checkBb20, %444
  %466 = load i32* %j, align 4, !llfi_index !1051
  %467 = sext i32 %466 to i64, !llfi_index !1052
  %468 = load i32* %i, align 4, !llfi_index !1053
  %469 = sext i32 %468 to i64, !llfi_index !1054
  %470 = load float*** %clusters, align 8, !llfi_index !1055
  %471 = getelementptr inbounds float** %470, i64 %469, !llfi_index !1056
  %472 = load float** %471, align 8, !llfi_index !1057
  %473 = getelementptr inbounds float* %472, i64 %467, !llfi_index !1058
  store float %463, float* %473, align 4, !llfi_index !1059
  br label %474, !llfi_index !1060

; <label>:474                                     ; preds = %465, %437
  %475 = load i32* %j, align 4, !llfi_index !1061
  %476 = sext i32 %475 to i64, !llfi_index !1062
  %477 = load i32* %i, align 4, !llfi_index !1063
  %478 = sext i32 %477 to i64, !llfi_index !1064
  %479 = load float*** %new_centers, align 8, !llfi_index !1065
  %480 = getelementptr inbounds float** %479, i64 %478, !llfi_index !1066
  %481 = load float** %480, align 8, !llfi_index !1067
  %482 = getelementptr inbounds float* %481, i64 %476, !llfi_index !1068
  store float 0.000000e+00, float* %482, align 4, !llfi_index !1069
  br label %483, !llfi_index !1070

; <label>:483                                     ; preds = %474
  %484 = load i32* %j, align 4, !llfi_index !1071
  %485 = load i32* %j, align 4, !llfi_index !1071
  %486 = add nsw i32 %484, 1, !llfi_index !1072
  %487 = add nsw i32 %485, 1, !llfi_index !1072
  %check_cmp21 = icmp eq i32 %486, %487
  br i1 %check_cmp21, label %488, label %checkBb22

checkBb22:                                        ; preds = %483
  call void @check_flag()
  br label %488

; <label>:488                                     ; preds = %checkBb22, %483
  store i32 %486, i32* %j, align 4, !llfi_index !1073
  br label %430, !llfi_index !1074

; <label>:489                                     ; preds = %436
  %490 = load i32* %i, align 4, !llfi_index !1075
  %491 = sext i32 %490 to i64, !llfi_index !1076
  %492 = load i32** %new_centers_len, align 8, !llfi_index !1077
  %493 = getelementptr inbounds i32* %492, i64 %491, !llfi_index !1078
  store i32 0, i32* %493, align 4, !llfi_index !1079
  br label %494, !llfi_index !1080

; <label>:494                                     ; preds = %489
  %495 = load i32* %i, align 4, !llfi_index !1081
  %496 = add nsw i32 %495, 1, !llfi_index !1082
  store i32 %496, i32* %i, align 4, !llfi_index !1083
  br label %425, !llfi_index !1084

; <label>:497                                     ; preds = %425
  br label %498, !llfi_index !1085

; <label>:498                                     ; preds = %497
  %499 = load float* %delta, align 4, !llfi_index !1086
  %500 = load float* %5, align 4, !llfi_index !1087
  %501 = fcmp ogt float %499, %500, !llfi_index !1088
  br i1 %501, label %502, label %506, !llfi_index !1089

; <label>:502                                     ; preds = %498
  %503 = load i32* %loop, align 4, !llfi_index !1090
  %504 = add nsw i32 %503, 1, !llfi_index !1091
  store i32 %504, i32* %loop, align 4, !llfi_index !1092
  %505 = icmp slt i32 %503, 500, !llfi_index !1093
  br label %506, !llfi_index !1094

; <label>:506                                     ; preds = %502, %498
  %507 = phi i1 [ false, %498 ], [ %505, %502 ], !llfi_index !1095
  br i1 %507, label %233, label %508, !llfi_index !1096

; <label>:508                                     ; preds = %506
  %509 = load float*** %new_centers, align 8, !llfi_index !1097
  %510 = getelementptr inbounds float** %509, i64 0, !llfi_index !1098
  %511 = load float** %510, align 8, !llfi_index !1099
  %512 = bitcast float* %511 to i8*, !llfi_index !1100
  call void @free(i8* %512) #5, !llfi_index !1101
  %513 = load float*** %new_centers, align 8, !llfi_index !1102
  %514 = bitcast float** %513 to i8*, !llfi_index !1103
  call void @free(i8* %514) #5, !llfi_index !1104
  %515 = load i32** %new_centers_len, align 8, !llfi_index !1105
  %516 = bitcast i32* %515 to i8*, !llfi_index !1106
  call void @free(i8* %516) #5, !llfi_index !1107
  %517 = load float*** %clusters, align 8, !llfi_index !1108
  ret float** %517, !llfi_index !1109
}
