...
; <label>:221                                     ; preds = %checkBb2, %216
  ...
  %223 = sext i32 %222 to i64, !llfi_index !288
...
; <label>:11                                      ; preds = %8
  ...
  br i1 %22, label %23, label %28, !llfi_index !479

; <label>:23                                      ; preds = %11
  %24 = load float* %dist, align 4, !llfi_index !480
  %25 = load float* %dist, align 4, !llfi_index !480
  %check_cmp1 = fcmp ueq float %24, %25
...
; <label>:9                                       ; preds = %checkBb, %4
  br i1 %7, label %10, label %42, !llfi_index !506
...
; <label>:10                                      ; preds = %9
  ...
  %21 = fsub float %15, %20, !llfi_index !517
  ...
  br label %36, !llfi_index !533

; <label>:36                                      ; preds = %10
  %37 = load i32* %i, align 4, !llfi_index !534
  %38 = load i32* %i, align 4, !llfi_index !534
  %39 = add nsw i32 %37, 1, !llfi_index !535
  %40 = add nsw i32 %38, 1, !llfi_index !535
  %check_cmp1 = icmp eq i32 %39, %40
...
; <label>:41                                      ; preds = %checkBb2, %36
  store i32 %39, i32* %i, align 4, !llfi_index !536
  br label %4, !llfi_index !537

; <label>:42                                      ; preds = %9
  %43 = load float* %ans, align 4, !llfi_index !538
  %44 = load float* %ans, align 4, !llfi_index !538
  %check_cmp3 = fcmp ueq float %43, %44
...
; <label>:45                                      ; preds = %checkBb4, %42
  ret float %43, !llfi_index !539
}
...
; <label>:288                                     ; preds = %checkBb4, %282
  br i1 %286, label %289, label %322, !llfi_index !886
...
; <label>:317                                     ; preds = %316
  ...
  %319 = add nsw i32 %318, 1, !llfi_index !913
...
; <label>:424                                     ; preds = %496, %423
  ...
  br i1 %427, label %428, label %499, !llfi_index !1021
...
; <label>:429                                     ; preds = %490, %428
  ...
  %433 = load i32* %2, align 4, !llfi_index !1025
  %434 = icmp slt i32 %430, %432, !llfi_index !1026
  %435 = icmp slt i32 %431, %433, !llfi_index !1026
  %check_cmp17 = icmp eq i1 %434, %435
  br i1 %check_cmp17, label %436, label %checkBb18

checkBb18:                                        ; preds = %429
  call void @check_flag()
  br label %436

; <label>:436                                     ; preds = %checkBb18, %429
  br i1 %434, label %437, label %491, !llfi_index !1027

; <label>:437                                     ; preds = %436
  %438 = load i32* %i, align 4, !llfi_index !1028
  %439 = sext i32 %438 to i64, !llfi_index !1029
  %440 = load i32** %new_centers_len, align 8, !llfi_index !1030
  %441 = getelementptr inbounds i32* %440, i64 %439, !llfi_index !1031
  %442 = load i32* %441, align 4, !llfi_index !1032
  %443 = icmp sgt i32 %442, 0, !llfi_index !1033
  %444 = icmp sgt i32 %442, 0, !llfi_index !1033
  %check_cmp19 = icmp eq i1 %443, %444
  br i1 %check_cmp19, label %445, label %checkBb20

checkBb20:                                        ; preds = %437
  call void @check_flag()
  br label %445

; <label>:445                                     ; preds = %checkBb20, %437
  br i1 %443, label %446, label %476, !llfi_index !1034

; <label>:446                                     ; preds = %445
  %447 = load i32* %j, align 4, !llfi_index !1035
  %448 = sext i32 %447 to i64, !llfi_index !1036
  %449 = load i32* %i, align 4, !llfi_index !1037
  %450 = sext i32 %449 to i64, !llfi_index !1038
  %451 = load float*** %new_centers, align 8, !llfi_index !1039
  %452 = getelementptr inbounds float** %451, i64 %450, !llfi_index !1040
  %453 = load float** %452, align 8, !llfi_index !1041
  %454 = getelementptr inbounds float* %453, i64 %448, !llfi_index !1042
  %455 = load float* %454, align 4, !llfi_index !1043
  %456 = load float* %454, align 4, !llfi_index !1043
  %457 = load i32* %i, align 4, !llfi_index !1044
  %458 = sext i32 %457 to i64, !llfi_index !1045
  %459 = load i32** %new_centers_len, align 8, !llfi_index !1046
  %460 = getelementptr inbounds i32* %459, i64 %458, !llfi_index !1047
  %461 = load i32* %460, align 4, !llfi_index !1048
  %462 = load i32* %460, align 4, !llfi_index !1048
  %463 = sitofp i32 %461 to float, !llfi_index !1049
  %464 = sitofp i32 %462 to float, !llfi_index !1049
  %465 = fdiv float %455, %463, !llfi_index !1050
  %466 = fdiv float %456, %464, !llfi_index !1050
  %check_cmp21 = fcmp ueq float %465, %466
  br i1 %check_cmp21, label %467, label %checkBb22

checkBb22:                                        ; preds = %446
  call void @check_flag()
  br label %467

; <label>:467                                     ; preds = %checkBb22, %446
  %468 = load i32* %j, align 4, !llfi_index !1051
  %469 = sext i32 %468 to i64, !llfi_index !1052
  %470 = load i32* %i, align 4, !llfi_index !1053
  %471 = sext i32 %470 to i64, !llfi_index !1054
  %472 = load float*** %clusters, align 8, !llfi_index !1055
  %473 = getelementptr inbounds float** %472, i64 %471, !llfi_index !1056
  %474 = load float** %473, align 8, !llfi_index !1057
  %475 = getelementptr inbounds float* %474, i64 %469, !llfi_index !1058
  store float %465, float* %475, align 4, !llfi_index !1059
  br label %476, !llfi_index !1060

; <label>:476                                     ; preds = %467, %445
  %477 = load i32* %j, align 4, !llfi_index !1061
  %478 = sext i32 %477 to i64, !llfi_index !1062
  %479 = load i32* %i, align 4, !llfi_index !1063
  %480 = sext i32 %479 to i64, !llfi_index !1064
  %481 = load float*** %new_centers, align 8, !llfi_index !1065
  %482 = getelementptr inbounds float** %481, i64 %480, !llfi_index !1066
  %483 = load float** %482, align 8, !llfi_index !1067
  %484 = getelementptr inbounds float* %483, i64 %478, !llfi_index !1068
  store float 0.000000e+00, float* %484, align 4, !llfi_index !1069
  br label %485, !llfi_index !1070

; <label>:485                                     ; preds = %476
  %486 = load i32* %j, align 4, !llfi_index !1071
  %487 = load i32* %j, align 4, !llfi_index !1071
  %488 = add nsw i32 %486, 1, !llfi_index !1072
  %489 = add nsw i32 %487, 1, !llfi_index !1072
  %check_cmp23 = icmp eq i32 %488, %489
  br i1 %check_cmp23, label %490, label %checkBb24

checkBb24:                                        ; preds = %485
  call void @check_flag()
  br label %490

; <label>:490                                     ; preds = %checkBb24, %485
  store i32 %488, i32* %j, align 4, !llfi_index !1073
  br label %429, !llfi_index !1074

; <label>:491                                     ; preds = %436
  %492 = load i32* %i, align 4, !llfi_index !1075
  %493 = sext i32 %492 to i64, !llfi_index !1076
  %494 = load i32** %new_centers_len, align 8, !llfi_index !1077
  %495 = getelementptr inbounds i32* %494, i64 %493, !llfi_index !1078
  store i32 0, i32* %495, align 4, !llfi_index !1079
  br label %496, !llfi_index !1080

; <label>:496                                     ; preds = %491
  %497 = load i32* %i, align 4, !llfi_index !1081
  %498 = add nsw i32 %497, 1, !llfi_index !1082
  store i32 %498, i32* %i, align 4, !llfi_index !1083
  br label %424, !llfi_index !1084

; <label>:499                                     ; preds = %424
  br label %500, !llfi_index !1085

; <label>:500                                     ; preds = %499
  %501 = load float* %delta, align 4, !llfi_index !1086
  %502 = load float* %5, align 4, !llfi_index !1087
  %503 = fcmp ogt float %501, %502, !llfi_index !1088
  br i1 %503, label %504, label %508, !llfi_index !1089

; <label>:504                                     ; preds = %500
  %505 = load i32* %loop, align 4, !llfi_index !1090
  %506 = add nsw i32 %505, 1, !llfi_index !1091
  store i32 %506, i32* %loop, align 4, !llfi_index !1092
  %507 = icmp slt i32 %505, 500, !llfi_index !1093
  br label %508, !llfi_index !1094

; <label>:508                                     ; preds = %504, %500
  %509 = phi i1 [ false, %500 ], [ %507, %504 ], !llfi_index !1095
  br i1 %509, label %233, label %510, !llfi_index !1096

; <label>:510                                     ; preds = %508
  %511 = load float*** %new_centers, align 8, !llfi_index !1097
  %512 = getelementptr inbounds float** %511, i64 0, !llfi_index !1098
  %513 = load float** %512, align 8, !llfi_index !1099
  %514 = bitcast float* %513 to i8*, !llfi_index !1100
  call void @free(i8* %514) #5, !llfi_index !1101
  %515 = load float*** %new_centers, align 8, !llfi_index !1102
  %516 = bitcast float** %515 to i8*, !llfi_index !1103
  call void @free(i8* %516) #5, !llfi_index !1104
  %517 = load i32** %new_centers_len, align 8, !llfi_index !1105
  %518 = bitcast i32* %517 to i8*, !llfi_index !1106
  call void @free(i8* %518) #5, !llfi_index !1107
  %519 = load float*** %clusters, align 8, !llfi_index !1108
  ret float** %519, !llfi_index !1109
}
