...
; <label>:10                                      ; preds = %checkBb, %4
  br i1 %8, label %11, label %53, !llfi_index !506
...
; <label>:11                                      ; preds = %10
  ...
  %23 = load float* %21, align 4, !llfi_index !516
  %24 = fsub float %16, %22, !llfi_index !517
  %25 = fsub float %17, %23, !llfi_index !517
  %26 = load i32* %i, align 4, !llfi_index !518
  %27 = sext i32 %26 to i64, !llfi_index !519
  %28 = load float** %1, align 8, !llfi_index !520
  %29 = getelementptr inbounds float* %28, i64 %27, !llfi_index !521
  %30 = load float* %29, align 4, !llfi_index !522
  %31 = load float* %29, align 4, !llfi_index !522
  %32 = load i32* %i, align 4, !llfi_index !523
  %33 = sext i32 %32 to i64, !llfi_index !524
  %34 = load float** %2, align 8, !llfi_index !525
  %35 = getelementptr inbounds float* %34, i64 %33, !llfi_index !526
  %36 = load float* %35, align 4, !llfi_index !527
  %37 = load float* %35, align 4, !llfi_index !527
  %38 = fsub float %30, %36, !llfi_index !528
  %39 = fsub float %31, %37, !llfi_index !528
  %40 = fmul float %24, %38, !llfi_index !529
  %41 = fmul float %25, %39, !llfi_index !529
  %42 = load float* %ans, align 4, !llfi_index !530
  %43 = load float* %ans, align 4, !llfi_index !530
  %44 = fadd float %42, %40, !llfi_index !531
  %45 = fadd float %43, %41, !llfi_index !531
  %check_cmp1 = fcmp ueq float %44, %45
...
; <label>:46                                      ; preds = %checkBb2, %11
  store float %44, float* %ans, align 4, !llfi_index !532
  br label %47, !llfi_index !533

; <label>:47                                      ; preds = %46
  %48 = load i32* %i, align 4, !llfi_index !534
  %49 = load i32* %i, align 4, !llfi_index !534
  %50 = add nsw i32 %48, 1, !llfi_index !535
  %51 = add nsw i32 %49, 1, !llfi_index !535
  %check_cmp3 = icmp eq i32 %50, %51
...
; <label>:52                                      ; preds = %checkBb4, %47
  store i32 %50, i32* %i, align 4, !llfi_index !536
  br label %4, !llfi_index !537

; <label>:53                                      ; preds = %10
  %54 = load float* %ans, align 4, !llfi_index !538
  %55 = load float* %ans, align 4, !llfi_index !538
  %check_cmp5 = fcmp ueq float %54, %55
...
; <label>:430                                     ; preds = %491, %429
  ...
  %434 = load i32* %2, align 4, !llfi_index !1025
  %435 = icmp slt i32 %431, %433, !llfi_index !1026
  %436 = icmp slt i32 %432, %434, !llfi_index !1026
  %check_cmp17 = icmp eq i1 %435, %436
  br i1 %check_cmp17, label %437, label %checkBb18

checkBb18:                                        ; preds = %430
  call void @check_flag()
  br label %437

; <label>:437                                     ; preds = %checkBb18, %430
  br i1 %435, label %438, label %492, !llfi_index !1027

; <label>:438                                     ; preds = %437
  %439 = load i32* %i, align 4, !llfi_index !1028
  %440 = sext i32 %439 to i64, !llfi_index !1029
  %441 = load i32** %new_centers_len, align 8, !llfi_index !1030
  %442 = getelementptr inbounds i32* %441, i64 %440, !llfi_index !1031
  %443 = load i32* %442, align 4, !llfi_index !1032
  %444 = icmp sgt i32 %443, 0, !llfi_index !1033
  %445 = icmp sgt i32 %443, 0, !llfi_index !1033
  %check_cmp19 = icmp eq i1 %444, %445
  br i1 %check_cmp19, label %446, label %checkBb20

checkBb20:                                        ; preds = %438
  call void @check_flag()
  br label %446

; <label>:446                                     ; preds = %checkBb20, %438
  br i1 %444, label %447, label %477, !llfi_index !1034

; <label>:447                                     ; preds = %446
  %448 = load i32* %j, align 4, !llfi_index !1035
  %449 = sext i32 %448 to i64, !llfi_index !1036
  %450 = load i32* %i, align 4, !llfi_index !1037
  %451 = sext i32 %450 to i64, !llfi_index !1038
  %452 = load float*** %new_centers, align 8, !llfi_index !1039
  %453 = getelementptr inbounds float** %452, i64 %451, !llfi_index !1040
  %454 = load float** %453, align 8, !llfi_index !1041
  %455 = getelementptr inbounds float* %454, i64 %449, !llfi_index !1042
  %456 = load float* %455, align 4, !llfi_index !1043
  %457 = load float* %455, align 4, !llfi_index !1043
  %458 = load i32* %i, align 4, !llfi_index !1044
  %459 = sext i32 %458 to i64, !llfi_index !1045
  %460 = load i32** %new_centers_len, align 8, !llfi_index !1046
  %461 = getelementptr inbounds i32* %460, i64 %459, !llfi_index !1047
  %462 = load i32* %461, align 4, !llfi_index !1048
  %463 = load i32* %461, align 4, !llfi_index !1048
  %464 = sitofp i32 %462 to float, !llfi_index !1049
  %465 = sitofp i32 %463 to float, !llfi_index !1049
  %466 = fdiv float %456, %464, !llfi_index !1050
  %467 = fdiv float %457, %465, !llfi_index !1050
  %check_cmp21 = fcmp ueq float %466, %467
  br i1 %check_cmp21, label %468, label %checkBb22

checkBb22:                                        ; preds = %447
  call void @check_flag()
  br label %468

; <label>:468                                     ; preds = %checkBb22, %447
  %469 = load i32* %j, align 4, !llfi_index !1051
  %470 = sext i32 %469 to i64, !llfi_index !1052
  %471 = load i32* %i, align 4, !llfi_index !1053
  %472 = sext i32 %471 to i64, !llfi_index !1054
  %473 = load float*** %clusters, align 8, !llfi_index !1055
  %474 = getelementptr inbounds float** %473, i64 %472, !llfi_index !1056
  %475 = load float** %474, align 8, !llfi_index !1057
  %476 = getelementptr inbounds float* %475, i64 %470, !llfi_index !1058
  store float %466, float* %476, align 4, !llfi_index !1059
  br label %477, !llfi_index !1060

; <label>:477                                     ; preds = %468, %446
  %478 = load i32* %j, align 4, !llfi_index !1061
  %479 = sext i32 %478 to i64, !llfi_index !1062
  %480 = load i32* %i, align 4, !llfi_index !1063
  %481 = sext i32 %480 to i64, !llfi_index !1064
  %482 = load float*** %new_centers, align 8, !llfi_index !1065
  %483 = getelementptr inbounds float** %482, i64 %481, !llfi_index !1066
  %484 = load float** %483, align 8, !llfi_index !1067
  %485 = getelementptr inbounds float* %484, i64 %479, !llfi_index !1068
  store float 0.000000e+00, float* %485, align 4, !llfi_index !1069
  br label %486, !llfi_index !1070

; <label>:486                                     ; preds = %477
  %487 = load i32* %j, align 4, !llfi_index !1071
  %488 = load i32* %j, align 4, !llfi_index !1071
  %489 = add nsw i32 %487, 1, !llfi_index !1072
  %490 = add nsw i32 %488, 1, !llfi_index !1072
  %check_cmp23 = icmp eq i32 %489, %490
  br i1 %check_cmp23, label %491, label %checkBb24

checkBb24:                                        ; preds = %486
  call void @check_flag()
  br label %491

; <label>:491                                     ; preds = %checkBb24, %486
  store i32 %489, i32* %j, align 4, !llfi_index !1073
  br label %430, !llfi_index !1074

; <label>:492                                     ; preds = %437
  %493 = load i32* %i, align 4, !llfi_index !1075
  %494 = sext i32 %493 to i64, !llfi_index !1076
  %495 = load i32** %new_centers_len, align 8, !llfi_index !1077
  %496 = getelementptr inbounds i32* %495, i64 %494, !llfi_index !1078
  store i32 0, i32* %496, align 4, !llfi_index !1079
  br label %497, !llfi_index !1080

; <label>:497                                     ; preds = %492
  %498 = load i32* %i, align 4, !llfi_index !1081
  %499 = add nsw i32 %498, 1, !llfi_index !1082
  store i32 %499, i32* %i, align 4, !llfi_index !1083
  br label %425, !llfi_index !1084

; <label>:500                                     ; preds = %425
  br label %501, !llfi_index !1085

; <label>:501                                     ; preds = %500
  %502 = load float* %delta, align 4, !llfi_index !1086
  %503 = load float* %5, align 4, !llfi_index !1087
  %504 = fcmp ogt float %502, %503, !llfi_index !1088
  br i1 %504, label %505, label %509, !llfi_index !1089

; <label>:505                                     ; preds = %501
  %506 = load i32* %loop, align 4, !llfi_index !1090
  %507 = add nsw i32 %506, 1, !llfi_index !1091
  store i32 %507, i32* %loop, align 4, !llfi_index !1092
  %508 = icmp slt i32 %506, 500, !llfi_index !1093
  br label %509, !llfi_index !1094

; <label>:509                                     ; preds = %505, %501
  %510 = phi i1 [ false, %501 ], [ %508, %505 ], !llfi_index !1095
  br i1 %510, label %233, label %511, !llfi_index !1096

; <label>:511                                     ; preds = %509
  %512 = load float*** %new_centers, align 8, !llfi_index !1097
  %513 = getelementptr inbounds float** %512, i64 0, !llfi_index !1098
  %514 = load float** %513, align 8, !llfi_index !1099
  %515 = bitcast float* %514 to i8*, !llfi_index !1100
  call void @free(i8* %515) #5, !llfi_index !1101
  %516 = load float*** %new_centers, align 8, !llfi_index !1102
  %517 = bitcast float** %516 to i8*, !llfi_index !1103
  call void @free(i8* %517) #5, !llfi_index !1104
  %518 = load i32** %new_centers_len, align 8, !llfi_index !1105
  %519 = bitcast i32* %518 to i8*, !llfi_index !1106
  call void @free(i8* %519) #5, !llfi_index !1107
  %520 = load float*** %clusters, align 8, !llfi_index !1108
  ret float** %520, !llfi_index !1109
}
