...
; <label>:5                                       ; preds = %35, %0
  ...
  %9 = icmp slt i32 %6, %7, !llfi_index !465
...
; <label>:10                                      ; preds = %checkBb, %5
  br i1 %8, label %11, label %36, !llfi_index !466
...
; <label>:11                                      ; preds = %10
  ...
  %22 = load float* %min_dist, align 4, !llfi_index !477
  %23 = fcmp olt float %20, %21, !llfi_index !478
  %24 = fcmp olt float %20, %22, !llfi_index !478
...
; <label>:25                                      ; preds = %checkBb2, %11
  br i1 %23, label %26, label %29, !llfi_index !479

; <label>:26                                      ; preds = %25
  %27 = load float* %dist, align 4, !llfi_index !480
  store float %27, float* %min_dist, align 4, !llfi_index !481
  %28 = load i32* %i, align 4, !llfi_index !482
  store i32 %28, i32* %index, align 4, !llfi_index !483
  br label %29, !llfi_index !484

; <label>:29                                      ; preds = %26, %25
  br label %30, !llfi_index !485

; <label>:30                                      ; preds = %29
  %31 = load i32* %i, align 4, !llfi_index !486
  %32 = load i32* %i, align 4, !llfi_index !486
  %33 = add nsw i32 %31, 1, !llfi_index !487
...
; <label>:35                                      ; preds = %checkBb4, %30
  store i32 %33, i32* %i, align 4, !llfi_index !488
  br label %5, !llfi_index !489

; <label>:36                                      ; preds = %10
  %37 = load i32* %index, align 4, !llfi_index !490
  ret i32 %37, !llfi_index !491
}
...
; <label>:9                                       ; preds = %checkBb, %4
  br i1 %7, label %10, label %44, !llfi_index !506
...
; <label>:10                                      ; preds = %9
  ...
  %33 = fsub float %26, %31, !llfi_index !528
  %34 = fmul float %21, %32, !llfi_index !529
  %35 = fmul float %21, %33, !llfi_index !529
...
; <label>:36                                      ; preds = %checkBb2, %10
  %37 = load float* %ans, align 4, !llfi_index !530
...
; <label>:39                                      ; preds = %checkBb4, %36
  %40 = fadd float %37, %34, !llfi_index !531
  store float %40, float* %ans, align 4, !llfi_index !532
  br label %41, !llfi_index !533

; <label>:41                                      ; preds = %39
  %42 = load i32* %i, align 4, !llfi_index !534
  %43 = add nsw i32 %42, 1, !llfi_index !535
  store i32 %43, i32* %i, align 4, !llfi_index !536
  br label %4, !llfi_index !537

; <label>:44                                      ; preds = %9
  %45 = load float* %ans, align 4, !llfi_index !538
  ret float %45, !llfi_index !539
}
