...
; <label>:29                                      ; preds = %91, %22
  %30 = load i32* %j, align 4, !llfi_index !224
  %31 = load i32* %j, align 4, !llfi_index !224
  %32 = load i32* %2, align 4, !llfi_index !225
  %33 = sext i32 %32 to i64, !llfi_index !226
  %34 = load i32** %5, align 8, !llfi_index !227
  %35 = load i32** %5, align 8, !llfi_index !227
  %36 = getelementptr inbounds i32* %34, i64 %33, !llfi_index !228
  %37 = getelementptr inbounds i32* %35, i64 %33, !llfi_index !228
  %check_cmp = icmp eq i32* %36, %37
...
; <label>:38                                      ; preds = %checkBb, %29
  %39 = load i32* %36, align 4, !llfi_index !229
  %40 = icmp slt i32 %30, %39, !llfi_index !230
  %41 = icmp slt i32 %31, %39, !llfi_index !230
...
; <label>:42                                      ; preds = %checkBb2, %38
  br i1 %40, label %43, label %94, !llfi_index !231

; <label>:43                                      ; preds = %42
  %44 = load i32* %j, align 4, !llfi_index !232
  %45 = sext i32 %44 to i64, !llfi_index !233
  %46 = load i32* %2, align 4, !llfi_index !234
  %47 = sext i32 %46 to i64, !llfi_index !235
  %48 = load i32*** %9, align 8, !llfi_index !236
  %49 = getelementptr inbounds i32** %48, i64 %47, !llfi_index !237
  %50 = load i32** %49, align 8, !llfi_index !238
  %51 = getelementptr inbounds i32* %50, i64 %45, !llfi_index !239
  %52 = load i32* %51, align 4, !llfi_index !240
  store i32 %52, i32* %p_nuc, align 4, !llfi_index !241
  %53 = load i32* %j, align 4, !llfi_index !242
  %54 = sext i32 %53 to i64, !llfi_index !243
  %55 = load i32* %2, align 4, !llfi_index !244
  %56 = sext i32 %55 to i64, !llfi_index !245
  %57 = load double*** %6, align 8, !llfi_index !246
  %58 = getelementptr inbounds double** %57, i64 %56, !llfi_index !247
  %59 = load double** %58, align 8, !llfi_index !248
  %60 = getelementptr inbounds double* %59, i64 %54, !llfi_index !249
  %61 = load double* %60, align 8, !llfi_index !250
  store double %61, double* %conc, align 8, !llfi_index !251
  %62 = load double* %1, align 8, !llfi_index !252
  %63 = load i32* %p_nuc, align 4, !llfi_index !253
  %64 = load i64* %3, align 8, !llfi_index !254
  %65 = load i64* %4, align 8, !llfi_index !255
  %66 = load %struct.GridPoint** %7, align 8, !llfi_index !256
  %67 = load %struct.NuclideGridPoint*** %8, align 8, !llfi_index !257
  %68 = load i64* %idx, align 8, !llfi_index !258
  %69 = trunc i64 %68 to i32, !llfi_index !259
  %70 = getelementptr inbounds [5 x double]* %xs_vector, i32 0, i32 0, !llfi_index !260
  call void @calculate_micro_xs(double %62, i32 %63, i64 %64, i64 %65, %struct.GridPoint* %66, %struct.NuclideGridPoint** %67, i32 %69, double* %70), !llfi_index !261
  store i32 0, i32* %k1, align 4, !llfi_index !262
  br label %71, !llfi_index !263

; <label>:71                                      ; preds = %87, %43
  %72 = load i32* %k1, align 4, !llfi_index !264
  %73 = icmp slt i32 %72, 5, !llfi_index !265
  br i1 %73, label %74, label %90, !llfi_index !266

; <label>:74                                      ; preds = %71
  %75 = load i32* %k1, align 4, !llfi_index !267
  %76 = sext i32 %75 to i64, !llfi_index !268
  %77 = getelementptr inbounds [5 x double]* %xs_vector, i32 0, i64 %76, !llfi_index !269
  %78 = load double* %77, align 8, !llfi_index !270
  %79 = load double* %conc, align 8, !llfi_index !271
  %80 = fmul double %78, %79, !llfi_index !272
  %81 = load i32* %k1, align 4, !llfi_index !273
  %82 = sext i32 %81 to i64, !llfi_index !274
  %83 = load double** %10, align 8, !llfi_index !275
  %84 = getelementptr inbounds double* %83, i64 %82, !llfi_index !276
  %85 = load double* %84, align 8, !llfi_index !277
  %86 = fadd double %85, %80, !llfi_index !278
  store double %86, double* %84, align 8, !llfi_index !279
  br label %87, !llfi_index !280

; <label>:87                                      ; preds = %74
  %88 = load i32* %k1, align 4, !llfi_index !281
  %89 = add nsw i32 %88, 1, !llfi_index !282
  store i32 %89, i32* %k1, align 4, !llfi_index !283
  br label %71, !llfi_index !284

; <label>:90                                      ; preds = %71
  br label %91, !llfi_index !285

; <label>:91                                      ; preds = %90
  %92 = load i32* %j, align 4, !llfi_index !286
  %93 = add nsw i32 %92, 1, !llfi_index !287
  store i32 %93, i32* %j, align 4, !llfi_index !288
...
; <label>:44                                      ; preds = %120, %0
  ...
  %48 = load i32* %46, align 4, !llfi_index !1232
  %49 = load i32* %47, align 4, !llfi_index !1232
  %50 = icmp slt i32 %45, %48, !llfi_index !1233
  %51 = icmp slt i32 %45, %49, !llfi_index !1233
...
; <label>:52                                      ; preds = %checkBb, %44
  br i1 %50, label %53, label %121, !llfi_index !1234

; <label>:53                                      ; preds = %52
  %54 = call double @rn_v(), !llfi_index !1235
  store double %54, double* %p_energy, align 8, !llfi_index !1236
  %55 = call i32 @pick_mat(i64* %seed), !llfi_index !1237
  store i32 %55, i32* %mat, align 4, !llfi_index !1238
  %56 = load double* %p_energy, align 8, !llfi_index !1239
  %57 = load i32* %mat, align 4, !llfi_index !1240
...
; <label>:59                                      ; preds = %checkBb2, %53
  %60 = getelementptr inbounds %struct.Inputs* %in, i32 0, i32 1, !llfi_index !1241
  %61 = load i64* %60, align 8, !llfi_index !1242
  %62 = getelementptr inbounds %struct.Inputs* %in, i32 0, i32 2, !llfi_index !1243
  %63 = load i64* %62, align 8, !llfi_index !1244
  %64 = load i32** %num_nucs, align 8, !llfi_index !1245
...
; <label>:66                                      ; preds = %checkBb4, %59
  %67 = load double*** %concs, align 8, !llfi_index !1246
  %68 = load %struct.GridPoint** %energy_grid, align 8, !llfi_index !1247
  %69 = load %struct.NuclideGridPoint*** %nuclide_grids, align 8, !llfi_index !1248
  %70 = load i32*** %mats, align 8, !llfi_index !1249
  %71 = getelementptr inbounds [5 x double]* %macro_xs_vector, i32 0, i32 0, !llfi_index !1250
  call void @calculate_macro_xs(double %56, i32 %57, i64 %61, i64 %63, i32* %64, double** %67, %struct.GridPoint* %68, %struct.NuclideGridPoint** %69, i32** %70, double* %71), !llfi_index !1251
  %72 = load double** %xs, align 8, !llfi_index !1252
  %73 = bitcast double* %72 to i8*, !llfi_index !1253
  %74 = bitcast [5 x double]* %macro_xs_vector to i8*, !llfi_index !1254
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %73, i8* %74, i64 40, i32 8, i1 false), !llfi_index !1255
  %75 = getelementptr inbounds [256 x i8]* %line, i32 0, i32 0, !llfi_index !1256
  %76 = load double* %p_energy, align 8, !llfi_index !1257
  %77 = load i32* %mat, align 4, !llfi_index !1258
...
; <label>:79                                      ; preds = %checkBb6, %66
  %80 = getelementptr inbounds [5 x double]* %macro_xs_vector, i32 0, i64 0, !llfi_index !1259
  %81 = getelementptr inbounds [5 x double]* %macro_xs_vector, i32 0, i64 0, !llfi_index !1259
  %check_cmp7 = icmp eq double* %80, %81
...
; <label>:82                                      ; preds = %checkBb8, %79
  %83 = load double* %80, align 8, !llfi_index !1260
  %84 = getelementptr inbounds [5 x double]* %macro_xs_vector, i32 0, i64 1, !llfi_index !1261
...
; <label>:86                                      ; preds = %checkBb10, %82
  %87 = load double* %84, align 8, !llfi_index !1262
  %88 = getelementptr inbounds [5 x double]* %macro_xs_vector, i32 0, i64 2, !llfi_index !1263
...
; <label>:90                                      ; preds = %checkBb12, %86
  %91 = load double* %88, align 8, !llfi_index !1264
  %92 = getelementptr inbounds [5 x double]* %macro_xs_vector, i32 0, i64 3, !llfi_index !1265
  %93 = getelementptr inbounds [5 x double]* %macro_xs_vector, i32 0, i64 3, !llfi_index !1265
  %check_cmp13 = icmp eq double* %92, %93
...
; <label>:94                                      ; preds = %checkBb14, %90
  %95 = load double* %92, align 8, !llfi_index !1266
  %96 = getelementptr inbounds [5 x double]* %macro_xs_vector, i32 0, i64 4, !llfi_index !1267
  %97 = getelementptr inbounds [5 x double]* %macro_xs_vector, i32 0, i64 4, !llfi_index !1267
  %check_cmp15 = icmp eq double* %96, %97
...
; <label>:98                                      ; preds = %checkBb16, %94
  %99 = load double* %96, align 8, !llfi_index !1268
  %100 = call i32 (i8*, i8*, ...)* @sprintf(i8* %75, i8* getelementptr inbounds ([39 x i8]* @.str38, i32 0, i32 0), double %76, i32 %77, double %83, double %87, double %91, double %95, double %99) #4, !llfi_index !1269
  %101 = getelementptr inbounds [256 x i8]* %line, i32 0, i32 0, !llfi_index !1270
  %102 = getelementptr inbounds [256 x i8]* %line, i32 0, i32 0, !llfi_index !1270
  %check_cmp17 = icmp eq i8* %101, %102
...
; <label>:103                                     ; preds = %checkBb18, %98
  %104 = call i32 @hash(i8* %101, i32 10000), !llfi_index !1271
  %105 = zext i32 %104 to i64, !llfi_index !1272
  %106 = zext i32 %104 to i64, !llfi_index !1272
...
; <label>:107                                     ; preds = %checkBb20, %103
  store i64 %105, i64* %vhash_local, align 8, !llfi_index !1273
  %108 = load i64* %vhash_local, align 8, !llfi_index !1274
  %109 = load i64* %vhash_local, align 8, !llfi_index !1274
  %110 = load i64* %vhash, align 8, !llfi_index !1275
  %111 = load i64* %vhash, align 8, !llfi_index !1275
  %112 = add i64 %110, %108, !llfi_index !1276
  %113 = add i64 %111, %109, !llfi_index !1276
  %check_cmp21 = icmp eq i64 %112, %113
...
; <label>:114                                     ; preds = %checkBb22, %107
  store i64 %112, i64* %vhash, align 8, !llfi_index !1277
  br label %115, !llfi_index !1278

; <label>:115                                     ; preds = %114
  %116 = load i32* %i, align 4, !llfi_index !1279
  %117 = load i32* %i, align 4, !llfi_index !1279
  %118 = add nsw i32 %116, 1, !llfi_index !1280
...
; <label>:120                                     ; preds = %checkBb24, %115
  store i32 %118, i32* %i, align 4, !llfi_index !1281
  br label %44, !llfi_index !1282

; <label>:121                                     ; preds = %52
  %122 = load i32* %mype, align 4, !llfi_index !1283
  %123 = load i32* %nprocs, align 4, !llfi_index !1284
  %124 = load i64* %vhash, align 8, !llfi_index !1285
  call void @print_results(%struct.Inputs* byval align 8 %in, i32 %122, double 0.000000e+00, i32 %123, i64 %124), !llfi_index !1286
