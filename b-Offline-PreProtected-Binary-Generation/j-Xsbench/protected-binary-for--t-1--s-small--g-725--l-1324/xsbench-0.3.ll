...
; <label>:29                                      ; preds = %92, %22
  ...
  %33 = sext i32 %31 to i64, !llfi_index !226
...
; <label>:39                                      ; preds = %checkBb, %29
  %40 = load i32* %37, align 4, !llfi_index !229
  %41 = icmp slt i32 %30, %40, !llfi_index !230
  %42 = icmp slt i32 %30, %40, !llfi_index !230
  %check_cmp1 = icmp eq i1 %41, %42
...
; <label>:5                                       ; preds = %33, %0
  ...
  br i1 %7, label %8, label %36, !llfi_index !1738
...
; <label>:10                                      ; preds = %23, %8
  ...
  %12 = load i32* %j, align 4, !llfi_index !1743
  %13 = icmp sgt i32 %11, 0, !llfi_index !1744
  %14 = icmp sgt i32 %12, 0, !llfi_index !1744
...
; <label>:15                                      ; preds = %checkBb, %10
  br i1 %13, label %16, label %26, !llfi_index !1745

; <label>:16                                      ; preds = %15
  %17 = load i32* %j, align 4, !llfi_index !1746
  %18 = sext i32 %17 to i64, !llfi_index !1747
  %19 = getelementptr inbounds [12 x double]* %dist, i32 0, i64 %18, !llfi_index !1748
  %20 = load double* %19, align 8, !llfi_index !1749
  %21 = load double* %running, align 8, !llfi_index !1750
  %22 = fadd double %21, %20, !llfi_index !1751
  store double %22, double* %running, align 8, !llfi_index !1752
  br label %23, !llfi_index !1753

; <label>:23                                      ; preds = %16
  %24 = load i32* %j, align 4, !llfi_index !1754
  %25 = add nsw i32 %24, -1, !llfi_index !1755
  store i32 %25, i32* %j, align 4, !llfi_index !1756
  br label %10, !llfi_index !1757

; <label>:26                                      ; preds = %15
  %27 = load double* %roll, align 8, !llfi_index !1758
  %28 = load double* %running, align 8, !llfi_index !1759
  %29 = fcmp olt double %27, %28, !llfi_index !1760
  br i1 %29, label %30, label %32, !llfi_index !1761

; <label>:30                                      ; preds = %26
  %31 = load i32* %i, align 4, !llfi_index !1762
  store i32 %31, i32* %1, !llfi_index !1763
  br label %37, !llfi_index !1764

; <label>:32                                      ; preds = %26
  br label %33, !llfi_index !1765

; <label>:33                                      ; preds = %32
  %34 = load i32* %i, align 4, !llfi_index !1766
  %35 = add nsw i32 %34, 1, !llfi_index !1767
  store i32 %35, i32* %i, align 4, !llfi_index !1768
  br label %5, !llfi_index !1769

; <label>:36                                      ; preds = %5
  store i32 0, i32* %1, !llfi_index !1770
  br label %37, !llfi_index !1771

; <label>:37                                      ; preds = %36, %30
  %38 = load i32* %1, !llfi_index !1772
  ret i32 %38, !llfi_index !1773
}
