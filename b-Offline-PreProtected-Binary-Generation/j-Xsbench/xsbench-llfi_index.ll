; ModuleID = '/research-projects/fault-tolerance/SC25-Unified-SDC-Coverage/random-fi-parallel/xsbench/xsbench--t-1--s-small--g-1000--l-10/fi-0/xsbench.ll'
...
@.str = private unnamed_addr constant [24 x i8] c"ERROR - Out Of Memory!\0A\00", align 1
...
@.str12 = private unnamed_addr constant [31 x i8] c"Unionized Energy Gridpoints:  \00", align 1
...
define %struct.GridPoint* @generate_energy_grid(i64 %n_isotopes, i64 %n_gridpoints, %struct.NuclideGridPoint** %nuclide_grids) #0 {
  ...
  %9 = call noalias i8* @malloc(i64 %8) #3, !llfi_index !570
...
; <label>:52                                      ; preds = %33
  ...
  %58 = call noalias i8* @malloc(i64 %57) #3, !llfi_index !627
...
; <label>:62                                      ; preds = %52
  ...
  %64 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %63, i8* getelementptr inbounds ([24 x i8]* @.str, i32 0, i32 0)), !llfi_index !634
...
; <label>:44                                      ; preds = %5
  %45 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([2 x i8]* @.str1, i32 0, i32 0)), !llfi_index !717
...
define void @logo(i32 %version) #0 {
  ...
  %5 = call i32 (i8*, i8*, ...)* @sprintf(i8* %3, i8* getelementptr inbounds ([12 x i8]* @.str24, i32 0, i32 0), i32 %4) #3, !llfi_index !728
...
define void @print_inputs(%struct.Inputs* byval align 8 %in, i32 %nprocs, i32 %version) #0 {
  ...
  %17 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([31 x i8]* @.str12, i32 0, i32 0)), !llfi_index !806
...
define void @read_CLI(%struct.Inputs* noalias sret %agg.result, i32 %argc, i8** %argv) #0 {
  ...
  %7 = call noalias i8* @malloc(i64 6) #3, !llfi_index !913
...
define double @get_wtime() #0 {
  ...
  %1 = call i32 @gettimeofday(%struct.timeval* %tv, %struct.timezone* null) #3, !llfi_index !1134
...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  call void @srand(i32 26) #3, !llfi_index !1175
  ...
  %42 = call noalias i8* @calloc(i64 5, i64 8) #3, !llfi_index !1223
...
; <label>:49                                      ; preds = %44
  ...
  %80 = call i32 (i8*, i8*, ...)* @sprintf(i8* %67, i8* getelementptr inbounds ([39 x i8]* @.str38, i32 0, i32 0), double %68, i32 %69, double %71, double %73, double %75, double %77, double %79) #3, !llfi_index !1269
...
define i32* @load_num_nucs(i64 %n_isotopes) #0 {
  ...
  %2 = call noalias i8* @malloc(i64 48) #3, !llfi_index !1291
...
define i32** @load_mats(i32* %num_nucs, i64 %n_isotopes) #0 {
  ...
  %3 = call noalias i8* @malloc(i64 96) #3, !llfi_index !1360
...
; <label>:8                                       ; preds = %5
  ...
  %16 = call noalias i8* @malloc(i64 %15) #3, !llfi_index !1375
...
define double** @load_concs(i32* %num_nucs) #0 {
  ...
  %2 = call noalias i8* @malloc(i64 96) #3, !llfi_index !1586
...
; <label>:7                                       ; preds = %4
  ...
  %15 = call noalias i8* @malloc(i64 %14) #3, !llfi_index !1601
...
; <label>:37                                      ; preds = %29
  %38 = call i32 @rand() #3, !llfi_index !1628
...
define double** @load_concs_v(i32* %num_nucs) #0 {
  ...
  %2 = call noalias i8* @malloc(i64 96) #3, !llfi_index !1658
...
; <label>:7                                       ; preds = %4
  ...
  %15 = call noalias i8* @malloc(i64 %14) #3, !llfi_index !1673
...
; <label>:5                                       ; preds = %30, %0
  ...
  %7 = icmp slt i32 %6, 12, !llfi_index !1737
  br i1 %7, label %8, label %33, !llfi_index !1738

; <label>:8                                       ; preds = %5
  store double 0.000000e+00, double* %running, align 8, !llfi_index !1739
  %9 = load i32* %i, align 4, !llfi_index !1740
  store i32 %9, i32* %j, align 4, !llfi_index !1741
  br label %10, !llfi_index !1742

; <label>:10                                      ; preds = %20, %8
  %11 = load i32* %j, align 4, !llfi_index !1743
  %12 = icmp sgt i32 %11, 0, !llfi_index !1744
  br i1 %12, label %13, label %23, !llfi_index !1745

; <label>:13                                      ; preds = %10
  %14 = load i32* %j, align 4, !llfi_index !1746
  %15 = sext i32 %14 to i64, !llfi_index !1747
  %16 = getelementptr inbounds [12 x double]* %dist, i32 0, i64 %15, !llfi_index !1748
  %17 = load double* %16, align 8, !llfi_index !1749
  %18 = load double* %running, align 8, !llfi_index !1750
  %19 = fadd double %18, %17, !llfi_index !1751
  store double %19, double* %running, align 8, !llfi_index !1752
  br label %20, !llfi_index !1753

; <label>:20                                      ; preds = %13
  %21 = load i32* %j, align 4, !llfi_index !1754
  %22 = add nsw i32 %21, -1, !llfi_index !1755
  store i32 %22, i32* %j, align 4, !llfi_index !1756
  br label %10, !llfi_index !1757

; <label>:23                                      ; preds = %10
  %24 = load double* %roll, align 8, !llfi_index !1758
  %25 = load double* %running, align 8, !llfi_index !1759
  %26 = fcmp olt double %24, %25, !llfi_index !1760
  br i1 %26, label %27, label %29, !llfi_index !1761

; <label>:27                                      ; preds = %23
  %28 = load i32* %i, align 4, !llfi_index !1762
  store i32 %28, i32* %1, !llfi_index !1763
  br label %34, !llfi_index !1764

; <label>:29                                      ; preds = %23
  br label %30, !llfi_index !1765

; <label>:30                                      ; preds = %29
  %31 = load i32* %i, align 4, !llfi_index !1766
  %32 = add nsw i32 %31, 1, !llfi_index !1767
  store i32 %32, i32* %i, align 4, !llfi_index !1768
  br label %5, !llfi_index !1769

; <label>:33                                      ; preds = %5
  store i32 0, i32* %1, !llfi_index !1770
  br label %34, !llfi_index !1771

; <label>:34                                      ; preds = %33, %27
  %35 = load i32* %1, !llfi_index !1772
  ret i32 %35, !llfi_index !1773
}
...
define %struct.NuclideGridPoint** @gpmatrix(i64 %m, i64 %n) #0 {
  ...
  %7 = call noalias i8* @malloc(i64 %6) #3, !llfi_index !1786
  ...
  %11 = call noalias i8* @malloc(i64 %10) #3, !llfi_index !1791
...
; <label>:3                                       ; preds = %9, %0
  ...
  %5 = getelementptr inbounds i8* %4, i32 1, !llfi_index !2000
  store i8* %5, i8** %1, align 8, !llfi_index !2001
  %6 = load i8* %4, align 1, !llfi_index !2002
  %7 = zext i8 %6 to i32, !llfi_index !2003
  store i32 %7, i32* %c, align 4, !llfi_index !2004
  %8 = icmp ne i32 %7, 0, !llfi_index !2005
  br i1 %8, label %9, label %16, !llfi_index !2006

; <label>:9                                       ; preds = %3
  %10 = load i32* %hash, align 4, !llfi_index !2007
  %11 = shl i32 %10, 5, !llfi_index !2008
  %12 = load i32* %hash, align 4, !llfi_index !2009
  %13 = add i32 %11, %12, !llfi_index !2010
  %14 = load i32* %c, align 4, !llfi_index !2011
  %15 = add i32 %13, %14, !llfi_index !2012
  store i32 %15, i32* %hash, align 4, !llfi_index !2013
  br label %3, !llfi_index !2014

; <label>:16                                      ; preds = %3
  %17 = load i32* %hash, align 4, !llfi_index !2015
  %18 = load i32* %2, align 4, !llfi_index !2016
  %19 = urem i32 %17, %18, !llfi_index !2017
  ret i32 %19, !llfi_index !2018
}
