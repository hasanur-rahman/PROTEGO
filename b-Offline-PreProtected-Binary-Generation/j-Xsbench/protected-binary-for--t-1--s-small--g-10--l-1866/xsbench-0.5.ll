...
; <label>:29                                      ; preds = %91, %22
  ...
  %check_cmp = icmp eq i32 %31, %32
  br i1 %check_cmp, label %33, label %checkBb

checkBb:                                          ; preds = %29
  call void @check_flag()
  br label %33

; <label>:33                                      ; preds = %checkBb, %29
  %34 = sext i32 %31 to i64, !llfi_index !226
...
; <label>:37                                      ; preds = %checkBb2, %33
  %38 = getelementptr inbounds i32* %35, i64 %34, !llfi_index !228
  %39 = load i32* %38, align 4, !llfi_index !229
  %40 = icmp slt i32 %30, %39, !llfi_index !230
  %41 = icmp slt i32 %30, %39, !llfi_index !230
...
; <label>:48                                      ; preds = %checkBb, %44
  %49 = load i32* %46, align 4, !llfi_index !1232
  %50 = icmp slt i32 %45, %49, !llfi_index !1233
  %51 = icmp slt i32 %45, %49, !llfi_index !1233
  %check_cmp1 = icmp eq i1 %50, %51
...
; <label>:94                                      ; preds = %checkBb16, %90
  ...
  %check_cmp17 = icmp eq double* %96, %97
...
; <label>:98                                      ; preds = %checkBb18, %94
  ...
  %check_cmp19 = icmp eq i8* %101, %102
