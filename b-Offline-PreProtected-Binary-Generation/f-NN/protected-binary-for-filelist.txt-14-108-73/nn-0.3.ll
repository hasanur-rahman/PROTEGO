...
; <label>:124                                     ; preds = %162, %123
  ...
  br i1 %127, label %128, label %165, !llfi_index !172
...
; <label>:128                                     ; preds = %124
  ...
  %141 = fsub double %138, %139, !llfi_index !185
  %check_cmp5 = fcmp ueq double %140, %141
  br i1 %check_cmp5, label %142, label %checkBb6

checkBb6:                                         ; preds = %128
  call void @check_flag()
  br label %142

; <label>:142                                     ; preds = %checkBb6, %128
  ...
  %146 = fmul double %140, %145, !llfi_index !189
  ...
  %160 = getelementptr inbounds double* %158, i64 %157, !llfi_index !202
  %check_cmp7 = icmp eq double* %159, %160
...
; <label>:166                                     ; preds = %249, %165
  %167 = load i32* %i, align 4, !llfi_index !211
  %168 = load i32* %rec_count, align 4, !llfi_index !212
  %169 = load i32* %rec_count, align 4, !llfi_index !212
  %170 = icmp slt i32 %167, %168, !llfi_index !213
  %171 = icmp slt i32 %167, %169, !llfi_index !213
  %check_cmp9 = icmp eq i1 %170, %171
  br i1 %check_cmp9, label %172, label %checkBb10

checkBb10:                                        ; preds = %166
  call void @check_flag()
  br label %172

; <label>:172                                     ; preds = %checkBb10, %166
  br i1 %170, label %173, label %252, !llfi_index !214
...
; <label>:173                                     ; preds = %172
  ...
  br label %174, !llfi_index !218

; <label>:174                                     ; preds = %196, %173
  %175 = load i32* %j, align 4, !llfi_index !219
  %176 = load i32* %k, align 4, !llfi_index !220
  %177 = icmp slt i32 %175, %176, !llfi_index !221
  br i1 %177, label %178, label %199, !llfi_index !222

; <label>:178                                     ; preds = %174
  %179 = load i32* %j, align 4, !llfi_index !223
  %180 = sext i32 %179 to i64, !llfi_index !224
  %181 = load %struct.neighbor** %neighbors, align 8, !llfi_index !225
  %182 = getelementptr inbounds %struct.neighbor* %181, i64 %180, !llfi_index !226
  %183 = getelementptr inbounds %struct.neighbor* %182, i32 0, i32 1, !llfi_index !227
  %184 = load double* %183, align 8, !llfi_index !228
  %185 = load double* %max_dist, align 8, !llfi_index !229
  %186 = fcmp ogt double %184, %185, !llfi_index !230
  br i1 %186, label %187, label %195, !llfi_index !231

; <label>:187                                     ; preds = %178
  %188 = load i32* %j, align 4, !llfi_index !232
  %189 = sext i32 %188 to i64, !llfi_index !233
  %190 = load %struct.neighbor** %neighbors, align 8, !llfi_index !234
  %191 = getelementptr inbounds %struct.neighbor* %190, i64 %189, !llfi_index !235
  %192 = getelementptr inbounds %struct.neighbor* %191, i32 0, i32 1, !llfi_index !236
  %193 = load double* %192, align 8, !llfi_index !237
  store double %193, double* %max_dist, align 8, !llfi_index !238
  %194 = load i32* %j, align 4, !llfi_index !239
  store i32 %194, i32* %max_idx, align 4, !llfi_index !240
  br label %195, !llfi_index !241

; <label>:195                                     ; preds = %187, %178
  br label %196, !llfi_index !242

; <label>:196                                     ; preds = %195
  %197 = load i32* %j, align 4, !llfi_index !243
  %198 = add nsw i32 %197, 1, !llfi_index !244
  store i32 %198, i32* %j, align 4, !llfi_index !245
  br label %174, !llfi_index !246

; <label>:199                                     ; preds = %174
  %200 = load i32* %i, align 4, !llfi_index !247
  %201 = load i32* %i, align 4, !llfi_index !247
  %202 = sext i32 %200 to i64, !llfi_index !248
  %203 = sext i32 %201 to i64, !llfi_index !248
  %204 = load double** %z, align 8, !llfi_index !249
  %205 = getelementptr inbounds double* %204, i64 %202, !llfi_index !250
  %206 = getelementptr inbounds double* %204, i64 %203, !llfi_index !250
