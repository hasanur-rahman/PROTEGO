...
; <label>:166                                     ; preds = %checkBb6, %162
  ...
  br i1 %167, label %168, label %250, !llfi_index !214
...
; <label>:194                                     ; preds = %169
  ...
  %203 = load double* %201, align 8, !llfi_index !251
  ...
  %207 = sext i32 %205 to i64, !llfi_index !253
  %check_cmp7 = icmp eq i64 %206, %207
...
; <label>:208                                     ; preds = %checkBb8, %194
  %209 = load %struct.neighbor** %neighbors, align 8, !llfi_index !254
  %210 = getelementptr inbounds %struct.neighbor* %209, i64 %206, !llfi_index !255
  ...
  %214 = fcmp olt double %203, %212, !llfi_index !258
  %215 = fcmp olt double %204, %213, !llfi_index !258
