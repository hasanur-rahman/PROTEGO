...
; <label>:80                                      ; preds = %checkBb, %73
  br i1 %78, label %81, label %249, !llfi_index !122
...
; <label>:162                                     ; preds = %245, %161
  %163 = load i32* %i, align 4, !llfi_index !211
  %164 = load i32* %rec_count, align 4, !llfi_index !212
  %165 = icmp slt i32 %163, %164, !llfi_index !213
  %166 = icmp slt i32 %163, %164, !llfi_index !213
  %check_cmp5 = icmp eq i1 %165, %166
  br i1 %check_cmp5, label %167, label %checkBb6

checkBb6:                                         ; preds = %162
  call void @check_flag()
  br label %167

; <label>:167                                     ; preds = %checkBb6, %162
  br i1 %165, label %168, label %248, !llfi_index !214
...
; <label>:194                                     ; preds = %169
  ...
  %200 = getelementptr inbounds double* %199, i64 %197, !llfi_index !250
  %201 = getelementptr inbounds double* %199, i64 %198, !llfi_index !250
  %check_cmp7 = icmp eq double* %200, %201
  br i1 %check_cmp7, label %202, label %checkBb8

checkBb8:                                         ; preds = %194
  call void @check_flag()
  br label %202

; <label>:202                                     ; preds = %checkBb8, %194
  %203 = load double* %200, align 8, !llfi_index !251
  ...
  %check_cmp9 = icmp eq %struct.neighbor* %206, %207
  br i1 %check_cmp9, label %208, label %checkBb10

checkBb10:                                        ; preds = %202
  call void @check_flag()
  br label %208

; <label>:208                                     ; preds = %checkBb10, %202
  %209 = getelementptr inbounds %struct.neighbor* %206, i64 %205, !llfi_index !255
  %210 = getelementptr inbounds %struct.neighbor* %209, i32 0, i32 1, !llfi_index !256
  %211 = load double* %210, align 8, !llfi_index !257
  %212 = fcmp olt double %203, %211, !llfi_index !258
  %213 = fcmp olt double %203, %211, !llfi_index !258
...
; <label>:214                                     ; preds = %checkBb12, %208
  br i1 %212, label %215, label %244, !llfi_index !259

; <label>:215                                     ; preds = %214
  %216 = load i32* %i, align 4, !llfi_index !260
  %217 = add nsw i32 %216, 1, !llfi_index !261
  %218 = mul nsw i32 %217, 49, !llfi_index !262
  %219 = sub nsw i32 %218, 1, !llfi_index !263
  %220 = sext i32 %219 to i64, !llfi_index !264
  %221 = getelementptr inbounds [490 x i8]* %sandbox, i32 0, i64 %220, !llfi_index !265
  store i8 0, i8* %221, align 1, !llfi_index !266
  %222 = load i32* %max_idx, align 4, !llfi_index !267
  %223 = sext i32 %222 to i64, !llfi_index !268
  %224 = load %struct.neighbor** %neighbors, align 8, !llfi_index !269
  %225 = getelementptr inbounds %struct.neighbor* %224, i64 %223, !llfi_index !270
  %226 = getelementptr inbounds %struct.neighbor* %225, i32 0, i32 0, !llfi_index !271
  %227 = getelementptr inbounds [49 x i8]* %226, i32 0, i32 0, !llfi_index !272
  %228 = getelementptr inbounds [490 x i8]* %sandbox, i32 0, i32 0, !llfi_index !273
  %229 = load i32* %i, align 4, !llfi_index !274
  %230 = mul nsw i32 %229, 49, !llfi_index !275
  %231 = sext i32 %230 to i64, !llfi_index !276
  %232 = getelementptr inbounds i8* %228, i64 %231, !llfi_index !277
  %233 = call i8* @strcpy(i8* %227, i8* %232) #7, !llfi_index !278
  %234 = load i32* %i, align 4, !llfi_index !279
  %235 = sext i32 %234 to i64, !llfi_index !280
  %236 = load double** %z, align 8, !llfi_index !281
  %237 = getelementptr inbounds double* %236, i64 %235, !llfi_index !282
  %238 = load double* %237, align 8, !llfi_index !283
  %239 = load i32* %max_idx, align 4, !llfi_index !284
  %240 = sext i32 %239 to i64, !llfi_index !285
  %241 = load %struct.neighbor** %neighbors, align 8, !llfi_index !286
  %242 = getelementptr inbounds %struct.neighbor* %241, i64 %240, !llfi_index !287
  %243 = getelementptr inbounds %struct.neighbor* %242, i32 0, i32 1, !llfi_index !288
  store double %238, double* %243, align 8, !llfi_index !289
  br label %244, !llfi_index !290

; <label>:244                                     ; preds = %215, %214
  br label %245, !llfi_index !291

; <label>:245                                     ; preds = %244
  %246 = load i32* %i, align 4, !llfi_index !292
  %247 = add nsw i32 %246, 1, !llfi_index !293
  store i32 %247, i32* %i, align 4, !llfi_index !294
...
; <label>:249                                     ; preds = %80
  %250 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([11 x i8]* @.str9, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8]* @.str10, i32 0, i32 0)), !llfi_index !297
  store %struct._IO_FILE* %250, %struct._IO_FILE** %out, align 8, !llfi_index !298
  %251 = load %struct._IO_FILE** %out, align 8, !llfi_index !299
  %252 = load i32* %k, align 4, !llfi_index !300
  %253 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %251, i8* getelementptr inbounds ([31 x i8]* @.str11, i32 0, i32 0), i32 %252), !llfi_index !301
  %254 = load i32* %k, align 4, !llfi_index !302
  %255 = sub nsw i32 %254, 1, !llfi_index !303
  store i32 %255, i32* %j, align 4, !llfi_index !304
  br label %256, !llfi_index !305

; <label>:256                                     ; preds = %291, %249
  %257 = load i32* %j, align 4, !llfi_index !306
  %258 = icmp sge i32 %257, 0, !llfi_index !307
  br i1 %258, label %259, label %294, !llfi_index !308

; <label>:259                                     ; preds = %256
  %260 = load i32* %j, align 4, !llfi_index !309
  %261 = sext i32 %260 to i64, !llfi_index !310
  %262 = load %struct.neighbor** %neighbors, align 8, !llfi_index !311
  %263 = getelementptr inbounds %struct.neighbor* %262, i64 %261, !llfi_index !312
  %264 = getelementptr inbounds %struct.neighbor* %263, i32 0, i32 1, !llfi_index !313
  %265 = load double* %264, align 8, !llfi_index !314
  %266 = fcmp ogt double %265, 1.000000e+04, !llfi_index !315
  br i1 %266, label %275, label %267, !llfi_index !316

; <label>:267                                     ; preds = %259
  %268 = load i32* %j, align 4, !llfi_index !317
  %269 = sext i32 %268 to i64, !llfi_index !318
  %270 = load %struct.neighbor** %neighbors, align 8, !llfi_index !319
  %271 = getelementptr inbounds %struct.neighbor* %270, i64 %269, !llfi_index !320
  %272 = getelementptr inbounds %struct.neighbor* %271, i32 0, i32 1, !llfi_index !321
  %273 = load double* %272, align 8, !llfi_index !322
  %274 = fcmp olt double %273, 1.000000e+04, !llfi_index !323
  br i1 %274, label %275, label %290, !llfi_index !324

; <label>:275                                     ; preds = %267, %259
  %276 = load %struct._IO_FILE** %out, align 8, !llfi_index !325
  %277 = load i32* %j, align 4, !llfi_index !326
  %278 = sext i32 %277 to i64, !llfi_index !327
  %279 = load %struct.neighbor** %neighbors, align 8, !llfi_index !328
  %280 = getelementptr inbounds %struct.neighbor* %279, i64 %278, !llfi_index !329
  %281 = getelementptr inbounds %struct.neighbor* %280, i32 0, i32 0, !llfi_index !330
  %282 = getelementptr inbounds [49 x i8]* %281, i32 0, i32 0, !llfi_index !331
  %283 = load i32* %j, align 4, !llfi_index !332
  %284 = sext i32 %283 to i64, !llfi_index !333
  %285 = load %struct.neighbor** %neighbors, align 8, !llfi_index !334
  %286 = getelementptr inbounds %struct.neighbor* %285, i64 %284, !llfi_index !335
  %287 = getelementptr inbounds %struct.neighbor* %286, i32 0, i32 1, !llfi_index !336
  %288 = load double* %287, align 8, !llfi_index !337
  %289 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %276, i8* getelementptr inbounds ([14 x i8]* @.str123, i32 0, i32 0), i8* %282, double %288), !llfi_index !338
  br label %290, !llfi_index !339

; <label>:290                                     ; preds = %275, %267
  br label %291, !llfi_index !340

; <label>:291                                     ; preds = %290
  %292 = load i32* %j, align 4, !llfi_index !341
  %293 = add nsw i32 %292, -1, !llfi_index !342
  store i32 %293, i32* %j, align 4, !llfi_index !343
  br label %256, !llfi_index !344

; <label>:294                                     ; preds = %256
  %295 = load %struct._IO_FILE** %out, align 8, !llfi_index !345
  %296 = call i32 @fclose(%struct._IO_FILE* %295), !llfi_index !346
  %297 = load %struct._IO_FILE** %flist, align 8, !llfi_index !347
  %298 = call i32 @fclose(%struct._IO_FILE* %297), !llfi_index !348
