...
; <label>:128                                     ; preds = %124
  ...
  %153 = fadd double %144, %151, !llfi_index !197
  %check_cmp5 = fcmp ueq double %152, %153
...
; <label>:154                                     ; preds = %checkBb6, %128
  %155 = call double @sqrt(double %152) #7, !llfi_index !198
...
; <label>:166                                     ; preds = %249, %165
  ...
  %check_cmp9 = icmp eq i32 %168, %169
  br i1 %check_cmp9, label %170, label %checkBb10

checkBb10:                                        ; preds = %166
  call void @check_flag()
  br label %170

; <label>:170                                     ; preds = %checkBb10, %166
  %171 = icmp slt i32 %167, %168, !llfi_index !213
  br i1 %171, label %172, label %252, !llfi_index !214
...
; <label>:198                                     ; preds = %173
  ...
  %check_cmp11 = icmp eq i64 %201, %202
  br i1 %check_cmp11, label %203, label %checkBb12

checkBb12:                                        ; preds = %198
  call void @check_flag()
  br label %203

; <label>:203                                     ; preds = %checkBb12, %198
  %204 = load double** %z, align 8, !llfi_index !249
  %205 = load double** %z, align 8, !llfi_index !249
  %check_cmp13 = icmp eq double* %204, %205
  br i1 %check_cmp13, label %206, label %checkBb14

checkBb14:                                        ; preds = %203
  call void @check_flag()
  br label %206

; <label>:206                                     ; preds = %checkBb14, %203
  %207 = getelementptr inbounds double* %204, i64 %201, !llfi_index !250
  %208 = load double* %207, align 8, !llfi_index !251
  ...
  %check_cmp15 = icmp eq i1 %216, %217
  br i1 %check_cmp15, label %218, label %checkBb16

checkBb16:                                        ; preds = %206
  call void @check_flag()
  br label %218

; <label>:218                                     ; preds = %checkBb16, %206
