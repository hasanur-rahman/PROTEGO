...
; <label>:80                                      ; preds = %checkBb, %73
  br i1 %78, label %81, label %254, !llfi_index !122
...
; <label>:162                                     ; preds = %250, %161
  %163 = load i32* %i, align 4, !llfi_index !211
  %164 = load i32* %rec_count, align 4, !llfi_index !212
  %165 = load i32* %rec_count, align 4, !llfi_index !212
  %166 = icmp slt i32 %163, %164, !llfi_index !213
  %167 = icmp slt i32 %163, %165, !llfi_index !213
  %check_cmp5 = icmp eq i1 %166, %167
...
; <label>:168                                     ; preds = %checkBb6, %162
  br i1 %166, label %169, label %253, !llfi_index !214
...
; <label>:170                                     ; preds = %192, %169
  %171 = load i32* %j, align 4, !llfi_index !219
  %172 = load i32* %k, align 4, !llfi_index !220
  %173 = icmp slt i32 %171, %172, !llfi_index !221
  br i1 %173, label %174, label %195, !llfi_index !222

; <label>:174                                     ; preds = %170
  %175 = load i32* %j, align 4, !llfi_index !223
  %176 = sext i32 %175 to i64, !llfi_index !224
  %177 = load %struct.neighbor** %neighbors, align 8, !llfi_index !225
  %178 = getelementptr inbounds %struct.neighbor* %177, i64 %176, !llfi_index !226
  %179 = getelementptr inbounds %struct.neighbor* %178, i32 0, i32 1, !llfi_index !227
  %180 = load double* %179, align 8, !llfi_index !228
  %181 = load double* %max_dist, align 8, !llfi_index !229
  %182 = fcmp ogt double %180, %181, !llfi_index !230
  br i1 %182, label %183, label %191, !llfi_index !231

; <label>:183                                     ; preds = %174
  %184 = load i32* %j, align 4, !llfi_index !232
  %185 = sext i32 %184 to i64, !llfi_index !233
  %186 = load %struct.neighbor** %neighbors, align 8, !llfi_index !234
  %187 = getelementptr inbounds %struct.neighbor* %186, i64 %185, !llfi_index !235
  %188 = getelementptr inbounds %struct.neighbor* %187, i32 0, i32 1, !llfi_index !236
  %189 = load double* %188, align 8, !llfi_index !237
  store double %189, double* %max_dist, align 8, !llfi_index !238
  %190 = load i32* %j, align 4, !llfi_index !239
  store i32 %190, i32* %max_idx, align 4, !llfi_index !240
  br label %191, !llfi_index !241

; <label>:191                                     ; preds = %183, %174
  br label %192, !llfi_index !242

; <label>:192                                     ; preds = %191
  %193 = load i32* %j, align 4, !llfi_index !243
  %194 = add nsw i32 %193, 1, !llfi_index !244
  store i32 %194, i32* %j, align 4, !llfi_index !245
  br label %170, !llfi_index !246
...
; <label>:195                                     ; preds = %170
  ...
  %204 = load double* %202, align 8, !llfi_index !251
  %205 = load double* %203, align 8, !llfi_index !251
  %206 = load i32* %max_idx, align 4, !llfi_index !252
  %207 = load i32* %max_idx, align 4, !llfi_index !252
  %208 = sext i32 %206 to i64, !llfi_index !253
  %209 = sext i32 %207 to i64, !llfi_index !253
  %check_cmp7 = icmp eq i64 %208, %209
  br i1 %check_cmp7, label %210, label %checkBb8

checkBb8:                                         ; preds = %195
  call void @check_flag()
  br label %210

; <label>:210                                     ; preds = %checkBb8, %195
  %211 = load %struct.neighbor** %neighbors, align 8, !llfi_index !254
  %212 = load %struct.neighbor** %neighbors, align 8, !llfi_index !254
  %check_cmp9 = icmp eq %struct.neighbor* %211, %212
  br i1 %check_cmp9, label %213, label %checkBb10

checkBb10:                                        ; preds = %210
  call void @check_flag()
  br label %213

; <label>:213                                     ; preds = %checkBb10, %210
  %214 = getelementptr inbounds %struct.neighbor* %211, i64 %208, !llfi_index !255
  %215 = getelementptr inbounds %struct.neighbor* %214, i32 0, i32 1, !llfi_index !256
  %216 = load double* %215, align 8, !llfi_index !257
  %217 = fcmp olt double %204, %216, !llfi_index !258
  %218 = fcmp olt double %205, %216, !llfi_index !258
  %check_cmp11 = icmp eq i1 %217, %218
  br i1 %check_cmp11, label %219, label %checkBb12

checkBb12:                                        ; preds = %213
  call void @check_flag()
  br label %219

; <label>:219                                     ; preds = %checkBb12, %213
  br i1 %217, label %220, label %249, !llfi_index !259

; <label>:220                                     ; preds = %219
  %221 = load i32* %i, align 4, !llfi_index !260
  %222 = add nsw i32 %221, 1, !llfi_index !261
  %223 = mul nsw i32 %222, 49, !llfi_index !262
  %224 = sub nsw i32 %223, 1, !llfi_index !263
  %225 = sext i32 %224 to i64, !llfi_index !264
  %226 = getelementptr inbounds [490 x i8]* %sandbox, i32 0, i64 %225, !llfi_index !265
  store i8 0, i8* %226, align 1, !llfi_index !266
  %227 = load i32* %max_idx, align 4, !llfi_index !267
  %228 = sext i32 %227 to i64, !llfi_index !268
  %229 = load %struct.neighbor** %neighbors, align 8, !llfi_index !269
  %230 = getelementptr inbounds %struct.neighbor* %229, i64 %228, !llfi_index !270
  %231 = getelementptr inbounds %struct.neighbor* %230, i32 0, i32 0, !llfi_index !271
  %232 = getelementptr inbounds [49 x i8]* %231, i32 0, i32 0, !llfi_index !272
  %233 = getelementptr inbounds [490 x i8]* %sandbox, i32 0, i32 0, !llfi_index !273
  %234 = load i32* %i, align 4, !llfi_index !274
  %235 = mul nsw i32 %234, 49, !llfi_index !275
  %236 = sext i32 %235 to i64, !llfi_index !276
  %237 = getelementptr inbounds i8* %233, i64 %236, !llfi_index !277
  %238 = call i8* @strcpy(i8* %232, i8* %237) #7, !llfi_index !278
  %239 = load i32* %i, align 4, !llfi_index !279
  %240 = sext i32 %239 to i64, !llfi_index !280
  %241 = load double** %z, align 8, !llfi_index !281
  %242 = getelementptr inbounds double* %241, i64 %240, !llfi_index !282
  %243 = load double* %242, align 8, !llfi_index !283
  %244 = load i32* %max_idx, align 4, !llfi_index !284
  %245 = sext i32 %244 to i64, !llfi_index !285
  %246 = load %struct.neighbor** %neighbors, align 8, !llfi_index !286
  %247 = getelementptr inbounds %struct.neighbor* %246, i64 %245, !llfi_index !287
  %248 = getelementptr inbounds %struct.neighbor* %247, i32 0, i32 1, !llfi_index !288
  store double %243, double* %248, align 8, !llfi_index !289
  br label %249, !llfi_index !290

; <label>:249                                     ; preds = %220, %219
  br label %250, !llfi_index !291

; <label>:250                                     ; preds = %249
  %251 = load i32* %i, align 4, !llfi_index !292
  %252 = add nsw i32 %251, 1, !llfi_index !293
  store i32 %252, i32* %i, align 4, !llfi_index !294
...
; <label>:254                                     ; preds = %80
  %255 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([11 x i8]* @.str9, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8]* @.str10, i32 0, i32 0)), !llfi_index !297
  store %struct._IO_FILE* %255, %struct._IO_FILE** %out, align 8, !llfi_index !298
  %256 = load %struct._IO_FILE** %out, align 8, !llfi_index !299
  %257 = load i32* %k, align 4, !llfi_index !300
  %258 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %256, i8* getelementptr inbounds ([31 x i8]* @.str11, i32 0, i32 0), i32 %257), !llfi_index !301
  %259 = load i32* %k, align 4, !llfi_index !302
  %260 = sub nsw i32 %259, 1, !llfi_index !303
  store i32 %260, i32* %j, align 4, !llfi_index !304
  br label %261, !llfi_index !305

; <label>:261                                     ; preds = %296, %254
  %262 = load i32* %j, align 4, !llfi_index !306
  %263 = icmp sge i32 %262, 0, !llfi_index !307
  br i1 %263, label %264, label %299, !llfi_index !308

; <label>:264                                     ; preds = %261
  %265 = load i32* %j, align 4, !llfi_index !309
  %266 = sext i32 %265 to i64, !llfi_index !310
  %267 = load %struct.neighbor** %neighbors, align 8, !llfi_index !311
  %268 = getelementptr inbounds %struct.neighbor* %267, i64 %266, !llfi_index !312
  %269 = getelementptr inbounds %struct.neighbor* %268, i32 0, i32 1, !llfi_index !313
  %270 = load double* %269, align 8, !llfi_index !314
  %271 = fcmp ogt double %270, 1.000000e+04, !llfi_index !315
  br i1 %271, label %280, label %272, !llfi_index !316

; <label>:272                                     ; preds = %264
  %273 = load i32* %j, align 4, !llfi_index !317
  %274 = sext i32 %273 to i64, !llfi_index !318
  %275 = load %struct.neighbor** %neighbors, align 8, !llfi_index !319
  %276 = getelementptr inbounds %struct.neighbor* %275, i64 %274, !llfi_index !320
  %277 = getelementptr inbounds %struct.neighbor* %276, i32 0, i32 1, !llfi_index !321
  %278 = load double* %277, align 8, !llfi_index !322
  %279 = fcmp olt double %278, 1.000000e+04, !llfi_index !323
  br i1 %279, label %280, label %295, !llfi_index !324

; <label>:280                                     ; preds = %272, %264
  %281 = load %struct._IO_FILE** %out, align 8, !llfi_index !325
  %282 = load i32* %j, align 4, !llfi_index !326
  %283 = sext i32 %282 to i64, !llfi_index !327
  %284 = load %struct.neighbor** %neighbors, align 8, !llfi_index !328
  %285 = getelementptr inbounds %struct.neighbor* %284, i64 %283, !llfi_index !329
  %286 = getelementptr inbounds %struct.neighbor* %285, i32 0, i32 0, !llfi_index !330
  %287 = getelementptr inbounds [49 x i8]* %286, i32 0, i32 0, !llfi_index !331
  %288 = load i32* %j, align 4, !llfi_index !332
  %289 = sext i32 %288 to i64, !llfi_index !333
  %290 = load %struct.neighbor** %neighbors, align 8, !llfi_index !334
  %291 = getelementptr inbounds %struct.neighbor* %290, i64 %289, !llfi_index !335
  %292 = getelementptr inbounds %struct.neighbor* %291, i32 0, i32 1, !llfi_index !336
  %293 = load double* %292, align 8, !llfi_index !337
  %294 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %281, i8* getelementptr inbounds ([14 x i8]* @.str123, i32 0, i32 0), i8* %287, double %293), !llfi_index !338
  br label %295, !llfi_index !339

; <label>:295                                     ; preds = %280, %272
  br label %296, !llfi_index !340

; <label>:296                                     ; preds = %295
  %297 = load i32* %j, align 4, !llfi_index !341
  %298 = add nsw i32 %297, -1, !llfi_index !342
  store i32 %298, i32* %j, align 4, !llfi_index !343
  br label %261, !llfi_index !344

; <label>:299                                     ; preds = %261
  %300 = load %struct._IO_FILE** %out, align 8, !llfi_index !345
  %301 = call i32 @fclose(%struct._IO_FILE* %300), !llfi_index !346
  %302 = load %struct._IO_FILE** %flist, align 8, !llfi_index !347
  %303 = call i32 @fclose(%struct._IO_FILE* %302), !llfi_index !348
