...
; <label>:124                                     ; preds = %158, %123
  ...
  br i1 %127, label %128, label %161, !llfi_index !172
...
; <label>:169                                     ; preds = %checkBb6, %162
  br i1 %167, label %170, label %244, !llfi_index !214
...
; <label>:196                                     ; preds = %171
  ...
  %check_cmp7 = icmp eq i32 %197, %198
  br i1 %check_cmp7, label %199, label %checkBb8

checkBb8:                                         ; preds = %196
  call void @check_flag()
  br label %199

; <label>:199                                     ; preds = %checkBb8, %196
  %200 = sext i32 %197 to i64, !llfi_index !248
  ...
  br i1 %210, label %211, label %240, !llfi_index !259
