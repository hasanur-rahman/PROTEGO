...
; <label>:80                                      ; preds = %checkBb, %73
  br i1 %78, label %81, label %245, !llfi_index !122
...
; <label>:128                                     ; preds = %124
  ...
  %144 = fmul double %140, %143, !llfi_index !189
  %145 = load double* %tmp_long, align 8, !llfi_index !190
  %146 = load double* %target_long, align 8, !llfi_index !191
  %147 = fsub double %145, %146, !llfi_index !192
  %148 = load double* %tmp_long, align 8, !llfi_index !193
  %149 = load double* %target_long, align 8, !llfi_index !194
  %150 = fsub double %148, %149, !llfi_index !195
  %151 = fmul double %147, %150, !llfi_index !196
  %152 = fadd double %144, %151, !llfi_index !197
  %153 = call double @sqrt(double %152) #7, !llfi_index !198
  ...
  %158 = getelementptr inbounds double* %156, i64 %155, !llfi_index !202
  %check_cmp5 = icmp eq double* %157, %158
  br i1 %check_cmp5, label %159, label %checkBb6

checkBb6:                                         ; preds = %128
  call void @check_flag()
  br label %159

; <label>:159                                     ; preds = %checkBb6, %128
...
; <label>:164                                     ; preds = %241, %163
  ...
  %check_cmp7 = icmp eq i32 %166, %167
  br i1 %check_cmp7, label %168, label %checkBb8

checkBb8:                                         ; preds = %164
  call void @check_flag()
  br label %168

; <label>:168                                     ; preds = %checkBb8, %164
  %169 = icmp slt i32 %165, %166, !llfi_index !213
  br i1 %169, label %170, label %244, !llfi_index !214
...
; <label>:196                                     ; preds = %171
  ...
  %198 = sext i32 %197 to i64, !llfi_index !248
  %199 = load double** %z, align 8, !llfi_index !249
  %200 = getelementptr inbounds double* %199, i64 %198, !llfi_index !250
  %201 = load double* %200, align 8, !llfi_index !251
  %202 = load i32* %max_idx, align 4, !llfi_index !252
  %203 = sext i32 %202 to i64, !llfi_index !253
  %204 = load %struct.neighbor** %neighbors, align 8, !llfi_index !254
  %205 = getelementptr inbounds %struct.neighbor* %204, i64 %203, !llfi_index !255
  %206 = getelementptr inbounds %struct.neighbor* %205, i32 0, i32 1, !llfi_index !256
  %207 = load double* %206, align 8, !llfi_index !257
  %208 = fcmp olt double %201, %207, !llfi_index !258
  %209 = fcmp olt double %201, %207, !llfi_index !258
  %check_cmp9 = icmp eq i1 %208, %209
  br i1 %check_cmp9, label %210, label %checkBb10

checkBb10:                                        ; preds = %196
  call void @check_flag()
  br label %210

; <label>:210                                     ; preds = %checkBb10, %196
  br i1 %208, label %211, label %240, !llfi_index !259

; <label>:211                                     ; preds = %210
  %212 = load i32* %i, align 4, !llfi_index !260
  %213 = add nsw i32 %212, 1, !llfi_index !261
  %214 = mul nsw i32 %213, 49, !llfi_index !262
  %215 = sub nsw i32 %214, 1, !llfi_index !263
  %216 = sext i32 %215 to i64, !llfi_index !264
  %217 = getelementptr inbounds [490 x i8]* %sandbox, i32 0, i64 %216, !llfi_index !265
  store i8 0, i8* %217, align 1, !llfi_index !266
  %218 = load i32* %max_idx, align 4, !llfi_index !267
  %219 = sext i32 %218 to i64, !llfi_index !268
  %220 = load %struct.neighbor** %neighbors, align 8, !llfi_index !269
  %221 = getelementptr inbounds %struct.neighbor* %220, i64 %219, !llfi_index !270
  %222 = getelementptr inbounds %struct.neighbor* %221, i32 0, i32 0, !llfi_index !271
  %223 = getelementptr inbounds [49 x i8]* %222, i32 0, i32 0, !llfi_index !272
  %224 = getelementptr inbounds [490 x i8]* %sandbox, i32 0, i32 0, !llfi_index !273
  %225 = load i32* %i, align 4, !llfi_index !274
  %226 = mul nsw i32 %225, 49, !llfi_index !275
  %227 = sext i32 %226 to i64, !llfi_index !276
  %228 = getelementptr inbounds i8* %224, i64 %227, !llfi_index !277
  %229 = call i8* @strcpy(i8* %223, i8* %228) #7, !llfi_index !278
  %230 = load i32* %i, align 4, !llfi_index !279
  %231 = sext i32 %230 to i64, !llfi_index !280
  %232 = load double** %z, align 8, !llfi_index !281
  %233 = getelementptr inbounds double* %232, i64 %231, !llfi_index !282
  %234 = load double* %233, align 8, !llfi_index !283
  %235 = load i32* %max_idx, align 4, !llfi_index !284
  %236 = sext i32 %235 to i64, !llfi_index !285
  %237 = load %struct.neighbor** %neighbors, align 8, !llfi_index !286
  %238 = getelementptr inbounds %struct.neighbor* %237, i64 %236, !llfi_index !287
  %239 = getelementptr inbounds %struct.neighbor* %238, i32 0, i32 1, !llfi_index !288
  store double %234, double* %239, align 8, !llfi_index !289
  br label %240, !llfi_index !290

; <label>:240                                     ; preds = %211, %210
  br label %241, !llfi_index !291

; <label>:241                                     ; preds = %240
  %242 = load i32* %i, align 4, !llfi_index !292
  %243 = add nsw i32 %242, 1, !llfi_index !293
  store i32 %243, i32* %i, align 4, !llfi_index !294
...
; <label>:245                                     ; preds = %80
  %246 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([11 x i8]* @.str9, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8]* @.str10, i32 0, i32 0)), !llfi_index !297
  store %struct._IO_FILE* %246, %struct._IO_FILE** %out, align 8, !llfi_index !298
  %247 = load %struct._IO_FILE** %out, align 8, !llfi_index !299
  %248 = load i32* %k, align 4, !llfi_index !300
  %249 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %247, i8* getelementptr inbounds ([31 x i8]* @.str11, i32 0, i32 0), i32 %248), !llfi_index !301
  %250 = load i32* %k, align 4, !llfi_index !302
  %251 = sub nsw i32 %250, 1, !llfi_index !303
  store i32 %251, i32* %j, align 4, !llfi_index !304
  br label %252, !llfi_index !305

; <label>:252                                     ; preds = %287, %245
  %253 = load i32* %j, align 4, !llfi_index !306
  %254 = icmp sge i32 %253, 0, !llfi_index !307
  br i1 %254, label %255, label %290, !llfi_index !308

; <label>:255                                     ; preds = %252
  %256 = load i32* %j, align 4, !llfi_index !309
  %257 = sext i32 %256 to i64, !llfi_index !310
  %258 = load %struct.neighbor** %neighbors, align 8, !llfi_index !311
  %259 = getelementptr inbounds %struct.neighbor* %258, i64 %257, !llfi_index !312
  %260 = getelementptr inbounds %struct.neighbor* %259, i32 0, i32 1, !llfi_index !313
  %261 = load double* %260, align 8, !llfi_index !314
  %262 = fcmp ogt double %261, 1.000000e+04, !llfi_index !315
  br i1 %262, label %271, label %263, !llfi_index !316

; <label>:263                                     ; preds = %255
  %264 = load i32* %j, align 4, !llfi_index !317
  %265 = sext i32 %264 to i64, !llfi_index !318
  %266 = load %struct.neighbor** %neighbors, align 8, !llfi_index !319
  %267 = getelementptr inbounds %struct.neighbor* %266, i64 %265, !llfi_index !320
  %268 = getelementptr inbounds %struct.neighbor* %267, i32 0, i32 1, !llfi_index !321
  %269 = load double* %268, align 8, !llfi_index !322
  %270 = fcmp olt double %269, 1.000000e+04, !llfi_index !323
  br i1 %270, label %271, label %286, !llfi_index !324

; <label>:271                                     ; preds = %263, %255
  %272 = load %struct._IO_FILE** %out, align 8, !llfi_index !325
  %273 = load i32* %j, align 4, !llfi_index !326
  %274 = sext i32 %273 to i64, !llfi_index !327
  %275 = load %struct.neighbor** %neighbors, align 8, !llfi_index !328
  %276 = getelementptr inbounds %struct.neighbor* %275, i64 %274, !llfi_index !329
  %277 = getelementptr inbounds %struct.neighbor* %276, i32 0, i32 0, !llfi_index !330
  %278 = getelementptr inbounds [49 x i8]* %277, i32 0, i32 0, !llfi_index !331
  %279 = load i32* %j, align 4, !llfi_index !332
  %280 = sext i32 %279 to i64, !llfi_index !333
  %281 = load %struct.neighbor** %neighbors, align 8, !llfi_index !334
  %282 = getelementptr inbounds %struct.neighbor* %281, i64 %280, !llfi_index !335
  %283 = getelementptr inbounds %struct.neighbor* %282, i32 0, i32 1, !llfi_index !336
  %284 = load double* %283, align 8, !llfi_index !337
  %285 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %272, i8* getelementptr inbounds ([14 x i8]* @.str123, i32 0, i32 0), i8* %278, double %284), !llfi_index !338
  br label %286, !llfi_index !339

; <label>:286                                     ; preds = %271, %263
  br label %287, !llfi_index !340

; <label>:287                                     ; preds = %286
  %288 = load i32* %j, align 4, !llfi_index !341
  %289 = add nsw i32 %288, -1, !llfi_index !342
  store i32 %289, i32* %j, align 4, !llfi_index !343
  br label %252, !llfi_index !344

; <label>:290                                     ; preds = %252
  %291 = load %struct._IO_FILE** %out, align 8, !llfi_index !345
  %292 = call i32 @fclose(%struct._IO_FILE* %291), !llfi_index !346
  %293 = load %struct._IO_FILE** %flist, align 8, !llfi_index !347
  %294 = call i32 @fclose(%struct._IO_FILE* %293), !llfi_index !348
