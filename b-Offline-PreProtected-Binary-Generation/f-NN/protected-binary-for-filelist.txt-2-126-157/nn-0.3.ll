...
; <label>:89                                      ; preds = %checkBb2, %81
  br i1 %87, label %90, label %120, !llfi_index !130
...
; <label>:121                                     ; preds = %159, %120
  ...
  br i1 %124, label %125, label %162, !llfi_index !172
...
; <label>:125                                     ; preds = %121
  ...
  %141 = fmul double %137, %140, !llfi_index !189
  %142 = fmul double %137, %140, !llfi_index !189
  %check_cmp3 = fcmp ueq double %141, %142
  br i1 %check_cmp3, label %143, label %checkBb4

checkBb4:                                         ; preds = %125
  call void @check_flag()
  br label %143

; <label>:143                                     ; preds = %checkBb4, %125
  ...
  %151 = fadd double %141, %150, !llfi_index !197
  %152 = call double @sqrt(double %151) #7, !llfi_index !198
  %153 = load i32* %i, align 4, !llfi_index !199
  %154 = sext i32 %153 to i64, !llfi_index !200
  %155 = load double** %z, align 8, !llfi_index !201
  %156 = getelementptr inbounds double* %155, i64 %154, !llfi_index !202
  %157 = getelementptr inbounds double* %155, i64 %154, !llfi_index !202
  %check_cmp5 = icmp eq double* %156, %157
...
; <label>:158                                     ; preds = %checkBb6, %143
  store double %152, double* %156, align 8, !llfi_index !203
...
; <label>:163                                     ; preds = %249, %162
  ...
  %check_cmp7 = icmp eq i1 %167, %168
  br i1 %check_cmp7, label %169, label %checkBb8

checkBb8:                                         ; preds = %163
  call void @check_flag()
  br label %169

; <label>:169                                     ; preds = %checkBb8, %163
  br i1 %167, label %170, label %252, !llfi_index !214
...
; <label>:196                                     ; preds = %171
  ...
  %check_cmp9 = icmp eq double* %203, %204
  br i1 %check_cmp9, label %205, label %checkBb10

checkBb10:                                        ; preds = %196
  call void @check_flag()
  br label %205

; <label>:205                                     ; preds = %checkBb10, %196
  ...
  %check_cmp11 = icmp eq %struct.neighbor* %209, %210
...
; <label>:211                                     ; preds = %checkBb12, %205
  %212 = getelementptr inbounds %struct.neighbor* %209, i64 %208, !llfi_index !255
  ...
  %216 = fcmp olt double %206, %214, !llfi_index !258
