...
; <label>:170                                     ; preds = %checkBb8, %164
  br i1 %168, label %171, label %253, !llfi_index !214
...
; <label>:197                                     ; preds = %172
  ...
  %206 = load double* %204, align 8, !llfi_index !251
  %207 = load double* %205, align 8, !llfi_index !251
  %208 = load i32* %max_idx, align 4, !llfi_index !252
  %209 = load i32* %max_idx, align 4, !llfi_index !252
  %check_cmp9 = icmp eq i32 %208, %209
...
; <label>:210                                     ; preds = %checkBb10, %197
  %211 = sext i32 %208 to i64, !llfi_index !253
  %212 = load %struct.neighbor** %neighbors, align 8, !llfi_index !254
  %213 = getelementptr inbounds %struct.neighbor* %212, i64 %211, !llfi_index !255
  %214 = getelementptr inbounds %struct.neighbor* %213, i32 0, i32 1, !llfi_index !256
  %215 = load double* %214, align 8, !llfi_index !257
  %216 = load double* %214, align 8, !llfi_index !257
  %217 = fcmp olt double %206, %215, !llfi_index !258
  %218 = fcmp olt double %207, %216, !llfi_index !258
