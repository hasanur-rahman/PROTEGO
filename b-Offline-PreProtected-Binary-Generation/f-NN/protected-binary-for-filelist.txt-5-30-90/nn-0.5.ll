...
; <label>:126                                     ; preds = %122
  ...
  %151 = call double @sqrt(double %150) #7, !llfi_index !198
  %152 = load i32* %i, align 4, !llfi_index !199
  %153 = sext i32 %152 to i64, !llfi_index !200
  %154 = load double** %z, align 8, !llfi_index !201
  %155 = getelementptr inbounds double* %154, i64 %153, !llfi_index !202
  %156 = getelementptr inbounds double* %154, i64 %153, !llfi_index !202
  %check_cmp3 = icmp eq double* %155, %156
  br i1 %check_cmp3, label %157, label %checkBb4

checkBb4:                                         ; preds = %126
  call void @check_flag()
  br label %157

; <label>:157                                     ; preds = %checkBb4, %126
  store double %151, double* %155, align 8, !llfi_index !203
...
; <label>:162                                     ; preds = %248, %161
  ...
  %check_cmp5 = icmp eq i32 %164, %165
  br i1 %check_cmp5, label %166, label %checkBb6

checkBb6:                                         ; preds = %162
  call void @check_flag()
  br label %166

; <label>:166                                     ; preds = %checkBb6, %162
  %167 = icmp slt i32 %163, %164, !llfi_index !213
  br i1 %167, label %168, label %251, !llfi_index !214
...
; <label>:194                                     ; preds = %169
  ...
  %check_cmp7 = icmp eq i32 %195, %196
...
; <label>:197                                     ; preds = %checkBb8, %194
  %198 = sext i32 %195 to i64, !llfi_index !248
  ...
  %check_cmp9 = icmp eq double* %201, %202
...
; <label>:203                                     ; preds = %checkBb10, %197
  ...
  %check_cmp11 = icmp eq i32 %205, %206
...
; <label>:207                                     ; preds = %checkBb12, %203
  ...
  %212 = getelementptr inbounds %struct.neighbor* %210, i32 0, i32 1, !llfi_index !256
  %check_cmp13 = icmp eq double* %211, %212
  br i1 %check_cmp13, label %213, label %checkBb14

checkBb14:                                        ; preds = %207
  call void @check_flag()
  br label %213

; <label>:213                                     ; preds = %checkBb14, %207
  %214 = load double* %211, align 8, !llfi_index !257
  %215 = fcmp olt double %204, %214, !llfi_index !258
  %216 = fcmp olt double %204, %214, !llfi_index !258
  %check_cmp15 = icmp eq i1 %215, %216
  br i1 %check_cmp15, label %217, label %checkBb16

checkBb16:                                        ; preds = %213
  call void @check_flag()
  br label %217

; <label>:217                                     ; preds = %checkBb16, %213
