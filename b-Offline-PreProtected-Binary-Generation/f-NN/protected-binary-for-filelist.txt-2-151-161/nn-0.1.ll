...
; <label>:79                                      ; preds = %checkBb, %73
  br i1 %77, label %80, label %247, !llfi_index !122
...
; <label>:164                                     ; preds = %checkBb4, %158
  br i1 %162, label %165, label %246, !llfi_index !214
...
; <label>:204                                     ; preds = %checkBb6, %191
  ...
  %210 = fcmp olt double %200, %209, !llfi_index !258
  %211 = fcmp olt double %201, %209, !llfi_index !258
  %check_cmp7 = icmp eq i1 %210, %211
  br i1 %check_cmp7, label %212, label %checkBb8

checkBb8:                                         ; preds = %204
  call void @check_flag()
  br label %212

; <label>:212                                     ; preds = %checkBb8, %204
